...
if (! (Test-Path "DKPowershell/functions/DK.ps1")) { Invoke-WebRequest -URI "$DKHTTP_DKPOWERSHELL_FUNCTIONS_DIR/functions/DK.ps1" -OutFile "DKPowershell\functions\DK.ps1" }
