...
var WebSocketServer = function WebSocketServer(url) {
	...
	this.pointer = CPP_Duktape_createDKObject("DKUWebSocketsServer")

	//// Instance properties ////
	Object.defineProperty(this, "isConnected", {
        get: function isConnected() {
            return CPP_DKUWebSocketsServer_isConnected(url)
        }
    })
