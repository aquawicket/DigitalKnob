...
if(mysql)
	...
	WIN_TARGET_dk_libDebug(${PATH_MYSQL}/lib/debug/mysqlclient.lib)
	WIN_TARGET_dk_libRelease(${PATH_MYSQL}/lib/mysqlclient.lib)
	APPLE_dk_libDebug(${PATH_MYSQL}/lib/libmysqlclient.a)
	APPLE_dk_libRelease(${PATH_MYSQL}/lib/libmysqlclient.a)
	LINUX_TARGET_dk_libDebug(${PATH_MYSQL}/lib/x86_64-linux-gnu/libmysqlclient.a)
	LINUX_TARGET_dk_libRelease(${PATH_MYSQL}/lib/x86_64-linux-gnu/libmysqlclient.a)
endif(mysql)
