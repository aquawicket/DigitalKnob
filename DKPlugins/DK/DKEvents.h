...
public:
	...
	{
		return DKEvents::AddEvent(id, type, boost::bind(func, _this_, boost::placeholders::_1), _this_);
	};
	...
	{
		return DKEvents::AddEvent(id, type, jsreturn, boost::bind(func, _this_, boost::placeholders::_1), _this_);
	};
	...
	{
		reg_funcs.push_back(boost::bind(func, _this_, boost::placeholders::_1, boost::placeholders::_2));
	}
	...
	static void RemoveRegisterEventFunc(bool (T::*func)(const DKString&, const DKString&), T* _this)
	{
		for(unsigned int i=0; i<reg_funcs.size(); ++i){
			if(reg_funcs[i] == boost::bind(func, _this_, boost::placeholders::_1, boost::placeholders::_2)){
	...
	{
		unreg_funcs.push_back(boost::bind(func, _this_, boost::placeholders::_1, boost::placeholders::_2));
	}
	...
	static void RemoveUnegisterEventFunc(bool (T::*func)(const DKString&, const DKString&), T* _this)
	{
		for(unsigned int i=0; i<unreg_funcs.size(); ++i){
			if(unreg_funcs[i] == boost::bind(func, _this_, boost::placeholders::_1, boost::placeholders::_2)){
	...
	static void RemoveSendEventFunc(bool (T::*func)(const DKString&, const DKString&, const DKString&), T* _this)
	{
		for(unsigned int i=0; i<send_funcs.size(); ++i){
			if(send_funcs[i] == boost::bind(func, _this_, boost::placeholders::_1, boost::placeholders::_2, boost::placeholders::_3)){
