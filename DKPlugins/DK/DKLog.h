...
//#endif
	...
	#define DKASSERT_COLOR  DKLTRED   //FOREGROUND_RED|FOREGROUND_INTENSITY|BACKGROUND_INTENSITY
	#define DKFATAL_COLOR   DKLTRED   //FOREGROUND_RED|FOREGROUND_INTENSITY|BACKGROUND_INTENSITY
	#define DKERROR_COLOR   DKRED     //FOREGROUND_RED|FOREGROUND_INTENSITY
	#define DKWARN_COLOR    DKYELLOW  //FOREGROUND_RED|FOREGROUND_GREEN|FOREGROUND_INTENSITY
	#define DKINFO_COLOR    DKWHITE   //FOREGROUND_RED|FOREGROUND_GREEN|FOREGROUND_BLUE|FOREGROUND_INTENSITY
	#define DKDEBUG_COLOR   DKDRKBLUE //FOREGROUND_BLUE|FOREGROUND_GREEN
	#define DKVERBOSE_COLOR DKLTBLUE  //FOREGROUND_BLUE|FOREGROUND_GREEN|BACKGROUND_BLUE|FOREGROUND_INTENSITY	
#else
	...
	#define DKERROR_COLOR   31 //"\x1B[31m"
