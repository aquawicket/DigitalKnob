...
bool DKAudio::Init(){
	...
	return DKERROR("DKAudio::Init(): No audio interface available\n");
}
...
bool DKAudio::GetDuration(int& duration){
	...
	return DKERROR("DKAudio::GetDuration(): No GetDuration funtion available\n");
}
...
bool DKAudio::GetTime(int& time){
	...
	return DKERROR("DKAudio::GetTime(): No GetTime funtion available\n");
}
...
bool DKAudio::GetVolume(int& volume){
	...
	return DKERROR("DKAudio::GetVolume(): No GetVolume funtion available\n");
}
...
bool DKAudio::Mute(){
	...
	return DKERROR("DKAudio::Mute(): No Mute funtion available\n");
}
...
bool DKAudio::OpenMusic(DKString& file){
	...
	return DKERROR("DKAudio::OpenMusic(): No OpenMusic funtion available\n");
}
...
bool DKAudio::Pause(DKString& file){
	...
	return DKERROR("DKAudio::Pause(): No Pause funtion available\n");
}
...
bool DKAudio::PlaySound(const DKString& file){
	...
	return DKERROR("DKAudio::PlaySound(): No PlaySound funtion available\n");
}
...
bool DKAudio::Resume(DKString& file){
	...
	return DKERROR("DKAudio::Resume(): No Resume funtion available\n");
}
...
bool DKAudio::SetTime(int& seconds){
	...
	return DKERROR("DKAudio::SetTime(): No SetTime funtion available\n");
}
...
bool DKAudio::SetVolume(int& volume){
	...
	return DKERROR("DKAudio::SetVolume(): No SetVolume funtion available\n");
}
...
bool DKAudio::UnMute(){
	...
	return DKERROR("DKAudio::UnMute(): No UnMute funtion available\n");
}