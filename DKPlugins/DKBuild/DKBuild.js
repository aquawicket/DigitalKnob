...
var OS = ""   //win32,win64,mac32,mac64,linux_x86,linux64,ios_arm32,ios_arm64,iossim_x86,iossim_x86_64,android_arm32,android_arm64,raspberry32,raspberry64 
var APP = ""  //DKAppname
...
function DKBuild_DoResults(){
	...
	//////// LINUX,  RASPBERRY //////////////////////////////////////////////////////////////
	if(OS === "linux_x86" || OS === "linux64" || OS === "raspberry32" || OS === "raspberry64"){
		DKBuild_ValidateGcc()
		CPP_DKFile_MkDir(app_path+OS)
		if(TYPE === "Debug" || TYPE === "ALL"){
