...
if(WIN)
	if(DEBUG)
		dk_copy(${DKPLUGINS}/DKRestart/${OS}/${DEBUG_DIR}/DKRestart.exe ${DKPROJECT}/assets/DKRestart/${OS}Debug OVERWRITE)
	endif()
	if(RELEASE)
		dk_copy(${DKPLUGINS}/DKRestart/${OS}/${RELEASE_DIR}/DKRestart.exe ${DKPROJECT}/assets/DKRestart/${OS}Release OVERWRITE)
	endif()
endif()
...
if(MAC)
	if(DEBUG)
		dk_copy(${DKPLUGINS}/DKRestart/${OS}/${DEBUG_DIR}/DKRestart.app ${DKPROJECT}/assets/DKRestart/${OS}Debug/DKRestart.app OVERWRITE)
	endif()
	if(RELEASE)
		dk_copy(${DKPLUGINS}/DKRestart/${OS}/${RELEASE_DIR}/DKRestart.app ${DKPROJECT}/assets/DKRestart/${OS}Release/DKRestart.app OVERWRITE)
	endif()
endif()
...
if(LINUX)
	if(DEBUG)
		dk_copy(${DKPLUGINS}/DKRestart/${OS}/${DEBUG_DIR}/DKRestart ${DKPROJECT}/assets/${OS}Debug/DKRestart OVERWRITE)
	endif()
	if(RELEASE)
		dk_copy(${DKPLUGINS}/DKRestart/${OS}/${RELEASE_DIR}/DKRestart ${DKPROJECT}/assets/${OS}Release/DKRestart OVERWRITE)
	endif()
endif()
