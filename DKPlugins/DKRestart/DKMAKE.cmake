...
if(WIN)
	if(DEBUG)
		dk_copy(${DKPLUGINS_DIR}/DKRestart/${OS}/${DEBUG_DIR}/DKRestart.exe ${DK_PROJECT_DIR}/assets/DKRestart/${OS}Debug OVERWRITE)
	endif()
	if(RELEASE)
		dk_copy(${DKPLUGINS_DIR}/DKRestart/${OS}/${RELEASE_DIR}/DKRestart.exe ${DK_PROJECT_DIR}/assets/DKRestart/${OS}Release OVERWRITE)
	endif()
endif()
...
if(MAC)
	if(DEBUG)
		dk_copy(${DKPLUGINS_DIR}/DKRestart/${OS}/${DEBUG_DIR}/DKRestart.app ${DK_PROJECT_DIR}/assets/DKRestart/${OS}Debug/DKRestart.app OVERWRITE)
	endif()
	if(RELEASE)
		dk_copy(${DKPLUGINS_DIR}/DKRestart/${OS}/${RELEASE_DIR}/DKRestart.app ${DK_PROJECT_DIR}/assets/DKRestart/${OS}Release/DKRestart.app OVERWRITE)
	endif()
endif()
...
if(LINUX)
	if(DEBUG)
		dk_copy(${DKPLUGINS_DIR}/DKRestart/${OS}/${DEBUG_DIR}/DKRestart ${DK_PROJECT_DIR}/assets/${OS}Debug/DKRestart OVERWRITE)
	endif()
	if(RELEASE)
		dk_copy(${DKPLUGINS_DIR}/DKRestart/${OS}/${RELEASE_DIR}/DKRestart ${DK_PROJECT_DIR}/assets/${OS}Release/DKRestart OVERWRITE)
	endif()
endif()
