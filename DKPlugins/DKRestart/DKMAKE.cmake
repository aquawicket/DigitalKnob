...
#	DKAPPEND_CMAKE("LIST(APPEND DEBUG_DKLIBS debug \${DKd}) \n")
#	DKAPPEND_CMAKE("FIND_LIBRARY(DK DK.lib ${DK}/${OS}/${RELEASE_DIR}) \n")
#	DKAPPEND_CMAKE("LIST(APPEND RELEASE_DKLIBS optimized \${DK}) \n")	
...
#	DKAPPEND_CMAKE("TARGET_LINK_LIBRARIES(DKRestart \${DEBUG_DKLIBS} \${RELEASE_DKLIBS}) \n")
...
if(LINUX)
	...
	if(DEBUG)
		...
		#DKAPPEND_CMAKE("TARGET_LINK_LIBRARIES(DKRestart  \${DEBUG_DKLIBS}) \n")
	endif()
	if(RELEASE)
		#DKAPPEND_CMAKE("FIND_LIBRARY(DK libDK.a ${DK}/${OS}/${RELEASE_DIR}) \n")
		#DKAPPEND_CMAKE("LIST(APPEND RELEASE_DKLIBS optimized \${DK}) \n")
		DKAPPEND_CMAKE("FILE(GLOB DKRestart_SRC ${DKPLUGINS}/DKRestart/*.cpp) \n")
		DKAPPEND_CMAKE("ADD_EXECUTABLE(DKRestart \${DKRestart_SRC}) \n")
		#DKAPPEND_CMAKE("TARGET_LINK_LIBRARIES(DKRestart  \${RELEASE_DKLIBS}) \n")
	endif()
endif()
