...
if(WIN)
	...
	if(DEBUG)
		dk_copy(${DKPLUGINS}/DKCefChild/${OS}/${DEBUG_DIR}/DKCefChild.exe ${DK_PROJECT_DIR}/assets/DKCef/${OS}Debug OVERWRITE)
	endif()
	if(RELEASE)
		dk_copy(${DKPLUGINS}/DKCefChild/${OS}/${RELEASE_DIR}/DKCefChild.exe ${DK_PROJECT_DIR}/assets/DKCef/${OS}Release OVERWRITE)
	endif()
endif()

if(MAC_X86_64)
#	if(DEBUG)
#		dk_copy(${DKPLUGINS}/DKCefChild/${OS}/${DEBUG_DIR}/DKCefChild.app "${DK_PROJECT_DIR}/assets/DKCef/${OS}Debug/${AppName} Helper.app" OVERWRITE)
...
#	endif()
#	if(RELEASE)
#		dk_copy(${DKPLUGINS}/DKCefChild/${OS}/${RELEASE_DIR}/DKCefChild.app "${DK_PROJECT_DIR}/assets/DKCef/${OS}Release/${AppName} Helper.app" OVERWRITE)
...
if(LINUX)
	...
	if(DEBUG)
		dk_copy(${DKPLUGINS}/DKCefChild/${OS}/${DEBUG_DIR}/DKCefChild ${DK_PROJECT_DIR}/assets/DKCef OVERWRITE)
	endif()
	if(RELEASE)
		dk_copy(${DKPLUGINS}/DKCefChild/${OS}/${RELEASE_DIR}/DKCefChild ${DK_PROJECT_DIR}/assets/DKCef OVERWRITE)
	endif()
endif()
