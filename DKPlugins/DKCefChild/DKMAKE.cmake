...
if(WIN)
	...
	if(DEBUG)
		dk_copy(${DKPLUGINS}/DKCefChild/${OS}/${DEBUG_DIR}/DKCefChild.exe ${DKPROJECT}/assets/DKCef/${OS}Debug OVERWRITE)
	endif()
	if(RELEASE)
		dk_copy(${DKPLUGINS}/DKCefChild/${OS}/${RELEASE_DIR}/DKCefChild.exe ${DKPROJECT}/assets/DKCef/${OS}Release OVERWRITE)
	endif()
endif()

if(MAC_64)
#	if(DEBUG)
#		dk_copy(${DKPLUGINS}/DKCefChild/${OS}/${DEBUG_DIR}/DKCefChild.app "${DKPROJECT}/assets/DKCef/${OS}Debug/${AppName} Helper.app" OVERWRITE)
...
#	endif()
#	if(RELEASE)
#		dk_copy(${DKPLUGINS}/DKCefChild/${OS}/${RELEASE_DIR}/DKCefChild.app "${DKPROJECT}/assets/DKCef/${OS}Release/${AppName} Helper.app" OVERWRITE)
...
if(LINUX)
	...
	if(DEBUG)
		dk_copy(${DKPLUGINS}/DKCefChild/${OS}/${DEBUG_DIR}/DKCefChild ${DKPROJECT}/assets/DKCef OVERWRITE)
	endif()
	if(RELEASE)
		dk_copy(${DKPLUGINS}/DKCefChild/${OS}/${RELEASE_DIR}/DKCefChild ${DKPROJECT}/assets/DKCef OVERWRITE)
	endif()
endif()
