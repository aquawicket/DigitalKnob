...
if(MAC_64)
#	if(DEBUG)
#		DKCOPY(${DKPLUGINS}/DKCefChild/${OS}/${DEBUG_DIR}/DKCefChild.app "${DKPROJECT}/assets/DKCef/${OS}Debug/${AppName} Helper.app" TRUE)
...
#	endif()
#	if(RELEASE)
#		DKCOPY(${DKPLUGINS}/DKCefChild/${OS}/${RELEASE_DIR}/DKCefChild.app "${DKPROJECT}/assets/DKCef/${OS}Release/${AppName} Helper.app" TRUE)
