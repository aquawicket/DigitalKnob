...
IF(WIN_32)
	...
	DKAPPEND_CMAKE("FIND_LIBRARY(libboost_systemD libboost_system-vc142-mt-sgd-x32-${BOOST_VERSION_MAJOR}_${BOOST_VERSION_MINOR}.lib ${BOOST}/${OS}/${DEBUG_DIR}/lib) \n")
	DKAPPEND_CMAKE("FIND_LIBRARY(libboost_systemR libboost_system-vc142-mt-s-x32-${BOOST_VERSION_MAJOR}_${BOOST_VERSION_MINOR}.lib ${BOOST}/${OS}/${RELEASE_DIR}/lib) \n")
	DKAPPEND_CMAKE("FIND_LIBRARY(libboost_filesystemD libboost_filesystem-vc142-mt-sgd-x32-${BOOST_VERSION_MAJOR}_${BOOST_VERSION_MINOR}.lib ${BOOST}/${OS}/${DEBUG_DIR}/lib) \n")
	DKAPPEND_CMAKE("FIND_LIBRARY(libboost_filesystemR libboost_filesystem-vc142-mt-s-x32-${BOOST_VERSION_MAJOR}_${BOOST_VERSION_MINOR}.lib ${BOOST}/${OS}/${RELEASE_DIR}/lib) \n")
