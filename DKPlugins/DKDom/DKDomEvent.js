...
var Event = function Event(_type, _options, _pointer) {
    ...
    Object.defineProperty(this, "composed", {
        get: function composed() {
            return CPP_DKDomEvent_composed(_pointer);
        }
    });
    ...
    Object.defineProperty(this, "currentTarget", {
        get: function currentTarget() {
			return window;
			/*
            var elementPointer = CPP_DKDomEvent_currentTarget(_pointer);
            if (!elementPointer) {
                return;
            }
	...
	Object.defineProperty(this, "defaultPrevented", {
        get: function defaultPrevented() {
            return CPP_DKDomEvent_defaultPrevented(_pointer);
        }
    });
    ...
    Object.defineProperty(this, "target", {
        //Read Only
        get: function target() {
            var elementPointer = CPP_DKDomEvent_target(_pointer);
            if (!elementPointer) {
                return;
            }
            return new HTMLElement(elementPointer);
	...
	*/
	...
	Object.defineProperty(this, "timeStamp", {
        get: function timeStamp() {
            return CPP_DKDomEvent_timeStamp(_pointer);
        }
    });
	// [Event.type](Read only) https://developer.mozilla.org/en-US/docs/Web/API/Event/type
	Object.defineProperty(this, "type", {
        get: function type() {
            return this._type//CPP_DKDomEvent_type(_pointer);
        }
    });
    ...
    Object.defineProperty(this, "cancelBubble", {
        set: function cancelBubble(flag) {
            return CPP_DKDomEvent_cancelBubble(_pointer, flag);
        }
    });
	...
	Object.defineProperty(this, "explicitOriginalTarget", {
        get: function explicitOriginalTarget() {
            return CPP_DKDomEvent_explicitOriginalTarget(_pointer);
        }
    });
	...
	Object.defineProperty(this, "originalTarget", {
        get: function originalTarget() {
            return CPP_DKDomEvent_originalTarget(_pointer);
        }
    });
	...
	Object.defineProperty(this, "returnValue", {
        get: function returnValue() {
            return CPP_DKDomEvent_returnValue(_pointer);
        }
    });
	// [Event.scoped](Read only)(Deprecated)
	Object.defineProperty(this, "scoped", {
        get: function scoped() {
            return CPP_DKDomEvent_scoped(_pointer);
        }
    });
	...
	Object.defineProperty(this, "deepPath", {
        get: function deepPath(){
            return CPP_DKDomEvent_deepPath(_pointer);
        }
    });
    Object.defineProperty(this, "srcElement", {
        get: function srcElement() {
            var elementPointer = CPP_DKDomEvent_srcElement(_pointer);
            if (!elementPointer) {
                return;
            }
            return new HTMLElement(elementPointer);
	...
	*/
	...
	Event.prototype.preventDefault = function preventDefault() {
        CPP_DKDomEvent_preventDefault(_pointer);
    }
	// [Event.stopImmediatePropagation()] https://developer.mozilla.org/en-US/docs/Web/API/Event/stopImmediatePropagation
	Event.prototype.stopImmediatePropagation = function stopImmediatePropagation() {
        CPP_DKDomEvent_stopImmediatePropagation(_pointer);
    }
	// [Event.stopPropagation()] https://developer.mozilla.org/en-US/docs/Web/API/Event/stopPropagation
	Event.prototype.stopPropagation = function stopPropagation() {
        CPP_DKDomEvent_stopPropagation(_pointer);
    }
	...
	Event.prototype.initEvent = function initEvent() {
        CPP_DKDomEvent_initEvent(_pointer);
    }
	
	////// Obsolete methods //////
	/*
    Event.prototype.createEvent = function createEvent() {
        CPP_DKDomEvent_createEvent(_pointer);
    }
    Event.prototype.composedPath = function composedPath() {
        CPP_DKDomEvent_composedPath(_pointer);
    }
    Event.prototype.getPreventDefault = function getPreventDefault() {
        CPP_DKDomEvent_getPreventDefault(_pointer);
    }
    Event.prototype.preventBubble = function preventBubble() {
        CPP_DKDomEvent_preventBubble(_pointer);
    }
    Event.prototype.preventCapture = function preventCapture() {
        CPP_DKDomEvent_preventCapture(_pointer);
    }
	*/
