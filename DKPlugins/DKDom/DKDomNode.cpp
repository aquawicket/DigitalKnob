...
{
	DKDEBUGFUNC();
	DKDuktape::AttachFunction("DKCPP_DKDomNode_baseURI", DKDomNode::baseURI);
	DKDuktape::AttachFunction("DKCPP_DKDomNode_baseUriObject", DKDomNode::baseURIObject);
	DKDuktape::AttachFunction("DKCPP_DKDomNode_childNodes", DKDomNode::childNodes);
	DKDuktape::AttachFunction("DKCPP_DKDomNode_firstChild", DKDomNode::firstChild);
	DKDuktape::AttachFunction("DKCPP_DKDomNode_isConnected", DKDomNode::isConnected);
	DKDuktape::AttachFunction("DKCPP_DKDomNode_lastChild", DKDomNode::lastChild);
	DKDuktape::AttachFunction("DKCPP_DKDomNode_nextSibling", DKDomNode::nextSibling);
	DKDuktape::AttachFunction("DKCPP_DKDomNode_nodeName", DKDomNode::nodeName);
	DKDuktape::AttachFunction("DKCPP_DKDomNode_nodeType", DKDomNode::nodeType);
	DKDuktape::AttachFunction("DKCPP_DKDomNode_nodeValue", DKDomNode::nodeValue);
	DKDuktape::AttachFunction("DKCPP_DKDomNode_ownerDocument", DKDomNode::ownerDocument);
	DKDuktape::AttachFunction("DKCPP_DKDomNode_parentNode", DKDomNode::parentNode);
	DKDuktape::AttachFunction("DKCPP_DKDomNode_parentElement", DKDomNode::parentElement);
	DKDuktape::AttachFunction("DKCPP_DKDomNode_previousSibling", DKDomNode::previousSibling);
	DKDuktape::AttachFunction("DKCPP_DKDomNode_textContent", DKDomNode::textContent);
	DKDuktape::AttachFunction("DKCPP_DKDomNode_localName", DKDomNode::localName);
	DKDuktape::AttachFunction("DKCPP_DKDomNode_namespaceURI", DKDomNode::namespaceURI);
	DKDuktape::AttachFunction("DKCPP_DKDomNode_nodePrincipal", DKDomNode::nodePrincipal);
	DKDuktape::AttachFunction("DKCPP_DKDomNode_prefix", DKDomNode::prefix);
	DKDuktape::AttachFunction("DKCPP_DKDomNode_rootNode", DKDomNode::rootNode);
	DKDuktape::AttachFunction("DKCPP_DKDomNode_appendChild", DKDomNode::appendChild);
	DKDuktape::AttachFunction("DKCPP_DKDomNode_cloneNode", DKDomNode::cloneNode);
	DKDuktape::AttachFunction("DKCPP_DKDomNode_compareDocumentPosition", DKDomNode::compareDocumentPosition);
	DKDuktape::AttachFunction("DKCPP_DKDomNode_contains", DKDomNode::contains);
	DKDuktape::AttachFunction("DKCPP_DKDomNode_getBoxQuads", DKDomNode::getBoxQuads);
	DKDuktape::AttachFunction("DKCPP_DKDomNode_getRootNode", DKDomNode::getRootNode);
	DKDuktape::AttachFunction("DKCPP_DKDomNode_hasChildNodes", DKDomNode::hasChildNodes);
	DKDuktape::AttachFunction("DKCPP_DKDomNode_insertBefore", DKDomNode::insertBefore);
	DKDuktape::AttachFunction("DKCPP_DKDomNode_isDefaultNamespace", DKDomNode::isDefaultNamespace);
	DKDuktape::AttachFunction("DKCPP_DKDomNode_isEqualNode", DKDomNode::isEqualNode);
	DKDuktape::AttachFunction("DKCPP_DKDomNode_isSameNode", DKDomNode::isSameNode);
	DKDuktape::AttachFunction("DKCPP_DKDomNode_lookupPrefix", DKDomNode::lookupPrefix);
	DKDuktape::AttachFunction("DKCPP_DKDomNode_lookupNamespaceURI", DKDomNode::lookupNamespaceURI);
	DKDuktape::AttachFunction("DKCPP_DKDomNode_normalize", DKDomNode::normalize);
	DKDuktape::AttachFunction("DKCPP_DKDomNode_removeChild", DKDomNode::removeChild);
	DKDuktape::AttachFunction("DKCPP_DKDomNode_replaceChild", DKDomNode::replaceChild);
	DKDuktape::AttachFunction("DKCPP_DKDomNode_getUserData", DKDomNode::getUserData);
	DKDuktape::AttachFunction("DKCPP_DKDomNode_hasAttributes", DKDomNode::hasAttributes);
	DKDuktape::AttachFunction("DKCPP_DKDomNode_isSupported", DKDomNode::isSupported);
	DKDuktape::AttachFunction("DKCPP_DKDomNode_setUserData", DKDomNode::setUserData);
