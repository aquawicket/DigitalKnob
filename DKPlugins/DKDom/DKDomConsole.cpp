...
{
	DKDEBUGFUNC();
	DKDuktape::AttachFunction("DKCPP_DKDomConsole_assert", DKDomConsole::_assert);
	DKDuktape::AttachFunction("DKCPP_DKDomConsole_clear", DKDomConsole::clear);
	DKDuktape::AttachFunction("DKCPP_DKDomConsole_count", DKDomConsole::count);
	DKDuktape::AttachFunction("DKCPP_DKDomConsole_countReset", DKDomConsole::countReset);
	DKDuktape::AttachFunction("DKCPP_DKDomConsole_debug", DKDomConsole::debug);
	DKDuktape::AttachFunction("DKCPP_DKDomConsole_dir", DKDomConsole::dir);
	DKDuktape::AttachFunction("DKCPP_DKDomConsole_dirxml", DKDomConsole::dirxml);
	DKDuktape::AttachFunction("DKCPP_DKDomConsole_error", DKDomConsole::error);
	DKDuktape::AttachFunction("DKCPP_DKDomConsole_exception", DKDomConsole::exception);
	DKDuktape::AttachFunction("DKCPP_DKDomConsole_group", DKDomConsole::group);
	DKDuktape::AttachFunction("DKCPP_DKDomConsole_groupCollapsed", DKDomConsole::groupCollapsed);
	DKDuktape::AttachFunction("DKCPP_DKDomConsole_groupEnd", DKDomConsole::groupEnd);
	DKDuktape::AttachFunction("DKCPP_DKDomConsole_info",  DKDomConsole::info);
	DKDuktape::AttachFunction("DKCPP_DKDomConsole_log", DKDomConsole::log);
	DKDuktape::AttachFunction("DKCPP_DKDomConsole_profile", DKDomConsole::profile);
	DKDuktape::AttachFunction("DKCPP_DKDomConsole_profileEnd", DKDomConsole::profileEnd);
	DKDuktape::AttachFunction("DKCPP_DKDomConsole_table", DKDomConsole::table);
	DKDuktape::AttachFunction("DKCPP_DKDomConsole_time", DKDomConsole::time);
	DKDuktape::AttachFunction("DKCPP_DKDomConsole_timeEnd", DKDomConsole::timeEnd);
	DKDuktape::AttachFunction("DKCPP_DKDomConsole_timeLog", DKDomConsole::timeLog);
	DKDuktape::AttachFunction("DKCPP_DKDomConsole_timeStamp", DKDomConsole::timeStamp);
	DKDuktape::AttachFunction("DKCPP_DKDomConsole_trace", DKDomConsole::trace);
	DKDuktape::AttachFunction("DKCPP_DKDomConsole_warn",  DKDomConsole::warn);
