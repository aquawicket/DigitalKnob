...
var Window = function Window(address) {
	...
	Object.defineProperty(this, "caches", {
		...
		//set: function caches(str)	{ return CPP_DKWindowDUK_caches(this.address, str) },
    })
	...
	Object.defineProperty(this, "clientInformation", {
		...
		//set: function clientInformation(str)	{ return CPP_DKWindowDUK_clientInformation(this.address, str) },
    })
	...
	Object.defineProperty(this, "closed", {
		...
		//set: function closed(flag){ return CPP_DKWindowDUK_closed(this.address, flag) },
    })
	...
	Object.defineProperty(this, "console", {
		...
		//set: function console(str){ return CPP_DKWindowDUK_console(this.address, str) },
    })
	...
	Object.defineProperty(this, "credentialless", {
		...
		//set: function credentialless(flag){ return CPP_DKWindowDUK_credentialless(this.address, flag) },
    })
	...
	Object.defineProperty(this, "crypto", {
		...
		//set: function crypto(str)	{ return CPP_DKWindowDUK_crypto(this.address, str) },
    })
	...
	Object.defineProperty(this, "customElements", {
		...
		//set: function customElements(str)	{ return CPP_DKWindowDUK_customElements(this.address, str) },
    })
	...
	Object.defineProperty(this, "devicePixelRatio", {
		...
		//set: function devicePixelRatio(num)	{ return CPP_DKWindowDUK_devicePixelRatio(this.address, num) },
    })
	...
	Object.defineProperty(this, "document", {
		...
		//set: function document(str)	{ return CPP_DKWindowDUK_document(this.address, str) },
    })
	...
	Object.defineProperty(this, "frameElement", {
		...
		//set: function frameElement(str)	{ return CPP_DKWindowDUK_frameElement(this.address, str) },
    })
	...
	Object.defineProperty(this, "frames", {
		...
		//set: function frames(str)	{ return CPP_DKWindowDUK_frames(this.address, str) },
    })
	...
	Object.defineProperty(this, "fullScreen", {
		...
		set: function fullScreen(str)	{ return CPP_DKWindowDUK_fullScreen(this.address, str) },
    })
	...
	Object.defineProperty(this, "history", {
		...
		//set: function history(str){ return CPP_DKWindowDUK_history(this.address, str) },
    })
	...
	Object.defineProperty(this, "indexedDB", {
		...
		//set: function indexedDB(str)	{ return CPP_DKWindowDUK_indexedDB(this.address, str) },
    })
	...
	Object.defineProperty(this, "innerHeight", {
		...
		//set: function innerHeight(num){ return CPP_DKWindowDUK_innerHeight(this.address, num) },
    })
	...
	Object.defineProperty(this, "innerWidth", {
		...
		//set: function innerWidth(num){ return CPP_DKWindowDUK_innerWidth(this.address, num) },
    })
	...
	Object.defineProperty(this, "isSecureContext", {
		...
		//set: function isSecureContext(num){ return CPP_DKWindowDUK_isSecureContext(this.address, num) },
    })
	...
	Object.defineProperty(this, "launchQueue", {
		...
		//set: function launchQueue(str){ return CPP_DKWindowDUK_launchQueue(this.address, str) },
    })
	...
	Object.defineProperty(this, "length", {
		...
		//set: function length(num)	{ return CPP_DKWindowDUK_length(this.address, num) },
    })
	// [Window.location] https://developer.mozilla.org/en-US/docs/Web/API/Window/location
	Object.defineProperty(this, "location", {
        get: function location()	{ return CPP_DKWindowDUK_location(this.address) },
		set: function location(str)	{ return CPP_DKWindowDUK_location(this.address, str) },
    })
	...
	Object.defineProperty(this, "locationbar", {
		...
		//set: function locationbar(str){ return CPP_DKWindowDUK_locationbar(this.address, str) },
    })
	...
	Object.defineProperty(this, "localStorage", {
		...
		//set: function localStorage(str)	{ return CPP_DKWindowDUK_localStorage(this.address, str) },
    })
	...
	Object.defineProperty(this, "menubar", {
		...
		//set: function menubar(str)	{ return CPP_DKWindowDUK_menubar(this.address, str) },
    })
	...
	Object.defineProperty(this, "mozInnerScreenX", {
		...
		//set: function mozInnerScreenX(num){ return CPP_DKWindowDUK_mozInnerScreenX(this.address, num) },
    })
	...
	Object.defineProperty(this, "mozInnerScreenY", {
		...
		//set: function mozInnerScreenY(num){ return CPP_DKWindowDUK_mozInnerScreenY(this.address, num) },
    })
	// [Window.name] https://developer.mozilla.org/en-US/docs/Web/API/Window/name
	Object.defineProperty(this, "name", {
        get: function name()	{ return CPP_DKWindowDUK_name(this.address) },
		set: function name(str)	{ return CPP_DKWindowDUK_name(this.address, str) },
    })
	...
	Object.defineProperty(this, "navigation", {
		...
		//set: function navigation(str)	{ return CPP_DKWindowDUK_navigation(this.address, str) },
    })
	...
	Object.defineProperty(this, "navigator", {
		...
		//set: function navigator(str)	{ return CPP_DKWindowDUK_navigator(this.address, str) },
    })
	// [Window.opener] https://developer.mozilla.org/en-US/docs/Web/API/Window/opener
	Object.defineProperty(this, "opener", {
        get: function opener()		{ return CPP_DKWindowDUK_opener(this.address) },
		set: function opener(str)	{ return CPP_DKWindowDUK_opener(this.address, str) },
    })
	...
	Object.defineProperty(this, "origin", {
		...
		//set: function origin(str)	{ return CPP_DKWindowDUK_origin(this.address, str) },
    })
	...
	Object.defineProperty(this, "outerHeight", {
		...
		//set: function outerHeight(num){ return CPP_DKWindowDUK_outerHeight(this.address, num) },
    })
	...
	Object.defineProperty(this, "outerWidth", {
		...
		//set: function outerWidth(num){ return CPP_DKWindowDUK_outerWidth(this.address, num) },
    })
	...
	Object.defineProperty(this, "pageXOffset", {
		...
		//set: function pageXOffset(num){ return CPP_DKWindowDUK_pageXOffset(this.address, num) },
    })
	...
	Object.defineProperty(this, "pageYOffset", {
		...
		//set: function pageYOffset(num){ return CPP_DKWindowDUK_pageYOffset(this.address, num) },
    })
	...
	Object.defineProperty(this, "parent", {
		...
		//set: function parent(str)	{ return CPP_DKWindowDUK_parent(this.address, str) },
    })
	...
	Object.defineProperty(this, "performance", {
		...
		//set: function performance(str){ return CPP_DKWindowDUK_performance(this.address, str) },
    })
	...
	Object.defineProperty(this, "personalbar", {
		...
		//set: function personalbar(str){ return CPP_DKWindowDUK_personalbar(this.address, str) },
    })
	...
	Object.defineProperty(this, "scheduler", {
		...
		//set: function scheduler(str)	{ return CPP_DKWindowDUK_scheduler(this.address, str) },
    })
	...
	Object.defineProperty(this, "screen", {
		...
		//set: function screen(str)	{ return CPP_DKWindowDUK_screen(this.address, str) },
    })
	...
	Object.defineProperty(this, "screenX", {
		...
		//set: function screenX(num){ return CPP_DKWindowDUK_screenX(this.address, num) },
    })
	...
	Object.defineProperty(this, "screenY", {
		...
		//set: function screenY(num){ return CPP_DKWindowDUK_screenY(this.address, num) },
    })
	...
	Object.defineProperty(this, "scrollbars", {
		...
		//set: function scrollbars(str)	{ return CPP_DKWindowDUK_scrollbars(this.address, str) },
    })
	...
	Object.defineProperty(this, "scrollMaxX", {
		...
		//set: function scrollMaxX(num)	{ return CPP_DKWindowDUK_scrollMaxX(this.address, num) },
    })
	...
	Object.defineProperty(this, "scrollMaxY", {
		...
		//set: function scrollMaxY(num)	{ return CPP_DKWindowDUK_scrollMaxY(this.address, num) },
    })
	...
	Object.defineProperty(this, "scrollX", {
		...
		//set: function scrollX(num){ return CPP_DKWindowDUK_scrollX(this.address, num) },
    })
	...
	Object.defineProperty(this, "scrollY", {
		...
		//set: function scrollY(num){ return CPP_DKWindowDUK_scrollY(this.address, num) },
    })
	...
	Object.defineProperty(this, "self", {
		...
		//set: function self(str)	{ return CPP_DKWindowDUK_self(this.address, str) },
    })
	...
	Object.defineProperty(this, "sessionStorage", {
		...
		set: function sessionStorage(str)	{ return CPP_DKWindowDUK_sessionStorage(this.address, str) },
    })
	...
	Object.defineProperty(this, "speechSynthesis", {
		...
		//set: function speechSynthesis(str){ return CPP_DKWindowDUK_speechSynthesis(this.address, str) },
    })
	...
	Object.defineProperty(this, "statusbar", {
		...
		//set: function statusbar(str)	{ return CPP_DKWindowDUK_statusbar(this.address, str) },
    })
	...
	Object.defineProperty(this, "toolbar", {
		...
		//set: function toolbar(str){ return CPP_DKWindowDUK_toolbar(this.address, str) },
    })
	...
	Object.defineProperty(this, "top", {
		...
		//set: function top(str){ return CPP_DKWindowDUK_top(this.address, str) },
    })
	...
	Object.defineProperty(this, "visualViewport", {
		...
		//set: function visualViewport(str){ return CPP_DKWindowDUK_visualViewport(this.address, str) },
    })
	...
	Object.defineProperty(this, "window", {
		...
		//set: function window(str){ return CPP_DKWindowDUK_window(this.address, str) },
    })
	...
	Object.defineProperty(this, "windows", {
		...
		//set: function windows(str){ return CPP_DKWindowDUK_windows(this.address, str) },
    })
	*/
	...
	Object.defineProperty(this, "content", {
		...
		//set: function content(str){ return CPP_DKWindowDUK_content(this.address, str) },
    })
	...
	Object.defineProperty(this, "defaultStatus", {
		...
		set: function defaultStatus(str)	{ return CPP_DKWindowDUK_defaultStatus(this.address, str) },
    })
	...
	Object.defineProperty(this, "event", {
		...
		//set: function event(str)	{ return CPP_DKWindowDUK_event(this.address, str) },
    })
	...
	Object.defineProperty(this, "external", {
		...
		//set: function external(str)	{ return CPP_DKWindowDUK_external(this.address, str) },
    })
	...
	Object.defineProperty(this, "orientation", {
		...
		//set: function orientation(num){ return CPP_DKWindowDUK_orientation(this.address, num) },
    })
	...
	Object.defineProperty(this, "returnValue", {
		...
		set: function returnValue(str){ return CPP_DKWindowDUK_returnValue(this.address, str) },
    })
	...
	Object.defineProperty(this, "sidebar", {
		...
		//set: function sidebar(str){ return CPP_DKWindowDUK_sidebar(this.address, str) },
    })
	...
	Object.defineProperty(this, "status", {
		...
		set: function status(str)	{ return CPP_DKWindowDUK_status(this.address, str) },
    })
