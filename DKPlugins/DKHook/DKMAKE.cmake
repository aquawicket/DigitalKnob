...
IF(WIN_32)
	dk_copy(${DKPLUGINS}/DKHook/win32/Release/hookdll.dll ${DKPROJECT}/assets/DKHook OVERWRITE)
ENDIF()

IF(WIN_64)
	dk_copy(${DKPLUGINS}/DKHook/win64/Release/hookdll.dll ${DKPROJECT}/assets/DKHook OVERWRITE)
ENDIF()
