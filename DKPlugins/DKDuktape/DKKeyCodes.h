...
static const unsigned int KeyTable[] = { 
    ...
    Key_ScrollLock,    // 145   0x91   VK_SCROLL           | Scroll Lock key
                       // Fujitsu/OASYS kbd --------------------
    Key_Jisho,         // 146   0x92   VK_OEM_FJ_JISHO     | 'Dictionary' key /
    ...
    Key_Oyayubi_Left,  //149   0x95  VK_OEM_FJ_LOYA  | 'Left OYAYUBI' key
    Key_Oyayubi_Right, //150  0x96  VK_OEM_FJ_ROYA  | 'Right OYAYUBI' key
    ...
    //Key_OEM_1,                  // 186   0xBA   VK_OEM_1            | ';:' for US
    ...
    //Key_OEM_4,      // 219   0xDB   VK_OEM_4            | '[{' for US
