...
bool DKDuktapeJS::Init()
{
	...
	*/
	...
	//duk_eval_string(DKDuktape::ctx, "var CPP_DKDuktape_ERROR = 0;");
	...
	DKDuktape::AttachFunction("CPP_DKDuktape_DKLoadPlugin", DKDuktapeJS::_LoadPlugin);
	DKDuktape::AttachFunction("CPP_DKDuktape_RemoveEvent", DKDuktapeJS::_RemoveEvent);
	DKDuktape::AttachFunction("CPP_DKDuktape_RemoveEvents", DKDuktapeJS::_RemoveEvents);
	DKDuktape::AttachFunction("CPP_DKDuktape_SendEvent", DKDuktapeJS::_SendEvent);
	DKDuktape::AttachFunction("CPP_DKDuktape_Valid", DKDuktapeJS::_Valid);

	DKDuktape::AttachFunction("CPP_DKDuktape_Beep", DKDuktapeJS::Beep);
	DKDuktape::AttachFunction("CPP_DKDuktape_CallLoops", DKDuktapeJS::CallLoops);
	DKDuktape::AttachFunction("CPP_DKDuktape_CallFunc", DKDuktapeJS::CallFunc);
	DKDuktape::AttachFunction("CPP_DKDuktape_ClearEvents", DKDuktapeJS::ClearEvents);
	DKDuktape::AttachFunction("CPP_DKDuktape_ClickImage", DKDuktapeJS::ClickImage);
	DKDuktape::AttachFunction("CPP_DKDuktape_CpuUsed", DKDuktapeJS::CpuUsed);
	DKDuktape::AttachFunction("CPP_DKDuktape_CpuUsedByApp", DKDuktapeJS::CpuUsedByApp);
	DKDuktape::AttachFunction("CPP_DKDuktape_Crash", DKDuktapeJS::Crash);
	DKDuktape::AttachFunction("CPP_DKDuktape_DoFrame", DKDuktapeJS::DoFrame);
	DKDuktape::AttachFunction("CPP_DKDuktape_DoubleClick", DKDuktapeJS::DoubleClick);
	DKDuktape::AttachFunction("CPP_DKDuktape_DumpError", DKDuktapeJS::DumpError);
	DKDuktape::AttachFunction("CPP_DKDuktape_Execute", DKDuktapeJS::Execute);
	DKDuktape::AttachFunction("CPP_DKDuktape_Exit", DKDuktapeJS::Exit);
	DKDuktape::AttachFunction("CPP_DKDuktape_GetArgs", DKDuktapeJS::GetArgs);
	DKDuktape::AttachFunction("CPP_DKDuktape_GetBrowser", DKDuktapeJS::GetBrowser);
	DKDuktape::AttachFunction("CPP_DKDuktape_GetClipboard", DKDuktapeJS::GetClipboard);
	DKDuktape::AttachFunction("CPP_DKDuktape_GetData", DKDuktapeJS::GetData);
	DKDuktape::AttachFunction("CPP_DKDuktape_GetDate", DKDuktapeJS::GetDate);
	DKDuktape::AttachFunction("CPP_DKDuktape_GetEvents", DKDuktapeJS::GetEvents);
	DKDuktape::AttachFunction("CPP_DKDuktape_GetFps", DKDuktapeJS::GetFps);
	...
	DKDuktape::AttachFunction("CPP_DKDuktape_GetMouseX", DKDuktapeJS::GetMouseX); 
	DKDuktape::AttachFunction("CPP_DKDuktape_GetMouseY", DKDuktapeJS::GetMouseY);
	DKDuktape::AttachFunction("CPP_DKDuktape_GetOS", DKDuktapeJS::GetOS);
	DKDuktape::AttachFunction("CPP_DKDuktape_GetObjects", DKDuktapeJS::GetObjects);
	DKDuktape::AttachFunction("CPP_DKDuktape_GetPixelUnderMouse", DKDuktapeJS::GetPixelUnderMouse);
	DKDuktape::AttachFunction("CPP_DKDuktape_GetProcessList", DKDuktapeJS::GetProcessList);
	DKDuktape::AttachFunction("CPP_DKDuktape_GetScreenHeight", DKDuktapeJS::GetScreenHeight);
	...
	DKDuktape::AttachFunction("CPP_DKDuktape_HideConsole", DKDuktapeJS::HideConsole);
	DKDuktape::AttachFunction("CPP_DKDuktape_IE", DKDuktapeJS::IE);
	DKDuktape::AttachFunction("CPP_DKDuktape_Include", DKDuktapeJS::Include);
	DKDuktape::AttachFunction("CPP_DKDuktape_KeyIsDown", DKDuktapeJS::KeyIsDown);
	DKDuktape::AttachFunction("CPP_DKDuktape_LeftClick", DKDuktapeJS::LeftClick);
	DKDuktape::AttachFunction("CPP_DKDuktape_LogGuiConsole", DKDuktapeJS::LogGuiConsole);
	DKDuktape::AttachFunction("CPP_DKDuktape_LowPowerMonitor", DKDuktapeJS::LowPowerMonitor);
	DKDuktape::AttachFunction("CPP_DKDuktape_MessageBox", DKDuktapeJS::MessageBox);
	DKDuktape::AttachFunction("CPP_DKDuktape_MouseToImage", DKDuktapeJS::MouseToImage);
	DKDuktape::AttachFunction("CPP_DKDuktape_PhysicalMemory", DKDuktapeJS::PhysicalMemory);
	DKDuktape::AttachFunction("CPP_DKDuktape_PhysicalMemoryUsed", DKDuktapeJS::PhysicalMemoryUsed);
	DKDuktape::AttachFunction("CPP_DKDuktape_PhysicalMemoryUsedByApp", DKDuktapeJS::PhysicalMemoryUsedByApp);
	DKDuktape::AttachFunction("CPP_DKDuktape_PressKey", DKDuktapeJS::PressKey);
	DKDuktape::AttachFunction("CPP_DKDuktape_QueueDuktape", DKDuktapeJS::QueueDuktape);
	DKDuktape::AttachFunction("CPP_DKDuktape_ReleaseKey", DKDuktapeJS::ReleaseKey);
	DKDuktape::AttachFunction("CPP_DKDuktape_Reload", DKDuktapeJS::Reload);
	DKDuktape::AttachFunction("CPP_DKDuktape_RightClick", DKDuktapeJS::RightClick);
	DKDuktape::AttachFunction("CPP_DKDuktape_Run", DKDuktapeJS::Run);
	DKDuktape::AttachFunction("CPP_DKDuktape_RunDuktape", DKDuktapeJS::RunDuktape);
	DKDuktape::AttachFunction("CPP_DKDuktape_SetBrightness", DKDuktapeJS::SetBrightness);
	DKDuktape::AttachFunction("CPP_DKDuktape_SetClipboard", DKDuktapeJS::SetClipboard);
	DKDuktape::AttachFunction("CPP_DKDuktape_SetClipboardFiles", DKDuktapeJS::SetClipboardFiles);
	DKDuktape::AttachFunction("CPP_DKDuktape_SetClipboardImage", DKDuktapeJS::SetClipboardImage);
	DKDuktape::AttachFunction("CPP_DKDuktape_SetCursorPos", DKDuktapeJS::SetCursorPos);
	DKDuktape::AttachFunction("CPP_DKDuktape_SetFramerate", DKDuktapeJS::SetFramerate);
	DKDuktape::AttachFunction("CPP_DKDuktape_SetLog", DKDuktapeJS::_SetLog);
	DKDuktape::AttachFunction("CPP_DKDuktape_SetVolume", DKDuktapeJS::SetVolume);
	DKDuktape::AttachFunction("CPP_DKDuktape_ShowConsole", DKDuktapeJS::ShowConsole);
	DKDuktape::AttachFunction("CPP_DKDuktape_Sleep", DKDuktapeJS::Sleep);
	DKDuktape::AttachFunction("CPP_DKDuktape_StopPropagation", DKDuktapeJS::StopPropagation);
	DKDuktape::AttachFunction("CPP_DKDuktape_StrokeKey", DKDuktapeJS::StrokeKey);
	DKDuktape::AttachFunction("CPP_DKDuktape_System", DKDuktapeJS::System);
	DKDuktape::AttachFunction("CPP_DKDuktape_TurnOffMonitor", DKDuktapeJS::TurnOffMonitor);
	DKDuktape::AttachFunction("CPP_DKDuktape_TurnOnMonitor", DKDuktapeJS::TurnOnMonitor);
	DKDuktape::AttachFunction("CPP_DKDuktape_Value", DKDuktapeJS::Value);
	DKDuktape::AttachFunction("CPP_DKDuktape_VirtualMemory", DKDuktapeJS::VirtualMemory);
	DKDuktape::AttachFunction("CPP_DKDuktape_VirtualMemoryUsed", DKDuktapeJS::VirtualMemoryUsed);
	DKDuktape::AttachFunction("CPP_DKDuktape_VirtualMemoryUsedByApp", DKDuktapeJS::VirtualMemoryUsedByApp);
	DKDuktape::AttachFunction("CPP_DKDuktape_WaitForImage", DKDuktapeJS::WaitForImage);
	return true;
}
