...
if "%ABI%"=="armeabi-v7a" (	set "CMAKE_GENERATOR_ARCH=ARM" ) else (	set "CMAKE_GENERATOR_ARCH=ARM64" )
...
if %compiler% EQU GRADLE goto :gradle
...
call %APP_ROOT%copy_assets %PACKAGE_NAME%
