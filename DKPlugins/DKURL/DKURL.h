...
public:
	...
	virtual void 				username(const USVString& username) 		{ _username = username; } 			// setter
	
	// attribute USVString password;
	USVString _password = "";
	virtual const USVString& 	password()									{ return _password; }				// getter
	virtual void 				password(const USVString& password) 		{ _password = password; } 			// setter
	...
	virtual void 				searchParams(const DKString& searchParams)	{ _searchParams = searchParams; } 	// setter
