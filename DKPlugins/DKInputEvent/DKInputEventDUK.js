// [IDL] file:///C:/Users/Administrator/digitalknob/Development/3rdParty/webref-curated/ed/idlnames/InputEvent.idl
...
var InputEvent = function InputEvent(type, options, address) {
	...
	Object.defineProperty(this, "data", {
		...
		set: function data(data){ return CPP_DKInputEventDUK_data(this.address, data) },
		configurable: true,
    })
	...
	Object.defineProperty(this, "inputType", {
		...
		set: function inputType(data){ return CPP_DKInputEventDUK_inputType(this.address, data) },
		configurable: true,
    })
