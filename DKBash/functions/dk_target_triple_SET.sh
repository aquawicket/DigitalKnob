...
dk_target_triple_SET() {
	...
	dk_call dk_echo " 3) android_arm32"
	dk_call dk_echo " 4) android_arm64"
	dk_call dk_echo " 5) android_x86"
	dk_call dk_echo " 6) android_x86_64"
	dk_call dk_echo " 7) emscripten"
	dk_call dk_echo " 8) ios_arm32"
	dk_call dk_echo " 9) ios_arm64"
	dk_call dk_echo "10) ios_x86"
	dk_call dk_echo "11) ios_x86_64"
	dk_call dk_echo "12) iossim_arm32"
	dk_call dk_echo "13) iossim_arm64"
	dk_call dk_echo "14) iossim_x86"
	dk_call dk_echo "15) iossim_x86_64"
	...
	dk_call dk_echo "23) mac_x86_64"
	dk_call dk_echo "24) raspberry_arm32"
	dk_call dk_echo "25) raspberry_arm64"
	dk_call dk_echo "26) raspberry_x86"
	dk_call dk_echo "27) raspberry_x86_64"
	dk_call dk_echo "28) windows_arm32"
