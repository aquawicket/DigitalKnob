...
#						echo "                   DKSCRIPT = ${DKSCRIPT-}"
						...
						echo "            DIGITALKNOB_DIR = $(dk_call dk_DIGITALKNOB_DIR)"
						echo "             DKDOWNLOAD_DIR = $(dk_call dk_DKDOWNLOAD_DIR)"
						echo "                DKTOOLS_DIR = $(dk_call dk_DKTOOLS_DIR)"
						echo "                   DKBRANCH = ${DKBRANCH}"
						echo "               DKBRANCH_DIR = ${DKBRANCH_DIR-}"
						echo "             DK3RDPARTY_DIR = $(dk_call dk_DK3RDPARTY_DIR)"
						...
						echo "                   DKVBS_DIR = ${DKVBS_DIR-}"
						echo "         DKVBS_FUNCTIONS_DIR = ${DKVBS_FUNCTIONS_DIR-}"
						echo "        DKVBS_FUNCTIONS_DIR_ = ${DKVBS_FUNCTIONS_DIR_-}"
