...
public:
	...
	template<class T>
	static void MyFuncs::RegisterFunc(const std::string& name, void (T::*func) (void*, void*), T* instance)
	{
	...
	static void MyFuncs::CallFunc(const std::string& name, void* input, void* output)
	{
