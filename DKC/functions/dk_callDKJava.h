#pragma once
#ifndef dk_callDKJava_h
#define dk_callDKJava_h
...
//####################################################################
//# dk_callDKJava(function, arguments..., rtn_var)
//#
...
//#
int dk_callDKJava(char* func, char* args, char* rtn_var){
	dk_echo("%s(%s)\n", func, args);
// main( int argc, char *argv[] )
	...
	//int exit_code = system(DKJAVA_COMMAND);
	fp = popen(DKJAVA_COMMAND, "r");
	if (fp == NULL) {
