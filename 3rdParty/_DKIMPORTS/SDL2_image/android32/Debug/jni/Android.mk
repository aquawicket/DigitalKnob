...
LOCAL_C_INCLUDES += $(LOCAL_PATH)/../../../../$(PNG)/android32/Debug/jni
LOCAL_C_INCLUDES += $(LOCAL_PATH)/../../../../$(TIF)/libtiff
LOCAL_C_INCLUDES += $(LOCAL_PATH)/../../../../$(TIF)/android32/Debug/jni
LOCAL_C_INCLUDES += $(LOCAL_PATH)/../../../../$(JPG)
LOCAL_C_INCLUDES += $(LOCAL_PATH)/../../../../$(JPG)/android32/Debug/jni
