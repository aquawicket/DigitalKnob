...
MAC64_COMMAND(${CMAKE_COMMAND} -G "Xcode" -DCMAKE_OSX_ARCHITECTURES=x86_64 ${SDL2_APPLE} ${VORBIS_APPLE} ${OGG_APPLE} ${SMPEG2_APPLE} ${SDLMIXER})
...
IOS_COMMAND(${CMAKE_COMMAND} -G "Xcode" -DCMAKE_TOOLCHAIN_FILE=${DKCMAKE}/iOS.cmake -DIOS_PLATFORM=OS ${SDL2_APPLE} ${VORBIS_APPLE} ${OGG_APPLE} ${SMPEG2_APPLE} ${SDLMIXER})
...
IOSSIM64_COMMAND(${CMAKE_COMMAND} -G "Xcode" -DCMAKE_TOOLCHAIN_FILE=${DKCMAKE}/iOS.cmake -DIOS_PLATFORM=SIMULATOR64 ${SDL2_APPLE} ${VORBIS_APPLE} ${OGG_APPLE} ${SMPEG2_APPLE} ${SDLMIXER})
...
LINUX_DEBUG_COMMAND(${CMAKE_COMMAND} -G "Unix Makefiles" -DCMAKE_BUILD_TYPE=DEBUG -DCMAKE_C_FLAGS=-fPIC ${SDL2_LINUX} ${VORBIS_LINUX} ${OGG_LINUX} ${SMPEG2_LINUX} ${SDLMIXER})
LINUX_DEBUG_COMMAND(make SDLMIXER)

LINUX_RELEASE_PATH(${SDLMIXER}/${OS}/${RELEASE})
LINUX_RELEASE_COMMAND(${CMAKE_COMMAND} -G "Unix Makefiles" -DCMAKE_BUILD_TYPE=RELEASE -DCMAKE_C_FLAGS=-fPIC ${SDL2_LINUX} ${VORBIS_LINUX} ${OGG_LINUX} ${SMPEG2_LINUX} ${SDLMIXER})
