...
WIN_HOST_DKSET(JAVA "C:/Program Files/Java/bin/jre1.8.0_311/bin")
WIN_GetShortPath(${JAVA} JAVA)
DKSET(JAVA "${JAVA}")
WIN_HOST_DKSET(JAVA_EXE ${JAVA}/java.exe)
...
if(NOT EXISTS "${JAVA_EXE}")
	...
	DKINFO("Installing ${JAVA_NAME}")
	WIN_HOST_DOWNLOAD(${JAVA_DL} ${DKDOWNLOAD})
	Wait()
	dk_exit()
	WIN_HOST_DKCOMMAND(${DKDOWNLOAD}/${JAVA_NAME}.exe)
else()
