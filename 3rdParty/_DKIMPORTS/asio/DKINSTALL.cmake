...
if(MSVC)
	dk_libDebug		(${${CURRENT_PLUGIN}.Debug_Dir}/${current_plugin}.lib)
	dk_libRelease	(${${CURRENT_PLUGIN}.Release_Dir}/${current_plugin}.lib)
else()
	dk_libDebug		(${${CURRENT_PLUGIN}.Debug_Dir}/lib${current_plugin}.a)
	dk_libRelease	(${${CURRENT_PLUGIN}.Release_Dir}/lib${current_plugin}.a)
endif()
