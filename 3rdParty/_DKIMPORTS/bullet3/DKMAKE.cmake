...
if(BulletCollision)
	...
	ANDROID_dk_libDebug		(${BULLET3}/${OS}/${DEBUG_DIR}/obj/local/armeabi-v7a/libBulletCollision.a)
...
if(BulletDynamics)
	...
	ANDROID_dk_libDebug		(${BULLET3}/${OS}/${DEBUG_DIR}/obj/local/armeabi-v7a/libBulletDynamics.a)
...
if(BulletMultiThreaded)
	...
	ANDROID_dk_libDebug		(${BULLET3}/${OS}/${DEBUG_DIR}/obj/local/armeabi-v7a/libBulletMultiThreaded.a)
...
if(BulletSoftBody)
	...
	ANDROID_dk_libDebug		(${BULLET3}/${OS}/${DEBUG_DIR}/obj/local/armeabi-v7a/libBulletSoftBody.a)
...
if(LinearMath)
	...
	ANDROID_dk_libDebug		(${BULLET3}/${OS}/${DEBUG_DIR}/obj/local/armeabi-v7a/libLinearMath.a)
...
if(MiniCL)
	...
	ANDROID_dk_libDebug		(${BULLET3}/${OS}/${DEBUG_DIR}/obj/local/armeabi-v7a/libMiniCL.a)
