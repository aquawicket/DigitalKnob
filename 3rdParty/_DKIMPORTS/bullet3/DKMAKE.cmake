...
if(Bullet3OpenCL)
	WIN_dk_libDebug			(${BULLET3}/${OS}/lib/${DEBUG_DIR}/Bullet3OpenCL_Debug.lib)
	WIN_dk_libRelease		(${BULLET3}/${OS}/lib/${RELEASE_DIR}/Bullet3OpenCL.lib)
	APPLE_dk_libDebug		(${BULLET3}/${OS}/src/Bullet3OpenCL/${DEBUG_DIR}/libBullet3OpenCL.a)
	APPLE_dk_libRelease		(${BULLET3}/${OS}/src/Bullet3OpenCL/${RELEASE_DIR}/libBullet3OpenCL.a)
	LINUX_dk_libDebug		(${BULLET3}/${OS}/${DEBUG_DIR}/src/Bullet3OpenCL/libBullet3OpenCL.a)
	LINUX_dk_libRelease		(${BULLET3}/${OS}/${RELEASE_DIR}/src/Bullet3OpenCL/libBullet3OpenCL.a)
	ANDROID_dk_libDebug		(${BULLET3}/${OS}/src/Bullet3OpenCL/${DEBUG_DIR}//libBullet3OpenCL.a)
	ANDROID_dk_libRelease	(${BULLET3}/${OS}/src/Bullet3OpenCL/${RELEASE_DIR}/libBullet3OpenCL.a)
endif()
if(Bullet3Serialize)
	WIN_dk_libDebug			(${BULLET3}/${OS}/lib/${DEBUG_DIR}/Bullet3Serialize_Debug.lib)
	WIN_dk_libRelease		(${BULLET3}/${OS}/lib/${RELEASE_DIR}/Bullet3Serialize.lib)
	APPLE_dk_libDebug		(${BULLET3}/${OS}/src/Bullet3Serialize/${DEBUG_DIR}/libBullet3Serialize.a)
	APPLE_dk_libRelease		(${BULLET3}/${OS}/src/Bullet3Serialize/${RELEASE_DIR}/libBullet3Serialize.a)
	LINUX_dk_libDebug		(${BULLET3}/${OS}/${DEBUG_DIR}/src/Bullet3Serialize/libBullet3Serialize.a)
	LINUX_dk_libRelease		(${BULLET3}/${OS}/${RELEASE_DIR}/src/Bullet3Serialize/libBullet3Serialize.a)
...
WIN_dk_queueCommand(${DKCMAKE_BUILD} -DBUILD_PYBULLET=ON -DBUILD_PYBULLET_NUMPY=ON -DUSE_DOUBLE_PRECISION=ON -DBT_USE_EGL=ON ${BULLET3})
