...
if(Bullet3Collision)
	if(MULTI_CONFIG)
		...
		dk_libDebug			(${BULLET3_CONFIG_DIR}/src/Bullet3Collision/libBullet3Collision.a)
...
if(Bullet3Common)
	if(MULTI_CONFIG)
		...
		dk_libDebug			(${BULLET3_CONFIG_DIR}/src/Bullet3Common/libBullet3Common.a)
...
if(Bullet3Dynamics)
	if(MULTI_CONFIG)
		...
		dk_libDebug			(${BULLET3_CONFIG_DIR}/src/Bullet3Dynamics/libBullet3Dynamics.a)
...
if(Bullet3Geometry)
	if(MULTI_CONFIG)
		...
		dk_libDebug			(${BULLET3_CONFIG_DIR}/src/Bullet3Geometry/libBullet3Geometry.a)
...
if(Bullet3OpenCL)
	if(MULTI_CONFIG)
		...
		dk_libDebug			(${BULLET3_CONFIG_DIR}/src/Bullet3OpenCL/libBullet3OpenCL_clew.a)
...
if(Bullet3Serialize)
	if(MULTI_CONFIG)
		...
		dk_libDebug			(${BULLET3_CONFIG_DIR}/src/Bullet3Serialize/Bullet2FileLoader/libBullet2FileLoader.a)
...
if(BulletCollision)
	if(MULTI_CONFIG)
		...
		dk_libDebug			(${BULLET3_CONFIG_DIR}/src/BulletCollision/libBulletCollision.a)
...
if(BulletDynamics)
	if(MULTI_CONFIG)
		...
		dk_libDebug			(${BULLET3_CONFIG_DIR}/src/BulletDynamics/libBulletDynamics.a)
...
if(BulletInverseDynamics)
	if(MULTI_CONFIG)
		if(MSVC)
			...
			dk_libDebug		(${BULLET3_CONFIG_DIR}/src/BulletInverseDynamics/${DEBUG_DIR}/libBulletInverseDynamics.a)
...
if(BulletSoftBody)
	if(MULTI_CONFIG)
		...
		dk_libDebug			(${BULLET3_CONFIG_DIR}/src/BulletSoftBody/libBulletSoftBody.a)
...
if(LinearMath)
	if(MULTI_CONFIG)
		...
		dk_libDebug			(${BULLET3_CONFIG_DIR}/src/LinearMath/libLinearMath.a)
