...
RASPBERRY32_DEBUG_COMMAND(${DKCMAKE_RASPBERRY_DEBUG} -DBUILD_TESTING=OFF -DENABLE_TEST=OFF -DENABLE_ACL=OFF -DENABLE_CPIO=OFF -DENABLE_CNG=OFF -DENABLE_ICONV=OFF -DENABLE_NETTLE=OFF -DENABLE_OPENSSL=OFF -DENABLE_TAR=ON -DENABLE_XATTR=OFF -DLIBXML2_INCLUDE_DIR=OFF -DLIBXML2_LIBRARIES=OFF -DLIBXML2_XMLLINT_EXECUTABLE=OFF -DEXPAT_INCLUDE_DIR=OFF -DEXPAT_LIBRARY=OFF -DICONV_INCLUDE_DIR=OFF -DENABLE_LibGCC=OFF ${XZ_RASPBERRY} ${BZIP2_RASPBERRY} ${ZLIB_CMAKE} ${ARCHIVE})
RASPBERRY32_DEBUG_COMMAND(make archive_static)
RASPBERRY32_RELEASE_PATH(${ARCHIVE}/${OS}/${RELEASE_DIR})
RASPBERRY32_RELEASE_COMMAND(${DKCMAKE_RASPBERRY_RELEASE} -DBUILD_TESTING=OFF -DENABLE_TEST=OFF -DENABLE_ACL=OFF -DENABLE_CPIO=OFF -DENABLE_CNG=OFF -DENABLE_ICONV=OFF -DENABLE_NETTLE=OFF -DENABLE_OPENSSL=OFF -DENABLE_TAR=ON -DENABLE_XATTR=OFF -DLIBXML2_INCLUDE_DIR=OFF -DLIBXML2_LIBRARIES=OFF -DLIBXML2_XMLLINT_EXECUTABLE=OFF -DEXPAT_INCLUDE_DIR=OFF -DEXPAT_LIBRARY=OFF -DICONV_INCLUDE_DIR=OFF -DENABLE_LibGCC=OFF ${XZ_RASPBERRY} ${BZIP2_RASPBERRY} ${ZLIB_CMAKE} ${ARCHIVE})
