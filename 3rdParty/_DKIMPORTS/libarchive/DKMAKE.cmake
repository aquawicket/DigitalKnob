...
if(MSCV)
	...
	WIN_dk_libDebug		(${LIBARCHIVE}/${OS}/${DEBUG_DIR}/libarchive/libarchive.a)
	WIN_dk_libRelease	(${LIBARCHIVE}/${OS}/${RELEASE_DIR}/libarchive/libarchive.a)
endif()
...
MAC_dk_queueCommand(${DKCMAKE_BUILD}
	...
	-DLZO2_INCLUDE_DIR=OFF
	-DLZO2_LIBRARY=OFF
	-DZSTD_FIND_QUIETLY=OFF
	-DZSTD_FOUND=OFF
	-DZSTD_INCLUDE_DIR=OFF
	-DZSTD_LIBRARY=OFF
	${BZIP2_CMAKE}
	${CRYPTOPP_CMAKE}
	${LIBB2_CMAKE}
