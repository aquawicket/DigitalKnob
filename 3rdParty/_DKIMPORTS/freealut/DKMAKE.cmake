...
### COMPILE ###
WIN_DKSETPATH(${FREEALUT}/${OS})
WIN32_DKQCOMMAND(${DKCMAKE_BUILD} "-DCMAKE_C_FLAGS=/DWIN32 /D_WINDOWS /W3 /nologo /GR /EHsc /I${OPENAL}/include/AL /I${MSINTTYPES} /DAL_LIBTYPE_STATIC" ${OPENAL_WIN} ${FREEALUT})
WIN64_DKQCOMMAND(${DKCMAKE_BUILD} "-DCMAKE_C_FLAGS=/DWIN64 /D_WINDOWS /W3 /nologo /GR /EHsc /I${OPENAL}/include/AL /I${MSINTTYPES} /DAL_LIBTYPE_STATIC" ${OPENAL_WIN} ${FREEALUT})
WIN_VS(${FREEALUT_NAME} Alut.sln alut_static)


MAC_DKSETPATH(${FREEALUT}/${OS})
MAC64_DKQCOMMAND(${DKCMAKE_BUILD} ${OPENAL_MAC} ${FREEALUT})
MAC_XCODE(${FREEALUT_NAME} alut_static)


LINUX_DEBUG_DKSETPATH(${FREEALUT}/${OS}/${DEBUG_DIR})
LINUX_DEBUG_DKQCOMMAND(${DKCMAKE_BUILD} ${OPENAL_LINUX} ${FREEALUT})
LINUX_DEBUG_DKQCOMMAND(make alut_static)

LINUX_RELEASE_DKSETPATH(${FREEALUT}/${OS}/${RELEASE_DIR})
LINUX_RELEASE_DKQCOMMAND(${DKCMAKE_BUILD} ${OPENAL_LINUX} ${FREEALUT})
LINUX_RELEASE_DKQCOMMAND(make alut_static)
