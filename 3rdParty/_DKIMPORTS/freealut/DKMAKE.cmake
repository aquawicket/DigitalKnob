...
WIN32_COMMAND(${DKCMAKE_BUILD} "-DCMAKE_C_FLAGS=/DWIN32 /D_WINDOWS /W3 /nologo /GR /EHsc /I${OPENAL}/include/AL /I${MSINTTYPES} /DAL_LIBTYPE_STATIC" ${OPENAL_WIN} ${FREEALUT})
WIN64_COMMAND(${DKCMAKE_BUILD} "-DCMAKE_C_FLAGS=/DWIN64 /D_WINDOWS /W3 /nologo /GR /EHsc /I${OPENAL}/include/AL /I${MSINTTYPES} /DAL_LIBTYPE_STATIC" ${OPENAL_WIN} ${FREEALUT})
WIN_VS(${FREEALUT_NAME} Alut.sln alut_static)


MAC_PATH(${FREEALUT}/${OS})
MAC64_COMMAND(${DKCMAKE_BUILD} ${OPENAL_MAC} ${FREEALUT})
MAC_XCODE(${FREEALUT_NAME} alut_static)


LINUX_DEBUG_PATH(${FREEALUT}/${OS}/${DEBUG_DIR})
LINUX_DEBUG_COMMAND(${DKCMAKE_BUILD} ${OPENAL_LINUX} ${FREEALUT})
LINUX_DEBUG_COMMAND(make alut_static)

LINUX_RELEASE_PATH(${FREEALUT}/${OS}/${RELEASE_DIR})
LINUX_RELEASE_COMMAND(${DKCMAKE_BUILD} ${OPENAL_LINUX} ${FREEALUT})
