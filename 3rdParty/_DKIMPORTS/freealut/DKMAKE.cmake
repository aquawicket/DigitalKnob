...
if(MSVC)
	WIN_TARGET_dk_libDebug		(${FREEALUT}/${OS}/src/${DEBUG_DIR}/alut_static.lib		FREEALUT_LIBRARY_DEBUG)
	WIN_TARGET_dk_libRelease	(${FREEALUT}/${OS}/src/${RELEASE_DIR}/alut_static.lib	FREEALUT_LIBRARY_RELEASE)
...
### 3RDPARTY LINK ###
if(MSVC)
	WIN_TARGET_dk_set	(FREEALUT_CMAKE "-DCMAKE_CXX_FLAGS=/I${FREEALUT_INCLUDE_DIR}" -DALUT_INCLUDE_DIR=${FREEALUT_INCLUDE_DIR} -DALUT_LIBRARY_DEBUG=${FREEALUT_LIBRARY_DEBUG} -DALUT_LIBRARY=${FREEALUT_LIBRARY_RELEASE})
else()
