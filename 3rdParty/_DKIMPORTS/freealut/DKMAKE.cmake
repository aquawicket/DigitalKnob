...
MAC64_COMMAND(${CMAKE_COMMAND} -G "Xcode" -DCMAKE_OSX_ARCHITECTURES=x86_64 -DOPENAL_INCLUDE_DIR=${OPENAL}/include -DOPENAL_LIB_DIR=${OPENAL}/${OS} -S ${FREEALUT} -B ${FREEALUT}/${OS})
