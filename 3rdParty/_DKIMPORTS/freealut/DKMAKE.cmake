...
MAC_COMMAND(${CMAKE_COMMAND} -G "Xcode" -DCMAKE_OSX_ARCHITECTURES=x86_64 -DOPENAL_INCLUDE_DIR=${OPENAL}/include -DOPENAL_LIB_DIR=${OPENAL}/${OS} -S ${FREEALUT} -B ${FREEALUT}/${OS})
MAC_XCODE_DEBUG(freealut-${FREEALUT_VERSION} alut_static)
MAC_XCODE_RELEASE(freealut-${FREEALUT_VERSION} alut_static)


LINUX_DEBUG_COMMAND(${CMAKE_COMMAND} -G "Unix Makefiles" -DCMAKE_BUILD_TYPE=DEBUG -DCMAKE_C_FLAGS=-fPIC -DOPENAL_INCLUDE_DIR=${OPENAL}/include -DOPENAL_LIB_DIR=${OPENAL}/${OS}/${DEBUG} -S ${FREEALUT} -B ${FREEALUT}/${OS}/${DEBUG})
LINUX_DEBUG_COMMAND(make alut_static)
LINUX_RELEASE_COMMAND(${CMAKE_COMMAND} -G "Unix Makefiles" -DCMAKE_BUILD_TYPE=RELEASE -DCMAKE_C_FLAGS=-fPIC -DOPENAL_INCLUDE_DIR=${OPENAL}/include -DOPENAL_LIB_DIR=${OPENAL}/${OS}/${RELEASE} -S ${FREEALUT} -B ${FREEALUT}/${OS}/${RELEASE})
