...
MAC_PATH(${CRYPTO}/${OS})
MAC32_COMMAND(${DKCMAKE_MAC32} -DBUILD_STATIC=ON -DBUILD_SHARED=OFF -DBUILD_TESTING=OFF -DDISABLE_ASM=ON ${CRYPTO})
MAC64_COMMAND(${DKCMAKE_MAC64} -DBUILD_STATIC=ON -DBUILD_SHARED=OFF -DBUILD_TESTING=OFF -DDISABLE_ASM=ON ${CRYPTO})
