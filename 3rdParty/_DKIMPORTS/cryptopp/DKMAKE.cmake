...
ANDROID32_COMMAND(${DKCMAKE_ANDROID32} -DCMAKE_CPP_FLAGS=DKINCLUDE(${ANDROIDNDK}/sources/android/cpufeatures ${CRYPTO})
ANDROID64_COMMAND(${DKCMAKE_ANDROID64} -DCMAKE_CPP_FLAGS=DKINCLUDE(${ANDROIDNDK}/sources/android/cpufeatures ${CRYPTO})
