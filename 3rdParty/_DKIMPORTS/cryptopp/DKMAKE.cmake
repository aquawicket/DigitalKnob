...
### COMPILE ###
WIN_PATH(${CRYPTO}/${OS})
WIN32_COMMAND(${DKCMAKE_BUILD} -DBUILD_STATIC=ON -DBUILD_SHARED=OFF -DBUILD_TESTING=OFF ${CRYPTO})
WIN64_COMMAND(${DKCMAKE_BUILD} -DBUILD_STATIC=ON -DBUILD_SHARED=OFF -DBUILD_TESTING=OFF ${CRYPTO})
...
MAC_PATH(${CRYPTO}/${OS})
MAC32_COMMAND(${DKCMAKE_BUILD} -DBUILD_STATIC=ON -DBUILD_SHARED=OFF -Dcryptocpp_DISPLAY_CMAKE_SUPPORT_WARNING=OFF -DBUILD_TESTING=OFF -DCRYPTOPP_DISABLE_MIXED_ASM=ON ${CRYPTO})
...
IOS_PATH(${CRYPTO}/${OS})
IOS32_COMMAND(${DKCMAKE_BUILD} -DBUILD_STATIC=ON -DBUILD_SHARED=OFF -DBUILD_TESTING=OFF ${CRYPTO})
IOS64_COMMAND(${DKCMAKE_BUILD} -DBUILD_STATIC=ON -DBUILD_SHARED=OFF -DBUILD_TESTING=OFF ${CRYPTO})
IOS_XCODE(${CRYPTO_NAME} cryptopp-static)


IOSSIM_PATH(${CRYPTO}/${OS})
IOSSIM32_COMMAND(${DKCMAKE_BUILD} -DBUILD_STATIC=ON -DBUILD_SHARED=OFF -DBUILD_TESTING=OFF ${LIBMD_APPLE} ${CRYPTO})
IOSSIM64_COMMAND(${DKCMAKE_BUILD} -DBUILD_STATIC=ON -DBUILD_SHARED=OFF -DBUILD_TESTING=OFF ${LIBMD_APPLE} ${CRYPTO})
IOSSIM_XCODE(${CRYPTO_NAME} cryptopp-static)


LINUX_DEBUG_PATH(${CRYPTO}/${OS}/${DEBUG_DIR})
LINUX_DEBUG_COMMAND(${DKCMAKE_BUILD} -DBUILD_STATIC=ON -DBUILD_SHARED=OFF -DBUILD_TESTING=OFF ${CRYPTO})
LINUX_DEBUG_COMMAND(make cryptopp-static)
LINUX_RELEASE_PATH(${CRYPTO}/${OS}/${RELEASE_DIR})
LINUX_RELEASE_COMMAND(${DKCMAKE_BUILD} -DBUILD_STATIC=ON -DBUILD_SHARED=OFF -DBUILD_TESTING=OFF ${CRYPTO})
LINUX_RELEASE_COMMAND(make cryptopp-static)


RASPBERRY_DEBUG_PATH(${CRYPTO}/${OS}/${DEBUG_DIR})
RASPBERRY_DEBUG_COMMAND(${DKCMAKE_BUILD} -DBUILD_STATIC=ON -DBUILD_SHARED=OFF -DBUILD_TESTING=OFF ${CRYPTO})
RASPBERRY_DEBUG_COMMAND(make cryptopp-static)
RASPBERRY_RELEASE_PATH(${CRYPTO}/${OS}/${RELEASE_DIR})
RASPBERRY_RELEASE_COMMAND(${DKCMAKE_BUILD} -DBUILD_STATIC=ON -DBUILD_SHARED=OFF -DBUILD_TESTING=OFF ${CRYPTO})
...
#ANDROID32_COMMAND(${DKCMAKE_BUILD} "-DCMAKE_CXX_FLAGS=/I${ANDROIDNDK}/sources/android/cpufeatures" -DBUILD_STATIC=ON -DBUILD_SHARED=OFF -DBUILD_TESTING=OFF ${CRYPTO})
