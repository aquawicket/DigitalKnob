...
ANDROID_dk_configure		(${CRYPTOPP_DIR} "-DCMAKE_CXX_FLAGS=/I${ANDROID_NDK}/sources/android/cpufeatures" -DBUILD_STATIC=${BUILD_STATIC_LIBS} -DBUILD_SHARED=${BUILD_SHARED_LIBS})
EMSCRIPTEN_dk_configure		(${CRYPTOPP_DIR} -DBUILD_STATIC=${BUILD_STATIC_LIBS} -DBUILD_SHARED=${BUILD_SHARED_LIBS})
IOS_dk_configure			(${CRYPTOPP_DIR} -DBUILD_STATIC=${BUILD_STATIC_LIBS} -DBUILD_SHARED=${BUILD_SHARED_LIBS} ${LIBMD_CMAKE})
IOSSIM_dk_configure			(${CRYPTOPP_DIR} -DBUILD_STATIC=${BUILD_STATIC_LIBS} -DBUILD_SHARED=${BUILD_SHARED_LIBS} ${LIBMD_CMAKE})
LINUX_dk_configure			(${CRYPTOPP_DIR} -DBUILD_STATIC=${BUILD_STATIC_LIBS} -DBUILD_SHARED=${BUILD_SHARED_LIBS})
MAC_dk_configure			(${CRYPTOPP_DIR} -DBUILD_STATIC=${BUILD_STATIC_LIBS} -DBUILD_SHARED=${BUILD_SHARED_LIBS} -DCRYPTOPP_DISABLE_MIXED_ASM=ON)
RASPBERRY_dk_configure		(${CRYPTOPP_DIR} -DBUILD_STATIC=${BUILD_STATIC_LIBS} -DBUILD_SHARED=${BUILD_SHARED_LIBS})
WIN_dk_configure			(${CRYPTOPP_DIR} -DBUILD_STATIC=${BUILD_STATIC_LIBS} -DBUILD_SHARED=${BUILD_SHARED_LIBS})
