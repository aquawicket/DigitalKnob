...
### LINK ###
if(Android)
	dk_libDebug		(${CRYPTOPP.Debug_Dir}/libcryptopp.a)
	dk_libRelease	(${CRYPTOPP.Release_Dir}/libcryptopp.a)
elseif(Apple)
	dk_libDebug		(${CRYPTOPP.Tuple_Dir}/cryptopp.build/${Debug_Dir}/cryptopp-object.build/libcryptopp-object.a)
	dk_libRelease	(${CRYPTOPP.Tuple_Dir}/cryptopp.build/${Release_Dir}/cryptopp-object.build/libcryptopp-object.a)
elseif(Emscripten)
	dk_libDebug		(${CRYPTOPP.Debug_Dir}/libcryptopp.a)
	dk_libRelease	(${CRYPTOPP.Release_Dir}/libcryptopp.a)
elseif(Linux)
...
elseif(Raspberry)
	...
	dk_libRelease	(${CRYPTOPP.Release_Dir}/libcryptopp.a)
elseif(MSVC)
	dk_libDebug		(${CRYPTOPP.Debug_Dir}/cryptopp-static.lib)
	dk_libRelease	(${CRYPTOPP.Release_Dir}/cryptopp-static.lib)
elseif(Windows)
	dk_libDebug		(${CRYPTOPP.Debug_Dir}/libcryptopp.a)
	dk_libRelease	(${CRYPTOPP.Release_Dir}/libcryptopp.a)
endif()
