...
IF(CMAKE_HOST_WIN32)
	IF(NOT EXISTS ${EMSCRIPTEN})
		DKSET(CURRENT_DIR ${DK}/Download)
		## DKDOWNLOAD(www.internet.com/emsdk-portable-64bit.zip) ## find an online link
		DKEXTRACT(${DK}/Download/emsdk-portable-64bit.zip ${3RDPARTY}/emsdk-portable-64bit)
	...
	DKEXTRACT(${DK}/Download/emsdk-portable.tar.gz ${3RDPARTY}/emsdk-portable)
