...
if(MULTI_CONFIG)
	...
	DEBUG_dk_set	(ZSTD_CMAKE -DZSTD_INCLUDE_DIR=${ZSTD_INCLUDE_DIR} -DZSTD_LIBRARY=${ZSTD_LIBRARY_DEBUG} -DZstd_INCLUDE_DIR=${ZSTD_INCLUDE_DIR} -DZstd_LIBRARY=${ZSTD_LIBRARY_DEBUG} -DZstd_LIBRARIES=${ZSTD_LIBRARY_DEBUG})
	RELEASE_dk_set	(ZSTD_CMAKE -DZSTD_INCLUDE_DIR=${ZSTD_INCLUDE_DIR} -DZSTD_LIBRARY=${ZSTD_LIBRARY_RELEASE} -DZstd_INCLUDE_DIR=${ZSTD_INCLUDE_DIR} -DZstd_LIBRARY=${ZSTD_LIBRARY_RELEASE} -DZstd_LIBRARIES=${ZSTD_LIBRARY_RELEASE})
endif()
