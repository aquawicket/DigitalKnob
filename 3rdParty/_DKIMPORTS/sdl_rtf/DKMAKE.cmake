...
dk_include					(${SDL_RTF})
if(MSVC)
	WIN_TARGET_dk_libDebug			(${SDL_RTF}/${OS}/lib/${DEBUG_DIR}/SDL_rtf.lib)
	WIN_TARGET_dk_libRelease		(${SDL_RTF}/${OS}/lib/${RELEASE_DIR}/SDL_rtf.lib)
elseif(APPLE)
	IOSSIM_TARGET_dk_libDebug		(${SDL_RTF}/${OS}/lib/Debug/SDL_rtf.a)
	IOSSIM_TARGET_dk_libRelease	(${SDL_RTF}/${OS}/lib/Release/SDL_rtf.a)
	MAC_TARGET_dk_libDebug			(${SDL_RTF}/${OS}/lib/${DEBUG_DIR}/SDL_rtf.a)
