...
## WIN32_COMMAND(${CMAKE_COMMAND} -G ${GENERATOR} -A Win32 "-DCMAKE_C_FLAGS=/DTEST /DWIN32 /D_WINDOWS /W3 /nologo" "-DCMAKE_C_FLAGS_DEBUG=/MTd /Od /Ob0 /Zi /RTC1 /DDEBUG /D_DEBUG" "-DCMAKE_C_FLAGS_RELEASE=/MT /O2 /Ob2 /DNDEBUG" -S ${IMAGEMAGICK_ROOT} -B ${IMAGEMAGICK_ROOT}/${OS})
...
WIN64_PATH(${IMAGEMAGICK_ROOT}/${OS})
...
WIN64_VS(ImageMagick-${IMAGEMAGICK_VERSION} imagemagick.sln imagemagick)

MAC_PATH(${IMAGEMAGICK_ROOT}/${OS})
MAC64_COMMAND(${CMAKE_COMMAND} -G "Xcode" -DCMAKE_OSX_ARCHITECTURES=x86_64 -S ${IMAGEMAGICK_ROOT} -B ${IMAGEMAGICK_ROOT}/${OS})
MAC_XCODE_DEBUG(ImageMagick-${IMAGEMAGICK_VERSION} imagemagick)
MAC_XCODE_RELEASE(ImageMagick-${IMAGEMAGICK_VERSION} imagemagick)


IOS_COMMAND(${CMAKE_COMMAND} -G "Xcode" -DCMAKE_TOOLCHAIN_FILE=${DKCMAKE}/iOS.cmake -DIOS_PLATFORM=OS -S ${IMAGEMAGICK_ROOT} -B ${IMAGEMAGICK_ROOT}/${OS})
IOS_XCODE_DEBUG(ImageMagick-${IMAGEMAGICK_VERSION} imagemagick)
IOS_XCODE_RELEASE(ImageMagick-${IMAGEMAGICK_VERSION} imagemagick)


IOSSIM_COMMAND(${CMAKE_COMMAND} -G "Xcode" -DCMAKE_TOOLCHAIN_FILE=${DKCMAKE}/iOS.cmake -DIOS_PLATFORM=SIMULATOR64 -S ${IMAGEMAGICK_ROOT} -B ${IMAGEMAGICK_ROOT}/${OS})
...
LINUX32_DEBUG_COMMAND(${CMAKE_COMMAND} -G "Unix Makefiles" -DCMAKE_BUILD_TYPE=DEBUG -DCMAKE_C_FLAGS=-fPIC -m32 -S ${IMAGEMAGICK_ROOT} -B ${IMAGEMAGICK_ROOT}/${OS}/${DEBUG})
LINUX32_DEBUG_COMMAND(make imagemagick)
LINUX32_RELEASE_COMMAND(${CMAKE_COMMAND} -G "Unix Makefiles" -DCMAKE_BUILD_TYPE=RELEASE -DCMAKE_C_FLAGS=-fPIC -m32 -S ${IMAGEMAGICK_ROOT} -B ${IMAGEMAGICK_ROOT}/${OS}/${RELEASE})
LINUX32_RELEASE_COMMAND(make imagemagick)


LINUX64_DEBUG_COMMAND(${CMAKE_COMMAND} -G "Unix Makefiles" -DCMAKE_BUILD_TYPE=DEBUG -DCMAKE_C_FLAGS=-fPIC -S ${IMAGEMAGICK_ROOT} -B ${IMAGEMAGICK_ROOT}/${OS}/${DEBUG})
LINUX64_DEBUG_COMMAND(make imagemagick)
LINUX64_RELEASE_COMMAND(${CMAKE_COMMAND} -G "Unix Makefiles" -DCMAKE_BUILD_TYPE=RELEASE -DCMAKE_C_FLAGS=-fPIC -S ${IMAGEMAGICK_ROOT} -B ${IMAGEMAGICK_ROOT}/${OS}/${RELEASE})
