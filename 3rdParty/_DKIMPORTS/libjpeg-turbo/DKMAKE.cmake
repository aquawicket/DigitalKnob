...
elseif(APPLE)
	...
	DEBUG_dk_set	(LIBJPEG_TURBO_CMAKE -DJPEG_INCLUDE_DIR=${LIBJPEG_TURBO_INCLUDE_DIR} -DJPEG_INCLUDE_DIR2=${LIBJPEG_TURBO_INCLUDE_DIR2} -DJPEG_LIBRARY=${LIBJPEG_TURBO_LIBRARY_DEBUG}   -DLIBJPEG_INCLUDE_DIR=${LIBJPEG_TURBO} -DLIBJPEG_LIBRARY=${LIBJPEG_TURBO_LIBRARY_DEBUG} "-DCMAKE_C_FLAGS=-I${LIBJPEG_TURBO}/${OS}/${DEBUG_DIR}" "-DCMAKE_CXX_FLAGS=-I${LIBJPEG_TURBO}/${OS}/${DEBUG_DIR}")
	RELEASE_dk_set	(LIBJPEG_TURBO_CMAKE -DJPEG_INCLUDE_DIR=${LIBJPEG_TURBO_INCLUDE_DIR} -DJPEG_INCLUDE_DIR2=${LIBJPEG_TURBO_INCLUDE_DIR2} -DJPEG_LIBRARY=${LIBJPEG_TURBO_LIBRARY_RELEASE} -DLIBJPEG_INCLUDE_DIR=${LIBJPEG_TURBO} -DLIBJPEG_LIBRARY=${LIBJPEG_TURBO_LIBRARY_RELEASE} )
endif()
