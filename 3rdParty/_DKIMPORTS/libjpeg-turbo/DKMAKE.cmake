...
### 3RDPARTY LINK ###
if(MSVC)
	WIN_dk_set		(LIBJPEG_TURBO_CMAKE -DJPEG_INCLUDE_DIR=${LIBJPEG_TURBO_INCLUDE_DIR} -DJPEG_INCLUDE_DIR2=${LIBJPEG_TURBO_INCLUDE_DIR2} -DJPEG_LIBRARY_DEBUG=${LIBJPEG_TURBO_LIBRARY_DEBUG} -DJPEG_LIBRARY_RELEASE=${LIBJPEG_TURBO_LIBRARY_RELEASE} "-DCMAKE_C_FLAGS=/I${LIBJPEG_TURBO}/${OS}" "-DCMAKE_CXX_FLAGS=/I${LIBJPEG_TURBO}/${OS}")
elseif(ANDROID)
...
elseif(APPLE)
	...
	DEBUG_dk_set	(LIBJPEG_TURBO_CMAKE -DJPEG_INCLUDE_DIR=${LIBJPEG_TURBO_INCLUDE_DIR} -DJPEG_INCLUDE_DIR2=${LIBJPEG_TURBO_INCLUDE_DIR2} -DJPEG_LIBRARY=${LIBJPEG_TURBO_LIBRARY_DEBUG}   -DLIBJPEG_INCLUDE_DIR=${LIBJPEG_TURBO} -DLIBJPEG_LIBRARY=${LIBJPEG_TURBO_LIBRARY_DEBUG} -DJPEG_INCLUDE_DIRS=${LIBJPEG_TURBO_INCLUDE_DIR} "-DCMAKE_C_FLAGS=-I${LIBJPEG_TURBO_INCLUDE_DIR2}" "-DCMAKE_CXX_FLAGS=-I${LIBJPEG_TURBO_INCLUDE_DIR2}")
	RELEASE_dk_set	(LIBJPEG_TURBO_CMAKE -DJPEG_INCLUDE_DIR=${LIBJPEG_TURBO_INCLUDE_DIR} -DJPEG_INCLUDE_DIR2=${LIBJPEG_TURBO_INCLUDE_DIR2} -DJPEG_LIBRARY=${LIBJPEG_TURBO_LIBRARY_RELEASE} -DLIBJPEG_INCLUDE_DIR=${LIBJPEG_TURBO} -DLIBJPEG_LIBRARY=${LIBJPEG_TURBO_LIBRARY_RELEASE} -DJPEG_INCLUDE_DIRS=${LIBJPEG_TURBO_INCLUDE_DIR})
endif()
