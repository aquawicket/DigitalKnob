...
elseif(APPLE)
	...
	DEBUG_dk_set			(LIBJPEG_TURBO_CMAKE -DJPEG_INCLUDE_DIR=${LIBJPEG_TURBO_INCLUDE_DIR} "-DCMAKE_C_FLAGS=-I${LIBJPEG_TURBO}/${OS}/Debug" "-DCMAKE_CXX_FLAGS=-I${LIBJPEG_TURBO}/${OS}/Debug" -DJPEG_INCLUDE_DIR2=${LIBJPEG_TURBO}/${OS}/${DEBUG_DIR} -DJPEG_LIBRARY=${LIBJPEG_TURBO}/${OS}/${DEBUG_DIR}/libturbojpeg.a -DLIBJPEG_INCLUDE_DIR=${LIBJPEG_TURBO} -DLIBJPEG_LIBRARY=${LIBJPEG_TURBO}/${OS}/${RELEASE_DIR}/libturbojpeg.a)
	RELEASE_dk_set			(LIBJPEG_TURBO_CMAKE -DJPEG_INCLUDE_DIR=${LIBJPEG_TURBO_INCLUDE_DIR} "-DCMAKE_C_FLAGS=-I${LIBJPEG_TURBO}/${OS}/Release" "-DCMAKE_CXX_FLAGS=-I${LIBJPEG_TURBO}/${OS}/Release" -DJPEG_INCLUDE_DIR2=${LIBJPEG_TURBO}/${OS}/${RELEASE_DIR} -DJPEG_LIBRARY=${LIBJPEG_TURBO}/${OS}/${RELEASE_DIR}/libturbojpeg.a -DLIBJPEG_INCLUDE_DIR=${LIBJPEG_TURBO} -DLIBJPEG_LIBRARY=${LIBJPEG_TURBO}/${OS}/${RELEASE_DIR}/libturbojpeg.a)
endif()
