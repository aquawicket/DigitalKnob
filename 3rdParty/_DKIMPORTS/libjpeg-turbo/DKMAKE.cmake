...
DKSET(JPEG_LINUX -DJPEG_INCLUDE_DIR=${JPEG} "-DCMAKE_C_FLAGS=/I${JPEG}/${OS}/${DEBUG_DIR}" -DJPEG_INCLUDE_DIR2=${JPEG}/${OS}/${RELEASE_DIR} -DJPEG_LIBRARY=${JPEG}/${OS}/${RELEASE_DIR}/libturbojpeg.a)
DKSET(JPEG_RASPBERRY -DJPEG_INCLUDE_DIR=${JPEG} "-DCMAKE_C_FLAGS=/I${JPEG}/${OS}/${DEBUG_DIR}" -DJPEG_INCLUDE_DIR2=${JPEG}/${OS}/${RELEASE_DIR} -DJPEG_LIBRARY=${JPEG}/${OS}/${RELEASE_DIR}/libturbojpeg.a)
