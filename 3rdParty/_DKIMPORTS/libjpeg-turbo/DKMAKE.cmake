### VERSION ###
DKSET(JPEG_VERSION libjpeg-turbo-1.5.3)

### INSTALL ###
DKINSTALL(https://sourceforge.net/projects/libjpeg-turbo/files/1.5.3/${JPEG_VERSION}.tar.gz libjpeg-turbo ${JPEG_VERSION})
DKSET(JPEG ${3RDPARTY}/${JPEG_VERSION})
...
WIN32_VS_DEBUG(${JPEG_VERSION} libjpeg-turbo.sln turbojpeg-static)
WIN32_VS_RELEASE(${JPEG_VERSION} libjpeg-turbo.sln turbojpeg-static)
...
WIN64_VS_DEBUG(${JPEG_VERSION} libjpeg-turbo.sln turbojpeg-static)
WIN64_VS_RELEASE(${JPEG_VERSION} libjpeg-turbo.sln turbojpeg-static)

DKSETPATH(${JPEG}/${OS})
MAC_COMMAND(${CMAKE_COMMAND} -G "Xcode" -DCMAKE_OSX_ARCHITECTURES=x86_64 ${JPEG})
MAC_XCODE_DEBUG(${JPEG_VERSION} turbojpeg-static)
MAC_XCODE_RELEASE(${JPEG_VERSION} turbojpeg-static)

DKSETPATH(${JPEG}/${OS})
IOS_COMMAND(${CMAKE_COMMAND} -G "Xcode" -DCMAKE_TOOLCHAIN_FILE=${DKCMAKE}/iOS.cmake -DIOS_PLATFORM=OS ${JPEG})
IOS_XCODE_DEBUG(${JPEG_VERSION} turbojpeg-static)
IOS_XCODE_RELEASE(${JPEG_VERSION} turbojpeg-static)

DKSETPATH(${JPEG}/${OS})
IOSSIM_COMMAND(${CMAKE_COMMAND} -G "Xcode" -DCMAKE_TOOLCHAIN_FILE=${DKCMAKE}/iOS.cmake -DIOS_PLATFORM=SIMULATOR ${JPEG})
IOSSIM_XCODE_DEBUG(${JPEG_VERSION} turbojpeg-static)
IOSSIM_XCODE_RELEASE(${JPEG_VERSION} turbojpeg-static)
...
ANDROID_NDK_DEBUG(${JPEG_VERSION})
ANDROID_NDK_RELEASE(${JPEG_VERSION})
