...
### 3RDPARTY LINK ###
if(MSVC)
	WIN_dk_set		(LIBJPEG_TURBO_CMAKE -DJPEG_INCLUDE_DIR=${LIBJPEG_TURBO_INCLUDE_DIR} "-DCMAKE_C_FLAGS=/I${LIBJPEG_TURBO}/${OS}" "-DCMAKE_CXX_FLAGS=/I${LIBJPEG_TURBO}/${OS}"  -DJPEG_LIBRARY_DEBUG=${LIBJPEG_TURBO_LIBRARY_DEBUG} -DJPEG_LIBRARY_RELEASE=${LIBJPEG_TURBO_LIBRARY_RELEASE})
else()
	ANDROID_dk_set	(LIBJPEG_TURBO_CMAKE -DJPEG_INCLUDE_DIR=${LIBJPEG_TURBO_INCLUDE_DIR} "-DCMAKE_C_FLAGS=-I${LIBJPEG_TURBO}/${OS}" "-DCMAKE_CXX_FLAGS=-I${LIBJPEG_TURBO}/${OS}"  -DJPEG_INCLUDE_DIR2=${LIBJPEG_TURBO}/${OS} -DJPEG_LIBRARY=${LIBJPEG_TURBO_LIBRARY_RELEASE} -DLIBJPEG_INCLUDE_DIR=${LIBJPEG_TURBO} -DLIBJPEG_LIBRARY=${LIBJPEG_TURBO_LIBRARY_RELEASE})
elseif(APPLE)
	APPLE_dk_set	(LIBJPEG_TURBO_CMAKE -DJPEG_INCLUDE_DIR=${LIBJPEG_TURBO_INCLUDE_DIR} "-DCMAKE_C_FLAGS=-I${LIBJPEG_TURBO}/${OS}" "-DCMAKE_CXX_FLAGS=-I${LIBJPEG_TURBO}/${OS}" -DJPEG_INCLUDE_DIR2=${LIBJPEG_TURBO}/${OS} -DJPEG_LIBRARY_RELEASE=${LIBJPEG_TURBO_LIBRARY_RELEASE} -DLIBJPEG_INCLUDE_DIR=${LIBJPEG_TURBO} -DLIBJPEG_LIBRARY=${LIBJPEG_TURBO_LIBRARY_RELEASE})
else()
	DEBUG_dk_set	(LIBJPEG_TURBO_CMAKE -DJPEG_INCLUDE_DIR=${LIBJPEG_TURBO_INCLUDE_DIR} "-DCMAKE_C_FLAGS=-I${LIBJPEG_TURBO}/${OS}/${DEBUG_DIR}" "-DCMAKE_CXX_FLAGS=-I${LIBJPEG_TURBO}/${OS}/${DEBUG_DIR}" -DJPEG_INCLUDE_DIR2=${LIBJPEG_TURBO}/${OS}/${DEBUG_DIR} -DJPEG_LIBRARY=${LIBJPEG_TURBO_LIBRARY_DEBUG} -DLIBJPEG_INCLUDE_DIR=${LIBJPEG_TURBO} -DLIBJPEG_LIBRARY=${LIBJPEG_TURBO_LIBRARY_DEBUG})
	RELEASE_dk_set	(LIBJPEG_TURBO_CMAKE -DJPEG_INCLUDE_DIR=${LIBJPEG_TURBO_INCLUDE_DIR} "-DCMAKE_C_FLAGS=-I${LIBJPEG_TURBO}/${OS}/${RELEASE_DIR}" "-DCMAKE_CXX_FLAGS=-I${LIBJPEG_TURBO}/${OS}/${RELEASE_DIR}" -DJPEG_INCLUDE_DIR2=${LIBJPEG_TURBO}/${OS}/${RELEASE_DIR} -DJPEG_LIBRARY=${LIBJPEG_TURBO_LIBRARY_RELEASE} -DLIBJPEG_INCLUDE_DIR=${LIBJPEG_TURBO} -DLIBJPEG_LIBRARY=${LIBJPEG_TURBO_LIBRARY_RELEASE})
endif()
