...
if(MSVC)
	...
	ANDROID_TARGET_dk_libRelease	(${LIBJPEG_TURBO}/${OS}/${RELEASE_DIR}/libturbojpeg.a			LIBJPEG_TURBO_LIBRARY_RELEASE)
else()
...
elseif(ANDROID)
	ANDROID_TARGET_dk_set	(LIBJPEG_TURBO_CMAKE -DJPEG_INCLUDE_DIR=${LIBJPEG_TURBO_INCLUDE_DIR} -DJPEG_INCLUDE_DIR2=${LIBJPEG_TURBO_INCLUDE_DIR2} -DJPEG_LIBRARY=${LIBJPEG_TURBO_LIBRARY_RELEASE} -DLIBJPEG_INCLUDE_DIR=${LIBJPEG_TURBO} -DLIBJPEG_LIBRARY=${LIBJPEG_TURBO_LIBRARY_RELEASE} "-DCMAKE_C_FLAGS=-I${LIBJPEG_TURBO}/${OS}" "-DCMAKE_CXX_FLAGS=-I${LIBJPEG_TURBO}/${OS}")
elseif(APPLE)
