...
LINUX_DEBUG_LIB(${UV}/${OS}/${DEBUG_DIR}/uv_a.a)
...
DKSET(LIBUV_APPLE -DLIBUV_INCLUDE_DIR=${UV} -DLIBUV_LIBRARY=${UV}/${OS}/${RELEASE_DIR}/uv_a.lib)
DKSET(LIBUV_LINUX -DLIBUV_INCLUDE_DIR=${UV} -DLIBUV_LIBRARY=${UV}/${OS}/${RELEASE_DIR}/uv_a.lib)
DKSET(LIBUV_RASPBERRY -DLIBUV_INCLUDE_DIR=${UV} -DLIBUV_LIBRARY=${UV}/${OS}/${RELEASE_DIR}/uv_a.lib)
DKSET(LIBUV_ANDROID -DLIBUV_INCLUDE_DIR=${UV} -DLIBUV_LIBRARY=${UV}/${OS}/${RELEASE_DIR}/uv_a.lib)
...
MAC64_XCODE_DEBUG(libuv-${UV_VERSION} libuv)
MAC64_XCODE_RELEASE(libuv-${UV_VERSION} libuv)


IOS_PATH(${UV}/${OS})
IOS_COMMAND(${CMAKE_COMMAND} -G "Xcode" -DCMAKE_TOOLCHAIN_FILE=${DKCMAKE}/iOS.cmake -DIOS_PLATFORM=OS ${UV})
IOS_XCODE_DEBUG(libuv-${UV_VERSION} libuv)
IOS_XCODE_RELEASE(libuv-${UV_VERSION} libuv)


IOSSIM_PATH(${UV}/${OS})
IOSSIM_COMMAND(${CMAKE_COMMAND} -G "Xcode" -DCMAKE_TOOLCHAIN_FILE=${DKCMAKE}/iOS.cmake -DIOS_PLATFORM=SIMULATOR ${UV})
IOSSIM_XCODE_DEBUG(libuv-${UV_VERSION} libuv)
IOSSIM_XCODE_RELEASE(libuv-${UV_VERSION} libuv)
...
RASPBERRY_DEBUG_COMMAND(make uv)
...
RASPBERRY_RELEASE_COMMAND(make uv)
