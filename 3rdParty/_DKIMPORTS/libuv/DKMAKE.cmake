...
### COMPILE ###
WIN_PATH(${UV}/${OS})
WIN32_COMMAND(${DKCMAKE_BUILD} ${UV})
WIN64_COMMAND(${DKCMAKE_BUILD} ${UV})
WIN_VS(${UV_NAME} libuv.sln uv_a)


MAC_PATH(${UV}/${OS})
MAC64_COMMAND(${DKCMAKE_BUILD} ${UV})
MAC_XCODE(${UV_NAME} uv_a)


IOS_PATH(${UV}/${OS})
IOS64_COMMAND(${DKCMAKE_BUILD} ${UV})
IOS_XCODE(${UV_NAME} uv_a)


IOSSIM_PATH(${UV}/${OS})
IOSSIM64_COMMAND(${DKCMAKE_BUILD} ${UV})
IOSSIM_XCODE(${UV_NAME} uv_a)


LINUX_DEBUG_PATH(${UV}/${OS}/${DEBUG_DIR})
LINUX_DEBUG_COMMAND(${DKCMAKE_BUILD} ${UV})
LINUX_DEBUG_COMMAND(make uv_a)

LINUX_RELEASE_PATH(${UV}/${OS}/${RELEASE_DIR})
LINUX_RELEASE_COMMAND(${DKCMAKE_BUILD} ${UV})
LINUX_RELEASE_COMMAND(make uv_a)


RASPBERRY_DEBUG_PATH(${UV}/${OS}/${DEBUG_DIR})
RASPBERRY_DEBUG_COMMAND(${DKCMAKE_BUILD} ${UV})
RASPBERRY_DEBUG_COMMAND(make uv_a)

RASPBERRY_RELEASE_PATH(${UV}/${OS}/${RELEASE_DIR})
RASPBERRY_RELEASE_COMMAND(${DKCMAKE_BUILD} ${UV})
RASPBERRY_RELEASE_COMMAND(make uv_a)


## ANDROID_NDK(${UV_NAME})
ANDROID_PATH(${UV}/${OS})
ANDROID32_COMMAND(${DKCMAKE_BUILD} ${UV})
ANDROID64_COMMAND(${DKCMAKE_BUILD} ${UV})
