...
LINUX_DEBUG_COMMAND(${DKCMAKE_LINUX_DEBUG} -DCMAKE_C_FLAGS=-fPIC ${ZLIB_LINUX} ${LIBUV_LINUX} ${OPENSSL_LINUX} ${UWEBSOCKETS})
LINUX_DEBUG_COMMAND(make uWebSockets)

LINUX_RELEASE_PATH(${UWEBSOCKETS}/${OS}/${RELEASE_DIR})
LINUX_RELEASE_COMMAND(${DKCMAKE_LINUX_RELEASE} -DCMAKE_C_FLAGS=-fPIC ${ZLIB_LINUX} ${LIBUV_LINUX} ${OPENSSL_LINUX} ${UWEBSOCKETS})
LINUX_RELEASE_COMMAND(make uWebSockets)


RASPBERRY_DEBUG_PATH(${UWEBSOCKETS}/${OS}/${DEBUG_DIR})
RASPBERRY_DEBUG_COMMAND(${DKCMAKE_RASPBERRY_DEBUG} -DCMAKE_C_FLAGS=-fPIC ${ZLIB_RASPBERRY} ${LIBUV_RASPBERRY} ${OPENSSL_RASPBERRY} ${UWEBSOCKETS})
RASPBERRY_DEBUG_COMMAND(make uWebSockets)

RASPBERRY_RELEASE_PATH(${UWEBSOCKETS}/${OS}/${RELEASE_DIR})
RASPBERRY_RELEASE_COMMAND(${DKCMAKE_RASPBERRY_RELEASE} -DCMAKE_C_FLAGS=-fPIC ${ZLIB_RASPBERRY} ${LIBUV_RASPBERRY} ${OPENSSL_RASPBERRY} ${UWEBSOCKETS})
