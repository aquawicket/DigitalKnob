...
#EMSCRIPTEN_DEBUG_dk_queueCommand	(${EMSDK}/upstream/emscripten/emmake make)
...
EMSCRIPTEN_dk_queueCommand			(${SDK}/build-scripts/emscripten-buildbot.sh)
EMSCRIPTEN_DEBUG_dk_copy			(${SDK}/buildbot/usr/local/include ${SDK}/emscripten/Debug/include)
EMSCRIPTEN_RELEASE_dk_copy			(${SDK}/buildbot/usr/local/include ${SDK}/emscripten/Release/include)
