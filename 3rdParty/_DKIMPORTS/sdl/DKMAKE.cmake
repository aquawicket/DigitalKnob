...
### 3RDPARTY LINK ###
#ANDROID_TARGET_dk_set(SDL_CMAKE
...
string(REPLACE "-std=c17" "" 	SDL_BUILD "${DKCMAKE_BUILD}")
string(REPLACE "  " " " 		SDL_BUILD "${SDL_BUILD}")
MAC_TARGET_dk_queueCommand				(${SDL_BUILD} -DSDL_SHARED=OFF -DSDL_OPENGL=ON -DSDL_METAL=ON -DHAVE_BUILTIN_ICONV=0 -DHAVE_LIBICONV=0 ${ICONV_CMAKE} ${SDL})
RASPBERRY_TARGET_dk_configure			(${SDL} -DSDL_SHARED=OFF -DVIDEO_OPENGLES=ON)
WIN_TARGET_dk_configure				(${SDL} -DLIBTYPE=STATIC -DSDL_SHARED=OFF -DSDL_LIBC=ON)
