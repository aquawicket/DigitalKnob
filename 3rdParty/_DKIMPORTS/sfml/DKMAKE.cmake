...
LINUX_DEBUG_COMMAND(${DKCMAKE_LINUX_DEBUG} ${JPEG_LINUX_DEBUG} ${OPENAL_LINUX} ${SFML})
LINUX_DEBUG_COMMAND(make)

LINUX_RELEASE_PATH(${SFML}/${OS}/${RELEASE_DIR})
LINUX_RELEASE_COMMAND(${DKCMAKE_LINUX_RELEASE} ${JPEG_LINUX_RELEASE} ${OPENAL_LINUX} ${VORBIX_LINUX} ${OGG_LINUX} ${SFML})
LINUX_RELEASE_COMMAND(make)


RASPBERRY_DEBUG_PATH(${SFML}/${OS}/${DEBUG_DIR})
RASPBERRY_LINUX_DEBUG_COMMAND(${DKCMAKE_RASPBERRY_DEBUG} ${JPEG_RASPBERRY_DEBUG} ${OPENAL_RASPBERRY} ${SFML})
RASPBERRY_LINUX_DEBUG_COMMAND(make)

RASPBERRY_LINUX_RELEASE_PATH(${SFML}/${OS}/${RELEASE_DIR})
RASPBERRY_LINUX_RELEASE_COMMAND(${DKCMAKE_RASPBERRY_RELEASE} ${JPEG_RASPBERRY_RELEASE} ${OPENAL_RASPBERRY} ${VORBIX_RASPBERRY} ${OGG_RASPBERRY} ${SFML})
