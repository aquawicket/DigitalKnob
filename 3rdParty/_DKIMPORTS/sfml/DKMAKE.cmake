...
LINUX_DEBUG_LIB(${SFML}/${OS}/lib/${DEBUG_DIR}/lib/libsfml-audio-s-d.a)
LINUX_RELEASE_LIB(${SFML}/${OS}/lib/${RELEASE_DIR}/lib/libsfml-audio-s.a)
LINUX_DEBUG_LIB(${SFML}/${OS}/lib/${DEBUG_DIR}/lib/libsfml-graphics-s-d.a)
LINUX_RELEASE_LIB(${SFML}/${OS}/lib/${RELEASE_DIR}/lib/libsfml-graphics-s.a)
LINUX_DEBUG_LIB(${SFML}/${OS}/lib/${DEBUG_DIR}/lib/libsfml-network-s-d.a)
LINUX_RELEASE_LIB(${SFML}/${OS}/lib/${RELEASE_DIR}/lib/libsfml-network-s.a)
LINUX_DEBUG_LIB(${SFML}/${OS}/lib/${DEBUG_DIR}/lib/libsfml-system-s-d.a)
LINUX_RELEASE_LIB(${SFML}/${OS}/lib/${RELEASE_DIR}/lib/libsfml-system-s.a)
LINUX_DEBUG_LIB(${SFML}/${OS}/lib/${DEBUG_DIR}/lib/libsfml-window-s-d.a)
LINUX_RELEASE_LIB(${SFML}/${OS}/lib/${RELEASE_DIR}/lib/libsfml-window-s.a)

RASPBERRY_DEBUG_LIB(${SFML}/${OS}/lib/${DEBUG_DIR}/lib/libsfml-audio-s-d.a)
RASPBERRY_RELEASE_LIB(${SFML}/${OS}/lib/${RELEASE_DIR}/lib/libsfml-audio-s.a)
RASPBERRY_DEBUG_LIB(${SFML}/${OS}/lib/${DEBUG_DIR}/lib/libsfml-graphics-s-d.a)
RASPBERRY_RELEASE_LIB(${SFML}/${OS}/lib/${RELEASE_DIR}/lib/libsfml-graphics-s.a)
RASPBERRY_DEBUG_LIB(${SFML}/${OS}/lib/${DEBUG_DIR}/lib/libsfml-network-s-d.a)
RASPBERRY_RELEASE_LIB(${SFML}/${OS}/lib/${RELEASE_DIR}/lib/libsfml-network-s.a)
RASPBERRY_DEBUG_LIB(${SFML}/${OS}/lib/${DEBUG_DIR}/lib/libsfml-system-s-d.a)
RASPBERRY_RELEASE_LIB(${SFML}/${OS}/lib/${RELEASE_DIR}/lib/libsfml-system-s.a)
RASPBERRY_DEBUG_LIB(${SFML}/${OS}/lib/${DEBUG_DIR}/lib/libsfml-window-s-d.a)
RASPBERRY_RELEASE_LIB(${SFML}/${OS}/lib/${RELEASE_DIR}/lib/libsfml-window-s.a)
