...
RASPBERRY_DEBUG_COMMAND(${DKCMAKE_RASPBERRY_DEBUG} ${JPEG_RASPBERRY_DEBUG} ${OPENAL_RASPBERRY_DEBUG} ${SFML})
RASPBERRY_DEBUG_COMMAND(make)

RASPBERRY_RELEASE_PATH(${SFML}/${OS}/${RELEASE_DIR})
RASPBERRY_RELEASE_COMMAND(${DKCMAKE_RASPBERRY_RELEASE} ${JPEG_RASPBERRY_RELEASE} ${OPENAL_RASPBERRY_RELEASE} ${VORBIX_RASPBERRY} ${OGG_RASPBERRY} ${SFML})
