...
WIN64_COMMAND(${DKCMAKE_WIN64} -DSFML_OS_WINDOWS=1 ${JPEG_WIN} ${OPENAL_WIN} ${OGG_WIN_CMAKE} ${VORBIS_WIN_RELEASE} ${FLAC_WIN}  ${SFML})
WIN_VS(SFML-${SFML_VERSION} SFML.sln)


MAC_PATH(${SFML}/${OS})
MAC32_COMMAND(${DKCMAKE_MAC32} -DSFML_OS_MACOSX=1 ${JPEG_APPLE} ${OPENAL_APPLE} ${OGG_APPLE_CMAKE} ${VORBIS_APPLE_RELEASE} ${FLAC_APPLE} ${SFML})
MAC64_COMMAND(${DKCMAKE_MAC64} -DSFML_OS_MACOSX=1 -DBUILD_SHARED_LIBS=FALSE ${JPEG_APPLE} ${OPENAL_APPLE} ${OGG_APPLE_CMAKE} ${VORBIS_APPLE_RELEASE} ${FLAC_APPLE} ${SFML})
