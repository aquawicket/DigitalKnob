...
### COMPILE ###
WIN_PATH(${SFML}/${OS})
WIN32_COMMAND(${DKCMAKE_WIN32} ${JPEG_WIN} ${OPENAL_WIN} ${FLAC_WIN} ${SFML})
WIN64_COMMAND(${DKCMAKE_WIN64} ${JPEG_WIN} ${OPENAL_WIN} ${FLAC_WIN} ${SFML})
...
LINUX_DEBUG_COMMAND(${DKCMAKE_LINUX_DEBUG} ${JPEG_LINUX_DEBUG} ${OPENAL_LINUX_DEBUG} ${SFML})
LINUX_DEBUG_COMMAND(make)

LINUX_RELEASE_PATH(${SFML}/${OS}/${RELEASE_DIR})
LINUX_RELEASE_COMMAND(${DKCMAKE_LINUX_RELEASE} ${JPEG_LINUX_RELEASE} ${OPENAL_LINUX_RELEASE} ${VORBIX_LINUX} ${OGG_LINUX} ${SFML})
LINUX_RELEASE_COMMAND(make)


RASPBERRY_DEBUG_PATH(${SFML}/${OS}/${DEBUG_DIR})
RASPBERRY_LINUX_DEBUG_COMMAND(${DKCMAKE_RASPBERRY_DEBUG} ${JPEG_RASPBERRY_DEBUG} ${OPENAL_RASPBERRY_DEBUG} ${SFML})
RASPBERRY_LINUX_DEBUG_COMMAND(make)

RASPBERRY_LINUX_RELEASE_PATH(${SFML}/${OS}/${RELEASE_DIR})
RASPBERRY_LINUX_RELEASE_COMMAND(${DKCMAKE_RASPBERRY_RELEASE} ${JPEG_RASPBERRY_RELEASE} ${OPENAL_RASPBERRY_RELEASE} ${VORBIX_RASPBERRY} ${OGG_RASPBERRY} ${SFML})
RASPBERRY_LINUX_RELEASE_COMMAND(make)



ANDROID_PATH(${SFML}/${OS})
ANDROID32_COMMAND(${DKCMAKE_ANDROID32} ${JPEG_ANDROID} ${OPENAL_ANDROID} ${SFML})
ANDROID64_COMMAND(${DKCMAKE_ANDROID64} ${JPEG_ANDROID} ${OPENAL_ANDROID} ${SFML})
