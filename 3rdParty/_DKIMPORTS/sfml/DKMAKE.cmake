...
### COMPILE ###
WIN_DKSETPATH(${SFML}/${OS})
WIN32_DKQCOMMAND(${DKCMAKE_BUILD} -DSFML_OS_WINDOWS=1 ${JPEG_WIN} ${OPENAL_WIN} ${OGG_WIN_CMAKE} ${VORBIS_WIN_RELEASE} ${FLAC_WIN} ${SFML})
WIN64_DKQCOMMAND(${DKCMAKE_BUILD} -DSFML_OS_WINDOWS=1 ${JPEG_WIN} ${OPENAL_WIN} ${OGG_WIN_CMAKE} ${VORBIS_WIN_RELEASE} ${FLAC_WIN}  ${SFML})
WIN_VS(SFML-${SFML_VERSION} SFML.sln)


MAC_DKSETPATH(${SFML}/${OS})
MAC32_DKQCOMMAND(${DKCMAKE_BUILD} -DSFML_OS_MACOSX=1 ${JPEG_APPLE} ${OPENAL_APPLE} ${OGG_APPLE_CMAKE} ${VORBIS_APPLE_RELEASE} ${FLAC_APPLE} ${SFML})
MAC64_DKQCOMMAND(${DKCMAKE_BUILD} -DSFML_OS_MACOSX=1 -DBUILD_SHARED_LIBS=FALSE ${JPEG_APPLE} ${OPENAL_APPLE} ${OGG_APPLE_CMAKE} ${VORBIS_APPLE_RELEASE} ${FLAC_APPLE} ${SFML})
MAC_XCODE(SFML-${SFML_VERSION})


IOS_DKSETPATH(${SFML}/${OS})
IOS32_DKQCOMMAND(${DKCMAKE_BUILD} ${JPEG_APPLE} ${OPENAL_APPLE} ${OGG_APPLE_CMAKE} ${VORBIS_APPLE_RELEASE} ${FLAC_APPLE} ${SFML})
IOS64_DKQCOMMAND(${DKCMAKE_BUILD} ${JPEG_APPLE} ${OPENAL_APPLE} ${OGG_APPLE_CMAKE} ${VORBIS_APPLE_RELEASE} ${FLAC_APPLE} ${SFML})
IOS_XCODE(SFML-${SFML_VERSION})


IOSSIM_DKSETPATH(${SFML}/${OS})
IOSSIM32_DKQCOMMAND(${DKCMAKE_BUILD} ${JPEG_APPLE} ${OPENAL_APPLE} ${OGG_APPLE_CMAKE} ${VORBIS_APPLE_RELEASE} ${FLAC_APPLE} ${SFML})
IOSSIM64_DKQCOMMAND(${DKCMAKE_BUILD} ${JPEG_APPLE} ${OPENAL_APPLE} ${OGG_APPLE_CMAKE} ${VORBIS_APPLE_RELEASE} ${FLAC_APPLE} ${SFML})
IOSSIM_XCODE(SFML-${SFML_VERSION})


LINUX_DEBUG_DKSETPATH(${SFML}/${OS}/${DEBUG_DIR})
LINUX_DEBUG_DKQCOMMAND(${DKCMAKE_BUILD} ${JPEG_LINUX_DEBUG} ${OPENAL_LINUX_DEBUG} ${OGG_LINUX_CMAKE} ${VORBIS_LINUX_DEBUG} ${FLAC_LINUX_DEBUG} ${SFML})
LINUX_DEBUG_DKQCOMMAND(make)
LINUX_RELEASE_DKSETPATH(${SFML}/${OS}/${RELEASE_DIR})
LINUX_RELEASE_DKQCOMMAND(${DKCMAKE_BUILD} ${JPEG_LINUX_RELEASE} ${OPENAL_LINUX_RELEASE} ${OGG_LINUX_CMAKE} ${VORBIS_LINUX_RELEASE} ${FLAC_LINUX_RELEASE} ${SFML})
LINUX_RELEASE_DKQCOMMAND(make)


RASPBERRY_DEBUG_DKSETPATH(${SFML}/${OS}/${DEBUG_DIR})
RASPBERRY_DEBUG_DKQCOMMAND(${DKCMAKE_BUILD} ${JPEG_RASPBERRY_DEBUG} ${OPENAL_RASPBERRY_DEBUG} ${OGG_RASPBERRY_CMAKE} ${VORBIS_RASPBERRY_DEBUG} ${FLAC_RASPBERRY_DEBUG} ${SFML})
RASPBERRY_DEBUG_DKQCOMMAND(make)
RASPBERRY_RELEASE_DKSETPATH(${SFML}/${OS}/${RELEASE_DIR})
RASPBERRY_RELEASE_DKQCOMMAND(${DKCMAKE_BUILD} ${JPEG_RASPBERRY_RELEASE} ${OPENAL_RASPBERRY_RELEASE} ${OGG_RASPBERRY_CMAKE} ${VORBIS_RASPBERRY_RELEASE} ${FLAC_RASPBERRY_RELEASE} ${SFML})
RASPBERRY_RELEASE_DKQCOMMAND(make)


ANDROID_DKSETPATH(${SFML}/${OS})
ANDROID32_DKQCOMMAND(${DKCMAKE_BUILD} ${JPEG_ANDROID} ${OPENAL_ANDROID} ${OGG_ANDROID_CMAKE} ${VORBIS_ANDROID_DEBUG} ${FLAC_ANDROID} ${FREETYPE_ANDROID} ${OGG_ANDROID_CMAKE} ${SFML})
ANDROID364_DKQCOMMAND(${DKCMAKE_BUILD} ${JPEG_ANDROID} ${OPENAL_ANDROID} ${OGG_ANDROID_CMAKE} ${VORBIS_ANDROID_RELEASE} ${FLAC_ANDROID} ${FREETYPE_ANDROID} ${OGG_ANDROID_CMAKE} ${SFML})
