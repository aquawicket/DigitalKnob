...
IOSSIM_dk_queueCommand(${DKCMAKE_BUILD} -DBUILD_SHARED_LIBS=FALSE ${JPEG_CMAKE} ${OPENAL_CMAKE} ${OGG_CMAKE} ${VORBIS_CMAKE} ${FLAC_CMAKE} ${SFML})
LINUX_dk_queueCommand(${DKCMAKE_BUILD} -DBUILD_SHARED_LIBS=FALSE ${JPEG_CMAKE} ${OPENAL_CMAKE} ${OGG_CMAKE} ${VORBIS_CMAKE} ${FLAC_CMAKE} ${SFML})
RASPBERRY_dk_queueCommand(${DKCMAKE_BUILD} -DBUILD_SHARED_LIBS=FALSE ${JPEG_CMAKE} ${OPENAL_CMAKE} ${OGG_CMAKE} ${VORBIS_CMAKE} ${FLAC_CMAKE} ${SFML})
