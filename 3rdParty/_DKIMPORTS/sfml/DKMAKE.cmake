...
WIN_dk_queueCommand			(${DKCMAKE_BUILD} -DSFML_OS_WINDOWS=1 -DBUILD_SHARED_LIBS=FALSE -DSFML_USE_STATIC_STD_LIBS=TRUE ${LIBJPEG-TURBO_CMAKE} ${OPENAL_CMAKE} ${OGG_CMAKE} ${VORBIS_CMAKE} ${FLAC_CMAKE} ${SFML})
MAC_dk_queueCommand			(${DKCMAKE_BUILD} -DSFML_OS_MACOSX=1 -DBUILD_SHARED_LIBS=FALSE ${LIBJPEG-TURBO_CMAKE} ${OPENAL_CMAKE} ${OGG_CMAKE} ${VORBIS_CMAKE} ${FLAC_CMAKE} ${SFML})
IOS_dk_queueCommand			(${DKCMAKE_BUILD} -DBUILD_SHARED_LIBS=FALSE ${LIBJPEG-TURBO_CMAKE} ${OPENAL_CMAKE} ${OGG_CMAKE} ${VORBIS_CMAKE} ${FLAC_CMAKE} ${SFML})
IOSSIM_dk_queueCommand		(${DKCMAKE_BUILD} -DBUILD_SHARED_LIBS=FALSE ${LIBJPEG-TURBO_CMAKE} ${OPENAL_CMAKE} ${OGG_CMAKE} ${VORBIS_CMAKE} ${FLAC_CMAKE} ${SFML})
LINUX_dk_queueCommand		(${DKCMAKE_BUILD} -DBUILD_SHARED_LIBS=FALSE ${LIBJPEG-TURBO_CMAKE} ${OPENAL_CMAKE} ${OGG_CMAKE} ${VORBIS_CMAKE} ${FLAC_CMAKE} ${SFML})
RASPBERRY_dk_queueCommand	(${DKCMAKE_BUILD} -DBUILD_SHARED_LIBS=FALSE ${LIBJPEG-TURBO_CMAKE} ${OPENAL_CMAKE} ${OGG_CMAKE} ${VORBIS_CMAKE} ${FLAC_CMAKE} ${SFML})
ANDROID_dk_queueCommand		(${DKCMAKE_BUILD} -DBUILD_SHARED_LIBS=FALSE ${LIBJPEG-TURBO_CMAKE} ${OPENAL_CMAKE} ${OGG_CMAKE} ${VORBIS_CMAKE} ${FLAC_CMAKE} ${SFML})
