...
elseif(RASPBERRY)
	...
	DEBUG_dk_set				(LIBPNG_CMAKE "-DCMAKE_C_FLAGS=-I${LIBPNG} -I${LIBPNG}/${OS}/${DEBUG_DIR}" "-DCMAKE_CXX_FLAGS=-I${LIBPNG} -I${LIBPNG}/${OS}/${DEBUG_DIR}" -DPNG_INCLUDE_DIR=${PNG_INCLUDE_DIR} -DPNG_INCLUDE_DIR2=${LIBPNG}/${OS}/${DEBUG_DIR} -DPNG_LIBRARY_DEBUG=${PNG_LIBRARY_DEBUG} -DPNG_LIBRARY_RELEASE=${PNG_LIBRARY_RELEASE})
