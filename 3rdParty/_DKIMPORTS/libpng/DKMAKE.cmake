...
if(MSVC)
	...
	ANDROID_TARGET_dk_libRelease	(${LIBPNG}/${OS}/${RELEASE_DIR}/libpng${LIBPNG_MAJOR}${LIBPNG_MINOR}.a			PNG_LIBRARY_RELEASE)
...
### 3RDPARTY LINK ###
if(MSVC)
	WIN_TARGET_dk_set(LIBPNG_CMAKE 
	...
	ANDROID_TARGET_dk_set(LIBPNG_CMAKE 
		"-DCMAKE_CXX_FLAGS=-I${PNG_INCLUDE_DIR} -I${PNG_INCLUDE_DIR2}" 
		"-DCMAKE_C_FLAGS=-I${PNG_INCLUDE_DIR} -I${PNG_INCLUDE_DIR2}" 
		-DPNG_INCLUDE_DIR=${PNG_INCLUDE_DIR}
		-DPNG_INCLUDE_DIR2=${PNG_INCLUDE_DIR2} 
