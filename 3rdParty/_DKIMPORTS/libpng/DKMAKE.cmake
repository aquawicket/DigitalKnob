...
if(MSVC)
	...
	ANDROID_dk_libRelease	(${LIBPNG}/${triple}/${RELEASE_DIR}/libpng${LIBPNG_MAJOR}${LIBPNG_MINOR}.a			PNG_LIBRARY_RELEASE)
	WIN_dk_libDebug			(${LIBPNG}/${triple}/${DEBUG_DIR}/libpng${LIBPNG_MAJOR}${LIBPNG_MINOR}_staticd.lib	PNG_LIBRARY_DEBUG)
	WIN_dk_libRelease		(${LIBPNG}/${triple}/${RELEASE_DIR}/libpng${LIBPNG_MAJOR}${LIBPNG_MINOR}_static.lib	PNG_LIBRARY_RELEASE)
elseif(APPLE)
	dk_libDebug				(${LIBPNG}/${triple}/${DEBUG_DIR}/libpng16d.a										PNG_LIBRARY_DEBUG)
	dk_libRelease			(${LIBPNG}/${triple}/${RELEASE_DIR}/libpng16d.a										PNG_LIBRARY_RELEASE)
else()
	dk_libDebug				(${LIBPNG}/${triple}/${DEBUG_DIR}/libpng${LIBPNG_MAJOR}${LIBPNG_MINOR}d.a			PNG_LIBRARY_DEBUG)
	dk_libRelease			(${LIBPNG}/${triple}/${RELEASE_DIR}/libpng${LIBPNG_MAJOR}${LIBPNG_MINOR}.a			PNG_LIBRARY_RELEASE)
endif()


### 3RDPARTY LINK ###
if(MSVC)
	WIN_dk_set(LIBPNG_CMAKE 
...
elseif(RASPBERRY)
	RASPBERRY_DEBUG_dk_set(LIBPNG_CMAKE 
		"-DCMAKE_CXX_FLAGS=-I${PNG_INCLUDE_DIR} -I${PNG_INCLUDE_DIR2}" 
		"-DCMAKE_C_FLAGS=-I${PNG_INCLUDE_DIR} -I${PNG_INCLUDE_DIR2}"  
		-DPNG_INCLUDE_DIR=${PNG_INCLUDE_DIR}
		-DPNG_INCLUDE_DIR2=${PNG_INCLUDE_DIR2}
	...
	RASPBERRY_RELEASE_dk_set(LIBPNG_CMAKE 
		"-DCMAKE_CXX_FLAGS=-I${PNG_INCLUDE_DIR} -I${PNG_INCLUDE_DIR2}" 
		"-DCMAKE_C_FLAGS=-I${PNG_INCLUDE_DIR} -I${PNG_INCLUDE_DIR2}" 
		-DPNG_INCLUDE_DIR=${PNG_INCLUDE_DIR}
		-DPNG_INCLUDE_DIR2=${PNG_INCLUDE_DIR2} 
