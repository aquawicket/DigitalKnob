...
if(WIN_HOST)
	dk_getFileParam(${DKIMPORTS_DIR}/android-cmake/dkconfig.txt ANDROID_CMAKE_WIN_DL)
	dk_import(${ANDROID_CMAKE_WIN_DL} PATH ${ANDROID_SDK}/cmake)
elseif(MAC_HOST)
	dk_getFileParam(${DKIMPORTS_DIR}/android-cmake/dkconfig.txt ANDROID_CMAKE_MAC_DL)
	dk_import(${ANDROID_CMAKE_MAC_DL} PATH ${ANDROID_SDK}/cmake)
elseif(LINUX_DL)
	dk_getFileParam(${DKIMPORTS_DIR}/android-cmake/dkconfig.txt ANDROID_CMAKE_LINUX_DL)
