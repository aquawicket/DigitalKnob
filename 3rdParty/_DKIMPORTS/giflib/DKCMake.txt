...
### VERSION ###
DKSET(GIF_VERSION giflib-5.1.1)

### INSTALL ###
DKINSTALL(https://sourceforge.net/projects/giflib/files/${GIF_VERSION}.tar.gz giflib ${GIF_VERSION})
DKSET(GIF ${3RDPARTY}/${GIF_VERSION})
...
ANDROID_NDK_DEBUG(${GIF_VERSION})
ANDROID_NDK_RELEASE(${GIF_VERSION})
...
### INJECT ###
DKSET(GIF_WIN32 
	-DGIF_INCLUDE_DIR=${GIF}
	-DGIF_INCLUDE_DIR2=${GIF}/${OS})