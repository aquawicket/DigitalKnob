...
WIN32_DEBUG_DKLIB(${FFMPEG}/lib/avcodec.lib)
WIN32_RELEASE_DKLIB(${FFMPEG}/lib/avcodec.lib)
WIN32_DEBUG_DKLIB(${FFMPEG}/lib/avdevice.lib)
WIN32_RELEASE_DKLIB(${FFMPEG}/lib/avdevice.lib)
WIN32_DEBUG_DKLIB(${FFMPEG}/lib/avfilter.lib)
WIN32_RELEASE_DKLIB(${FFMPEG}/lib/avfilter.lib)
WIN32_DEBUG_DKLIB(${FFMPEG}/lib/avformat.lib)
WIN32_RELEASE_DKLIB(${FFMPEG}/lib/avformat.lib)
WIN32_DEBUG_DKLIB(${FFMPEG}/lib/avutil.lib)
WIN32_RELEASE_DKLIB(${FFMPEG}/lib/avutil.lib)
WIN32_DEBUG_DKLIB(${FFMPEG}/lib/swresample.lib)
WIN32_RELEASE_DKLIB(${FFMPEG}/lib/swresample.lib)
WIN32_DEBUG_DKLIB(${FFMPEG}/lib/swscale.lib)
WIN32_RELEASE_DKLIB(${FFMPEG}/lib/swscale.lib)
