...
WIN32_INCLUDE(${FFMPEG-DEV})
WIN32_INCLUDE(${FFMPEG-DEV}/include)
WIN32_INCLUDE(${FFMPEG-DEV}/include/libavcodec)
WIN32_INCLUDE(${FFMPEG-DEV}/include/libavdevice)
WIN32_INCLUDE(${FFMPEG-DEV}/include/libavfilter)
WIN32_INCLUDE(${FFMPEG-DEV}/include/libavformat)
WIN32_INCLUDE(${FFMPEG-DEV}/include/libavutil)
WIN32_INCLUDE(${FFMPEG-DEV}/include/libswresample)
WIN32_INCLUDE(${FFMPEG-DEV}/include/libswscale)
WIN32_dk_libDebug(${FFMPEG-DEV}/lib/avcodec.lib)
WIN32_dk_libRelease(${FFMPEG-DEV}/lib/avcodec.lib)
WIN32_dk_libDebug(${FFMPEG-DEV}/lib/avdevice.lib)
WIN32_dk_libRelease(${FFMPEG-DEV}/lib/avdevice.lib)
WIN32_dk_libDebug(${FFMPEG-DEV}/lib/avfilter.lib)
WIN32_dk_libRelease(${FFMPEG-DEV}/lib/avfilter.lib)
WIN32_dk_libDebug(${FFMPEG-DEV}/lib/avformat.lib)
WIN32_dk_libRelease(${FFMPEG-DEV}/lib/avformat.lib)
WIN32_dk_libDebug(${FFMPEG-DEV}/lib/avutil.lib)
WIN32_dk_libRelease(${FFMPEG-DEV}/lib/avutil.lib)
WIN32_dk_libDebug(${FFMPEG-DEV}/lib/swresample.lib)
WIN32_dk_libRelease(${FFMPEG-DEV}/lib/swresample.lib)
WIN32_dk_libDebug(${FFMPEG-DEV}/lib/swscale.lib)
WIN32_dk_libRelease(${FFMPEG-DEV}/lib/swscale.lib)


### COMPILE ###
WIN32_dk_queueCommand(call C:/Windows/System32/cmd.exe /K ${VISUALSTUDIO}/VC/vcvarsall.bat amd64)
WIN32_dk_queueCommand(${VISUALSTUDIO}/VC/bin/amd64_x86/lib.exe /machine:i386 /def:${FFMPEG-DEV}/lib/avcodec-56.def /out:${FFMPEG-DEV}/lib/avcodec.lib & 
