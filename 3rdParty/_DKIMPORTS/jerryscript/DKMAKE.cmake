...
dk_include					(${JERRYSCRIPT}/${target_triple})

# jerry-core
if(MSVC)
	ANDROID_dk_libDebug		(${JERRYSCRIPT}/${target_triple}/lib/${DEBUG_DIR}/libjerry-core.a)
	ANDROID_dk_libRelease	(${JERRYSCRIPT}/${target_triple}/lib/${RELEASE_DIR}/libjerry-core.a)
else()
...
APPLE_dk_libDebug			(${JERRYSCRIPT}/${target_triple}/lib/${DEBUG_DIR}/libjerry-core.a)
APPLE_dk_libRelease			(${JERRYSCRIPT}/${target_triple}/lib/${RELEASE_DIR}/libjerry-core.a)
...
WIN_dk_libDebug				(${JERRYSCRIPT}/${target_triple}/lib/${DEBUG_DIR}/jerry-core.lib)
WIN_dk_libRelease			(${JERRYSCRIPT}/${target_triple}/lib/${RELEASE_DIR}/jerry-core.lib)

# jerry-ext
if(MSVC)
	ANDROID_dk_libDebug		(${JERRYSCRIPT}/${target_triple}/lib/${DEBUG_DIR}/libjerry-ext.a)
	ANDROID_dk_libRelease	(${JERRYSCRIPT}/${target_triple}/lib/${RELEASE_DIR}/libjerry-ext.a)
else()
...
APPLE_dk_libDebug			(${JERRYSCRIPT}/${target_triple}/lib/${DEBUG_DIR}/libjerry-ext.a)
APPLE_dk_libRelease			(${JERRYSCRIPT}/${target_triple}/lib/${RELEASE_DIR}/libjerry-ext.a)
...
WIN_dk_libDebug				(${JERRYSCRIPT}/${target_triple}/lib/${DEBUG_DIR}/jerry-ext.lib)
WIN_dk_libRelease			(${JERRYSCRIPT}/${target_triple}/lib/${RELEASE_DIR}/jerry-ext.lib)

# jerry-port
if(MSVC)
	ANDROID_dk_libDebug		(${JERRYSCRIPT}/${target_triple}/lib/${DEBUG_DIR}/libjerry-port.a)
	ANDROID_dk_libRelease	(${JERRYSCRIPT}/${target_triple}/lib/${RELEASE_DIR}/libjerry-port.a)
else()
...
APPLE_dk_libDebug			(${JERRYSCRIPT}/${target_triple}/lib/${DEBUG_DIR}/libjerry-port.a)
APPLE_dk_libRelease			(${JERRYSCRIPT}/${target_triple}/lib/${RELEASE_DIR}/libjerry-port.a)
...
WIN_dk_libDebug				(${JERRYSCRIPT}/${target_triple}/lib/${DEBUG_DIR}/jerry-port.lib)
WIN_dk_libRelease			(${JERRYSCRIPT}/${target_triple}/lib/${RELEASE_DIR}/jerry-port.lib)
