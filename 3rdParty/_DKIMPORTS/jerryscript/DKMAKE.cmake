...
if(MSVC)
	...
	ANDROID_dk_libRelease	(${JERRYSCRIPT}/${triple}/${RELEASE_DIR}/lib/libjerry-core.a)
endif()
...
EMSCRIPTEN_dk_libRelease	(${JERRYSCRIPT}/${triple}/${RELEASE_DIR}/lib/libjerry-core.a)
LINUX_dk_libDebug			(${JERRYSCRIPT}/${triple}/${DEBUG_DIR}/lib/libjerry-core.a)
LINUX_dk_libRelease			(${JERRYSCRIPT}/${triple}/${RELEASE_DIR}/lib/libjerry-core.a)
RASPBERRY_dk_libDebug		(${JERRYSCRIPT}/${triple}/${DEBUG_DIR}/lib/libjerry-core.a)
RASPBERRY_dk_libRelease		(${JERRYSCRIPT}/${triple}/${RELEASE_DIR}/lib/libjerry-core.a)
...
if(MSVC)
	...
	ANDROID_dk_libRelease	(${JERRYSCRIPT}/${triple}/${RELEASE_DIR}/lib/libjerry-ext.a)
endif()
...
EMSCRIPTEN_dk_libRelease	(${JERRYSCRIPT}/${triple}/${RELEASE_DIR}/lib/libjerry-ext.a)
LINUX_dk_libDebug			(${JERRYSCRIPT}/${triple}/${DEBUG_DIR}/lib/libjerry-ext.a)
LINUX_dk_libRelease			(${JERRYSCRIPT}/${triple}/${RELEASE_DIR}/lib/libjerry-ext.a)
RASPBERRY_dk_libDebug		(${JERRYSCRIPT}/${triple}/${DEBUG_DIR}/lib/libjerry-ext.a)
RASPBERRY_dk_libRelease		(${JERRYSCRIPT}/${triple}/${RELEASE_DIR}/lib/libjerry-ext.a)
...
if(MSVC)
	...
	ANDROID_dk_libRelease	(${JERRYSCRIPT}/${triple}/${RELEASE_DIR}/lib/libjerry-port.a)
endif()
...
EMSCRIPTEN_dk_libRelease	(${JERRYSCRIPT}/${triple}/${RELEASE_DIR}/lib/libjerry-port.a)
LINUX_dk_libDebug			(${JERRYSCRIPT}/${triple}/${DEBUG_DIR}/lib/libjerry-port.a)
LINUX_dk_libRelease			(${JERRYSCRIPT}/${triple}/${RELEASE_DIR}/lib/libjerry-port.a)
RASPBERRY_dk_libDebug		(${JERRYSCRIPT}/${triple}/${DEBUG_DIR}/lib/libjerry-port.a)
RASPBERRY_dk_libRelease		(${JERRYSCRIPT}/${triple}/${RELEASE_DIR}/lib/libjerry-port.a)
