...
WIN32_COMMAND(${DKCMAKE_BUILD} ${JERRYSCRIPT})
WIN64_COMMAND(${DKCMAKE_BUILD} ${JERRYSCRIPT})
WIN_VS(${JERRYSCRIPT_NAME} Jerry.sln jerry)


MAC_PATH(${JERRYSCRIPT}/${OS})
MAC32_COMMAND(${DKCMAKE_BUILD} ${JERRYSCRIPT})
MAC64_COMMAND(${DKCMAKE_BUILD} ${JERRYSCRIPT})
MAC_XCODE(${JERRYSCRIPT_NAME} jerry)


IOS_PATH(${JERRYSCRIPT}/${OS})
IOS32_COMMAND(${DKCMAKE_BUILD} ${JERRYSCRIPT})
IOS64_COMMAND(${DKCMAKE_BUILD} ${JERRYSCRIPT})
IOS_XCODE(${JERRYSCRIPT_NAME} jerry)


IOSSIM_PATH(${JERRYSCRIPT}/${OS})
IOSSIM32_COMMAND(${DKCMAKE_BUILD} ${JERRYSCRIPT})
IOSSIM64_COMMAND(${DKCMAKE_BUILD} ${JERRYSCRIPT})
IOSSIM_XCODE(${JERRYSCRIPT_NAME} jerry)


LINUX_DEBUG_PATH(${JERRYSCRIPT}/${OS}/${DEBUG_DIR})
LINUX_DEBUG_COMMAND(${DKCMAKE_BUILD} ${JERRYSCRIPT})
LINUX_DEBUG_COMMAND(make jerry)

LINUX_RELEASE_PATH(${JERRYSCRIPT}/${OS}/${RELEASE_DIR})
LINUX_RELEASE_COMMAND(${DKCMAKE_BUILD} ${JERRYSCRIPT})
LINUX_RELEASE_COMMAND(make jerry)


RASPBERRY_DEBUG_PATH(${JERRYSCRIPT}/${OS}/${DEBUG_DIR})
RASPBERRY_DEBUG_COMMAND(${DKCMAKE_BUILD} ${JERRYSCRIPT})
RASPBERRY_DEBUG_COMMAND(make jerry)

RASPBERRY_RELEASE_PATH(${JERRYSCRIPT}/${OS}/${RELEASE_DIR})
RASPBERRY_RELEASE_COMMAND(${DKCMAKE_BUILD} ${JERRYSCRIPT})
RASPBERRY_RELEASE_COMMAND(make jerry)


##ANDROID_NDK(${JERRYSCRIPT_NAME})
ANDROID_PATH(${JERRYSCRIPT}/${OS})
ANDROID32_COMMAND(${DKCMAKE_BUILD} ${JERRYSCRIPT})
ANDROID64_COMMAND(${DKCMAKE_BUILD} ${JERRYSCRIPT})
