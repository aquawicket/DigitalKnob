...
if(MSVC)
	...
	if(MSYS)
		dk_libDebug		(${ZLIB}/${OS}/${DEBUG_DIR}/libzlibstatic.a)
		dk_libRelease	(${ZLIB}/${OS}/${RELEASE_DIR}/libzlibstatic.a)
	else()
...
if(MSVC)
	...
	if(MSYS)
		WIN_DEBUG_dk_set		(ZLIB_CMAKE -DZLIB_INCLUDE_DIR=${ZLIB} "-DCMAKE_C_FLAGS=-I${ZLIB}/${OS}/${DEBUG_DIR}" "-DCMAKE_CXX_FLAGS=-I${ZLIB}/${OS}/${DEBUG_DIR}" -DZLIB_LIBRARY_DEBUG=${ZLIB}/${OS}/${DEBUG_DIR}/libzlibstatic.a -DZLIB_LIBRARY_RELEASE=${ZLIB}/${OS}/${RELEASE_DIR}/libzlibstatic.a)
		WIN_RELEASE_dk_set		(ZLIB_CMAKE -DZLIB_INCLUDE_DIR=${ZLIB} "-DCMAKE_C_FLAGS=-I${ZLIB}/${OS}/${RELEASE_DIR}" "-DCMAKE_CXX_FLAGS=-I${ZLIB}/${OS}/${RELEASE_DIR}" -DZLIB_LIBRARY_DEBUG=${ZLIB}/${OS}/${DEBUG_DIR}/libzlibstatic.a -DZLIB_LIBRARY_RELEASE=${ZLIB}/${OS}/${RELEASE_DIR}/libzlibstatic.a)
	else()
