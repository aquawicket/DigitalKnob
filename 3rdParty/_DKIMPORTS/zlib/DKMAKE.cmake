...
if(MULTI_CONFIG)
	...
	DEBUG_dk_set	(ZLIB_CMAKE -DZLIB_INCLUDE_DIR=${ZLIB_INCLUDE_DIR} -DZLIB_LIBRARY_DEBUG=${ZLIB_LIBRARY_DEBUG} -DZLIB_LIBRARY=${ZLIB_LIBRARY_DEBUG} -DZLIB_LIBRARIES=${ZLIB_LIBRARY_DEBUG} "-DCMAKE_C_FLAGS=-I${ZLIB} -I${ZLIB}/${OS}/${DEBUG_DIR}" "-DCMAKE_CXX_FLAGS=-I${ZLIB} -I${ZLIB}/${OS}/${DEBUG_DIR}")
