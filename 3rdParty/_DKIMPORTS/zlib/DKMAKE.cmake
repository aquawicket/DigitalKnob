...
DKSET(ZLIB_LINUX "-DCMAKE_C_FLAGS=-I${ZLIB} -I${ZLIB}/${OS}/${RELEASE}" "-DCMAKE_CXX_FLAGS=-I${ZLIB} -I${ZLIB}/${OS}/${RELEASE}" -DZLIB_INCLUDE_DIR=${ZLIB} -DZLIB_LIBRARY_DEBUG=${ZLIB}/${OS}/${DEBUG}/libz.a -DZLIB_LIBRARY_RELEASE=${ZLIB}/${OS}/${RELEASE}/libz.a)
