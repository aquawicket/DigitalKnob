...
LINUX32_DEBUG_COMMAND(${CMAKE_COMMAND} -G "Unix Makefiles" -DCMAKE_BUILD_TYPE=DEBUG -DCMAKE_C_FLAGS=-fPIC -m32 -S ${ZLIB} -B ${ZLIB}/${OS}/${DEBUG})
LINUX32_DEBUG_COMMAND(make zlibstatic)
LINUX32_RELEASE_COMMAND(${CMAKE_COMMAND} -G "Unix Makefiles" -DCMAKE_BUILD_TYPE=RELEASE -DCMAKE_C_FLAGS=-fPIC -m32 -H${ZLIB} -B${ZLIB}/${OS}/${RELEASE})
