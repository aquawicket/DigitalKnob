...
### 3RDPARTY LINK ###
DKSET(ZLIB_WIN -DCMAKE_C_FLAGS=/I${ZLIB}/${OS} -DZLIB_INCLUDE_DIR=${ZLIB} -DZLIB_LIBRARY_DEBUG=${ZLIB}/${OS}/Debug/zlibstatic.lib -DZLIB_LIBRARY_RELEASE=${ZLIB}/${OS}/Release/zlibstatic.lib)
DKSET(ZLIB_LINUX -DZLIB_INCLUDE_DIR=${ZLIB} -DZLIB_LIBRARY_DEBUG=${ZLIB}/${OS}/${DEBUG}/libz.a -DZLIB_LIBRARY_RELEASE=${ZLIB}/${OS}/${RELEASE}/libz.a)
DKSET(ZLIB_APPLE -DZLIB_INCLUDE_DIR=${ZLIB} -DZLIB_LIBRARY_DEBUG=${ZLIB}/${OS}/${DEBUG}/libz.a -DZLIB_LIBRARY_RELEASE=${ZLIB}/${OS}/${RELEASE}/libz.a)
DKSET(ZLIB_RASPBERRY -DZLIB_INCLUDE_DIR=${ZLIB} -DZLIB_LIBRARY_DEBUG=${ZLIB}/${OS}/${DEBUG}/libz.a -DZLIB_LIBRARY_RELEASE=${ZLIB}/${OS}/${RELEASE}/libz.a)
DKSET(ZLIB_ANDROID -DZLIB_INCLUDE_DIR=${ZLIB} -DZLIB_LIBRARY_DEBUG=${ZLIB}/${OS}/${DEBUG}/obj/local/armeabi-v7a/libzlib.a -DZLIB_LIBRARY_RELEASE=${ZLIB}/${OS}/${RELEASE}/obj/local/armeabi-v7a/libzlib.a)
