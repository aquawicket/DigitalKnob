...
if(MULTI_CONFIG)
	if(MSVC)
		...
		"-DCMAKE_C_FLAGS=/I${ZLIB} /I${ZLIB}/${OS}" 
		"-DCMAKE_CXX_FLAGS=/I${ZLIB} /I${ZLIB}/${OS}")
	else()
		dk_set		(ZLIB_CMAKE 
		-DZLIB_INCLUDE_DIR=${ZLIB_INCLUDE_DIR} 
		-DZLIB_LIBRARY_DEBUG=${ZLIB_LIBRARY_DEBUG} 
	...
	RELEASE_dk_set	(ZLIB_CMAKE 
		...
		"-DCMAKE_C_FLAGS=-I${ZLIB} -I${ZLIB}/${OS}/${RELEASE_DIR}" 
		"-DCMAKE_CXX_FLAGS=-I${ZLIB} -I${ZLIB}/${OS}/${RELEASE_DIR}"
