...
if(NOT EXISTS "${DKTOOLS_DIR}/ADK")
	...
	execute_process(COMMAND cmd /c "$ENV{DKDOWNLOAD_DIR}/ADK/adksetup.exe" /installpath "${DKTOOLS_DIR}/ADK" /q)
endif()
...
if(NOT EXISTS "${DKTOOLS_DIR}/ADKWinPEAddons")
	...
	dk_validate(DKTOOLS_DIR "dk_DKTOOLS_DIR()")
	execute_process(COMMAND cmd /c "$ENV{DKDOWNLOAD_DIR}/ADKWinPEAddons/adkwinpesetup.exe" /installpath "${DKTOOLS_DIR}/ADK" /q)
endif()
