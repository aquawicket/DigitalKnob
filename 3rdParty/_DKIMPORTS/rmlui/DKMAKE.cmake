...
if(rmlui_RmlCore)
	WIN_dk_visualStudio(${RMLUI_NAME} RmlUi.sln RmlCore)
endif()
if(rmlui_RmlDebugger)
	WIN_dk_visualStudio(${RMLUI_NAME} RmlUi.sln RmlDebugger)
endif()
...
#WIN_dk_visualStudio(${RMLUI_NAME} RmlUi.sln)
...
MAC_dk_queueCommand(${DKCMAKE_BUILD} -DENABLE_PRECOMPILED_HEADERS=OFF ${FREETYPE_CMAKE} ${RMLUI})
...
ANDROID_dk_visualStudio(${RMLUI_NAME} RmlUi.sln RmlCore)
ANDROID_dk_visualStudio(${RMLUI_NAME} RmlUi.sln RmlDebugger)
