...
if(rmlui_core OR rmlui_all)
	if(MSVC)
		WIN_TARGET_dk_libDebug		(${RMLUI}/${OS}/${DEBUG_DIR}/Source/Core/librmlui.lib)
		WIN_TARGET_dk_libRelease	(${RMLUI}/${OS}/${RELEASE_DIR}/Source/Core/librmlui.lib)
	else()
...
if(rmlui_debugger OR rmlui_all)
	...
	if(MSVC)
		WIN_TARGET_dk_libRelease	(${RMLUI}/${OS}/${RELEASE_DIR}/Source/Debugger/librmlui_debugger.lib)
		WIN_TARGET_dk_libDebug		(${RMLUI}/${OS}/${DEBUG_DIR}/Source/Debugger/librmlui_debugger.lib)
	else()
...
if(rmlui_shell OR rmlui_all)
	...
	if(MSVC)
		WIN_TARGET_dk_libDebug		(${RMLUI}/${OS}/${DEBUG_DIR}/Samples/shell/librmlui_shell.lib)
		WIN_TARGET_dk_libRelease	(${RMLUI}/${OS}/${RELEASE_DIR}/Samples/shell/librmlui_shell.lib)
	else()
...
if(rmlui_treeview OR rmlui_all)
	...
	WIN_TARGET_dk_libDebug			(${RMLUI}/${OS}/${DEBUG_DIR}/rmlui_sample_tree_view.exe)
	WIN_TARGET_dk_libRelease		(${RMLUI}/${OS}/${RELEASE_DIR}/rmlui_sample_tree_view.exe)
...
if(rmlui_invaders OR rmlui_all)
	...
	WIN_TARGET_dk_libDebug			(${RMLUI}/${OS}/${DEBUG_DIR}/rmlui_sample_invaders.exe)
	WIN_TARGET_dk_libRelease		(${RMLUI}/${OS}/${RELEASE_DIR}/rmlui_sample_invaders.exe)
