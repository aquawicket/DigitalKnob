...
if(rmlui_debugger OR rmlui_all)
	...
	if(MSVC)
		WIN_dk_libDebug		(${RMLUI_CONFIG_DIR}/Source/Debugger/${DEBUG_DIR}/librmlui_debugger.lib)
		WIN_dk_libRelease	(${RMLUI_CONFIG_DIR}/Source/Debugger/${RELEASE_DIR}/librmlui_debugger.lib)
	else()
