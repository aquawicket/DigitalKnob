...
MAC_PATH(${RMLUI}/${OS})
MAC64_COMMAND(${DKCMAKE_MAC64} -DENABLE_PRECOMPILED_HEADERS=OFF ${FREETYPE_APPLE} ${RMLUI})
MAC_XCODE(${RMLUI_NAME})


IOS_PATH(${RMLUI}/${OS})
IOS64_COMMAND(${DKCMAKE_IOS64} -DBUILD_SHARED_LIBS=OFF -DENABLE_PRECOMPILED_HEADERS=OFF ${FREETYPE_APPLE} ${RMLUI})
IOS_XCODE(${RMLUI_NAME})


IOSSIM_PATH(${RMLUI}/${OS})
IOSSIM64_COMMAND(${DKCMAKE_IOSSIM64} -DBUILD_SHARED_LIBS=OFF -DENABLE_PRECOMPILED_HEADERS=OFF ${FREETYPE_APPLE} ${RMLUI})
