...
if(rmlui_core OR rmlui_all)
	if(MSVC)
		WIN_dk_libDebug		(${RMLUI_DEBUG_DIR}/Source/Core/${DEBUG_DIR}/rmlui.lib)
		WIN_dk_libRelease	(${RMLUI_RELEASE_DIR}/Source/Core/${RELEASE_DIR}/rmlui.lib)
	else()
...
if(rmlui_debugger OR rmlui_all)
	...
	if(MSVC)
		WIN_dk_libRelease	(${RMLUI_RELEASE_DIR}/Source/Debugger/librmlui_debugger.lib)
		WIN_dk_libDebug		(${RMLUI_DEBUG_DIR}/Source/Debugger/librmlui_debugger.lib)
	else()
