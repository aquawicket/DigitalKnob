...
MAC_dk_queueCommand			(${DKCMAKE_BUILD} -DENABLE_PRECOMPILED_HEADERS=OFF -DBUILD_LUA_BINDINGS=OFF ${FREETYPE_CMAKE} ${LUA_CMAKE} ${RMLUI})
IOS_dk_queueCommand			(${DKCMAKE_BUILD} -DENABLE_PRECOMPILED_HEADERS=OFF -DBUILD_LUA_BINDINGS=OFF ${FREETYPE_CMAKE} ${LUA_CMAKE} ${RMLUI})
IOSSIM_dk_queueCommand		(${DKCMAKE_BUILD} -DENABLE_PRECOMPILED_HEADERS=OFF -DBUILD_LUA_BINDINGS=OFF ${FREETYPE_CMAKE} ${LUA_CMAKE} ${RMLUI})
LINUX_dk_queueCommand		(${DKCMAKE_BUILD} -DENABLE_PRECOMPILED_HEADERS=OFF -DBUILD_LUA_BINDINGS=OFF ${FREETYPE_CMAKE} ${LUA_CMAKE} ${RMLUI})
RASPBERRY_dk_queueCommand	(${DKCMAKE_BUILD} -DENABLE_PRECOMPILED_HEADERS=OFF -DBUILD_LUA_BINDINGS=OFF ${FREETYPE_CMAKE} ${LUA_CMAKE} ${RMLUI})
ANDROID_dk_queueCommand		(${DKCMAKE_BUILD} -DENABLE_PRECOMPILED_HEADERS=OFF -DBUILD_LUA_BINDINGS=OFF ${FREETYPE_CMAKE} ${LUA_CMAKE} "-DCMAKE_CXX_FLAGS=-DRMLUI_STATIC_LIB -DCHOBO_FLAT_MAP_NO_THROW -DRMLUI_USE_CUSTOM_RTTI -std=c++1z" ${RMLUI}) #-DDISABLE_RTTI_AND_EXCEPTIONS=ON 
