...
WIN32_DKQCOMMAND(${DKCMAKE_BUILD} "-DCMAKE_CXX_FLAGS=/DRMLUI_STATIC_LIB /DGLEW_STATIC /I${RMLUI}/Include /I${SDL}/include /I${GLEW}/include" -DBUILD_SHARED_LIBS=OFF
-DBUILD_SAMPLES=OFF -DBUILD_TESTING=OFF -DENABLE_SVG_PLUGIN=OFF -DENABLE_LOTTIE_PLUGIN=OFF -DBUILD_LUA_BINDINGS=OFF ${FREETYPE_CMAKE} ${RMLUI})
if(rmlui_RmlCore)
...
LINUX_DEBUG_DKQCOMMAND(${DKCMAKE_BUILD} ${FREETYPE_CMAKE} ${RMLUI})
LINUX_DEBUG_DKQCOMMAND(make)

RASPBERRY_DEBUG_DKQCOMMAND(${DKCMAKE_BUILD} ${FREETYPE_CMAKE} ${RMLUI})
RASPBERRY_DEBUG_DKQCOMMAND(make)

ANDROID_DKQCOMMAND(${DKCMAKE_BUILD} "-DANDROID_COMPILER_FLAGS=-DRMLUI_STATIC_LIB -I${RMLUI}/Include" -DENABLE_PRECOMPILED_HEADERS=OFF -DBUILD_SAMPLES=OFF ${FREETYPE_CMAKE} ${RMLUI})
