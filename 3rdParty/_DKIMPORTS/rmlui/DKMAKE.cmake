...
WIN64_COMMAND(${DKCMAKE_BUILD} "-DCMAKE_CXX_FLAGS=/DWIN64 /D_WINDOWS /W3 /nologo /GR /EHsc -DRMLUI_STATIC_LIB /I${RMLUI}/Include /I${SDL}/include /I${GLEW}/include" -DBUILD_SAMPLES=ON 
...
MAC_PATH(${RMLUI}/${OS})
MAC64_COMMAND(${DKCMAKE_BUILD} -DENABLE_PRECOMPILED_HEADERS=OFF ${FREETYPE_APPLE} ${RMLUI})
MAC_XCODE(${RMLUI_NAME})


IOS_PATH(${RMLUI}/${OS})
IOS64_COMMAND(${DKCMAKE_BUILD} -DBUILD_SHARED_LIBS=OFF -DENABLE_PRECOMPILED_HEADERS=OFF ${FREETYPE_APPLE} ${RMLUI})
IOS_XCODE(${RMLUI_NAME})


IOSSIM_PATH(${RMLUI}/${OS})
IOSSIM64_COMMAND(${DKCMAKE_BUILD} -DBUILD_SHARED_LIBS=OFF -DENABLE_PRECOMPILED_HEADERS=OFF ${FREETYPE_APPLE} ${RMLUI})
IOSSIM_XCODE(${RMLUI_NAME})


LINUX_DEBUG_PATH(${RMLUI}/${OS}/${DEBUG_DIR})
LINUX_DEBUG_COMMAND(${DKCMAKE_BUILD} ${FREETYPE_LINUX} ${RMLUI})
LINUX_DEBUG_COMMAND(make)

LINUX_RELEASE_PATH(${RMLUI}/${OS}/${RELEASE_DIR})
LINUX_RELEASE_COMMAND(${DKCMAKE_BUILD} ${FREETYPE_LINUX} ${RMLUI})
LINUX_RELEASE_COMMAND(make)


RASPBERRY_DEBUG_PATH(${RMLUI}/${OS}/${DEBUG_DIR})
RASPBERRY_DEBUG_COMMAND(${DKCMAKE_BUILD} ${FREETYPE_RASPBERRY} ${RMLUI})
RASPBERRY_DEBUG_COMMAND(make)

RASPBERRY_RELEASE_PATH(${RMLUI}/${OS}/${RELEASE_DIR})
RASPBERRY_RELEASE_COMMAND(${DKCMAKE_BUILD} ${FREETYPE_RASPBERRY} ${RMLUI})
RASPBERRY_RELEASE_COMMAND(make)


##ANDROID_NDK(${RMLUI_NAME})
ANDROID_PATH(${RMLUI}/${OS})
ANDROID32_COMMAND(${DKCMAKE_BUILD} "-DANDROID_COMPILER_FLAGS=-DRMLUI_STATIC_LIB -I${RMLUI}/Include" -DENABLE_PRECOMPILED_HEADERS=OFF -DBUILD_SAMPLES=OFF ${FREETYPE_ANDROID} ${RMLUI})
ANDROID64_COMMAND(${DKCMAKE_BUILD} "-DANDROID_COMPILER_FLAGS=-DRMLUI_STATIC_LIB -I${RMLUI}/Include" -DENABLE_PRECOMPILED_HEADERS=OFF -DBUILD_SAMPLES=OFF ${FREETYPE_ANDROID} ${RMLUI})
