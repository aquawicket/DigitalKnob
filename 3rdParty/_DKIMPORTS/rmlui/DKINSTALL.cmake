...
if(rmlui_all OR rmlui_core)
	...
	if(MSVC)
		dk_libDebug			(${RMLUI.Config_Dir}/Source/Core/${Debug_Dir}/rmlui.lib)
		dk_libRelease		(${RMLUI.Config_Dir}/Source/Core/${Release_Dir}/rmlui.lib)
	else()
		dk_libDebug			(${RMLUI.Debug_Dir}/Source/Core/librmlui.a)
		dk_libRelease		(${RMLUI.Release_Dir}/Source/Core/librmlui.a)
	endif()
endif()
...
if(rmlui_all OR rmlui_debugger)
	...
	if(MSVC)
		dk_libDebug			(${RMLUI.Config_Dir}/Source/Debugger/${Debug_Dir}/rmlui_debugger.lib)
		dk_libRelease		(${RMLUI.Config_Dir}/Source/Debugger/${Release_Dir}/rmlui_debugger.lib)
	else()
		dk_libDebug			(${RMLUI.Debug_Dir}/Source/Debugger/librmlui_debugger.a)
        dk_libRelease		(${RMLUI.Release_Dir}/Source/Debugger/librmlui_debugger.a)
	endif()
endif()
...
if(rmlui_all OR rmlui_shell)
	...
	if(MSVC)
		dk_libDebug			(${RMLUI.Debug_Dir}/Samples/shell/librmlui_shell.lib)
		dk_libRelease		(${RMLUI.Release_Dir}/Samples/shell/librmlui_shell.lib)
	else()
		dk_libDebug			(${RMLUI.Debug_Dir}/Samples/shell/librmlui_shell.a)
		dk_libRelease		(${RMLUI.Release_Dir}/Samples/shell/librmlui_shell.a)
	endif()
endif()
...
if(rmlui_all OR rmlui_treeview)
	...
	if(Windows)
		dk_libDebug			(${RMLUI.Debug_Dir}/rmlui_sample_tree_view.exe)
		dk_libRelease		(${RMLUI.Release_Dir}/rmlui_sample_tree_view.exe)
	endif()
	if(Unix)
		dk_libDebug			(${RMLUI.Debug_Dir}/rmlui_sample_tree_view)
		dk_libRelease		(${RMLUI.Release_Dir}/rmlui_sample_tree_view)
	endif()
endif()
...
if(rmlui_all OR rmlui_invaders)
	...
	if(Windows)
		dk_libDebug			(${RMLUI.Debug_Dir}/rmlui_sample_invaders.exe)
		dk_libRelease		(${RMLUI.Release_Dir}/rmlui_sample_invaders.exe)
	endif()
	if(Unix)
		dk_libDebug			(${RMLUI.Debug_Dir}/rmlui_sample_invaders)
		dk_libRelease		(${RMLUI.Release_Dir}/rmlui_sample_invaders)
	endif()
endif()
