...
dk_include				(${RTAUDIO})
if(MSVC)
	dk_libDebug			(${RTAUDIO.Debug_Dir}/rtaudiod.lib)
	dk_libRelease		(${RTAUDIO.Release_Dir}/rtaudio.lib)
else()
	dk_libDebug			(${RTAUDIO.Debug_Dir}/librtaudiod.a)
	dk_libRelease		(${RTAUDIO.Release_Dir}/librtaudio.a)
endif()
