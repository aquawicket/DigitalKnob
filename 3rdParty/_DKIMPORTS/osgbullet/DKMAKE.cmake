...
if(osgbCollision)
	...
	APPLE_dk_libDebug(${OSGBULLET}/${target_triple}/lib/${DEBUG_DIR}/libosgbCollision.a)
	APPLE_dk_libRelease(${OSGBULLET}/${target_triple}/lib/${RELEASE_DIR}/libosgbCollision.a)
	...
	WIN_dk_libDebug(${OSGBULLET}/${target_triple}/lib/${DEBUG_DIR}/osgbCollisiond.lib)
	WIN_dk_libRelease(${OSGBULLET}/${target_triple}/lib/${RELEASE_DIR}/osgbCollision.lib)
endif()
if(osgbDynamics)
	...
	APPLE_dk_libDebug(${OSGBULLET}/${target_triple}/lib/${DEBUG_DIR}/libosgbDynamics.a)
	APPLE_dk_libRelease(${OSGBULLET}/${target_triple}/lib/${RELEASE_DIR}/libosgbDynamics.a)
	...
	WIN_dk_libDebug(${OSGBULLET}/${target_triple}/lib/${DEBUG_DIR}/osgbDynamicsd.lib)
	WIN_dk_libRelease(${OSGBULLET}/${target_triple}/lib/${RELEASE_DIR}/osgbDynamics.lib)
endif()
if(osgbInteraction)
	...
	APPLE_dk_libDebug(${OSGBULLET}/${target_triple}/lib/${DEBUG_DIR}/libosgbInteraction.a)
	APPLE_dk_libRelease(${OSGBULLET}/${target_triple}/lib/${RELEASE_DIR}/libosgbInteraction.a)
	...
	WIN_dk_libDebug(${OSGBULLET}/${target_triple}/lib/${DEBUG_DIR}/osgbInteractiond.lib)
	WIN_dk_libRelease(${OSGBULLET}/${target_triple}/lib/${RELEASE_DIR}/osgbInteraction.lib)
endif()
if(osgdb_osgbdynamics)
	...
	APPLE_dk_libDebug(${OSGBULLET}/${target_triple}/lib/${DEBUG_DIR}/osgdb_osgbdynamics.a)
	APPLE_dk_libRelease(${OSGBULLET}/${target_triple}/lib/${RELEASE_DIR}/osgdb_osgbdynamics.a)
	...
	WIN_dk_libDebug(${OSGBULLET}/${target_triple}/lib/${DEBUG_DIR}/osgdb_osgbdynamicsd.lib)
	WIN_dk_libRelease(${OSGBULLET}/${target_triple}/lib/${RELEASE_DIR}/osgdb_osgbdynamics.lib)
endif()
if(osgdb_sgb)
	ANDROID_dk_libDebug(${OSGBULLET_DEBUG_DIR}/libosgdb_sgb.a)
	ANDROID_dk_libRelease(${OSGBULLET_RELEASE_DIR}/libosgdb_sgb.a)
	APPLE_dk_libDebug(${OSGBULLET}/${target_triple}/lib/${DEBUG_DIR}/osgdb_sgb.a)
	APPLE_dk_libRelease(${OSGBULLET}/${target_triple}/lib/${RELEASE_DIR}/osgdb_sgb.a)
	...
	WIN_dk_libDebug(${OSGBULLET}/${target_triple}/lib/${DEBUG_DIR}/osgdb_sgbd.lib)
	WIN_dk_libRelease(${OSGBULLET}/${target_triple}/lib/${RELEASE_DIR}/osgdb_sgb.lib)
endif()


### GENERATE ###
ANDROID_dk_configure			(${OSGBULLET} ${OPENSCENEGRAPH_CMAKE} ${OSGWORKS_CMAKE} -DOSGBULLET_BUILD_APPLICATIONS=OFF -DOSGBULLET_BUILD_EXAMPLES=OFF -DOSGBULLET_INSTALL_DATA=OFF "-DBulletInstallType=Source And Build Tree" -DBulletSourceRoot=${BULLET3} -DBulletBuildRoot=${BULLET3}/${target_triple} ${BULLET3_CMAKE})
...
MAC_dk_configure				(${OSGBULLET} ${OPENSCENEGRAPH_CMAKE} ${OSGWORKS_CMAKE} -DOSGBULLET_BUILD_APPLICATIONS=OFF -DOSGBULLET_BUILD_EXAMPLES=OFF -DOSGBULLET_INSTALL_DATA=OFF "-DBulletInstallType=Source And Build Tree" -DBulletSourceRoot=${BULLET3} -DBulletBuildRoot=${BULLET3}/${target_triple} ${BULLET3_CMAKE})
...
WIN_dk_configure				(${OSGBULLET} ${OPENSCENEGRAPH_CMAKE} ${OSGWORKS_CMAKE} -DOSGBULLET_BUILD_APPLICATIONS=OFF -DOSGBULLET_BUILD_EXAMPLES=OFF -DOSGBULLET_INSTALL_DATA=OFF "-DBulletInstallType=Source And Build Tree" -DBulletSourceRoot=${BULLET3} -DBulletBuildRoot=${BULLET3}/${target_triple} ${BULLET3_CMAKE})
