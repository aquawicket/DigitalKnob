...
EMSCRIPTEN_TARGET_DEBUG_dk_configure	(${OSGBULLET} ${OPENSCENEGRAPH_CMAKE} ${OSGWORKS_CMAKE} -DOSGBULLET_BUILD_APPLICATIONS=OFF -DOSGBULLET_BUILD_EXAMPLES=OFF -DOSGBULLET_INSTALL_DATA=OFF "-DBulletInstallType=Source And Build Tree" -DBulletSourceRoot=${BULLET3} -DBulletBuildRoot=${BULLET3}/${OS}/${DEBUG_DIR} ${BULLET3_CMAKE})
