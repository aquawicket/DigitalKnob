...
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../../../$(BULLET)/android_arm32/Debug/$(LIBDIR)/libBulletCollision.a
...
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../../../$(BULLET)/android_arm32/Debug/$(LIBDIR)/libBulletDynamics.a
include $(PREBUILT_STATIC_LIBRARY)
...
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../../../$(BULLET)/android_arm32/Debug/$(LIBDIR)/libBulletMultiThreaded.a
include $(PREBUILT_STATIC_LIBRARY)
...
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../../../$(BULLET)/android_arm32/Debug/$(LIBDIR)/libBulletSoftBody.a
include $(PREBUILT_STATIC_LIBRARY)
...
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../../../$(BULLET)/android_arm32/Debug/$(LIBDIR)/libLinearMath.a
include $(PREBUILT_STATIC_LIBRARY)
...
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../../../$(BULLET)/android_arm32/Debug/$(LIBDIR)/libMiniCL.a
include $(PREBUILT_STATIC_LIBRARY)
