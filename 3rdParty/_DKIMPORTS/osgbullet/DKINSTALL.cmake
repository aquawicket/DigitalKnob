...
if(osgbCollision)
	...
	WIN_dk_libDebug(${OSGBULLET}/${Target_Tuple}/lib/${DEBUG_DIR}/osgbCollisiond.lib)
	WIN_dk_libRelease(${OSGBULLET}/${Target_Tuple}/lib/${RELEASE_DIR}/osgbCollision.lib)
endif()
if(osgbDynamics)
	...
	WIN_dk_libDebug(${OSGBULLET}/${Target_Tuple}/lib/${DEBUG_DIR}/osgbDynamicsd.lib)
	WIN_dk_libRelease(${OSGBULLET}/${Target_Tuple}/lib/${RELEASE_DIR}/osgbDynamics.lib)
endif()
if(osgbInteraction)
	...
	WIN_dk_libDebug(${OSGBULLET}/${Target_Tuple}/lib/${DEBUG_DIR}/osgbInteractiond.lib)
	WIN_dk_libRelease(${OSGBULLET}/${Target_Tuple}/lib/${RELEASE_DIR}/osgbInteraction.lib)
endif()
if(osgdb_osgbdynamics)
	...
	WIN_dk_libDebug(${OSGBULLET}/${Target_Tuple}/lib/${DEBUG_DIR}/osgdb_osgbdynamicsd.lib)
	WIN_dk_libRelease(${OSGBULLET}/${Target_Tuple}/lib/${RELEASE_DIR}/osgdb_osgbdynamics.lib)
endif()
if(osgdb_sgb)
	...
	WIN_dk_libDebug(${OSGBULLET}/${Target_Tuple}/lib/${DEBUG_DIR}/osgdb_sgbd.lib)
	WIN_dk_libRelease(${OSGBULLET}/${Target_Tuple}/lib/${RELEASE_DIR}/osgdb_sgb.lib)
endif()
...
WIN_dk_configure				(${OSGBULLET} ${OPENSCENEGRAPH_CMAKE} ${OSGWORKS_CMAKE} -DOSGBULLET_BUILD_APPLICATIONS=OFF -DOSGBULLET_BUILD_EXAMPLES=OFF -DOSGBULLET_INSTALL_DATA=OFF "-DBulletInstallType=Source And Build Tree" -DBulletSourceRoot=${BULLET3} -DBulletBuildRoot=${BULLET3}/${Target_Tuple} ${BULLET3_CMAKE})
