...
WIN32_COMMAND(${CMAKE_COMMAND} -G ${GENERATOR} -A Win32 "-DCMAKE_CXX_FLAGS=/DWIN32 /D_WINDOWS /W3 /nologo" "-DCMAKE_CXX_FLAGS_DEBUG=/MTd /Od /Ob0 /Zi /RTC1 /DDEBUG /D_DEBUG" "-DCMAKE_CXX_FLAGS_RELEASE=/MT /O2 /Ob2 /DNDEBUG" -DSTATIC=ON -DCMAKE_INSTALL_PREFIX=${LEPTONICA} ${ZLIB_WIN} ${TIFF_WIN} -DPNG_PNG_INCLUDE_DIR=${PNG} -DPNG_PNG_INCLUDE_DIR2=${PNG}/${OS} -DPNG_LIBRARY_DEBUG=${PNG}/${OS}/${DEBUG}/libpng17_staticd.lib -DPNG_LIBRARY_RELEASE=${PNG}/${OS}/${RELEASE}/libpng17_static.lib ${LEPTONICA})
WIN32_VS_DEBUG(${LEPTONICA_NAME} LEPTONICA.sln leptonica)
WIN32_VS_RELEASE(${LEPTONICA_NAME} LEPTONICA.sln leptonica)

DKSETPATH(${LEPTONICA}/${OS})
WIN64_COMMAND(${CMAKE_COMMAND} -G ${GENERATOR} -A x64 "-DCMAKE_CXX_FLAGS=/DWIN64 /D_WINDOWS /W3 /nologo" "-DCMAKE_CXX_FLAGS_DEBUG=/MTd /Od /Ob0 /Zi /RTC1 /DDEBUG /D_DEBUG" "-DCMAKE_CXX_FLAGS_RELEASE=/MT /O2 /Ob2 /DNDEBUG" -DSTATIC=ON -DCMAKE_INSTALL_PREFIX=${LEPTONICA} ${ZLIB_WIN} ${TIFF_WIN} -DPNG_PNG_INCLUDE_DIR=${PNG} -DPNG_PNG_INCLUDE_DIR2=${PNG}/${OS} -DPNG_LIBRARY_DEBUG=${PNG}/${OS}/${DEBUG}/libpng17_staticd.lib -DPNG_LIBRARY_RELEASE=${PNG}/${OS}/${RELEASE}/libpng17_static.lib ${LEPTONICA})
WIN64_VS_DEBUG(${LEPTONICA_NAME} LEPTONICA.sln leptonica)
WIN64_VS_RELEASE(${LEPTONICA_NAME} LEPTONICA.sln leptonica)

DKSETPATH(${LEPTONICA}/${OS})
MAC_COMMAND(${CMAKE_COMMAND} -G "Xcode" -DCMAKE_OSX_ARCHITECTURES=x86_64 -DSTATIC=ON -DCMAKE_INSTALL_PREFIX=${LEPTONICA} ${ZLIB_APPLE} ${TIFF_APPLE} -DPNG_PNG_INCLUDE_DIR=${PNG} -DPNG_PNG_INCLUDE_DIR2=${PNG}/${OS} -DPNG_LIBRARY_DEBUG=${PNG}/${OS}/${DEBUG}/libpng17_staticd.lib -DPNG_LIBRARY_RELEASE=${PNG}/${OS}/${RELEASE}/libpng17_static.lib -DJPEG_INCLUDE_DIR=${JPEG} -DJPEG_INCLUDE_DIR2=${JPEG}/${OS} -DJPEG_LIBRARY=${JPEG}/${OS}/${RELEASE}/libturbojpeg.a ${LEPTONICA})
MAC_XCODE_DEBUG(${LEPTONICA_NAME} leptonica)
MAC_XCODE_RELEASE(${LEPTONICA_NAME} leptonica)

DKSETPATH(${LEPTONICA}/${OS})
IOS_COMMAND(${CMAKE_COMMAND} -G "Xcode" -DCMAKE_TOOLCHAIN_FILE=${DKCMAKE}/iOS.cmake -DIOS_PLATFORM=OS -DSTATIC=ON -DCMAKE_INSTALL_PREFIX=${LEPTONICA} ${ZLIB_APPLE} ${TIFF_APPLE} -DPNG_PNG_INCLUDE_DIR=${PNG} -DPNG_PNG_INCLUDE_DIR2=${PNG}/${OS} -DPNG_LIBRARY_DEBUG=${PNG}/${OS}/${DEBUG}/libpng17_staticd.lib -DPNG_LIBRARY_RELEASE=${PNG}/${OS}/${RELEASE}/libpng17_static.lib -DJPEG_INCLUDE_DIR=${JPEG} -DJPEG_INCLUDE_DIR2=${JPEG}/${OS} -DJPEG_LIBRARY=${JPEG}/${OS}/${RELEASE}/libturbojpeg.a ${LEPTONICA})
IOS_XCODE_DEBUG(${LEPTONICA_NAME} leptonica)
IOS_XCODE_RELEASE(${LEPTONICA_NAME} leptonica)

DKSETPATH(${LEPTONICA}/${OS})
IOSSIM_COMMAND(${CMAKE_COMMAND} -G "Xcode" -DCMAKE_TOOLCHAIN_FILE=${DKCMAKE}/iOS.cmake -DIOS_PLATFORM=SIMULATOR64 -DSTATIC=ON -DCMAKE_INSTALL_PREFIX=${LEPTONICA} ${SDL2_APPLE} ${TIFF_APPLE} -DPNG_PNG_INCLUDE_DIR=${PNG} -DPNG_PNG_INCLUDE_DIR2=${PNG}/${OS} -DPNG_LIBRARY_DEBUG=${PNG}/${OS}/${DEBUG}/libpng17_staticd.lib -DPNG_LIBRARY_RELEASE=${PNG}/${OS}/${RELEASE}/libpng17_static.lib -DJPEG_INCLUDE_DIR=${JPEG} -DJPEG_INCLUDE_DIR2=${JPEG}/${OS} -DJPEG_LIBRARY=${JPEG}/${OS}/${RELEASE}/libturbojpeg.a ${LEPTONICA})
IOSSIM_XCODE_DEBUG(${LEPTONICA_NAME} leptonica)
IOSSIM_XCODE_RELEASE(${LEPTONICA_NAME} leptonica)

DKSETPATH(${LEPTONICA}/${OS}/${DEBUG})
LINUX_DEBUG_COMMAND(${CMAKE_COMMAND} -G "Unix Makefiles" -DCMAKE_BUILD_TYPE=DEBUG -DSTATIC=ON -DCMAKE_INSTALL_PREFIX=${LEPTONICA} ${SDL2_LINUX} ${TIFF_LINUX} -DPNG_PNG_INCLUDE_DIR=${PNG} -DPNG_PNG_INCLUDE_DIR2=${PNG}/${OS}/${DEBUG} -DPNG_LIBRARY_DEBUG=${PNG}/${OS}/${DEBUG}/libpng17_staticd.lib -DPNG_LIBRARY_RELEASE=${PNG}/${OS}/${RELEASE}/libpng17_static.lib -DJPEG_INCLUDE_DIR=${JPEG} -DJPEG_INCLUDE_DIR2=${JPEG}/${OS}/${DEBUG} -DJPEG_LIBRARY=${JPEG}/${OS}/${DEBUG}/libturbojpeg.a ${LEPTONICA})
LINUX_DEBUG_COMMAND(make leptonica)

DKSETPATH(${LEPTONICA}/${OS}/${RELEASE})
LINUX_RELEASE_COMMAND(${CMAKE_COMMAND} -G "Unix Makefiles" -DCMAKE_BUILD_TYPE=RELEASE -DSTATIC=ON -DCMAKE_INSTALL_PREFIX=${LEPTONICA} ${SDL2_LINUX} ${TIFF_LINUX} -DPNG_PNG_INCLUDE_DIR=${PNG} -DPNG_PNG_INCLUDE_DIR2=${PNG}/${OS}/${RELEASE} -DPNG_LIBRARY_DEBUG=${PNG}/${OS}/${DEBUG}/libpng17_staticd.lib -DPNG_LIBRARY_RELEASE=${PNG}/${OS}/${RELEASE}/libpng17_static.lib -DJPEG_INCLUDE_DIR=${JPEG} -DJPEG_INCLUDE_DIR2=${JPEG}/${OS}/${RELEASE} -DJPEG_LIBRARY=${JPEG}/${OS}/${RELEASE}/libturbojpeg.a ${LEPTONICA})
