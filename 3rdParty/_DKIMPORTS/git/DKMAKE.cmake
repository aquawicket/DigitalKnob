...
#	endif()
#	
#	dk_command(command -v git.exe OUTPUT_VARIABLE GIT_EXE NOASSERT BASH)
#	if(GIT_EXE)
...
#	endif()
#	
#	dk_command(command -v git.exe OUTPUT_VARIABLE GIT_EXE BASH)
#	if(GIT_EXE)
#		dk_command(cygpath -m ${GIT_EXE} OUTPUT_VARIABLE GIT_EXE)
#	endif()
#
	...
	if(WIN_HOST)
		...
		dk_command(command -v git OUTPUT_VARIABLE GIT_EXE BASH)
		if(NOT EXISTS ${GIT_EXE})
