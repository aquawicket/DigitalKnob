...
:dk_uninstallGit
 ...
 ::setlocal	
    ...
    ::if "%DK_HOST_ARCH%"=="arm32"        %dk_call% dk_set GIT_DL ""
    ::if "%DK_HOST_ARCH%"=="arm64"        %dk_call% dk_set GIT_DL ""
    if "%DK_HOST_ARCH%"=="x86"            %dk_call% dk_set GIT_DL "https://github.com/git-for-windows/git/releases/download/v2.44.0.windows.1/PortableGit-2.44.0-32-bit.7z.exe"
    if "%DK_HOST_ARCH%"=="x86_64"         %dk_call% dk_set GIT_DL "https://github.com/git-for-windows/git/releases/download/v2.44.0.windows.1/PortableGit-2.44.0-64-bit.7z.exe"
