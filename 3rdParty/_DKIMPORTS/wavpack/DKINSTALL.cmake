...
if(MSVC AND Windows)
	dk_libDebug		(${WAVPACK.Debug_Dir}/wavpack.lib		WAVPACK_LIBRARY_DEBUG)
	dk_libRelease	(${WAVPACK.Release_Dir}/wavpack.lib		WAVPACK_LIBRARY_RELEASE)
else()
	dk_libDebug		(${WAVPACK.Debug_Dir}/libwavpack.a		WAVPACK_LIBRARY_DEBUG)
	dk_libRelease	(${WAVPACK.Release_Dir}/libwavpack.a	WAVPACK_LIBRARY_RELEASE)
endif()
