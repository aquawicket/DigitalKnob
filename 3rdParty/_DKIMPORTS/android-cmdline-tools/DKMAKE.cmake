...
if(WIN_HOST)
	...
	if(NOT EXISTS ${ANDROID-SDK}/system-images/${ANDROIDIMAGES_VERSION}/google_apis/armeabi-v7a)
		dk_info("Installing Android system image: ${ANDROIDIMAGES_VERSION} armeabi-v7a")
		set(ARGUMNTS "${SDKMANAGER_BAT} --install system-images\\;${ANDROIDIMAGES_VERSION}\\;google_apis\\;armeabi-v7a --sdk_root=${ANDROID-SDK}")
		separate_arguments(ARGUMNTS)
		dk_executeProcess(${ARGUMNTS} WORKING_DIRECTORY ${ANDROID-SDK}/bin)
	endif()
	if(NOT EXISTS ${ANDROID-SDK}/system-images/${ANDROIDIMAGES_VERSION}/google_apis/armeabi-v7a)
	...
	if(NOT EXISTS ${ANDROID-SDK}/system-images/${ANDROIDIMAGES_VERSION}/google_apis/arm64-v8a)
		dk_info("Installing Android API system image: ${ANDROIDIMAGES_VERSION} arm64-v8a")
		set(ARGUMNTS "${SDKMANAGER_BAT} --install system-images\\;${ANDROIDIMAGES_VERSION}\\;google_apis\\;arm64-v8a --sdk_root=${ANDROID-SDK}")
		separate_arguments(ARGUMNTS)
		dk_executeProcess(${ARGUMNTS} WORKING_DIRECTORY ${ANDROID-SDK}/bin)
	endif()
	if(NOT EXISTS ${ANDROID-SDK}/system-images/${ANDROIDIMAGES_VERSION}/google_apis/arm64-v8a)
	...
	if(NOT EXISTS ${ANDROID-SDK}/system-images/${ANDROIDIMAGES_VERSION}/google_apis/x86)
		dk_info("Installing Android API system image: ${ANDROIDIMAGES_VERSION} x86")
		set(ARGUMNTS "${SDKMANAGER_BAT} --install system-images\\;${ANDROIDIMAGES_VERSION}\\;google_apis\\;x86 --sdk_root=${ANDROID-SDK}")
		separate_arguments(ARGUMNTS)
		dk_executeProcess(${ARGUMNTS} WORKING_DIRECTORY ${ANDROID-SDK}/bin)
	endif()
	if(NOT EXISTS ${ANDROID-SDK}/system-images/${ANDROIDIMAGES_VERSION}/google_apis/x86)
	...
	if(NOT EXISTS ${ANDROID-SDK}/system-images/${ANDROIDIMAGES_VERSION}/google_apis/x86_64)
		dk_info("Installing Android API system image: ${ANDROIDIMAGES_VERSION} x86_64")
		set(ARGUMNTS "${SDKMANAGER_BAT} --install system-images\\;${ANDROIDIMAGES_VERSION}\\;google_apis\\;x86_64 --sdk_root=${ANDROID-SDK}")
		separate_arguments(ARGUMNTS)
		dk_executeProcess(${ARGUMNTS} WORKING_DIRECTORY ${ANDROID-SDK}/bin)
	endif()
