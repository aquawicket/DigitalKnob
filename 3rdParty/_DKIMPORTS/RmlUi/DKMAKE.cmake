...
#### DEBUG COMPILE #####
WIN_PATH(${RMLUI}/${OS})
WIN32_COMMAND(${DKCMAKE_WIN32} "-DCMAKE_CXX_FLAGS=/DWIN32 /D_WINDOWS /W3 /nologo /GR /EHsc -DRMLUI_STATIC_LIB /I${RMLUI}/Include /I${SDL}/include /I${GLEW}/include"  -DBUILD_SAMPLES=ON ${FREETYPE_WIN} ${SDL2_WIN} ${RMLUI})
