...
dk_add_target(boost atomic)
dk_add_target(boost chrono)
dk_add_target(boost container)
dk_add_target(boost context)
dk_add_target(boost contract)
dk_add_target(boost coroutine)
dk_add_target(boost date_time)
dk_add_target(boost exception)
dk_add_target(boost fiber)
dk_add_target(boost filesystem)
dk_add_target(boost graph)
dk_add_target(boost graph_parallel)
dk_add_target(boost headers)
dk_add_target(boost iostreams)
dk_add_target(boost json)
dk_add_target(boost locale)
dk_add_target(boost log)
dk_add_target(boost math)
dk_add_target(boost mpi)
dk_add_target(boost nowide)
dk_add_target(boost program_options)
dk_add_target(boost python)
dk_add_target(boost random)
dk_add_target(boost regex)
dk_add_target(boost serialization)
dk_add_target(boost stacktrace)
dk_add_target(boost system)
dk_add_target(boost test)
dk_add_target(boost thread)
dk_add_target(boost timer)
dk_add_target(boost type_erasure)
dk_add_target(boost wave)
