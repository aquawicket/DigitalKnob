...
if(ALL_LIBS)
	...
	dk_enable(osgdb_ac)
	if(NOT MAC)
		dk_enable(osgdb_avfoundation)	#FIXME: Not buildig on MAC
	endif()
	dk_enable(osgdb_bmp)
	dk_enable(osgdb_bsp)
	dk_enable(osgdb_bvh)
	...
	if(NOT MAC)
		dk_enable(osgdb_dae)			#FIXME: Not buildig on MAC
	endif()
	dk_enable(osgdb_dds)
	if(NOT MAC)
		dk_enable(osgdb_dicom)			#FIXME: Not buildig on MAC
	endif()
	if(NOT MAC)
		dk_enable(osgdb_directshow)		#FIXME: Not buildig on MAC
	endif()
	dk_enable(osgdb_dot)
	dk_enable(osgdb_dxf)
	if(NOT MAC)
		dk_enable(osgdb_exr)			#FIXME: Not buildig on MAC
	endif()
	if(NOT MAC)
		dk_enable(osgdb_fbx)			#FIXME: Not buildig on MAC
	endif()
	if(FFMPEG)
	...
	if(NOT MAC)
		dk_enable(osgdb_gstreamer)		#FIXME: Not buildig on MAC
	endif()
	if(NOT MAC)
		dk_enable(osgdb_gta)			#FIXME: Not buildig on MAC
	endif()
	dk_enable(osgdb_gz)
	dk_enable(osgdb_hdr)
	...
	dk_enable(osgdb_ive)
	if(NOT MAC)
		dk_enable(osgdb_jp2)			#FIXME: Not buildig on MAC
	endif()
	dk_enable(osgdb_jpeg)
	dk_enable(osgdb_ktx)
	if(NOT MAC)
		dk_enable(osgdb_las)			#FIXME: Not buildig on MAC
	endif()
	...
	if(NOT MAC)
		dk_enable(osgdb_nvtt)			#FIXME: Not buildig on MAC
	endif()
	dk_enable(osgdb_obj)
	if(NOT MAC)
		dk_enable(osgdb_ogr)			#FIXME: Not buildig on MAC
	endif()
	if(NOT MAC)
		dk_enable(osgdb_opencascade)	#FIXME: Not buildig on MAC
	endif()
	...
	dk_enable(osgdb_p3d)
	if(NOT MAC)
		dk_enable(osgdb_pdf)			#FIXME: Not buildig on MAC
	endif()
	dk_enable(osgdb_pic)
	dk_enable(osgdb_ply)
	...
	dk_enable(osgdb_pvr)
	if(NOT MAC)
		dk_enable(osgdb_python)			#FIXME: Not buildig on MAC
	endif()
	if(NOT MAC)
		dk_enable(osgdb_qtkit)			#FIXME: Not buildig on MAC
	endif()
	if(NOT MAC)
		dk_enable(osgdb_quicktime)		#FIXME: Not buildig on MAC
	endif()
	if(NOT MAC)
		dk_enable(osgdb_resthttpdevice)	#FIXME: Not buildig on MAC
	endif()
	...
	dk_enable(osgdb_x)
	if(NOT MAC)
		dk_enable(osgdb_zeroconfdevice)	#FIXME: Not buildig on MAC
	endif()
	dk_enable(osgdb_zip)
