...
LINUX_DEBUG_dk_queueCommand(${OPENCV_BUILD} 
	"-DCMAKE_CXX_FLAGS=-I${LIBJPEG-TURBO}/${OS}/Debug -I${LIBPNG}/${OS}/Debug -I${LIBVNCSERVER} -I${TIFF}/${OS}/Debug/libtiff -I${ZLIB}/${OS}/Debug" 
...
LINUX_RELEASE_dk_queueCommand(${OPENCV_BUILD} 
	"-DCMAKE_CXX_FLAGS=-I${LIBJPEG-TURBO}/${OS}/Release -I${LIBPNG}/${OS}/Release -I${LIBVNCSERVER} -I${TIFF}/${OS}/Release/libtiff -I${ZLIB}/${OS}/Release" 
