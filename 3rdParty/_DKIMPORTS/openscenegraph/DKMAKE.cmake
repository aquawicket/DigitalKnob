...
if(OpenThreads)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libOpenThreadsd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libOpenThreads.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libOpenThreadsd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libOpenThreads.a)
...
if(osg)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosg.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosg.a)
...
if(osgUtil)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgUtild.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgUtil.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgUtild.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgUtil.a)
...
if(osgDB)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgDBd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgDB.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgDBd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgDB.a)
...
if(osgGA)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgGAd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgGA.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgGAd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgGA.a)
...
if(osgText)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgTextd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgText.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgTextd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgText.a)
...
if(osgViewer)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgViewerd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgViewer.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgViewerd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgViewer.a)
...
if(osgAnimation)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgAnimationd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgAnimation.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgAnimationd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgAnimation.a)
...
if(osgFX)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgFXd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgFX.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgFXd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgFX.a)
...
if(osgManipulator)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgManipulatord.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgManipulator.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgManipulatord.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgManipulator.a)
...
if(osgParticle)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgParticled.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgParticle.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgParticled.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgParticle.a)
...
if(osgVolume)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgVolumed.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgVolume.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgVolumed.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgVolume.a)
...
if(osgWidget)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgWidgetd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgWidget.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgWidgetd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgWidget.a)
...
if(osgPresentation)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgPresentationd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgPresentation.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgPresentationd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgPresentation.a)
...
if(osgShadow)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgShadowd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgShadow.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgShadowd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgShadow.a)
...
if(osgSim)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgSimd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgSim.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgSimd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgSim.a)
...
if(osgTerrain)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgTerraind.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgTerrain.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgTerraind.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgTerrain.a)
...
if(osgdb_deprecated_osg)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_deprecated_osgd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_deprecated_osg.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_deprecated_osgd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_deprecated_osg.a)
...
if(osgdb_serializers_osgparticle)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_serializers_osgparticled.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_serializers_osgparticle.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_serializers_osgparticled.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_serializers_osgparticle.a)
...
if(osgdb_serializers_osg)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_serializers_osgd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_serializers_osg.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_serializers_osgd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_serializers_osg.a)
...
if(osgdb_trans)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_transd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_trans.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_transd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_trans.a)
...
if(osgdb_normals)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_normalsd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_normals.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_normalsd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_normals.a)
...
if(osgdb_scale)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_scaled.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_scale.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_scaled.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_scale.a)
...
if(osgdb_rot)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_rotd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_rot.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_rotd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_rot.a)
...
if(osgdb_x)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_xd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_x.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_xd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_x.a)
...
if(osgdb_stl)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_stld.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_stl.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_stld.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_stl.a)
...
if(osgdb_shp)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_shpd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_shp.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_shpd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_shp.a)
...
if(osgdb_osg)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_osgd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_osg.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_osgd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_osg.a)
...
if(osgdb_openflight)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_openflightd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_openflight.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_openflightd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_openflight.a)
...
if(osgdb_obj)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_objd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_obj.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_objd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_obj.a)
...
if(osgdb_md2)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_md2d.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_md2.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_md2d.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_md2.a)
...
if(osgdb_lws)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_lwsd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_lws.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_lwsd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_lws.a)
...
if(osgdb_lwo)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_lwod.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_lwo.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_lwod.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_lwo.a)
...
if(osgdb_logo)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_logod.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_logo.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_logod.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_logo.a)
...
if(osgdb_ive)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_ived.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_ive.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_ived.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_ive.a)
...
if(osgdb_dxf)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_dxfd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_dxf.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_dxfd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_dxf.a)
...
if(osgdb_dw)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_dwd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_dw.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_dwd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_dw.a)
...
if(osgdb_bsp)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_bspd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_bsp.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_bspd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_bsp.a)
...
if(osgdb_ac)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_acd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_ac.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_acd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_ac.a)
...
if(osgdb_3ds)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_3dsd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_3ds.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_3dsd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_3ds.a)
...
if(osgdb_3dc)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_3dcd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_3dc.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_3dcd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_3dc.a)
...
if(osgdb_deprecated_osgwidget)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_deprecated_osgwidgetd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_deprecated_osgwidget.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_deprecated_osgwidgetd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_deprecated_osgwidget.a)
...
if(osgdb_tga)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_tgad.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_tga.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_tgad.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_tga.a)
...
if(osgdb_tiff)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_tiffd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_tiff.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_tiffd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_tiff.a)
...
if(osgdb_png)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_pngd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_png.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_pngd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_png.a)
...
if(osgdb_jpeg)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_jpegd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_jpeg.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_jpegd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_jpeg.a)
...
if(osgdb_gif)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_gifd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_gif.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_gifd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_gif.a)
...
if(osgdb_freetype)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_freetyped.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_freetype.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_freetyped.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_freetype.a)
...
if(osgdb_bmp)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_bmpd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_bmp.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_bmpd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_bmp.a)
...
if(osgdb_vtf)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_vtfd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_vtf.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_vtfd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_vtf.a)
...
if(osgdb_txp)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_txpd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_txp.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_txpd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_txp.a)
...
if(osgdb_txf)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_txfd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_txf.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_txfd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_txf.a)
...
if(osgdb_trk)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_trkd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_trk.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_trkd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_trk.a)
...
if(osgdb_tgz)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_tgzd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_tgz.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_tgzd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_tgz.a)
...
if(osgdb_serializers_osgvolume)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_serializers_osgvolumed.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_serializers_osgvolume.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_serializers_osgvolumed.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_serializers_osgvolume.a)
...
if(osgdb_serializers_osgviewer)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_serializers_osgviewerd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_serializers_osgviewer.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_serializers_osgviewerd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_serializers_osgviewer.a)
...
if(osgdb_serializers_osgtext)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_serializers_osgtextd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_serializers_osgtext.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_serializers_osgtextd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_serializers_osgtext.a)
...
if(osgdb_serializers_osgterrain)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_serializers_osgterraind.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_serializers_osgterrain.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_serializers_osgterraind.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_serializers_osgterrain.a)
...
if(osgdb_serializers_osgsim)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_serializers_osgsimd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_serializers_osgsim.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_serializers_osgsimd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_serializers_osgsim.a)
...
if(osgdb_serializers_osgshadow)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_serializers_osgshadowd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_serializers_osgshadow.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_serializers_osgshadowd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_serializers_osgshadow.a)
...
if(osgdb_serializers_osgmanipulator)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_serializers_osgmanipulatord.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_serializers_osgmanipulator.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_serializers_osgmanipulatord.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_serializers_osgmanipulator.a)
...
if(osgdb_serializers_osgga)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_serializers_osggad.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_serializers_osgga.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_serializers_osggad.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_serializers_osgga.a)
...
if(osgdb_serializers_osgfx)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_serializers_osgfxd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_serializers_osgfx.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_serializers_osgfxd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_serializers_osgfx.a)
...
if(osgdb_serializers_osganimation)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_serializers_osganimationd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_serializers_osganimation.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_serializers_osganimationd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_serializers_osganimation.a)
...
if(osgdb_rgb)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_rgbd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_rgb.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_rgbd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_rgb.a)
...
if(osgdb_revisions)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_revisionsd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_revisions.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_revisionsd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_revisions.a)
...
if(osgdb_pvr)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_pvrd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_pvr.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_pvrd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_pvr.a)
...
if(osgdb_pov)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_povd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_pov.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_povd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_pov.a)
...
if(osgdb_pnm)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_pnmd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_pnm.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_pnmd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_pnm.a)
...
if(osgdb_ply)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_plyd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_ply.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_plyd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_ply.a)
...
if(osgdb_pic)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_picd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_pic.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_picd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_pic.a)
...
if(osgdb_p3d)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_p3dd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_p3d.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_p3dd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_p3d.a)
...
if(osgdb_osgviewer)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_osgviewerd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_osgviewer.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_osgviewerd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_osgviewer.a)
...
if(osgdb_osgtgz)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_osgtgzd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_osgtgz.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_osgtgzd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_osgtgz.a)
...
if(osgdb_osgterrain)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_osgterraind.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_osgterrain.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_osgterraind.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_osgterrain.a)
...
if(osgdb_osgshadow)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_osgshadowd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_osgshadow.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_osgshadowd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_osgshadow.a)
...
if(osgdb_osga)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_osgad.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_osga.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_osgad.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_osga.a)
...
if(osgdb_osc)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_oscd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_osc.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_oscd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_osc.a)
...
if(osgdb_mdl)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_mdld.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_mdl.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_mdld.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_mdl.a)
...
if(osgdb_ktx)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_ktxd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_ktx.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_ktxd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_ktx.a)
...
if(osgdb_hdr)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_hdrd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_hdr.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_hdrd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_hdr.a)
...
if(osgdb_glsl)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_glsld.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_glsl.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_glsld.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_glsl.a)
...
if(osgdb_dot)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_dotd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_dot.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_dotd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_dot.a)
...
if(osgdb_deprecated_osgvolume)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_deprecated_osgvolumed.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_deprecated_osgvolume.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_deprecated_osgvolumed.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_deprecated_osgvolume.a)
...
if(osgdb_deprecated_osgviewer)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_deprecated_osgviewerd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_deprecated_osgviewer.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_deprecated_osgviewerd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_deprecated_osgviewer.a)
...
if(osgdb_deprecated_osgtext)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_deprecated_osgtextd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_deprecated_osgtext.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_deprecated_osgtextd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_deprecated_osgtext.a)
...
if(osgdb_deprecated_osgterrain)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_deprecated_osgterraind.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_deprecated_osgterrain.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_deprecated_osgterraind.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_deprecated_osgterrain.a)
...
if(osgdb_deprecated_osgsim)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_deprecated_osgsimd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_deprecated_osgsim.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_deprecated_osgsimd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_deprecated_osgsim.a)
...
if(osgdb_deprecated_osgshadow)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_deprecated_osgshadowd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_deprecated_osgshadow.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_deprecated_osgshadowd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_deprecated_osgshadow.a)
...
if(osgdb_deprecated_osgparticle)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_deprecated_osgparticled.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_deprecated_osgparticle.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_deprecated_osgparticled.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_deprecated_osgparticle.a)
...
if(osgdb_deprecated_osgfx)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_deprecated_osgfxd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_deprecated_osgfx.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_deprecated_osgfxd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_deprecated_osgfx.a)
...
if(osgdb_deprecated_osganimation)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_deprecated_osganimationd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_deprecated_osganimation.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_deprecated_osganimationd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_deprecated_osganimation.a)
...
if(osgdb_dds)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_ddsd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_dds.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_ddsd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_dds.a)
...
if(osgdb_cfg)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_cfgd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_cfg.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_cfgd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_cfg.a)
...
if(osgdb_bvh)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_bvhd.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_bvh.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_bvhd.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_bvh.a)
...
if(osgdb_curl)
	...
	LINUX_dk_libDebug		(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_curld.a)
	LINUX_dk_libRelease		(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_curl.a)
	RASPBERRY_dk_libDebug	(${OPENSCENEGRAPH}/${OS}/${DEBUG}/lib/libosgdb_curld.a)
	RASPBERRY_dk_libRelease	(${OPENSCENEGRAPH}/${OS}/${RELEASE}/lib/libosgdb_curl.a)
...
WIN_dk_queueCommand	(${DKCMAKE_BUILD}
	"-DCMAKE_CXX_FLAGS=/D__STDC_CONSTANT_MACROS /I${ZLIB}/${OS} /I${PNG}/${OS} /I${TIFF}/${OS}/libtiff /I${JPEG}/${OS}" 
...
MAC_dk_queueCommand(${DKCMAKE_BUILD} 
	"-DCMAKE_CXX_FLAGS=-I${ZLIB}/${OS} -I${PNG}/${OS} -I${TIFF}/${OS}/libtiff -I${LIBJPEG-TURBO}/${OS}" 
	-DBUILD_OSG_APPLICATIONS=OFF 
	-DDYNAMIC_OPENTHREADS=OFF 
	-DDYNAMIC_OPENSCENEGRAPH=OFF 
	-DOSG_GL_DISPLAYLISTS_AVAILABLE=OFF 
...
#IOS_dk_removeSubstring("-std=c++17" "${DKCMAKE_BUILD}" DKCMAKE_BUILD)
string(REPLACE "-std=c++17" "" DKCMAKE_BUILD "${DKCMAKE_BUILD}")
string(REPLACE "  " " " DKCMAKE_BUILD "${DKCMAKE_BUILD}")
...
#IOSSIM_dk_removeSubstring("-std=c++17" "${DKCMAKE_BUILD}" DKCMAKE_BUILD)
string(REPLACE "-std=c++17" "" DKCMAKE_BUILD "${DKCMAKE_BUILD}")
string(REPLACE "  " " " DKCMAKE_BUILD "${DKCMAKE_BUILD}")
...
#LINUX_dk_removeSubstring("-std=c++17" "${DKCMAKE_BUILD}" DKCMAKE_BUILD)
string(REPLACE "-std=c++17" "" DKCMAKE_BUILD "${DKCMAKE_BUILD}")
string(REPLACE "  " " " DKCMAKE_BUILD "${DKCMAKE_BUILD}")
LINUX_dk_queueCommand(${DKCMAKE_BUILD} 
	"-DCMAKE_CXX_FLAGS=-I${ZLIB}/${OS}/Debug -I${PNG}/${OS}/Debug -I${TIFF}/${OS}/Debug/libtiff -I${JPEG}/${OS}/Debug" 
...
#RASPBERRY_dk_removeSubstring("-std=c++17" "${DKCMAKE_BUILD}" DKCMAKE_BUILD)
string(REPLACE "-std=c++17" "" DKCMAKE_BUILD "${DKCMAKE_BUILD}")
string(REPLACE "  " " " DKCMAKE_BUILD "${DKCMAKE_BUILD}")
...
#ANDROID_dk_removeSubstring("-std=c++17" "${DKCMAKE_BUILD}" DKCMAKE_BUILD)
string(REPLACE "-std=c++17" "" DKCMAKE_BUILD "${DKCMAKE_BUILD}")
string(REPLACE "  " " " DKCMAKE_BUILD "${DKCMAKE_BUILD}")
ANDROID_dk_queueCommand(${DKCMAKE_BUILD} 
	"-DCMAKE_CXX_FLAGS=-I${JPEG}/${OS}/${DEBUG_DIR}/jni -I${FREETYPE}/include -I${PNG}/${OS}/${DEBUG_DIR}/jni -I${TIFF}/${OS}/libtiff -I${ZLIB}/${OS}/${DEBUG_DIR}/jni" 
