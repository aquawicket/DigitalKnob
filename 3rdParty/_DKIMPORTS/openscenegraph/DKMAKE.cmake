...
if(ALL_LIBS)
	...
	dk_enable(osgdb_pic)
	dk_enable(osgdb_ply)
	if(LIBPNG AND NOT MAC)
		dk_enable(osgdb_png)	#brken on mac
	endif()
	dk_enable(osgdb_pnm)
	dk_enable(osgdb_pov)
	dk_enable(osgdb_pvr)
...
### 3RDPARTY LINK ###
WIN_dk_set				(OPENSCENEGRAPH_CMAKE "-DOSGInstallType=Source And Build Tree" -DOSGSourceRoot=${OPENSCENEGRAPH} -DOSGBuildRoot=${OPENSCENEGRAPH}/${OS})
MAC_dk_set				(OPENSCENEGRAPH_CMAKE "-DOSGInstallType=Source And Build Tree" -DOSGSourceRoot=${OPENSCENEGRAPH} -DOSGBuildRoot=${OPENSCENEGRAPH}/${OS})
IOS_dk_set				(OPENSCENEGRAPH_CMAKE "-DOSGInstallType=Source And Build Tree" -DOSGSourceRoot=${OPENSCENEGRAPH} -DOSGBuildRoot=${OPENSCENEGRAPH}/${OS})
IOSSIM_dk_set			(OPENSCENEGRAPH_CMAKE "-DOSGInstallType=Source And Build Tree" -DOSGSourceRoot=${OPENSCENEGRAPH} -DOSGBuildRoot=${OPENSCENEGRAPH}/${OS})
LINUX_DEBUG_dk_set		(OPENSCENEGRAPH_CMAKE "-DOSGInstallType=Source And Build Tree" -DOSGSourceRoot=${OPENSCENEGRAPH} -DOSGBuildRoot=${OPENSCENEGRAPH}/${OS}/${DEBUG_DIR})
LINUX_RELEASE_dk_set	(OPENSCENEGRAPH_CMAKE "-DOSGInstallType=Source And Build Tree" -DOSGSourceRoot=${OPENSCENEGRAPH} -DOSGBuildRoot=${OPENSCENEGRAPH}/${OS}/${RELEASE_DIR})
RASPBERRY_DEBUG_dk_set	(OPENSCENEGRAPH_CMAKE "-DOSGInstallType=Source And Build Tree" -DOSGSourceRoot=${OPENSCENEGRAPH} -DOSGBuildRoot=${OPENSCENEGRAPH}/${OS}/${DEBUG_DIR})
RASPBERRY_RELEASE_dk_set(OPENSCENEGRAPH_CMAKE "-DOSGInstallType=Source And Build Tree" -DOSGSourceRoot=${OPENSCENEGRAPH} -DOSGBuildRoot=${OPENSCENEGRAPH}/${OS}/${RELEASE_DIR})
ANDROID_dk_set			(OPENSCENEGRAPH_CMAKE "-DOSGInstallType=Source And Build Tree" -DOSGSourceRoot=${OPENSCENEGRAPH} -DOSGBuildRoot=${OPENSCENEGRAPH}/${OS})
...
WIN_dk_queueCommand	(${OPENCV_BUILD}
	"-DCMAKE_CXX_FLAGS=/D__STDC_CONSTANT_MACROS /I${LIBJPEG-TURBO}/${OS} /I${LIBPNG} /I${LIBPNG}/${OS} /I${LIBVNCSERVER} /I${LIBVNCSERVER}/${OS} /I${TIFF}/${OS}/libtiff /I${ZLIB}/${OS}" 
...
MAC_dk_queueCommand(${OPENCV_BUILD} 
	"-DCMAKE_CXX_FLAGS=-I${LIBJPEG-TURBO}/${OS} -I${LIBPNG}/${OS} -I${LIBVNCSERVER} -I${TIFF}/${OS}/libtiff -I${ZLIB}/${OS}"
...
LINUX_DEBUG_dk_queueCommand(${OPENCV_BUILD} 
	"-DCMAKE_CXX_FLAGS=-I${LIBJPEG-TURBO}/${OS}/Debug -I${LIBPNG}/${OS}/Debug -I${LIBVNCSERVER} -I${LIBVNCSERVER}/${OS}/Debug -I${TIFF}/${OS}/Debug/libtiff -I${ZLIB}/${OS}/Debug" 
...
LINUX_RELEASE_dk_queueCommand(${OPENCV_BUILD} 
	"-DCMAKE_CXX_FLAGS=-I${LIBJPEG-TURBO}/${OS}/Release -I${LIBPNG}/${OS}/Release -I${LIBVNCSERVER} -I${LIBVNCSERVER}/${OS}/Release -I${TIFF}/${OS}/Release/libtiff -I${ZLIB}/${OS}/Release" 
...
ANDROID_dk_queueCommand(${OPENCV_BUILD} 
	"-DCMAKE_CXX_FLAGS=-I${FREETYPE}/include -I${LIBJPEG-TURBO}/${OS}/${DEBUG_DIR}/jni -I${LIBVNCSERVER} -I${LIBPNG}/${OS}/${DEBUG_DIR}/jni -I${TIFF}/${OS}/libtiff -I${ZLIB}/${OS}/${DEBUG_DIR}/jni" 
