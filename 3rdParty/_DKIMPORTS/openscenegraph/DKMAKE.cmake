...
IOS_dk_queueCommand(${DKCMAKE_BUILD} 
	"-DCMAKE_CXX_FLAGS=-I${ZLIB}/${OS} -I${PNG}/${OS} -I${TIFF}/${OS} -I${JPEG}/${OS}" 
	-DBUILD_OSG_APPLICATIONS=OFF 
	-DDYNAMIC_OPENTHREADS=OFF 
	-DDYNAMIC_OPENSCENEGRAPH=OFF 
	-DOSG_GL_DISPLAYLISTS_AVAILABLE=OFF 
...
LINUX_dk_queueCommand(${DKCMAKE_BUILD} 
	"-DCMAKE_CXX_FLAGS=-I${ZLIB}/${OS}/Debug -I${PNG}/${OS}/Debug -I${TIFF}/${OS}/Debug -I${JPEG}/${OS}/Debug" 
...
ANDROID_dk_queueCommand(${DKCMAKE_BUILD} 
	"-DCMAKE_CXX_FLAGS=-I${JPEG}/${OS}/${DEBUG_DIR}/jni -I${FREETYPE}/include -I${PNG}/${OS}/${DEBUG_DIR}/jni -I${TIFF}/${OS}/${DEBUG_DIR}/jni -I${ZLIB}/${OS}/${DEBUG_DIR}/jni" 
