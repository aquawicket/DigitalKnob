...
if(WIN_HOST)
	...
	file(APPEND ${registerJDK11} "setx JAVA_VERSION ${JAVA_VERSION}\n")
	file(APPEND ${registerJDK11} "set JAVA_HOME=${OPENJDK_WINPATH}\n")
	file(APPEND ${registerJDK11} "setx JAVA_HOME ${OPENJDK_WINPATH}\n")
	file(APPEND ${registerJDK11} "setx VS_JavaHome ${OPENJDK_WINPATH}\n")
	file(APPEND ${registerJDK11} "setx STUDIO_JDK ${OPENJDK_WINPATH}\n")
	file(APPEND ${registerJDK11} "setx STUDIO_GRADLE_JDK ${OPENJDK_WINPATH}\n")
	file(APPEND ${registerJDK11} "reg add \"HKLM\\SOFTWARE\\JavaSoft\\Java Runtime Environment\" /v CurrentVersion /t REG_SZ /d ${JAVA_VERSION} /f\n")
	file(APPEND ${registerJDK11} "reg add \"HKLM\\SOFTWARE\\JavaSoft\\Java Runtime Environment\\${JAVA_VERSION}\" /v JavaHome /t REG_SZ /d \"${OPENJDK_WINPATH}\" /f\n")
	file(APPEND ${registerJDK11} "reg add \"HKLM\\SOFTWARE\\JavaSoft\\Java Runtime Environment\\${JAVA_VERSION}\" /v RuntimeLib /t REG_SZ /d \"${OPENJDK_WINPATH}\\bin\\server\\jvm.dll\" /f\n")
...
#dk_add_registry_key("HKLM/SOFTWARE/JavaSoft/Java Runtime Environment" "CurrentVersion" "${OPENJDK_11_VERSION}")
#dk_add_registry_key("HKLM/SOFTWARE/JavaSoft/Java Runtime Environment/${OPENJDK_11_VERSION}" "JavaHome" "${OPENJDK_11}")
#dk_add_registry_key("HKLM/SOFTWARE/JavaSoft/Java Runtime Environment/${OPENJDK_11_VERSION}" "RuntimeLib" "${OPENJDK_11}/bin/server/jvm.dll")