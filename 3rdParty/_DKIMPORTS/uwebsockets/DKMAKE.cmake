...
MAC64_COMMAND(${DKCMAKE_BUILD} ${ZLIB_CMAKE} ${LIBUV_APPLE} ${OPENSSL_APPLE} ${UWEBSOCKETS})
MAC_XCODE(${UWEBSOCKETS_NAME} libuWS)


IOS_PATH(${UWEBSOCKETS}/${OS})
IOS64_COMMAND(${DKCMAKE_BUILD} ${ZLIB_CMAKE} ${LIBUV_APPLE} ${OPENSSL_APPLE} ${UWEBSOCKETS})
IOS_XCODE(${UWEBSOCKETS_NAME} libuWS)


IOSSIM_PATH(${UWEBSOCKETS}/${OS})
IOSSIM64_COMMAND(${DKCMAKE_BUILD} ${ZLIB_CMAKE} ${LIBUV_APPLE} ${OPENSSL_APPLE} ${UWEBSOCKETS})
IOSSIM_XCODE(${UWEBSOCKETS_NAME} libuWS)


LINUX_DEBUG_PATH(${UWEBSOCKETS}/${OS}/${DEBUG_DIR})
LINUX_DEBUG_COMMAND(${DKCMAKE_BUILD} ${ZLIB_CMAKE} ${LIBUV_LINUX} ${OPENSSL_LINUX} ${UWEBSOCKETS})
LINUX_DEBUG_COMMAND(make uWebSockets)

LINUX_RELEASE_PATH(${UWEBSOCKETS}/${OS}/${RELEASE_DIR})
LINUX_RELEASE_COMMAND(${DKCMAKE_BUILD} ${ZLIB_CMAKE} ${LIBUV_LINUX} ${OPENSSL_LINUX} ${UWEBSOCKETS})
LINUX_RELEASE_COMMAND(make uWebSockets)


RASPBERRY_DEBUG_PATH(${UWEBSOCKETS}/${OS}/${DEBUG_DIR})
RASPBERRY_DEBUG_COMMAND(${DKCMAKE_BUILD} ${ZLIB_CMAKE} ${LIBUV_RASPBERRY} ${OPENSSL_RASPBERRY} ${UWEBSOCKETS})
RASPBERRY_DEBUG_COMMAND(make uWebSockets)

RASPBERRY_RELEASE_PATH(${UWEBSOCKETS}/${OS}/${RELEASE_DIR})
RASPBERRY_RELEASE_COMMAND(${DKCMAKE_BUILD} ${ZLIB_CMAKE} ${LIBUV_RASPBERRY} ${OPENSSL_RASPBERRY} ${UWEBSOCKETS})
RASPBERRY_RELEASE_COMMAND(make uWebSockets)


##ANDROID_NDK(${UWEBSOCKETS_NAME})
ANDROID_PATH(${UWEBSOCKETS}/${OS})
ANDROID32_COMMAND(${DKCMAKE_BUILD} ${ZLIB_CMAKE} ${LIBUV_ANDROID} ${OPENSSL_ANDROID} ${UWEBSOCKETS})
ANDROID64_COMMAND(${DKCMAKE_BUILD} ${ZLIB_CMAKE} ${LIBUV_ANDROID} ${OPENSSL_ANDROID} ${UWEBSOCKETS})
