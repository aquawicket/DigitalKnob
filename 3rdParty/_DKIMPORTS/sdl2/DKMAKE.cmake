...
MAC_PATH(${SDL2}/${OS})
MAC_COMMAND(${DKCMAKE_MAC64} -DSDL_SHARED=OFF -DVIDEO_OPENGLES=OFF -DHAVE_BUILTIN_ICONV=0 -DHAVE_LIBICONV=0 ${ICONV_APPLE} ${SDL2})
MAC_XCODE(${SDL2_NAME} SDL2-static)


IOS_PATH(${SDL2}/${OS})
IOS_COMMAND(${DKCMAKE_IOS64} -DSDL_SHARED=OFF -DVIDEO_OPENGLES=ON -DSDL_VIDEO_RENDER_OGL=ON -DSDL_JOYSTICK=OFF -DSDL_HAPTIC=OFF ${SDL2})
IOS_XCODE(${SDL2_NAME} SDL2-static)


IOSSIM_PATH(${SDL2}/${OS})
IOSSIM_COMMAND(${DKCMAKE_IOSSIM64} -DSDL_SHARED=OFF -DVIDEO_OPENGLES=ON -DSDL_VIDEO_RENDER_OGL=ON -DSDL_JOYSTICK=OFF -DSDL_HAPTIC=OFF ${SDL2})
