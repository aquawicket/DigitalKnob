...
### COMPILE ###
WIN_PATH(${SDL2}/${OS})
WIN32_COMMAND(${DKCMAKE_WIN32} -DSDL_SHARED=OFF -DVIDEO_OPENGLES=OFF -DDIRECTX=OFF -DHAVE_LIBC -DLIBC=ON ${SDL2})
WIN64_COMMAND(${DKCMAKE_WIN64} -DSDL_SHARED=OFF -DVIDEO_OPENGLES=OFF -DDIRECTX=OFF -DHAVE_LIBC -DLIBC=ON ${SDL2})
...
IOS_PATH(${SDL2}/${OS})
#IOS_COMMAND(${DKCMAKE_IOS64} -DSDL_SHARED=OFF -DVIDEO_OPENGLES=ON -DSDL_JOYSTICK=OFF -DSDL_HAPTIC=OFF ${SDL2})   #2.0.16
IOS_COMMAND(${DKCMAKE_IOS64} -DSDL_SHARED=OFF -DSDL_OPENGLES=ON -DSDL_METAL=ON -DSDL_JOYSTICK=OFF -DSDL_HAPTIC=OFF ${SDL2})   #2.0.18
IOS_XCODE(${SDL2_NAME} SDL2-static)


IOSSIM_PATH(${SDL2}/${OS})
#IOSSIM_COMMAND(${DKCMAKE_IOSSIM64} -DSDL_SHARED=OFF -DVIDEO_OPENGLES=ON -DSDL_JOYSTICK=OFF -DSDL_HAPTIC=OFF ${SDL2})   #2.0.16
IOSSIM_COMMAND(${DKCMAKE_IOSSIM64} -DSDL_SHARED=OFF -DSDL_OPENGLES=ON -DSDL_METAL=ON -DSDL_JOYSTICK=OFF -DSDL_HAPTIC=OFF ${SDL2})   #2.0.18
