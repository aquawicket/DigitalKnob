...
if(USE_SDL2main)
	IOS_DEBUG_LIB(${SDL2}/${OS}/${DEBUG_DIR}/libSDL2maind.lib)
	IOS_RELEASE_LIB(${SDL2}/${OS}/${RELEASE_DIR}/libSDL2main.lib)
endif()
IOSSIM_DEBUG_LIB(${SDL2}/${OS}/${DEBUG_DIR}/libSDL2d.a)
IOSSIM_RELEASE_LIB(${SDL2}/${OS}/${RELEASE_DIR}/libSDL2.a)
if(USE_SDL2main)
	IOSSIM_DEBUG_LIB(${SDL2}/${OS}/${DEBUG_DIR}/SDL2maind.lib)
	IOSSIM_RELEASE_LIB(${SDL2}/${OS}/${RELEASE_DIR}/SDL2main.lib)
endif()
...
DKSET(SDL2_APPLE_MAIN	
	-DSDL2MAIN_LIBRARY_DEBUG=${SDL2}/${OS}/${DEBUG_DIR}/libSDL2maind.lib
	-DSDL2MAIN_LIBRARY_RELEASE=${SDL2}/${OS}/${RELEASE_DIR}/libSDL2main.lib)
...
### COMPILE ###
WIN_PATH(${SDL2}/${OS})
WIN32_COMMAND(${DKCMAKE_WIN32} -DSDL_SHARED=OFF -DSDL_LIBC=ON ${SDL2})
WIN64_COMMAND(${DKCMAKE_WIN64} -DSDL_SHARED=OFF -DSDL_LIBC=ON ${SDL2})
...
if(MAC)
	string(REPLACE "-std=c17 " " " DKCMAKE_MAC64_SDL2 "${DKCMAKE_MAC64}")
endif()
MAC_PATH(${SDL2}/${OS})
MAC64_COMMAND(${DKCMAKE_MAC64_SDL2} -DSDL_SHARED=OFF -DSDL_OPENGL=ON -DSDL_METAL=ON -DHAVE_BUILTIN_ICONV=0 -DHAVE_LIBICONV=0 ${ICONV_APPLE} ${SDL2})
