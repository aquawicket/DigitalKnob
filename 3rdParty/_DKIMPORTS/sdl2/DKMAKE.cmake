...
MAC_PATH(${SDL2}/${OS})
MAC_COMMAND(${DKCMAKE_MAC64} -DSDL_SHARED=OFF -DVIDEO_OPENGLES=OFF -DVIDEO_OPENGL=ON -DVIDEO_METAL=ON -DHAVE_BUILTIN_ICONV=0 -DHAVE_LIBICONV=0 ${ICONV_APPLE} ${SDL2})
...
ANDROID32_COMMAND(${DKCMAKE_ANDROID32} -DLIBTYPE=STATIC -DSDL_SHARED=OFF -DHIDAPI=OFF -DSDL_ATOMIC=OFF ${SDL2})
