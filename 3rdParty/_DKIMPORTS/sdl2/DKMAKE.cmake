...
MAC_PATH(${SDL2}/${OS})
MAC32_COMMAND(${DKCMAKE_MAC32} -DSDL_SHARED=OFF -DVIDEO_OPENGLES=OFF -DDIRECTX=OFF -DHAVE_BUILTIN_ICONV=0 -DHAVE_LIBICONV=0 ${ICONV_APPLE} ${SDL2})
MAC64_COMMAND(${DKCMAKE_MAC64} -DSDL_SHARED=OFF -DVIDEO_OPENGLES=OFF -DHAVE_BUILTIN_ICONV=0 -DHAVE_LIBICONV=0 ${ICONV_APPLE} ${SDL2})
MAC_XCODE(${SDL2_NAME} SDL2-static)


IOS_PATH(${SDL2}/${OS})
IOS32_COMMAND(${DKCMAKE_IOS32} -DDIRECTX=OFF -DSDL_JOYSTICK=OFF -DSDL_HAPTIC=OFF ${SDL2})
IOS64_COMMAND(${DKCMAKE_IOS64} -DSDL_JOYSTICK=OFF -DSDL_HAPTIC=OFF ${SDL2})
IOS_XCODE(${SDL2_NAME} SDL2-static)


IOSSIM_PATH(${SDL2}/${OS})
IOSSIM32_COMMAND(${DKCMAKE_IOSSIM32} -DDIRECTX=OFF -DSDL_JOYSTICK=OFF -DSDL_HAPTIC=OFF ${SDL2})
IOSSIM64_COMMAND(${DKCMAKE_IOSSIM64} -DSDL_JOYSTICK=OFF -DSDL_HAPTIC=OFF ${SDL2})
...
ANDROID32_COMMAND(${DKCMAKE_ANDROID32} -DLIBTYPE=STATIC -DSDL_SHARED=OFF -DVIDEO_OPENGLES=ON -DHIDAPI=OFF -DSDL_ATOMIC=OFF ${SDL2})
ANDROID64_COMMAND(${DKCMAKE_ANDROID64} -DLIBTYPE=STATIC -DSDL_SHARED=OFF -DVIDEO_OPENGLES=ON -DHIDAPI=OFF -DSDL_ATOMIC=OFF ${SDL2})
