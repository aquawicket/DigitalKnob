...
MAC_PATH(${SDL2}/${OS})
MAC32_COMMAND(${DKCMAKE_MAC32} -DSDL_SHARED=OFF -DVIDEO_OPENGLES=OFF -DDIRECTX=OFF -DLIBC=ON ${ICONV_APPLE} ${SDL2})
MAC64_COMMAND(${DKCMAKE_MAC64} -DSDL_SHARED=OFF -DVIDEO_OPENGLES=OFF -DDIRECTX=OFF -DLIBC=ON ${ICONV_APPLE} ${SDL2})
