...
# -DHAVE_BUILTIN_ICONV=0 -DHAVE_LIBICONV=0 ${ICONV_APPLE} 
if(MAC)
	string(REPLACE "-std=c17 " " " DKCMAKE_MAC64_SDL2 "${DKCMAKE_MAC64}")
endif()

MAC_PATH(${SDL2}/${OS})
MAC64_COMMAND(${DKCMAKE_MAC64_SDL2} -DSDL_SHARED=OFF -DSDL_OPENGL=ON -DSDL_METAL=ON ${SDL2}) #-DSDL_JOYSTICK=OFF -DSDL_HAPTIC=OFF 
