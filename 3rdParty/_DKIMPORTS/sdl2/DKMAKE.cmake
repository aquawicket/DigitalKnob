...
IOS_PATH(${SDL2}/${OS})
IOS_COMMAND(${DKCMAKE_IOS64} -DSDL_SHARED=OFF -DVIDEO_OPENGLES=ON -DSDL_JOYSTICK=OFF -DSDL_HAPTIC=OFF ${SDL2})
IOS_XCODE(${SDL2_NAME} SDL2-static)


IOSSIM_PATH(${SDL2}/${OS})
IOSSIM_COMMAND(${DKCMAKE_IOSSIM64} -DSDL_SHARED=OFF -DVIDEO_OPENGLES=ON -DSDL_JOYSTICK=OFF -DSDL_HAPTIC=OFF ${SDL2})
