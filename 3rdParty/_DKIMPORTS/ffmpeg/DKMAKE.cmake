...
set(FFMPEG_CONFIGURE "${DKCONFIGURE_BUILD}")
string(REPLACE "CFLAGS=-DMAC -DMAC64 -std=c17" "" FFMPEG_CONFIGURE "${FFMPEG_CONFIGURE}")
string(REPLACE "CXXFLAGS=-DMAC -DMAC64 -std=c++17" "" FFMPEG_CONFIGURE "${FFMPEG_CONFIGURE}")
#string(REPLACE "-DMAC64" "" FFMPEG_CONFIGURE "${FFMPEG_CONFIGURE}")
#string(REPLACE "-std=c17" "" FFMPEG_CONFIGURE "${FFMPEG_CONFIGURE}")
