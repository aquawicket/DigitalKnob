...
### COMPILE ###
WIN_DKSETPATH(${WEBSOCKETS}/${OS})
WIN32_DKQCOMMAND(${DKCMAKE_BUILD} -LWS_WITH_SSL=OFF ${WEBSOCKETS})
WIN64_DKQCOMMAND(${DKCMAKE_BUILD} -LWS_WITH_SSL=OFF ${WEBSOCKETS})
WIN_VS(${WEBSOCKETS_NAME} libwebsockets.sln websockets)

DKSETPATH(${WEBSOCKETS}/${OS}/Debug)
LINUX_DEBUG_DKQCOMMAND(${DKCMAKE_BUILD} -DLWS_WITH_SSL=OFF ${WEBSOCKETS})
LINUX_DEBUG_DKQCOMMAND(make)

DKSETPATH(${WEBSOCKETS}/${OS}/${RELEASE_DIR})
LINUX_RELEASE_DKQCOMMAND(${DKCMAKE_BUILD} -DLWS_WITH_SSL=OFF ${WEBSOCKETS})
