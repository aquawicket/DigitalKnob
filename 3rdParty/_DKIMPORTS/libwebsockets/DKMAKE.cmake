...
DKSET(WEBSOCKETS_VERSION ${WEBSOCKETS_MAJOR_VERSION}.${WEBSOCKETS_MINOR_VERSION}.${WEBSOCKETS_BUILD_VERSION})
DKSET(WEBSOCKETS_NAME libwebsockets-${WEBSOCKETS_VERSION})
DKSET(WEBSOCKETS ${3RDPARTY}/${WEBSOCKETS_NAME})


### INSTALL ###
DKINSTALL(https://github.com/warmcat/libwebsockets/archive/v${WEBSOCKETS_MAJOR_VERSION}.${WEBSOCKETS_MINOR_VERSION}.${WEBSOCKETS_BUILD_VERSION}.zip libwebsockets ${WEBSOCKETS_NAME})
...
LINUX_DEBUG_LIB(${WEBSOCKETS}/linux64/${DEBUG_DIR}/lib/libwebsockets.a)
