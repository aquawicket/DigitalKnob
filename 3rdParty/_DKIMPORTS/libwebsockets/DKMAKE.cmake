...
WIN32_COMMAND(${DKCMAKE_BUILD} -LWS_WITH_SSL=OFF ${WEBSOCKETS})
WIN64_COMMAND(${DKCMAKE_BUILD} -LWS_WITH_SSL=OFF ${WEBSOCKETS})
WIN_VS(${WEBSOCKETS_NAME} libwebsockets.sln websockets)

DKSETPATH(${WEBSOCKETS}/${OS}/Debug)
LINUX_DEBUG_COMMAND(${DKCMAKE_BUILD} -DLWS_WITH_SSL=OFF ${WEBSOCKETS})
LINUX_DEBUG_COMMAND(make)

DKSETPATH(${WEBSOCKETS}/${OS}/${RELEASE_DIR})
LINUX_RELEASE_COMMAND(${DKCMAKE_BUILD} -DLWS_WITH_SSL=OFF ${WEBSOCKETS})
