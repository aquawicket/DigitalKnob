...
if(ANDROID)
	ANDROID_dk_libDebug		(${OGG}/${OS}/${DEBUG_DIR}/libogg.a		OGG_LIBRARY_DEBUG)
	ANDROID_dk_libRelease	(${OGG}/${OS}/${RELEASE_DIR}/libogg.a		OGG_LIBRARY_RELEASE)
else()
...
### GENERATE ###
if(ANDROID)
	dk_queueCommand(${DKCMAKE_BUILD} ${OGG})
else()
