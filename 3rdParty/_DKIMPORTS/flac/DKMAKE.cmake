...
IOS_DEBUG_COMMAND(../../configure --disable-shared --enable-static ${OGG_APPLE_DEBUG})
IOS_DEBUG_COMMAND(make)
IOS_RELEASE_PATH(${FLAC}/${OS}/${RELEASE_DIR})
IOS_RELEASE_COMMAND(../../configure --disable-shared --enable-static ${OGG_APPLE_RELEASE})
IOS_RELEASE_COMMAND(make)


IOSSIM_DEBUG_PATH(${FLAC}/${OS}/${DEBUG_DIR})
IOSSIM_DEBUG_COMMAND(../../configure --disable-shared --enable-static ${OGG_APPLE_DEBUG})
IOSSIM_DEBUG_COMMAND(make)
IOSSIM_RELEASE_PATH(${FLAC}/${OS}/${RELEASE_DIR})
IOSSIM_RELEASE_COMMAND(../../configure --disable-shared --enable-static ${OGG_APPLE_RELEASE})
