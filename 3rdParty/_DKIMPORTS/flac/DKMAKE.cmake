...
MAC64_DEBUG_COMMAND(${DKCONFIGURE_MAC64} CC=${XCODE_CLANG} CXX=${XCODE_CLANGXX})# ${OGG_APPLE_DEBUG})
MAC64_DEBUG_COMMAND(make)
MAC64_RELEASE_PATH(${FLAC}/${OS}/${RELEASE_DIR})
MAC64_RELEASE_COMMAND(${DKCONFIGURE_MAC64} CC=${XCODE_CLANG} CXX=${XCODE_CLANGXX})# ${OGG_APPLE_RELEASE})
...
IOSSIM_DEBUG_COMMAND(${DKCONFIGURE_IOSSIM64} ${OGG_APPLE_RELEASE})
