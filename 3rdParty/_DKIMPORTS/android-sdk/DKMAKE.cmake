...
DKSET(ANDROIDIMAGES_VERSION android-30)
...
if(CMAKE_HOST_WIN32)
	...
	if(NOT EXISTS ${ANDROIDSDK}/system-images/${ANDROIDIMAGES_VERSION}/google_apis/armeabi-v7a)
		message("Installing Android API Sources: ${ANDROIDIMAGES_VERSION} armeabi-v7a")
	...
	if(NOT EXISTS ${ANDROIDSDK}/system-images/${ANDROIDIMAGES_VERSION}/google_apis/arm64-v8a)
		message("Installing Android API Sources: ${ANDROIDIMAGES_VERSION} arm64-v8a")
	...
	if(NOT EXISTS ${ANDROIDSDK}/system-images/${ANDROIDIMAGES_VERSION}/google_apis/x86)
		message("Installing Android API Sources: ${ANDROIDIMAGES_VERSION} x86")
	...
	if(NOT EXISTS ${ANDROIDSDK}/system-images/${ANDROIDIMAGES_VERSION}/google_apis/x86_64)
		message("Installing Android API Sources: ${ANDROIDIMAGES_VERSION} x86_64")
