...
if(0)
	...
	if(WIN_HOST)
		if(EXISTS "$ENV{DKIMPORTS_DIR}/openjdk-8/registerJDK.cmd")
			dk_executeProcess(call "$ENV{DKIMPORTS_DIR}/openjdk-8/registerJDK.cmd")
		endif()
		...
		if(EXISTS "$ENV{DKIMPORTS_DIR}/android-sdk/SignLicenses.cmd")
			dk_executeProcess(call "$ENV{DKIMPORTS_DIR}/android-sdk/SignLicenses.cmd")
		endif()
		
		if(EXISTS "$ENV{DKIMPORTS_DIR}/openjdk/registerJDK.cmd")
			dk_executeProcess(call "$ENV{DKIMPORTS_DIR}/openjdk/registerJDK.cmd")
		endif()
	endif()
	
	if(UNIX_HOST)
		if(EXISTS "$ENV{DKIMPORTS_DIR}/android-sdk/SignLicenses.sh")
			dk_executeProcess(chmod 777 "$ENV{DKIMPORTS_DIR}/android-sdk/SignLicenses.sh")
			dk_executeProcess("$ENV{DKIMPORTS_DIR}/android-sdk/SignLicenses.sh")
		endif()
	endif()
endif()
