...
DKSET(SDKMANAGER_EXE ${ANDROIDSDK}/cmdline-tools/latest/bin/sdkmanager.bat)
...
if(CMAKE_HOST_WIN32)
	...
	DKSETPATH(${ANDROIDSDK}/cmdline-tools/latest/bin)
	DKEXECUTE_PROCESS(COMMAND sdkmanager WORKING_DIRECTORY ${ANDROIDSDK}/cmdline-tools/latest/bin)
	WaitForEnter()
	if(NOT EXISTS ${ANDROIDSDK}/build-tools/${ANDROIDBUILDTOOLS_VERSION})
		...
		DKEXECUTE_PROCESS(COMMAND cmd /c ${ARGUMNTS} WORKING_DIRECTORY ${ANDROIDSDK}/cmdline-tools/latest/bin)
		WaitForEnter()
	endif()
#	if(NOT EXISTS ${ANDROIDSDK}/build-tools/${ANDROIDBUILDTOOLS_VERSION})
