...
if(NOT $ENV{ANDROID_SDK_ROOT} MATCHES ${ANDROIDSDK})
	set(ENV{ANDROID_SDK_ROOT} ${ANDROIDSDK})
endif()
...
if(CMAKE_HOST_WIN32)
	...
	#	set(ARGUMNTS "${ANDROIDSDK}/bin/sdkmanager ndk\\;${ANDROIDNDK_BUILD} platforms\\;${ANDROIDPLATFORM_VERSION} build-tools\\;${ANDROIDBUILDTOOLS_VERSION} --sdk_root=${ANDROIDSDK}")
	...
	if(NOT EXISTS ${ANDROIDSDK}/system-images/android-26/google_apis/x86)
		message("Installing Android API Sources: ${ANDROIDSOURCES_VERSION}")
		DKSET(QUEUE_BUILD ON)
		set(ARGUMNTS "${SDKMANAGER_EXE} --install system-images\\;android-26\\;google_apis\\;x86 --sdk_root=${ANDROIDSDK}")
		separate_arguments(ARGUMNTS)
		execute_process(COMMAND cmd /c ${ARGUMNTS} WORKING_DIRECTORY ${ANDROIDSDK}/bin)
	endif()
	if(NOT EXISTS ${ANDROIDSDK}/system-images/android-26/google_apis/x86_64)
		message("Installing Android API Sources: ${ANDROIDSOURCES_VERSION}")
		DKSET(QUEUE_BUILD ON)
		set(ARGUMNTS "${SDKMANAGER_EXE} --install system-images\\;android-26\\;google_apis\\;x86_64 --sdk_root=${ANDROIDSDK}")
		separate_arguments(ARGUMNTS)
		execute_process(COMMAND cmd /c ${ARGUMNTS} WORKING_DIRECTORY ${ANDROIDSDK}/bin)
	endif()
