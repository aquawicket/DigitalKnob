...
dk_include				(${LIBICONV.Config_Dir})
if(Debug)
	dk_include			(${LIBICONV.Debug_Dir})
endif()
if(Release)
	dk_include			(${LIBICONV.Release_Dir})
endif()

# libcharset
if(MSVC)
	if(Windows)
		dk_libDebug		(${LIBICONV.Debug_Dir}/charset.lib		LIBICONV_CHARSET_LIBRARY_DEBUG)
		dk_libRelease	(${LIBICONV.Release_Dir}/charset.lib	LIBICONV_CHARSET_LIBRARY_RELEASE)
	endif()
else()
	dk_libDebug			(${LIBICONV.Debug_Dir}/libcharset.a		LIBICONV_CHARSET_LIBRARY_DEBUG)
	dk_libRelease		(${LIBICONV.Release_Dir}/libcharset.a	LIBICONV_CHARSET_LIBRARY_RELEASE)
endif()

#libiconv
if(MSVC)
	if(Windows)
		dk_libDebug		(${LIBICONV.Debug_Dir}/iconv.lib		LIBICONV_LIBRARY_DEBUG)
		dk_libRelease	(${LIBICONV.Release_Dir}/iconv.lib		LIBICONV_LIBRARY_RELEASE)
	endif()
else()
	dk_libDebug			(${LIBICONV.Debug_Dir}/libiconv.a		LIBICONV_LIBRARY_DEBUG)
	dk_libRelease		(${LIBICONV.Release_Dir}/libiconv.a		LIBICONV_LIBRARY_RELEASE)
endif()
