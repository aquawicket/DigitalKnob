...
### COMPILE ###
WIN_PATH(${ICONV}/${OS})
WIN32_COMMAND(${DKCMAKE_BUILD} ${ICONV})
WIN64_COMMAND(${DKCMAKE_BUILD} ${ICONV})
WIN_VS(${ICONV_NAME} libiconv.sln iconv)


MAC_PATH(${ICONV}/${OS})
MAC32_COMMAND(${DKCMAKE_BUILD} ${ICONV})
MAC64_COMMAND(${DKCMAKE_BUILD} ${ICONV})
MAC_XCODE(${ICONV_NAME} iconv)


IOS_PATH(${ICONV}/${OS})
IOS32_COMMAND(${DKCMAKE_BUILD} ${ICONV})
IOS64_COMMAND(${DKCMAKE_BUILD} ${ICONV})
IOS_XCODE(${ICONV_NAME} iconv)


IOSSIM_PATH(${ICONV}/${OS})
IOSSIM32_COMMAND(${DKCMAKE_BUILD} ${ICONV})
IOSSIM64_COMMAND(${DKCMAKE_BUILD} ${ICONV})
IOSSIM_XCODE(${ICONV_NAME} iconv)


LINUX_DEBUG_PATH(${ICONV}/${OS}/${DEBUG_DIR})
LINUX_DEBUG_COMMAND(${DKCMAKE_BUILD} ${ICONV})
LINUX_DEBUG_COMMAND(make iconv)
LINUX_RELEASE_PATH(${ICONV}/${OS}/${RELEASE_DIR})
LINUX_RELEASE_COMMAND(${DKCMAKE_BUILD} ${ICONV})
LINUX_RELEASE_COMMAND(make iconv)


RASPBERRY_DEBUG_PATH(${ICONV}/${OS}/${DEBUG_DIR})
RASPBERRY_DEBUG_COMMAND(${DKCMAKE_BUILD} ${ICONV})
RASPBERRY_DEBUG_COMMAND(make iconv)
RASPBERRY_RELEASE_PATH(${ICONV}/${OS}/${RELEASE_DIR})
RASPBERRY_RELEASE_COMMAND(${DKCMAKE_BUILD} ${ICONV})
RASPBERRY_RELEASE_COMMAND(make iconv)


ANDROID_PATH(${ICONV}/${OS})
ANDROID32_COMMAND(${DKCMAKE_BUILD} ${ICONV})
ANDROID64_COMMAND(${DKCMAKE_BUILD} ${ICONV})
