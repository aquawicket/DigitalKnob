...
ANDROID_TARGET_dk_include		(${LIBICONV}/${OS}/$(BUILD_TYPE)/jni)

# libcharset
if(MSVC)
	WIN_TARGET_dk_libDebug		(${LIBICONV}/${OS}/${DEBUG_DIR}/charset.lib		LIBICONV_CHARSET_LIBRARY_DEBUG)
	WIN_TARGET_dk_libRelease	(${LIBICONV}/${OS}/${RELEASE_DIR}/charset.lib	LIBICONV_CHARSET_LIBRARY_RELEASE)
else()
...
#libiconv
if(MSVC)
	WIN_TARGET_dk_libDebug		(${LIBICONV}/${OS}/${DEBUG_DIR}/iconv.lib		LIBICONV_LIBRARY_DEBUG)
	WIN_TARGET_dk_libRelease	(${LIBICONV}/${OS}/${RELEASE_DIR}/iconv.lib		LIBICONV_LIBRARY_RELEASE)
else()
