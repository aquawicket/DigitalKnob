...
IOSSIM_DEBUG_COMMAND(${DKCONFIGURE_IOSSIM64} --with-ogg-includes=${OGG}/include ${OGG_APPLE_DEBUG})
IOSSIM_DEBUG_COMMAND(make)
IOSSIM_RELEASE_PATH(${VORBIS}/${OS}/${RELEASE_DIR})
IOSSIM_DEBUG_COMMAND(${DKCONFIGURE_IOSSIM64} --with-ogg-includes=${OGG}/include ${OGG_APPLE_RELEASE})
...
RASPBERRY_DEBUG_COMMAND(${DKCONFIGURE_RASPBERRY} ${OGG_RASPBERRY_DEBUG})
RASPBERRY_DEBUG_COMMAND(make)
if(RASPBERRY AND RELEASE)
	set(ENV{PKG_CONFIG_PATH} "${OGG}/${OS}/${RELEASE_DIR}")
endif()
RASPBERRY_RELEASE_PATH(${VORBIS}/${OS}/${RELEASE_DIR})
RASPBERRY_RELEASE_COMMAND(${DKCONFIGURE_RASPBERRY} ${OGG_RASPBERRY_RELEASE})
