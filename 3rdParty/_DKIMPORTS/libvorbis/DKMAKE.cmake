...
LINUX_DEBUG_COMMAND(${DKCONFIGURE_LINUX} --with-ogg-libraries=${OGG}/${OS}/${DEBUG_DIR}/src/.libs)
LINUX_DEBUG_COMMAND(make)
if(LINUX)
	set(ENV{PKG_CONFIG_PATH} "${OGG}/${OS}/${RELEASE_DIR}")
endif()
LINUX_RELEASE_PATH(${VORBIS}/${OS}/${RELEASE_DIR})
LINUX_RELEASE_COMMAND(${DKCONFIGURE_LINUX} CPPFLAGS=-I${OGG}/${OS}/${RELEASE_DIR}/include --with-ogg-libraries=${OGG}/${OS}/${RELEASE_DIR}/src/.libs)
