...
LINUX_DEBUG_COMMAND(${DKCONFIGURE_LINUX} --with-ogg-includes=${OGG}/include ${OGG_LINUX_DEBUG})
LINUX_DEBUG_COMMAND(make)
if(LINUX)
	set(ENV{PKG_CONFIG_PATH} "${OGG}/${OS}/${RELEASE_DIR}")
endif()
LINUX_RELEASE_PATH(${VORBIS}/${OS}/${RELEASE_DIR})
LINUX_RELEASE_COMMAND(${DKCONFIGURE_LINUX} --with-ogg-includes=${OGG}/include ${OGG_LINUX_RELEASE})
