...
WIN32_DEBUG_MSYS(${DKCONFIGURE_WIN32} ${OGG_WIN_DEBUG})
WIN32_DEBUG_MSYS(make)
WIN32_RELEASE_PATH(${VORBIS}/${OS}/${RELEASE_DIR})
WIN32_RELEASE_MSYS(${DKCONFIGURE_WIN32} ${OGG_WIN_RELEASE})
WIN32_RELEASE_MSYS(make)


WIN64_DEBUG_PATH(${VORBIS}/${OS}/${DEBUG_DIR})
WIN64_DEBUG_MSYS(${DKCONFIGURE_WIN64} ${OGG_WIN_DEBUG})
WIN64_DEBUG_MSYS(make)
WIN64_RELEASE_PATH(${VORBIS}/${OS}/${RELEASE_DIR})
WIN64_RELEASE_MSYS(${DKCONFIGURE_WIN64} ${OGG_WIN_RELEASE})
WIN64_RELEASE_MSYS(make)


MAC_DEBUG_PATH(${VORBIS}/${OS}/${DEBUG_DIR})
MAC_DEBUG_COMMAND(${DKCONFIGURE_MAC64} ${OGG_APPLE_DEBUG})
MAC_DEBUG_COMMAND(make)
MAC_RELEASE_PATH(${VORBIS}/${OS}/${RELEASE_DIR})
MAC_RELEASE_COMMAND(${DKCONFIGURE_MAC64} ${OGG_APPLE_RELEASE})
...
IOS_DEBUG_COMMAND(${DKCONFIGURE_IOS64} ${OGG_APPLE_RELEASE})
...
#ANDROID_DEBUG_MSYS(${DKCONFIGURE_ANDROID} ${OGG_ANDROID_DEBUG})
#ANDROID_DEBUG_MSYS(make)
#if(ANDROID)
#	set(ENV{PKG_CONFIG_PATH} "${OGG}/${OS}/${RELEASE_DIR}")
#endif()
#ANDROID_RELEASE_PATH(${VORBIS}/${OS}/${RELEASE_DIR})
#ANDROID_RELEASE_MSYS(${DKCONFIGURE_ANDROID} ${OGG_ANDROID_RELEASE})
