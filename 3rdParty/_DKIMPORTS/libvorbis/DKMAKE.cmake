...
LINUX_DEBUG_COMMAND(${DKCONFIGURE_BUILD} ${OGG_LINUX_DEBUG})
LINUX_DEBUG_COMMAND(make)
if(LINUX AND RELEASE)
	set(ENV{PKG_CONFIG_PATH} "${OGG}/${OS}/${RELEASE_DIR}")
endif()
LINUX_RELEASE_PATH(${VORBIS}/${OS}/${RELEASE_DIR})
LINUX_RELEASE_COMMAND(${DKCONFIGURE_BUILD} ${OGG_LINUX_RELEASE})
...
RASPBERRY_DEBUG_COMMAND(${DKCONFIGURE_BUILD} ${OGG_RASPBERRY_DEBUG})
RASPBERRY_DEBUG_COMMAND(make)
if(RASPBERRY AND RELEASE)
	set(ENV{PKG_CONFIG_PATH} "${OGG}/${OS}/${RELEASE_DIR}")
endif()
RASPBERRY_RELEASE_PATH(${VORBIS}/${OS}/${RELEASE_DIR})
RASPBERRY_RELEASE_COMMAND(${DKCONFIGURE_BUILD} ${OGG_RASPBERRY_RELEASE})
