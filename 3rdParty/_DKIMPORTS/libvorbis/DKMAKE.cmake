...
WIN32_DEBUG_MSYS(${DKCONFIGURE_WIN32} --with-ogg-includes=${OGG}/include ${OGG_WIN_DEBUG})
WIN32_DEBUG_MSYS(make)
WIN32_RELEASE_PATH(${VORBIS}/${OS}/${RELEASE_DIR})
WIN32_RELEASE_MSYS(${DKCONFIGURE_WIN32} --with-ogg-includes=${OGG}/include ${OGG_WIN_RELEASE})
WIN32_RELEASE_MSYS(make)


WIN64_DEBUG_PATH(${VORBIS}/${OS}/${DEBUG_DIR})
WIN64_DEBUG_MSYS(${DKCONFIGURE_WIN64} --with-ogg-includes=${OGG}/include ${OGG_WIN_DEBUG})
WIN64_DEBUG_MSYS(make)
WIN64_RELEASE_PATH(${VORBIS}/${OS}/${RELEASE_DIR})
WIN64_RELEASE_MSYS(${DKCONFIGURE_WIN64} --with-ogg-includes=${OGG}/include ${OGG_WIN_RELEASE})
WIN64_RELEASE_MSYS(make)


MAC_DEBUG_PATH(${VORBIS}/${OS}/${DEBUG_DIR})
MAC_DEBUG_COMMAND(${DKCONFIGURE_MAC64} --with-ogg-includes=${OGG}/include ${OGG_APPLE_DEBUG})
MAC_DEBUG_COMMAND(make)
MAC_RELEASE_PATH(${VORBIS}/${OS}/${RELEASE_DIR})
MAC_RELEASE_COMMAND(${DKCONFIGURE_MAC64} --with-ogg-includes=${OGG}/include ${OGG_APPLE_RELEASE})
...
IOSSIM_DEBUG_COMMAND(${DKCONFIGURE_IOS64} --with-ogg-includes=${OGG}/include ${OGG_APPLE_DEBUG})
IOSSIM_DEBUG_COMMAND(make)
IOSSIM_RELEASE_PATH(${VORBIS}/${OS}/${RELEASE_DIR})
IOSSIM_DEBUG_COMMAND(${DKCONFIGURE_IOS64} --with-ogg-includes=${OGG}/include ${OGG_APPLE_RELEASE})
...
LINUX_DEBUG_COMMAND(${DKCONFIGURE_LINUX} --with-ogg-includes="${OGG}/include ${OGG}/${OS}/${DEBUG_DIR}/include" --with-ogg-libraries=${OGG}/${OS}/${DEBUG_DIR}/src/.libs)
LINUX_DEBUG_COMMAND(make)
if(LINUX)
	set(ENV{PKG_CONFIG_PATH} "${OGG}/${OS}/${RELEASE_DIR}")
endif()
LINUX_RELEASE_PATH(${VORBIS}/${OS}/${RELEASE_DIR})
LINUX_RELEASE_COMMAND(${DKCONFIGURE_LINUX} --with-ogg-includes="${OGG}/include ${OGG}/${OS}/${DEBUG_DIR}/include" --with-ogg-libraries=${OGG}/${OS}/${RELEASE_DIR}/src/.libs)
...
RASPBERRY_DEBUG_COMMAND(${DKCONFIGURE_RASPBERRY} --with-ogg-includes=${OGG}/include ${OGG_RASPBERRY_DEBUG})
RASPBERRY_DEBUG_COMMAND(make)
if(RASPBERRY)
	set(ENV{PKG_CONFIG_PATH} "${OGG}/${OS}/${RELEASE_DIR}")
endif()
RASPBERRY_RELEASE_PATH(${VORBIS}/${OS}/${RELEASE_DIR})
RASPBERRY_RELEASE_COMMAND(${DKCONFIGURE_RASPBERRY} --with-ogg-includes=${OGG}/include ${OGG_RASPBERRY_RELEASE})
...
#ANDROID_DEBUG_MSYS(${DKCONFIGURE_ANDROID} --with-ogg-includes=${OGG}/include ${OGG_ANDROID_DEBUG})
#ANDROID_DEBUG_MSYS(make)
#if(ANDROID)
#	set(ENV{PKG_CONFIG_PATH} "${OGG}/${OS}/${RELEASE_DIR}")
#endif()
#ANDROID_RELEASE_PATH(${VORBIS}/${OS}/${RELEASE_DIR})
#ANDROID_RELEASE_MSYS(${DKCONFIGURE_ANDROID} --with-ogg-includes=${OGG}/include ${OGG_ANDROID_RELEASE})
