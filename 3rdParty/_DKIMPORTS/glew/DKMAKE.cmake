...
if(MSVC)
	WIN_TARGET_dk_libDebug		(${GLEW}/${OS}/lib/${DEBUG_DIR}/libglew32d.lib		GLEW_LIBRARY_DEBUG)
	WIN_TARGET_dk_libRelease	(${GLEW}/${OS}/lib/${RELEASE_DIR}/libglew32.lib		GLEW_LIBRARY_RELEASE)
elseif(APPLE)
...
if(MSVC)
	WIN_TARGET_dk_set	(GLEW_CMAKE "-DCMAKE_C_FLAGS=/I${GLEW}/include /DGLEW_STATIC" "-DCMAKE_CXX_FLAGS=/I${GLEW_INCLUDE_DIR} /DGLEW_STATIC" -DGLEW_INCLUDE_DIR=${GLEW_INCLUDE_DIR} -DGLEW_LIBRARY=${GLEW_LIBRARY_DEBUG})
else()
