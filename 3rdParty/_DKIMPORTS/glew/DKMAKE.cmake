...
LINUX_DEBUG_LIB(${GLEW}/${OS}/lib/${DEBUG_DIR}/libGLEWd.a)
LINUX_RELEASE_LIB(${GLEW}/${OS}/lib/${RELEASE_DIR}/libGLEW.a)
RASPBERRY_DEBUG_LIB(${GLEW}/${OS}/lib/${DEBUG_DIR}/libGLEWd.a)
RASPBERRY_RELEASE_LIB(${GLEW}/${OS}/lib/${RELEASE_DIR}/libGLEW.a)
...
LINUX_DEBUG_COMMAND(${DKCMAKE_LINUX_DEBUG} ${GLEW})
LINUX_DEBUG_COMMAND(make GLEW)
LINUX_RELEASE_PATH(${GLEW}/${OS}/${RELEASE_DIR})
LINUX_RELEASE_COMMAND(${DKCMAKE_LINUX_RELEASE} ${GLEW})
LINUX_RELEASE_COMMAND(make GLEW)


RASPBERRY_DEBUG_PATH(${GLEW}/${OS}/${DEBUG_DIR})
RASPBERRY_DEBUG_COMMAND(${DKCMAKE_RASPBERRY_DEBUG} ${GLEW})
RASPBERRY_DEBUG_COMMAND(make GLEW)
RASPBERRY_RELEASE_PATH(${GLEW}/${OS}/${RELEASE_DIR})
RASPBERRY_RELEASE_COMMAND(${DKCMAKE_RASPBERRY_RELEASE} ${GLEW})
RASPBERRY_RELEASE_COMMAND(make GLEW)