...
DKSET(GLEW_WIN32 
	...
	-DGLEW_LIBRARY=${GLEW}/${OS}/lib/${DEBUG}/libglew32.lib
	-DGLEW_INCLUDE_DIR=${GLEW}
	-DGLEW_STATIC_LIBRARY_DEBUG=${GLEW}/${OS}/lib/${DEBUG}/libglew32d.lib
	-DGLEW_STATIC_LIBRARY_RELEASE=${GLEW}/${OS}/lib/${RELEASE}/libglew32.lib
	-DGLEW_SHARED_LIBRARY_DEBUG=${GLEW}/${OS}/lib/${DEBUG}/glew32d.lib
	-DGLEW_SHARED_LIBRARY_RELEASE=${GLEW}/${OS}/lib/${RELEASE}/glew32.lib
	-DGLEW_LIBRARIES=${GLEW}/${OS}/lib/${DEBUG}/libglew32d.lib ${GLEW}/${OS}/lib/${RELEASE}/libglew32.lib)
...
### COMPILE ###
WIN32_COMMAND(${CMAKE_COMMAND} -G ${GENERATOR} -A Win32 "-DCMAKE_C_FLAGS=/DWIN32 /D_WINDOWS /W3 /nologo" "-DCMAKE_C_FLAGS_DEBUG=/MTd /Od /Ob0 /Zi /RTC1 /DDEBUG /D_DEBUG" "-DCMAKE_C_FLAGS_RELEASE=/MT /O2 /Ob2 /DNDEBUG" -S ${GLEW}/build/cmake -B ${GLEW}/${OS})
...
WIN64_COMMAND(${CMAKE_COMMAND} -G ${GENERATOR} -A x64 "-DCMAKE_C_FLAGS=/DWIN32 /D_WINDOWS /W3 /nologo" "-DCMAKE_C_FLAGS_DEBUG=/MTd /Od /Ob0 /Zi /RTC1 /DDEBUG /D_DEBUG" "-DCMAKE_C_FLAGS_RELEASE=/MT /O2 /Ob2 /DNDEBUG" -S ${GLEW}/build/cmake -S ${GLEW}/${OS})
