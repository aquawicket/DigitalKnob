...
### INSTALL ###
	...
	dk_command($ENV{DKDOWNLOAD_DIR}/${VC_REDIST_X86_IMPORT_FILE} /uninstall /quiet /norestart) #/log $ENV{DK3RDPARTY_DIR}/vc_redist_install_log.txt
#endif()
...
### INSTALL ###
	...
	dk_command($ENV{DKDOWNLOAD_DIR}/${VC_REDIST_X86_64_IMPORT_FILE} /uninstall /quiet /norestart) #/log $ENV{DK3RDPARTY_DIR}/vc_redist_install_log.txt
#endif()
