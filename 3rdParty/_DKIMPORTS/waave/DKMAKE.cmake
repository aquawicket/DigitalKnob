...
### COMPILE ###
WIN_PATH(${WAAVE}/${OS})
WIN32_COMMAND(${DKCMAKE_BUILD} ${FFMPEG_WIN} ${SDL2_WIN} ${WAAVE})
WIN64_COMMAND(${DKCMAKE_BUILD} ${FFMPEG_WIN} ${SDL2_WIN} ${WAAVE})
WIN_VS(${WAAVE_NAME} waave.sln waave)


MAC_PATH(${WAAVE}/${OS})
MAC64_COMMAND(${DKCMAKE_BUILD} ${WAAVE})
MAC_XCODE(${WAAVE_NAME} waave)


IOS_PATH(${WAAVE}/${OS})
IOS64_COMMAND(${DKCMAKE_BUILD} ${WAAVE})
IOS_XCODE(${WAAVE_NAME} waave)


IOSSIM_PATH(${WAAVE}/${OS})
IOSSIM64_COMMAND(${DKCMAKE_BUILD} ${WAAVE})
IOSSIM_XCODE(${WAAVE_NAME} waave)


LINUX_DEBUG_PATH(${WAAVE}/${OS}/${DEBUG_DIR})
LINUX_DEBUG_COMMAND(${DKCMAKE_BUILD} ${WAAVE})
LINUX_DEBUG_COMMAND(make waave)

LINUX_RELEASE_PATH(${WAAVE}/${OS}/${RELEASE_DIR})
LINUX_RELEASE_COMMAND(${DKCMAKE_BUILD} ${WAAVE})
