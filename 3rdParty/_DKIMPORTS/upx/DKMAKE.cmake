...
WIN32_SET(UPX_DL https://github.com/upx/upx/releases/download/v${UPX_VERSION}/${UPX_NAME}-win32.zip)
WIN64_SET(UPX_DL https://github.com/upx/upx/releases/download/v${UPX_VERSION}/${UPX_NAME}-win64.zip)
LINUX_SET(UPX_DL https://github.com/upx/upx/releases/download/v${UPX_VERSION}/${UPX_NAME}-i386_linux.zip)
RASPBERRY_SET(UPX_DL https://github.com/upx/upx/releases/download/v${UPX_VERSION}/${UPX_NAME}-arm_linux.tar.xz)
DKSET(UPX ${3RDPARTY}/${UPX_NAME})
WIN32_SET(UPX_EXE ${UPX}/upx.exe)
WIN64_SET(UPX_EXE ${UPX}/upx.exe)
