...
if(NOT ANDROID_HOST)
	...
	if(EXISTS ${AAPT2}/aapt2-7.0.3-7396180-linux.jar)
		...
		dk_executeProcess(zip aapt2-7.0.3-7396180-linux.jar ${AAPT2}/* WORKING_DIRECTORY ${AAPT2})
		dk_executeProcess(rm -rf META-INF NOTICE aapt2 WORKING_DIRECTORY ${AAPT2})
	endif()
endif()

# 34.0.3
#WIN_HOST_dk_import(https://dl.google.com/android/repository/platform-tools_r34.0.3-windows.zip PATH ${ANDROID-SDK}/platform-tools)
#MAC_HOST_dk_import(https://mirrors.cloud.tencent.com/AndroidSDK/platform-tools_r34.0.3-darwin.zip PATH ${ANDROID-SDK}/platform-tools)
#if(NOT ANDROID_HOST)
#	LINUX_HOST_dk_import(https://dl.google.com/android/repository/platform-tools_r34.0.3-linux.zip PATH ${ANDROID-SDK}/platform-tools)
#else()
