...
DKSET(DKCMAKE_ANDROID32 ${CMAKE_COMMAND} -G ${GENERATOR} -A ARM -DCMAKE_ANDROID_NDK=${ANDROID_NDK} -DCMAKE_TOOLCHAIN_FILE=${ANDROID_NDK}/build/cmake/android.toolchain.cmake -DANDROID_PLATFORM=android-26 -DANDROID_ABI=armeabi-v7a -DANDROID_ARM_NEON=TRUE  -DCMAKE_ANDROID_STL=c++_static "-DANDROID_CPP_FEATURES=rtti exceptions" -DBUILD_SHARED_LIBS=OFF "-DCMAKE_C_FLAGS=-DANDROID -D_ANDROID32" "-DCMAKE_C_FLAGS_DEBUG=-g2 -gdwarf-2 -O0 -DDEBUG -D_DEBUG" "-DCMAKE_C_FLAGS_RELEASE=-DNDEBUG" "-DCMAKE_CXX_FLAGS=-DANDROID -D_ANDROID32 -std=c++14" "-DCMAKE_CXX_FLAGS_DEBUG=-g2 -gdwarf-2 -O0 -DDEBUG -D_DEBUG" "-DCMAKE_CXX_FLAGS_RELEASE=-DNDEBUG")

#DKSET(DKCMAKE_ANDROID32 ${CMAKE_COMMAND} -G ${GENERATOR} -A ARM -DCMAKE_SYSTEM_NAME=Android -DCMAKE_SYSTEM_VERSION=26 -DCMAKE_ANDROID_API=26 -DCMAKE_ANDROID_API_MIN=16 -DCMAKE_ANDROID_NDK=${ANDROID_NDK} -DCMAKE_ANDROID_ARCH=armeabi-v7a -DCMAKE_ANDROID_ARCH_ABI=armeabi-v7a)


DKSET(DKCMAKE_ANDROID64 ${CMAKE_COMMAND} -G ${GENERATOR} -A ARM64 -DCMAKE_TOOLCHAIN_FILE=${ANDROID_NDK}/build/cmake/android.toolchain.cmake "-DANDROID_ABI=armeabi-v7a with NEON" ANDROID_NATIVE_API_LEVEL=android-26 )
