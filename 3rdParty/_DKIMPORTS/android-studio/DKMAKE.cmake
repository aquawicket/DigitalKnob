...
if(NOT EXISTS ${ANDROIDSTUDIO_EXE})
	...
	if(CMAKE_HOST_WIN32)
		ANDROID_COMMAND(${DIGITALKNOB}/Download/${ANDROIDSTUDIO_NAME}-windows.exe)
	endif()
	if(CMAKE_HOST_APPLE)
		ANDROID_COMMAND(${DIGITALKNOB}/Download/${ANDROIDSTUDIO_NAME}-mac.dmg)
	endif()
	if(CMAKE_HOST_LINUX)
		ANDROID_COMMAND(${DIGITALKNOB}/Download/${ANDROIDSTUDIO_NAME}-linux.zip)
	endif()
endif()
