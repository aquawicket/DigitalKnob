...
WIN_HOST_SET(ANDROIDSTUDIO_DL "https://r5---sn-a5meknsy.gvt1.com/edgedl/android/studio/install/4.2.2.0/android-studio-ide-202.7486908-windows.exe?cms_redirect=yes&mh=2R&mip=47.148.227.149&mm=28&mn=sn-a5meknsy&ms=nvh&mt=1627334431&mv=m&mvi=5&pl=16&rmhost=r2---sn-a5meknsy.gvt1.com&shardbypass=yes&smhost=r6---sn-a5mekner.gvt1.com")
WIN_HOST_SET(ANDROIDSTUDIO "C:/Program Files/Android/Android Studio/bin")
WIN_HOST_SET(ANDROIDSTUDIO_NAME "studio.exe")
WIN_HOST_SET(ANDROIDSTUDIO_EXE "${ANDROIDSTUDIO}/${ANDROIDSTUDIO_NAME}")
MAC_HOST_SET(ANDROIDSTUDIO "/Applications")
MAC_HOST_SET(ANDROIDSTUDIO_EXE "${ANDROIDSTUDIO}/Android Studio.app")
LINUX_HOST_SET(ANDROIDSTUDIO "${3RDPARTY}/android-studio/bin")
LINUX_HOST_SET(ANDROIDSTUDIO_EXE "${ANDROIDSTUDIO}/Android Studio.app")
...
if(NOT EXISTS ${ANDROIDSTUDIO_EXE})
	...
	ANDROID_COMMAND(${DKDOWNLOAD}/${ANDROIDSTUDIO_NAME})
endif()
