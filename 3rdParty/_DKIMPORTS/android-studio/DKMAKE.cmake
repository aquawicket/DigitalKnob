...
LINUX_DKSET(ANDROIDSTUDIO "${DIGITALKNOB}/DK/3rdParty/android-studio/bin")
...
if(NOT EXISTS ${ANDROIDSTUDIO_EXE})
	DKSETPATH(${DIGITALKNOB}/DK/Download)
	DOWNLOAD("${ANDROIDSTUDIO_DL}")
	DKSET(QUEUE_BUILD ON)
	if(CMAKE_HOST_WIN32)
		ANDROID_COMMAND(${DIGITALKNOB}/DK/Download/${ANDROIDSTUDIO_NAME}-windows.exe)
	endif()
	if(CMAKE_HOST_APPLE)
		ANDROID_COMMAND(${DIGITALKNOB}/DK/Download/${ANDROIDSTUDIO_NAME}-mac.dmg)
	endif()
	if(CMAKE_HOST_LINUX)
		ANDROID_COMMAND(${DIGITALKNOB}/DK/Download/${ANDROIDSTUDIO_NAME}-linux.zip)
	endif()
endif()
