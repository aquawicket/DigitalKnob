...
if(WIN_HOST)
	if(NOT EXISTS "${ProgramFiles}/Android/Android Studio/bin/studio.exe")
		...
		#dk_remove(${DKDOWNLOAD_DIR}/android-studio-2020.3.1.26-windows.exe)
	endif()
endif()
...
if(MAC_HOST)
	if(NOT EXISTS "/Applications/Android Studio.app")
		...
		#dk_remove(${DKDOWNLOAD_DIR}/android-studio-2021.3.1.17-mac.dmg)
	endif()
endif()
...
if(LINUX_HOST)
	if(NOT EXISTS "${DK3RDPARTY_DIR}/android-studio/bin/studio.sh")
		...
		#dk_remove(${DKDOWNLOAD_DIR}/android-studio-2021.3.1.17-linux.tar.gz)
	endif()
endif()
