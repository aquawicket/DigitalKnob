...
if(WIN_X86_64_HOST)
	if(NOT EXISTS "${ProgramFiles}/Android/Android Studio/bin/studio64.exe")
		...
		dk_getFileParam	($ENV{DKIMPORTS_DIR}/android-studio/dkconfig.txt ANDROID_STUDIO_WIN_DL)
...
elseif(MAC_HOST)
	if(NOT EXISTS "/Applications/Android Studio.app")
		dk_validate		(DKIMPORTS_DIR "dk_DKIMPORTS_DIR()")
		dk_getFileParam	($ENV{DKIMPORTS_DIR}/android-studio/dkconfig.txt ANDROID_STUDIO_MAC_DL)
...
elseif(LINUX_HOST)
	...
	if(NOT EXISTS "$ENV{DK3RDPARTY_DIR}/android-studio/bin/studio.sh")
		dk_validate		(DKIMPORTS_DIR "dk_DKIMPORTS_DIR()")
		dk_getFileParam	($ENV{DKIMPORTS_DIR}/android-studio/dkconfig.txt ANDROID_STUDIO_LINUX_DL)
