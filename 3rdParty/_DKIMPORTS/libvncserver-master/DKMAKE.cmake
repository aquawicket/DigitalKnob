...
DKSETPATH(${VNCSERVER}/${OS})
MAC64_COMMAND(${CMAKE_COMMAND} -G "Xcode" -DCMAKE_OSX_ARCHITECTURES=x86_64 "-DCMAKE_C_FLAGS=-I${PNG}/${OS} -I${JPEG}/${OS}" -DPNG_PNG_INCLUDE_DIR=${PNG} -DPNG_LIBRARY_DEBUG=${PNG}/${OS}/${DEBUG_DIR}/libpng17d.a -DPNG_LIBRARY_RELEASE=${PNG}/${OS}/${RELEASE_DIR}/libpng17.a -DJPEG_INCLUDE_DIR=${JPEG} -DJPEG_LIBRARY=${JPEG}/${OS}/${RELEASE_DIR}/libturbojpeg.a -DZLIB_INCLUDE_DIR=${ZLIB} -DZLIB_LIBRARY_DEBUG=${ZLIB}/${OS}/${DEBUG_DIR}/libz.a -DZLIB_LIBRARY_RELEASE=${ZLIB}/${OS}/${RELEASE_DIR}/libz.a -DWITH_JPEG=ON ${VNCSERVER})
...
DKSETPATH(${VNCSERVER}/${OS}/${DEBUG_DIR})
LINUX_DEBUG_COMMAND(${CMAKE_COMMAND} -G "Unix Makefiles" -DCMAKE_BUILD_TYPE=DEBUG "-DCMAKE_C_FLAGS=-fPIC -I${ZLIB}/${OS}/Debug -I${PNG}/${OS}/Debug -I${JPEG}/${OS}/Debug" -DJPEG_INCLUDE_DIR=${JPEG} -DJPEG_LIBRARY=${JPEG}/${OS}/Debug/libturbojpeg.a -DZLIB_INCLUDE_DIR=${ZLIB} -DZLIB_LIBRARY_DEBUG=${ZLIB}/${OS}/${DEBUG_DIR}/libz.a -DZLIB_LIBRARY_RELEASE=${ZLIB}/${OS}/${RELEASE_DIR}/libz.a -DWITH_JPEG=ON ${VNCSERVER})
LINUX_DEBUG_COMMAND(make vncserver)
LINUX_DEBUG_COMMAND(make vncclient)

DKSETPATH(${VNCSERVER}/${OS}/${RELEASE_DIR})
LINUX_RELEASE_COMMAND(${CMAKE_COMMAND} -G "Unix Makefiles" -DCMAKE_BUILD_TYPE=RELEASE "-DCMAKE_C_FLAGS=-fPIC -I${ZLIB}/${OS}/${RELEASE_DIR} -I${PNG}/${OS}/${RELEASE_DIR} -I${JPEG}/${OS}/${RELEASE_DIR}" -DJPEG_INCLUDE_DIR=${JPEG} -DJPEG_LIBRARY=${JPEG}/${OS}/${RELEASE_DIR}/libturbojpeg.a -DWITH_JPEG=ON -DZLIB_INCLUDE_DIR=${ZLIB} -DZLIB_LIBRARY_DEBUG=${ZLIB}/${OS}/${DEBUG_DIR}/libz.a -DZLIB_LIBRARY_RELEASE=${ZLIB}/${OS}/${RELEASE_DIR}/libz.a ${VNCSERVER})
