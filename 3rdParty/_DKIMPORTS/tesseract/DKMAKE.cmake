...
ANDROID_dk_libDebug		(${TESSERACT}/${triple}/${DEBUG_DIR}/obj/local/armeabi-v7a/libtesseract.a)
ANDROID_dk_libRelease	(${TESSERACT}/${triple}/${RELEASE_DIR}/obj/local/armeabi-v7a/libtesseract.a)
APPLE_dk_libDebug		(${TESSERACT}/${triple}/${DEBUG_DIR}/libtesseract.a)
APPLE_dk_libRelease		(${TESSERACT}/${triple}/${RELEASE_DIR}/libtesseract.a)
EMSCRIPTEN_dk_libDebug	(${TESSERACT}/${triple}/${DEBUG_DIR}/libtesseract.a)
EMSCRIPTEN_dk_libRelease(${TESSERACT}/${triple}/${RELEASE_DIR}/libtesseract.a)
LINUX_dk_libDebug		(${TESSERACT}/${triple}/${DEBUG_DIR}/libtesseract.a)
LINUX_dk_libRelease		(${TESSERACT}/${triple}/${RELEASE_DIR}/libtesseract.a)
RASPBERRY_dk_libDebug	(${TESSERACT}/${triple}/${DEBUG_DIR}/libtesseract.a)
RASPBERRY_dk_libRelease	(${TESSERACT}/${triple}/${RELEASE_DIR}/libtesseract.a)
WIN_dk_libDebug			(${TESSERACT}/${triple}/${DEBUG_DIR}/tesseract53d.lib)
WIN_dk_libRelease		(${TESSERACT}/${triple}/${RELEASE_DIR}/tesseract53.lib)
