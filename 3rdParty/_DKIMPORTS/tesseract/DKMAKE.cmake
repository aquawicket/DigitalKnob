...
WIN32_COMMAND(${DKCMAKE_BUILD} -DSTATIC=ON -DBUILD_TRAINING_TOOLS=OFF ${LEPTONICA_WIN} ${TESSERACT})
WIN64_COMMAND(${DKCMAKE_BUILD} -DSTATIC=ON -DBUILD_TRAINING_TOOLS=OFF ${LEPTONICA_WIN} ${TESSERACT})
WIN_VS(${TESSERACT_NAME} tesseract.sln libtesseract)


MAC_PATH(${TESSERACT}/${OS})
MAC64_COMMAND(${DKCMAKE_BUILD} -DSTATIC=ON -DBUILD_TRAINING_TOOLS=OFF -DLeptonica_DIR=${LEPTONICA}/${OS} ${TESSERACT})
MAC_XCODE(${TESSERACT_NAME} libtesseract)

IOS_PATH(${TESSERACT}/${OS})
IOS64_COMMAND(${DKCMAKE_BUILD} -DSTATIC=ON -DBUILD_TRAINING_TOOLS=OFF -DLeptonica_DIR=${LEPTONICA}/${OS} ${TESSERACT})
IOS_XCODE(${TESSERACT_NAME} libtesseract)

IOSSIM_PATH(${TESSERACT}/${OS})
IOSSIM64_COMMAND(${DKCMAKE_BUILD} -DSTATIC=ON -DBUILD_TRAINING_TOOLS=OFF -DLeptonica_DIR=${LEPTONICA}/${OS} ${TESSERACT})
IOSSIM_XCODE(${TESSERACT_NAME} libtesseract)

LINUX_DEBUG_PATH(${TESSERACT}/${OS}/Debug)
LINUX_DEBUG_COMMAND(${DKCMAKE_BUILD} -DSTATIC=ON "-DCMAKE_CXX_FLAGS=-DGRAPHICS_DISABLED" -DBUILD_TRAINING_TOOLS=OFF -DLeptonica_DIR=${LEPTONICA}/${OS}/${RELEASE_DIR} ${TESSERACT})
LINUX_DEBUG_COMMAND(make libtesseract)

LINUX_RELEASE_PATH(${TESSERACT}/${OS}/${RELEASE_DIR})
LINUX_RELEASE_COMMAND(${DKCMAKE_BUILD} -DSTATIC=ON "-DCMAKE_CXX_FLAGS=-DGRAPHICS_DISABLED" -DBUILD_TRAINING_TOOLS=OFF -DLeptonica_DIR=${LEPTONICA}/${OS}/${RELEASE_DIR} ${TESSERACT})
