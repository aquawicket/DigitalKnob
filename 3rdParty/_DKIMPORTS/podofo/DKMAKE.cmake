...
IOS64_dk_queueCommand(${DKCMAKE_BUILD} -DPODOFO_BUILD_STATIC=ON ${ZLIB_CMAKE} ${FREETYPE_CMAKE} ${PNG_CMAKE} ${PODOFO}) #-DPODOFO_NO_FONTMANAGER=ON
IOS_dk_xcode(podofo-${PODOFO_VERSION} podofo_static)

IOSSIM64_dk_queueCommand(${DKCMAKE_BUILD} -DPODOFO_BUILD_STATIC=ON ${ZLIB_CMAKE} ${FREETYPE_CMAKE} ${PNG_CMAKE} ${PODOFO}) #-DPODOFO_NO_FONTMANAGER=ON
