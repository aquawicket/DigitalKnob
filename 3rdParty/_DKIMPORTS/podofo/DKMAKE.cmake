...
WIN_dk_libDebug(${PODOFO}/${OS}/src/Debug/podofo.lib)
WIN_dk_libRelease(${PODOFO}/${OS}/src/${RELEASE_DIR}/podofo.lib)
MAC_dk_libDebug(${PODOFO}/${OS}/src/${DEBUG_DIR}/libpodofo.a)
MAC_dk_libRelease(${PODOFO}/${OS}/src/${RELEASE_DIR}/libpodofo.a)
IOS_dk_libDebug(${PODOFO}/${OS}/src/${DEBUG_DIR}/libpodofo.a)
IOS_dk_libRelease(${PODOFO}/${OS}/src/${RELEASE_DIR}/libpodofo.a)
IOSSIM_dk_libDebug(${PODOFO}/${OS}/src/${DEBUG_DIR}/libpodofo.a)
IOSSIM_dk_libRelease(${PODOFO}/${OS}/src/${RELEASE_DIR}/libpodofo.a)
LINUX_dk_libDebug(${PODOFO}/${OS}/Debug/src/libpodofo.a)
LINUX_dk_libRelease(${PODOFO}/${OS}/${RELEASE_DIR}/src/libpodofo.a)
ANDROID_dk_libDebug(${PODOFO}/${OS}/Debug/obj/local/armeabi-v7a/libpodofo.a)
