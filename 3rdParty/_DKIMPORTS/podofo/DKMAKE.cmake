...
WIN_dk_queueCommand		(${DKCMAKE_BUILD} "-DCMAKE_CXX_FLAGS=/I${ZLIB}/${OS}" -DPODOFO_BUILD_STATIC=ON ${ZLIB_CMAKE} ${FREETYPE_CMAKE} ${LIBPNG_CMAKE} ${PODOFO})
MAC_dk_queueCommand		(${DKCMAKE_BUILD} -DPODOFO_BUILD_STATIC=ON ${ZLIB_CMAKE} ${FREETYPE_CMAKE} ${LIBPNG_CMAKE} ${PODOFO}) #-DPODOFO_NO_FONTMANAGER=ON
IOS_dk_queueCommand		(${DKCMAKE_BUILD} -DPODOFO_BUILD_STATIC=ON ${ZLIB_CMAKE} ${FREETYPE_CMAKE} ${LIBPNG_CMAKE} ${PODOFO}) #-DPODOFO_NO_FONTMANAGER=ON
IOSSIM_dk_queueCommand	(${DKCMAKE_BUILD} -DPODOFO_BUILD_STATIC=ON ${ZLIB_CMAKE} ${FREETYPE_CMAKE} ${LIBPNG_CMAKE} ${PODOFO}) #-DPODOFO_NO_FONTMANAGER=ON
LINUX_dk_queueCommand	(${DKCMAKE_BUILD} -DPODOFO_BUILD_STATIC=ON ${ZLIB_CMAKE} ${FREETYPE_CMAKE} ${LIBPNG_CMAKE} ${PODOFO})
ANDROID_dk_queueCommand	(${DKCMAKE_BUILD} "-DCMAKE_CXX_FLAGS=/I${ZLIB}/${OS}" -DPODOFO_BUILD_STATIC=ON ${ZLIB_CMAKE} ${FREETYPE_CMAKE} ${LIBPNG_CMAKE} ${PODOFO})
