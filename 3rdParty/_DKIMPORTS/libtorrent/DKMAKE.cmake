...
### COMPILE ###
WIN_PATH(${TORRENT}/${OS})
WIN32_COMMAND(${DKCMAKE_BUILD} -Dshared=OFF -Dunicode=OFF -Dstatic_runtime=ON ${OPENSSL_WIN32} -DBOOST_ROOT=${BOOST} -DBOOST_LIBRARYDIR=${BOOST}/${OS}/lib ${TORRENT})
WIN64_COMMAND(${DKCMAKE_BUILD} -Dshared=OFF -Dunicode=OFF -Dstatic_runtime=ON ${OPENSSL_WIN64} -DBOOST_ROOT=${BOOST} -DBOOST_LIBRARYDIR=${BOOST}/${OS}/lib ${TORRENT})
WIN_VS(${TORRENT_NAME} libtorrent.sln torrent-rasterbar)


MAC_PATH(${TORRENT}/${OS})
MAC64_COMMAND(${DKCMAKE_BUILD} ${TORRENT})
MAC_XCODE_DEBUG(${TORRENT_NAME} libtorrent-rasterbar)


IOS_PATH(${TORRENT}/${OS})
IOS_COMMAND(${DKCMAKE_BUILD} ${TORRENT})
IOS_XCODE(${TORRENT_NAME} libtorrent-rasterbar)

IOSSIM_PATH(${TORRENT}/${OS})
IOSSIM64_COMMAND(${DKCMAKE_BUILD} ${TORRENT})
IOSSIM_XCODE(${TORRENT_NAME} libtorrent-rasterbar)

LINUX_DEBUG_PATH(${TORRENT}/${OS}/${DEBUG_DIR})
LINUX_DEBUG_COMMAND(${DKCMAKE_BUILD} ${TORRENT})
LINUX_DEBUG_COMMAND(make torrent-rasterbar)

LINUX_RELEASE_PATH(${TORRENT}/${OS}/${RELEASE_DIR})
LINUX_RELEASE_COMMAND(${DKCMAKE_BUILD} ${TORRENT})
