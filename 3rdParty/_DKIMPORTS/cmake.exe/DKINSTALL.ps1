Read-Host;
if(${env:DKPOWERSHELL_FUNCTIONS_DIR}){ . ${env:DKPOWERSHELL_FUNCTIONS_DIR}/DK.ps1; } else { . "${ENV:USERPROFILE}/Digital Knob/Development/DKPowershell/functions/DK.ps1"; }
...
function Global:DKINSTALL() {
	...
	dk_call dk_fileVariables ${PSScriptRoot}/dkconfig.txt;
