...
if(WIN_HOST)
	...
	DEBUG_dk_msys2			(${DKCONFIGURE_BUILD} --with-ogg-includes=${OGG}/include ${OGG_CONFIGURE})
	DEBUG_dk_msys2			(make)
	if(RELEASE)
		set(ENV{PKG_CONFIG_PATH} "${OGG}/${OS}/${RELEASE_DIR}")
	endif()
	RELEASE_dk_setPath		(${VORBIS}/${OS}/${RELEASE_DIR})
	RELEASE_dk_msys2		(${DKCONFIGURE_BUILD} --with-ogg-includes=${OGG}/include ${OGG_CONFIGURE})
