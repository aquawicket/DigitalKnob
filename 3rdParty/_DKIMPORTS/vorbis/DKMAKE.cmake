...
if(WIN_HOST)
	...
	DEBUG_dk_queueMsys2		(${DKCONFIGURE_BUILD} --with-ogg-includes=${OGG}/include ${OGG_CONFIGURE})
	DEBUG_dk_queueMsys2		(make)
	if(RELEASE)
		set(ENV{PKG_CONFIG_PATH} "${OGG}/${OS}/${RELEASE_DIR}")
	endif()
	RELEASE_dk_setPath		(${VORBIS}/${OS}/${RELEASE_DIR})
	RELEASE_dk_queueMsys2	(${DKCONFIGURE_BUILD} --with-ogg-includes=${OGG}/include ${OGG_CONFIGURE})
	...
	DEBUG_dk_setPath		(${VORBIS}/${OS}/${DEBUG_DIR})
	DEBUG_dk_queueCommand	(${DKCONFIGURE_BUILD} --with-ogg-includes=${OGG}/include ${OGG_CONFIGURE})
	DEBUG_dk_queueCommand	(make)
	if(RELEASE)
		set(ENV{PKG_CONFIG_PATH} "${OGG}/${OS}/${RELEASE_DIR}")
	endif()
	RELEASE_dk_setPath		(${VORBIS}/${OS}/${RELEASE_DIR})
	RELEASE_dk_queueCommand	(${DKCONFIGURE_BUILD} --with-ogg-includes=${OGG}/include ${OGG_CONFIGURE})
