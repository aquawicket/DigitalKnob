...
if(BZIP2_USE_CMAKE)
	...
	if(LINUX_HOST)
		...
		dk_configure(${BZIP2} -DENABLE_SHARED_LIB=OFF -DENABLE_STATIC_LIB=ON ${PYTHON3_CMAKE}) #-DPython3_EXECUTABLE=${PYTHON3_EXE})
	endif()
	...
	### LINK ###
	dk_include(${BZIP2}/${triple}															BZIP2_INCLUDE_DIR)
	if(MSVC)
	...
	if(MSVC)
		if(WIN_X86)
			...
			dk_copy		(${BZIP2}/build-VS2019 ${BZIP2}/${triple})
			dk_cd		(${BZIP2}/${triple})
		...
		if(NOT EXISTS ${BZIP2}/${triple}/bzip2.c)
			dk_copy		(${BZIP2}/copy ${BZIP2}/${triple} OVERWRITE)
