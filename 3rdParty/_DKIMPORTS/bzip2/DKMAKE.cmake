...
WIN32_DEBUG_LIB(${BZIP2}/${OS}/${DEBUG_DIR}/libbz2-static.lib)
WIN32_RELEASE_LIB(${BZIP2}/${OS}/${RELEASE_DIR}/libbz2-static.lib)
WIN64_DEBUG_LIB(${BZIP2}/${OS}/x64/${DEBUG_DIR}/libbz2-static.lib)
WIN64_RELEASE_LIB(${BZIP2}/${OS}/x64/${RELEASE_DIR}/libbz2-static.lib)
...
### 3RDPARTY LINK ###
WIN_DKSET(BZIP2_CMAKE -DBZIP2_INCLUDE_DIR=${BZIP2} -DBZIP2_LIBRARY_DEBUG=${BZIP2}/${OS}/${DEBUG_DIR}/libbz2-static.lib -DBZIP2_LIBRARY_RELEASE=${BZIP2}/${OS}/${RELEASE_DIR}/libbz2-static.lib) #-DBZIP2_LIBRARIES=${BZIP2}/${OS}/${RELEASE_DIR}/libbz2-static.lib)
