...
if(MULTI_CONFIG)
	...
	RELEASEdk_set	(LIBXML2_CMAKE -DLIBXML2_INCLUDE_DIR=${LIBXML2_INCLUDE_DIR} -DLIBXML2_INCLUDE_DIRS=${LIBXML2_INCLUDE_DIR2} -DLIBXML2_LIBRARY=${LIBXML2_LIBRARY_RELEASE} -DLIBXML2_LIBRARIES=${LIBXML2_LIBRARY_RELEASE})
endif()
