...
### 3RDPARTY LINK ###
DKSET(XML2_WIN -DLIBXML2_INCLUDE=${XML2}/include -DLIBXML2_LIBRARY=${XML2}/${OS}/${RELEASE_DIR}/xml2.lib)
DKSET(XML2_APPLE -DLIBXML2_INCLUDE=${XML2}/include -DLIBXML2_LIBRARY=${XML2}/${OS}/${RELEASE_DIR}/libxml2.a)
DKSET(XML2_LINUX -DLIBXML2_INCLUDE=${XML2}/include -DLIBXML2_LIBRARY=${XML2}/${OS}/${RELEASE_DIR}/libxml2.a)
DKSET(XML2_RASPBERRY -DLIBXML2_INCLUDE=${XML2}/include -DLIBXML2_LIBRARY=${XML2}/${OS}/${RELEASE_DIR}/libxml2.a)
DKSET(XML2_ANDROID -DLIBXML2_INCLUDE=${XML2}/include -DLIBXML2_LIBRARY=${XML2}/${OS}/${RELEASE_DIR}/libxml2.a)



### COMPILE ###
WIN_PATH(${XML2}/${OS})
WIN32_COMMAND(${DKCMAKE_WIN32} ${ICONV_WIN} ${ZLIB_WIN} ${XML2})
WIN64_COMMAND(${DKCMAKE_WIN64} ${ICONV_WIN} ${ZLIB_WIN} ${XML2})
WIN_VS(${XML2_NAME} xml2.sln xml2)


MAC_PATH(${XML2}/${OS})
MAC32_COMMAND(${DKCMAKE_MAC32} ${ZLIB_APPLE} ${XML2})
MAC64_COMMAND(${DKCMAKE_MAC64} ${ZLIB_APPLE} ${XML2})
MAC_XCODE(${XML2_NAME} xml2)


IOS_PATH(${XML2}/${OS})
IOS32_COMMAND(${DKCMAKE_IOS32} ${ZLIB_APPLE} ${XML2})
IOS64_COMMAND(${DKCMAKE_IOS64} ${ZLIB_APPLE} ${XML2})
IOS_XCODE(${XML2_NAME} xml2)


IOSSIM_PATH(${XML2}/${OS})
IOSSIM32_COMMAND(${DKCMAKE_IOSSIM32} ${ZLIB_APPLE} ${XML2})
