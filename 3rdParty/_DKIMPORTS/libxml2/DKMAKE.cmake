...
### 3RDPARTY LINK ###
if(MULTI_CONFIG)
	dk_set			(LIBXML2_CMAKE -DLIBXML2_INCLUDE_DIR=${LIBXML2_INCLUDE_DIR} -DLIBXML2_INCLUDE_DIRS=${LIBXML2_INCLUDE_DIR2} -DLIBXML2_LIBRARY=${LIBXML2_LIBRARY_RELEASE} -DLIBXML2_LIBRARIES=${LIBXML2_LIBRARY_RELEASE} "-DCMAKE_C_FLAGS=-I${LIBXML2_INCLUDE_DIR2}" "-DCMAKE_CXX_FLAGS=-I${LIBXML2_INCLUDE_DIR2}")
else()
	DEBUG_dk_set	(LIBXML2_CMAKE -DLIBXML2_INCLUDE_DIR=${LIBXML2_INCLUDE_DIR} -DLIBXML2_INCLUDE_DIRS=${LIBXML2_INCLUDE_DIR2} -DLIBXML2_LIBRARY=${LIBXML2_LIBRARY_DEBUG} -DLIBXML2_LIBRARIES=${LIBXML2_LIBRARY_DEBUG} "-DCMAKE_C_FLAGS=-I${LIBXML2_INCLUDE_DIR2}" "-DCMAKE_CXX_FLAGS=-I${LIBXML2_INCLUDE_DIR2}")
	RELEASE_dk_set	(LIBXML2_CMAKE -DLIBXML2_INCLUDE_DIR=${LIBXML2_INCLUDE_DIR} -DLIBXML2_INCLUDE_DIRS=${LIBXML2_INCLUDE_DIR2} -DLIBXML2_LIBRARY=${LIBXML2_LIBRARY_RELEASE} -DLIBXML2_LIBRARIES=${LIBXML2_LIBRARY_RELEASE} "-DCMAKE_C_FLAGS=-I${LIBXML2_INCLUDE_DIR2}" "-DCMAKE_CXX_FLAGS=-I${LIBXML2_INCLUDE_DIR2}")
endif()
...
ANDROID_DEBUG_dk_queueCommand		(${DKCMAKE_BUILD} "-DCMAKE_C_FLAGS=-DLIBXML_THREAD_ENABLED -DHAVE_ERRNO_H -I${LIBXML2_INCLUDE_DIR2}" ${LIBICONV_CMAKE} ${PYTHON_CMAKE} ${XZ_CMAKE} ${ZLIB_CMAKE} ${LIBXML2})
ANDROID_RELEASE_dk_queueCommand		(${DKCMAKE_BUILD} "-DCMAKE_C_FLAGS=-DLIBXML_THREAD_ENABLED -DHAVE_ERRNO_H -I${LIBXML2_INCLUDE_DIR2}" ${LIBICONV_CMAKE} ${PYTHON_CMAKE} ${XZ_CMAKE} ${ZLIB_CMAKE} ${LIBXML2})


APPLE_dk_queueCommand				(${DKCMAKE_BUILD} "-DCMAKE_C_FLAGS=-I${LIBXML2_INCLUDE_DIR2}" ${LIBICONV_CMAKE} ${PYTHON_CMAKE} ${XZ_CMAKE} ${ZLIB_CMAKE} ${LIBXML2})
...
LINUX_DEBUG_dk_queueCommand			(${DKCMAKE_BUILD} -DLIBXML2_WITH_PYTHON=OFF "-DCMAKE_C_FLAGS=-DHAVE_ERRNO_H -I${LIBXML2_INCLUDE_DIR2}" ${LIBICONV_CMAKE} ${XZ_CMAKE} ${ZLIB_CMAKE} ${LIBXML2})
LINUX_RELEASE_dk_queueCommand		(${DKCMAKE_BUILD} -DLIBXML2_WITH_PYTHON=OFF "-DCMAKE_C_FLAGS=-DHAVE_ERRNO_H -I${LIBXML2_INCLUDE_DIR2}" ${LIBICONV_CMAKE} ${XZ_CMAKE} ${ZLIB_CMAKE} ${LIBXML2})
...
#	dk_queueCommand					(${DKCMAKE_BUILD} "-DCMAKE_C_FLAGS=-I${LIBXML2_INCLUDE_DIR2}" ${LIBICONV_CMAKE} ${XZ_CMAKE} ${ZLIB_CMAKE} ${LIBXML2})
	...
	WIN_dk_queueCommand(
		...
		-DLIBXML2_WITH_READER=OFF			# Add the xmlReader parsing interface ON
		...
		-DLIBXML2_WITH_WRITER=OFF			# Add the xmlWriter saving interface ON
