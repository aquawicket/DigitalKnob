...
### COMPILE ###
WIN_PATH(${XML2}/${OS})
WIN32_COMMAND(${DKCMAKE_WIN32} ${ICONV_WIN} ${ZLIB_CMAKE} ${XML2})
WIN64_COMMAND(${DKCMAKE_WIN64} ${ICONV_WIN} ${ZLIB_CMAKE} ${XML2})
WIN_VS(${XML2_NAME} xml2.sln xml2)


MAC_PATH(${XML2}/${OS})
MAC32_COMMAND(${DKCMAKE_MAC32} ${ZLIB_CMAKE} ${XML2})
MAC64_COMMAND(${DKCMAKE_MAC64} ${ZLIB_CMAKE} ${XML2})
MAC_XCODE(${XML2_NAME} xml2)


IOS_PATH(${XML2}/${OS})
IOS32_COMMAND(${DKCMAKE_IOS32} ${ZLIB_CMAKE} ${XML2})
IOS64_COMMAND(${DKCMAKE_IOS64} ${ZLIB_CMAKE} ${XML2})
IOS_XCODE(${XML2_NAME} xml2)


IOSSIM_PATH(${XML2}/${OS})
IOSSIM32_COMMAND(${DKCMAKE_IOSSIM32} ${ZLIB_CMAKE} ${XML2})
IOSSIM64_COMMAND(${DKCMAKE_IOSSIM64} ${ZLIB_CMAKE} ${XML2})
IOSSIM_XCODE(${XML2_NAME} xml2)


LINUX_DEBUG_PATH(${XML2}/${OS}/${DEBUG_DIR})
LINUX_DEBUG_COMMAND(${DKCONFIGURE_LINUX})
LINUX_DEBUG_COMMAND(${DKCMAKE_LINUX_DEBUG} "-DCMAKE_C_FLAGS=-DLIBXML_THREAD_ENABLED -DHAVE_ERRNO_H -I${XML2}/${OS}/${DEBUG_DIR}" ${ZLIB_CMAKE} ${XML2})
LINUX_DEBUG_COMMAND(make xml2)
LINUX_RELEASE_PATH(${XML2}/${OS}/${RELEASE_DIR})
LINUX_RELEASE_COMMAND(${DKCONFIGURE_LINUX})
LINUX_RELEASE_COMMAND(${DKCMAKE_LINUX_RELEASE} "-DCMAKE_C_FLAGS=-DLIBXML_THREAD_ENABLED -DHAVE_ERRNO_H -I${XML2}/${OS}/${RELEASE_DIR}" ${ZLIB_CMAKE} ${XML2})
LINUX_RELEASE_COMMAND(make xml2)


RASPBERRY_DEBUG_PATH(${XML2}/${OS}/${DEBUG_DIR})
RASPBERRY_DEBUG_COMMAND(${DKCONFIGURE_RASPBERRY})
RASPBERRY_DEBUG_COMMAND(${DKCMAKE_RASPBERRY_DEBUG} "-DCMAKE_C_FLAGS=-DLIBXML_THREAD_ENABLED -DHAVE_ERRNO_H -I${XML2}/${OS}/${DEBUG_DIR}" ${ZLIB_CMAKE} ${XML2})
...
RASPBERRY_RELEASE_COMMAND(${DKCMAKE_RASPBERRY_RELEASE} "-DCMAKE_C_FLAGS=-DLIBXML_THREAD_ENABLED -DHAVE_ERRNO_H -I${XML2}/${OS}/${RELEASE_DIR}" ${ZLIB_CMAKE} ${XML2})
RASPBERRY_RELEASE_COMMAND(make xml2)


ANDROID_PATH(${XML2}/${OS})
ANDROID32_MSYS(${DKCONFIGURE_ANDROID})
ANDROID32_COMMAND(${DKCMAKE_ANDROID32} "-DANDROID_COMPILER_FLAGS=-DANDROID32 -D_ANDROID -I${XML2}/${OS}" ${ICONV_ANDROID} ${ZLIB_CMAKE} ${XML2})
ANDROID64_MSYS(${DKCONFIGURE_ANDROID})
ANDROID64_COMMAND(${DKCMAKE_ANDROID64} "-DANDROID_COMPILER_FLAGS=-DANDROID64 -D_ANDROID -I${XML2}/${OS}" ${ICONV_ANDROID} ${ZLIB_CMAKE} ${XML2})
