...
LINUX_DEBUG_PATH(${XML2}/${OS}/${DEBUG})
...
RASPBERRY_DEBUG_PATH(${XML2}/${OS}/${DEBUG})
##RASPBERRY_DEBUG_COMMAND(../../configure --disable-shared --enable-static)
RASPBERRY_DEBUG_COMMAND(${CMAKE_COMMAND} -G "Unix Makefiles" -DCMAKE_BUILD_TYPE=DEBUG "-DCMAKE_C_FLAGS=-DLIBXML_THREAD_ENABLED -DHAVE_ERRNO_H -I${XML2}/${OS}/${DEBUG} -I${ZLIB}/${OS}/${DEBUG}" -DZLIB_INCLUDE_DIR=${ZLIB} -DZLIB_LIBRARY=${ZLIB}/${OS}/${DEBUG}/libz.a ${XML2})
