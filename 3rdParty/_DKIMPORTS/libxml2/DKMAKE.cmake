...
#LINUX_dk_queueCommand				(${DKCONFIGURE_BUILD} --with-python=off)
LINUX_DEBUG_dk_queueCommand			(${DKCMAKE_BUILD} -DLIBXML2_WITH_PYTHON=OFF "-DCMAKE_C_FLAGS=-DLIBXML_THREAD_ENABLED -DHAVE_ERRNO_H -I${LIBXML2_INCLUDE_DIR2}" ${LIBICONV_CMAKE} ${XZ_CMAKE} ${ZLIB_CMAKE} ${LIBXML2})
LINUX_RELEASE_dk_queueCommand		(${DKCMAKE_BUILD} -DLIBXML2_WITH_PYTHON=OFF "-DCMAKE_C_FLAGS=-DLIBXML_THREAD_ENABLED -DHAVE_ERRNO_H -I${LIBXML2_INCLUDE_DIR2}" ${LIBICONV_CMAKE} ${XZ_CMAKE} ${ZLIB_CMAKE} ${LIBXML2})
