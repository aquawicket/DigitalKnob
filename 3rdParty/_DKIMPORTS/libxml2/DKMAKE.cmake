...
#DKIMPORT(https://github.com/GNOME/libxml2 PATCH)
DKIMPORT(https://github.com/GNOME/libxml2/archive/f2ad86fa600885429a6083aaf6926c7e2e5b24d6.zip PATCH)
#DKSET(LIBXML2_VERSION 2.9.8)
#DKSET(LIBXML2_NAME libxml2-${LIBXML2_VERSION})
#DKSET(LIBXML2_DL https://github.com/GNOME/libxml2/archive/refs/tags/v${LIBXML2_VERSION}.zip)
#DKSET(LIBXML2 ${3RDPARTY}/${LIBXML2_NAME})
...
### 3RDPARTY LINK ###
WIN_DKSET(LIBXML2_CMAKE -DLIBXML2_INCLUDE_DIR=${LIBXML2}/include -DLIBXML2_LIBRARIES=${LIBXML2}/${OS}/${RELEASE_DIR}/xml2.lib)
APPLE_DKSET(LIBXML2_CMAKE -DLIBXML2_INCLUDE_DIR=${LIBXML2}/include -DLIBXML2_LIBRARIES=${LIBXML2}/${OS}/${RELEASE_DIR}/libxml2.a)
LINUX_DKSET(LIBXML2_CMAKE -DLIBXML2_INCLUDE_DIR=${LIBXML2}/include -DLIBXML2_LIBRARIES=${LIBXML2}/${OS}/${RELEASE_DIR}/libxml2.a)
RASPBERRY_DKSET(LIBXML2_CMAKE -DLIBXML2_INCLUDE_DIR=${LIBXML2}/include -DLIBXML2_LIBRARIES=${LIBXML2}/${OS}/${RELEASE_DIR}/libxml2.a)
ANDROID_DKSET(LIBXML2_CMAKE -DLIBXML2_INCLUDE_DIR=${LIBXML2}/include -DLIBXML2_LIBRARIES=${LIBXML2}/${OS}/${RELEASE_DIR}/libxml2.a)
