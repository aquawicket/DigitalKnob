...
MAC_RELEASE_DKLIB(${SDLGPU}/${OS}/SDL_gpu/lib/Release/libSDL2_gpu.a)
IOS_DEBUG_DKLIB(${SDLGPU}/${OS}/SDL_gpu/lib/Debug/libSDL2_gpu_s.a)
IOS_RELEASE_DKLIB(${SDLGPU}/${OS}/SDL_gpu/lib/Release/libSDL2_gpu_s.a)
IOSSIM_DEBUG_DKLIB(${SDLGPU}/${OS}/SDL_gpu/lib/Debug/libSDL2_gpu_s.a)
IOSSIM_RELEASE_DKLIB(${SDLGPU}/${OS}/SDL_gpu/lib/Release/libSDL2_gpu_s.a)
LINUX_DEBUG_DKLIB(${SDLGPU}/${OS}/SDL_gpu/lib/Debug/libSDL2_gpu_s.a)
LINUX_RELEASE_DKLIB(${SDLGPU}/${OS}/SDL_gpu/lib/Release/libSDL2_gpu_s.a)
RASPBERRY_DEBUG_DKLIB(${SDLGPU}/${OS}/SDL_gpu/lib/Debug/libSDL2_gpu_s.a)
RASPBERRY_RELEASE_DKLIB(${SDLGPU}/${OS}/SDL_gpu/lib/Release/libSDL2_gpu_s.a)
ANDROID_DEBUG_DKLIB(${SDLGPU}/${OS}/SDL_gpu-VS/lib/Debug/libSDL2_gpu_s.a)
ANDROID_RELEASE_DKLIB(${SDLGPU}/${OS}/SDL_gpu-VS/lib/Release/libSDL2_gpu_s.a)
