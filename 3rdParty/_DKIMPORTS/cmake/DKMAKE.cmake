...
dk_getFileParam ("$ENV{DKIMPORTS_DIR}/cmake/dkconfig.txt" CMAKE_LINUX_AARCH64_DL)
dk_getFileParam	("$ENV{DKIMPORTS_DIR}/cmake/dkconfig.txt" CMAKE_LINUX_X86_64_DL)
dk_getFileParam	("$ENV{DKIMPORTS_DIR}/cmake/dkconfig.txt" CMAKE_MAC_10_DL)
dk_getFileParam	("$ENV{DKIMPORTS_DIR}/cmake/dkconfig.txt" CMAKE_MAC_UNIVERSAL_DL)
dk_getFileParam	("$ENV{DKIMPORTS_DIR}/cmake/dkconfig.txt" CMAKE_WIN_ARM64_DL)
dk_getFileParam	("$ENV{DKIMPORTS_DIR}/cmake/dkconfig.txt" CMAKE_WIN_X86_DL)
dk_getFileParam	("$ENV{DKIMPORTS_DIR}/cmake/dkconfig.txt" CMAKE_WIN_X86_64_DL)
...
elseif(WIN_HOST)
	...
	if(MAC_HOST)
		...
		dk_import(${CMAKE_DL} PATH $ENV{DKTOOLS_DIR}/${CMAKE_FOLDER})
	...
	if(WIN_HOST)
		if(NOT CMAKE_EXE)
			...
			if(NOT EXISTS ${CMAKE_EXE})
				...
				dk_download(${CMAKE_DL} $ENV{DKDOWNLOAD_DIR})			
				dk_nativePath("$ENV{DKDOWNLOAD_DIR}/${CMAKE_DL_FILE}" CMAKE_INSTALL_FILE)
