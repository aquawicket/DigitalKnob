...
if(MSYSTEM)
	...
	dk_command(command -v cmake.exe OUTPUT_VARIABLE CMAKE_EXE NOASSERT BASH)
	if(CMAKE_EXE)
	...
	dk_command(command -v cmake.exe OUTPUT_VARIABLE CMAKE_EXE BASH)
	if(CMAKE_EXE)
		dk_command(cygpath -m ${CMAKE_EXE} OUTPUT_VARIABLE CMAKE_EXE)
	endif()
	...
	if(WIN_HOST)
		...
		dk_command(command -v cmake OUTPUT_VARIABLE CMAKE_EXE BASH)
		if(NOT EXISTS ${CMAKE_EXE})
