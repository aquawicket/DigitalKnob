...
dk_getFileParam ("${DKIMPORTS_DIR}/cmake/dkconfig.txt" CMAKE_LINUX_AARCH64_DL)
dk_getFileParam	("${DKIMPORTS_DIR}/cmake/dkconfig.txt" CMAKE_LINUX_X86_64_DL)
dk_getFileParam	("${DKIMPORTS_DIR}/cmake/dkconfig.txt" CMAKE_MAC_10_DL)
dk_getFileParam	("${DKIMPORTS_DIR}/cmake/dkconfig.txt" CMAKE_MAC_UNIVERSAL_DL)
dk_getFileParam	("${DKIMPORTS_DIR}/cmake/dkconfig.txt" CMAKE_WIN_ARM64_DL)
	...
	if(WIN_HOST)
		if(NOT CMAKE_EXE)
			...
			if(NOT EXISTS ${CMAKE_EXE})
				...
				dk_nativePath("${DKTOOLS_DIR}/${CMAKE_FOLDER}" CMAKE_INSTALL_PATH)
