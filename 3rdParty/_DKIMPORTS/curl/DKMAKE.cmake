...
##ANDROID32_COMMAND(${DKCMAKE_ANDROID32} "-DCMAKE_C_FLAGS=-DANDROID32 -D_ANDROID -DHAVE_POSIX_STRERROR_R" -DBUILD_CURL_EXE=OFF -DBUILD_CURL_TESTS=OFF -DCURL_STATICLIB=ON -DCMAKE_USE_OPENSSL=OFF ${ZLIB_ANDROID} ${CURL})
##ANDROID64_COMMAND(${DKCMAKE_ANDROID64} "-DCMAKE_C_FLAGS=-DANDROID64 -D_ANDROID -DHAVE_POSIX_STRERROR_R" -DBUILD_CURL_EXE=OFF -DBUILD_CURL_TESTS=OFF -DCURL_STATICLIB=ON -DCMAKE_USE_OPENSSL=OFF ${ZLIB_ANDROID} ${CURL})
