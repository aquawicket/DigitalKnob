...
IOSSIM_PATH(${CURL}/${OS})
IOSSIM64_COMMAND(${DKCMAKE_IOSSIM64} -DBUILD_CURL_EXE=OFF -DBUILD_CURL_TESTS=OFF -DCURL_STATICLIB=ON -DCURL_DISABLE_LDAP=ON -DCMAKE_USE_OPENSSL=OFF  ${ZLIB_APPLE} ${CURL})
