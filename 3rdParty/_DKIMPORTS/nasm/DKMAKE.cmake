...
if(LINUX_X86_HOST)
	...
	#dk_depend(rpm)
	#dk_command(${SUDO_EXE} rpm -i ${DKDOWNLOAD_DIR}/nasm-2.16.01-0.fc36.i686.rpm)
	...
	dk_validate(ALIEN_EXE "dk_depend(alien)")
	dk_command(${SUDO_EXE} ${ALIEN_EXE} -i ${DKDOWNLOAD_DIR}/linux/nasm-2.16.01-0.fc36.i686.rpm)
...
if(LINUX_HOST)
	...
	#dk_depend(rpm)
	#dk_command(${SUDO_EXE} rpm -i ${DKDOWNLOAD_DIR}/nasm-2.16.01-0.fc36.x86_64.rpm)
	
	dk_download(https://www.nasm.us/pub/nasm/releasebuilds/2.16.01/linux/nasm-2.16.01-0.fc36.x86_64.rpm)
	dk_validate(SUDO_EXE "dk_depend(sudo)")
	dk_validate(ALIEN_EXE "dk_depend(alien)")
	dk_command(${SUDO_EXE} ${ALIEN_EXE} -i ${DKDOWNLOAD_DIR}/nasm-2.16.01-0.fc36.x86_64.rpm)
	dk_set(NASM_EXE ${NASM_DIR}/nasm)
endif()
