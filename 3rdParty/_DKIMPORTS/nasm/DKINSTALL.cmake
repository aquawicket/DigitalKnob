...
############ nasm ############
# https://www.nasm.us
# https://www.nasm.us/pub/nasm/releasebuilds/2.16.01/linux/nasm-2.16.01-0.fc36.i686.rpm
...
# https://www.nasm.us/pub/nasm/releasebuilds/2.16.01/win32/nasm-2.16.01-win32.zip
# https://github.com/microsoft/vcpkg/files/12073957/nasm-2.16.01-win64.zip
function(DKINSTALL)
	if(Android_Host)
		return()
	endif()
	...
	if(Linux_X86_Host)
		...
		#dk_depend(rpm)
		#dk_exec(${sudo_exe} rpm -i ${DKDOWNLOAD_DIR}/nasm-2.16.01-0.fc36.i686.rpm)
	...
	if(Linux_X86_64_Host)
		...
		#dk_depend(rpm)
		#dk_exec(${sudo_exe} rpm -i ${DKDOWNLOAD_DIR}/nasm-2.16.01-0.fc36.x86_64.rpm)
