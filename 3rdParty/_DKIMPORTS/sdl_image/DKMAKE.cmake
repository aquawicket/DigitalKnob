...
if(MSVC)
	...
	WIN_dk_libDebug			(${SDL_IMAGE}/${triple}/lib/${DEBUG_DIR}/SDL_image.lib		SDL2_IMAGE_LIBRARY_DEBUG)
	WIN_dk_libRelease		(${SDL_IMAGE}/${triple}/lib/${RELEASE_DIR}/SDL_image.lib	SDL2_IMAGE_LIBRARY_RELEASE)
elseif(APPLE)
	dk_libDebug				(${SDL_IMAGE}/${triple}/lib/Debug/SDL_image.a				SDL2_IMAGE_LIBRARY_DEBUG)
	dk_libRelease			(${SDL_IMAGE}/${triple}/lib/Release/SDL_image.a				SDL2_IMAGE_LIBRARY_RELEASE)
else()
	dk_libDebug				(${SDL_IMAGE}/${triple}/${DEBUG_DIR}/lib/SDL_image.a		SDL2_IMAGE_LIBRARY_DEBUG)
	dk_libRelease			(${SDL_IMAGE}/${triple}/${RELEASE_DIR}/lib/SDL_image.a		SDL2_IMAGE_LIBRARY_RELEASE)
endif()
