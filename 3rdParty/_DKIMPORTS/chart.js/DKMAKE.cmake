...
#dk_install(${CHART.JS_DL} chart.js ${CHART.JS})


### INSTALL ###
## if(${CHARTJS_MAJOR} GREATER_EQUAL 3)
## dk_install(https://cdn.jsdelivr.net/npm/chart.js@${CHARTJS_MAJOR}.${CHARTJS_MINOR}.${CHARTJS_BUILD}/dist/chart.min.js Chart.js ${CHARTJS})
## else()
	#dk_install(${CHART.JS_DL} chart.js ${CHART.JS})
## endif()
