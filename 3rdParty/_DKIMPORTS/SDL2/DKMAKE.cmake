...
DKINSTALL(https://www.libsdl.org/release/${SDL2_NAME}.zip SDL2 ${SDL2_NAME})
...
LINUX_DEBUG_COMMAND(${DKCMAKE_LINUX_DEBUG} -DCMAKE_C_FLAGS=-fPIC -DSDL_SHARED=OFF -DVIDEO_OPENGLES=OFF -DDIRECTX=OFF -DVIDEO_WAYLAND=OFF ${SDL2})
LINUX_DEBUG_COMMAND(make SDL2-static)

LINUX_RELEASE_PATH(${SDL2}/${OS}/${RELEASE_DIR})
LINUX_RELEASE_COMMAND(${DKCMAKE_LINUX_RELEASE} -DCMAKE_C_FLAGS=-fPIC -DSDL_SHARED=OFF -DVIDEO_OPENGLES=OFF -DDIRECTX=OFF -DVIDEO_WAYLAND=OFF ${SDL2})
LINUX_RELEASE_COMMAND(make SDL2-static)


RASPBERRY_DEBUG_PATH(${SDL2}/${OS}/${DEBUG_DIR})
RASPBERRY_DEBUG_COMMAND(${DKCMAKE_RASPBERRY_DEBUG} -DCMAKE_C_FLAGS=-fPIC -DSDL_SHARED=OFF -DVIDEO_OPENGLES=ON ${SDL2})
RASPBERRY_DEBUG_COMMAND(make SDL2-static)

RASPBERRY_RELEASE_PATH(${SDL2}/${OS}/${RELEASE_DIR})
RASPBERRY_RELEASE_COMMAND(${DKCMAKE_RASPBERRY_RELEASE} -DCMAKE_C_FLAGS=-fPIC -DSDL_SHARED=OFF -DVIDEO_OPENGLES=ON ${SDL2})
RASPBERRY_RELEASE_COMMAND(make SDL2-static)


##ANDROID_NDK(${SDL2_NAME})
ANDROID_PATH(${SDL2}/${OS})
ANDROID32_COMMAND(${DKCMAKE_ANDROID32} -DCMAKE_TOOLCHAIN_FILE=${ANDROIDNDK}/build/cmake/android.toolchain.cmake -DSDL_SHARED=OFF -DVIDEO_OPENGLES=ON -DHIDAPI=OFF ${SDL2})
ANDROID64_COMMAND(${DKCMAKE_ANDROID64} -DCMAKE_TOOLCHAIN_FILE=${ANDROIDNDK}/build/cmake/android.toolchain.cmake -DSDL_SHARED=OFF -DVIDEO_OPENGLES=ON -DHIDAPI=OFF ${SDL2})
ANDROID_VS(${SDL2_NAME} SDL2.sln SDL2)
