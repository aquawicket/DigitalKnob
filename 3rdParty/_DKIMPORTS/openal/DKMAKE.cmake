...
WIN_DKQCOMMAND(${DKCMAKE_BUILD} "-DCMAKE_C_FLAGS=/DAL_LIBTYPE_STATIC" -DLIBTYPE=STATIC -DEXAMPLES=OFF -DFORCE_STATIC_VCRT=ON ${OGG_WIN_CMAKE} ${VORBIS_CMAKE} ${FLAC_CMAKE} ${OPENAL})
...
LINUX_DEBUG_DKQCOMMAND(${DKCMAKE_BUILD} -DLIBTYPE=STATIC -DEXAMPLES=OFF ${OGG_CMAKE} ${VORBIS_CMAKE} ${FLAC_CMAKE} ${OPENAL})
