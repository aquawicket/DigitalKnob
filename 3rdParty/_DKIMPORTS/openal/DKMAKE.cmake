...
### COMPILE ###
WIN_PATH(${OPENAL}/${OS})
WIN32_COMMAND(${DKCMAKE_BUILD} "-DCMAKE_C_FLAGS=/DWIN32 /D_WINDOWS /W3 /nologo /DAL_LIBTYPE_STATIC" -DLIBTYPE=STATIC -DEXAMPLES=OFF -DFORCE_STATIC_VCRT=ON ${OGG_WIN_CMAKE} ${VORBIS_WIN_RELEASE} ${FLAC_WIN} ${OPENAL})
WIN64_COMMAND(${DKCMAKE_BUILD} "-DCMAKE_C_FLAGS=/DWIN64 /D_WINDOWS /W3 /nologo /DAL_LIBTYPE_STATIC" -DLIBTYPE=STATIC -DEXAMPLES=OFF -DFORCE_STATIC_VCRT=ON ${OGG_WIN_CMAKE} ${VORBIS_WIN_RELEASE} ${FLAC_WIN} ${OPENAL})
WIN_VS(${OPENAL_NAME} OpenAL.sln OpenAL)


MAC_PATH(${OPENAL}/${OS})
MAC64_COMMAND(${DKCMAKE_BUILD} -DLIBTYPE=STATIC -DEXAMPLES=OFF ${OGG_MAC_CMAKE} ${VORBIS_MAC_RELEASE} ${FLAC_MAC} ${OPENAL})
MAC_XCODE(${OPENAL_NAME} OpenAL)


IOS_PATH(${OPENAL}/${OS})
IOS64_COMMAND(${DKCMAKE_BUILD} -DLIBTYPE=STATIC -DEXAMPLES=OFF ${OGG_IOS_CMAKE} ${VORBIS_IOS_RELEASE} ${FLAC_IOS} ${OPENAL})
IOS_XCODE(${OPENAL_NAME} OpenAL)


IOSSIM_PATH(${OPENAL}/${OS})
IOSSIM64_COMMAND(${DKCMAKE_BUILD} -DLIBTYPE=STATIC -DEXAMPLES=OFF ${OGG_IOSSIM_CMAKE} ${VORBIS_IOSSIM_RELEASE} ${FLAC_IOSSIM} ${OPENAL})
IOSSIM_XCODE(${OPENAL_NAME} OpenAL)


LINUX_DEBUG_PATH(${OPENAL}/${OS}/${DEBUG_DIR})
LINUX_DEBUG_COMMAND(${DKCMAKE_BUILD} -DLIBTYPE=STATIC -DEXAMPLES=OFF ${OGG_LINUX_CMAKE} ${VORBIS_LINUX_DEBUG} ${FLAC_LINUX_DEBUG} ${OPENAL})
LINUX_DEBUG_COMMAND(make)
LINUX_RELEASE_PATH(${OPENAL}/${OS}/${RELEASE_DIR})
LINUX_RELEASE_COMMAND(${DKCMAKE_BUILD} -DLIBTYPE=STATIC -DEXAMPLES=OFF ${OGG_LINUX_CMAKE} ${VORBIS_LINUX_RELEASE} ${FLAC_LINUX_RELEASE} ${OPENAL})
LINUX_RELEASE_COMMAND(make)


RASPBERRY_DEBUG_PATH(${OPENAL}/${OS}/${DEBUG_DIR})
RASPBERRY_DEBUG_COMMAND(${DKCMAKE_BUILD} -DLIBTYPE=STATIC -DEXAMPLES=OFF ${OGG_RASPBERRY_CMAKE} ${VORBIS_RASPBERRY_DEBUG} ${FLAC_RASPBERRY_DEBUG} ${OPENAL})
RASPBERRY_DEBUG_COMMAND(make)
RASPBERRY_RELEASE_PATH(${OPENAL}/${OS}/${RELEASE_DIR})
RASPBERRY_RELEASE_COMMAND(${DKCMAKE_BUILD} -DLIBTYPE=STATIC -DEXAMPLES=OFF ${OGG_RASPBERRY_CMAKE} ${VORBIS_RASPBERRY_RELEASE} ${FLAC_RASPBERRY_RELEASE} ${OPENAL})
RASPBERRY_RELEASE_COMMAND(make)


ANDROID_PATH(${OPENAL}/${OS})
ANDROID32_COMMAND(${DKCMAKE_BUILD} -DLIBTYPE=STATIC -DEXAMPLES=OFF ${OGG_ANDROID_CMAKE} ${VORBIS_ANDROID_DEBUG} ${FLAC_ANDROID} ${OPENAL})
ANDROID64_COMMAND(${DKCMAKE_BUILD} -DLIBTYPE=STATIC -DEXAMPLES=OFF ${OGG_ANDROID_CMAKE} ${VORBIS_ANDROID_RELEASE} ${FLAC_ANDROID} ${OPENAL})
