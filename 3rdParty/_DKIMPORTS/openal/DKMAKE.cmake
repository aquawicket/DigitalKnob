...
### 3RDPARTY LINK ###
WIN_dk_set				(OPENAL_CMAKE "-DCMAKE_C_FLAGS=/DAL_LIBTYPE_STATIC /I${OPENAL}/include/AL" -DOPENAL_INCLUDE_DIR=${OPENAL}/include/AL -DOPENAL_LIBRARY_DEBUG=${OPENAL}/${OS}/${DEBUG_DIR}/libopenal.a -DOPENAL_LIBRARY_RELEASE=${OPENAL}/${OS}/${RELEASE_DIR}/libopenal.a -DOPENAL_LIBRARY=${OPENAL}/${OS}/${RELEASE_DIR}/libopenal.a)
APPLE_dk_set			(OPENAL_CMAKE "-DCMAKE_C_FLAGS=-DAL_LIBTYPE_STATIC -I${OPENAL}/include/AL" -DOPENAL_INCLUDE_DIR=${OPENAL}/include/AL -DOPENAL_LIBRARY_DEBUG=${OPENAL}/${OS}/${DEBUG_DIR}/libopenal.a -DOPENAL_LIBRARY_RELEASE=${OPENAL}/${OS}/${RELEASE_DIR}/libopenal.a)
LINUX_DEBUG_dk_set		(OPENAL_CMAKE "-DCMAKE_C_FLAGS=-DAL_LIBTYPE_STATIC -I${OPENAL}/include" -DOPENAL_INCLUDE_DIR=${OPENAL}/include/AL -DOPENAL_LIBRARY=${OPENAL}/${OS}/${DEBUG_DIR}/libopenal.a)
LINUX_RELEASE_dk_set	(OPENAL_CMAKE "-DCMAKE_C_FLAGS=-DAL_LIBTYPE_STATIC -I${OPENAL}/include" -DOPENAL_INCLUDE_DIR=${OPENAL}/include/AL -DOPENAL_LIBRARY=${OPENAL}/${OS}/${RELEASE_DIR}/libopenal.a)
RASPBERRY_DEBUG_dk_set	(OPENAL_CMAKE "-DCMAKE_C_FLAGS=-DAL_LIBTYPE_STATIC -I${OPENAL}/include" -DOPENAL_INCLUDE_DIR=${OPENAL}/include/AL -DOPENAL_LIBRARY=${OPENAL}/${OS}/${DEBUG_DIR}/libopenal.a)
RASPBERRY_RELEASE_dk_set(OPENAL_CMAKE "-DCMAKE_C_FLAGS=-DAL_LIBTYPE_STATIC -I${OPENAL}/include" -DOPENAL_INCLUDE_DIR=${OPENAL}/include/AL -DOPENAL_LIBRARY=${OPENAL}/${OS}/${RELEASE_DIR}/libopenal.a)
ANDROID_dk_set			(OPENAL_CMAKE "-DCMAKE_C_FLAGS=-DAL_LIBTYPE_STATIC -I${OPENAL}/include/AL" -DOPENAL_INCLUDE_DIR=${OPENAL}/include/AL -DOPENAL_LIBRARY=${OPENAL}/${OS}/${RELEASE_DIR}/libopenal.a -DOPENAL_LIBRARY_DEBUG=${OPENAL}/${OS}/${DEBUG_DIR}/libopenal.a -DOPENAL_LIBRARY_RELEASE=${OPENAL}/${OS}/${RELEASE_DIR}/libopenal.a)
