...
if(Android AND Debug)
	dk_include				(${OPENAL.Debug_Dir}/jni)
endif()
if(Android AND Release)	
	dk_include				(${OPENAL.Release_Dir}/jni)
endif()
...
if(Android AND Debug)
	dk_libDebug				("${OPENAL.Debug_Dir}/obj/local/armeabi-v7a/libopenal.a"	OPENAL_LIBRARY_DEBUG)
elseif(Android AND Release)
	dk_libRelease			("${OPENAL.Release_Dir}/obj/local/armeabi-v7a/libopenal.a"	OPENAL_LIBRARY_RELEASE)
elseif(Windows AND Debug)
	dk_libDebug				("${OPENAL.Debug_Dir}/OpenAL32.lib"							OPENAL_LIBRARY_DEBUG)
elseif(Windows AND Release)
	dk_libRelease			("${OPENAL.Release_Dir}/OpenAL32.lib"						OPENAL_LIBRARY_RELEASE)
elseif(Debug)
	dk_libDebug				("${OPENAL.Debug_Dir}/libopenal.a"							OPENAL_LIBRARY_DEBUG)
elseif(Release)
	dk_libRelease			("${OPENAL.Release_Dir}/libopenal.a"						OPENAL_LIBRARY_RELEASE)
endif()
