...
if(MSVC)
	WIN_TARGET_dk_libDebug		(${FREETYPE}/${OS}/${DEBUG_DIR}/freetype.lib		FREETYPE_LIBRARY_DEBUG)
	WIN_TARGET_dk_libRelease	(${FREETYPE}/${OS}/${RELEASE_DIR}/freetype.lib		FREETYPE_LIBRARY_RELEASE)
else()
