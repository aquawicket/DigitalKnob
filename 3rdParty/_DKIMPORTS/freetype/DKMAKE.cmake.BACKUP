...
if(HAVE_bzip2)
	...
	DKSET(FREETYPE_LIBS "${FREETYPE_LIBS} -DFT_DISABLE_BZIP2=1")
endif()
...
if(HAVE_libpng AND NOT RASPBERRY)
...
if(HAVE_harfbuzz)
	...
	DKSET(FREETYPE_LIBS "${FREETYPE_LIBS} -DFT_DISABLE_HARFBUZZ=1 -DCMAKE_DISABLE_FIND_PACKAGE_HarfBuzz=1")
endif()
...
DKQCOMMAND(${DKCMAKE_BUILD} ${FREETYPE_LIBS} -DSKIP_INSTALL_ALL=1 ${FREETYPE})
