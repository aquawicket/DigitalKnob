...
WIN_dk_command(${DKCMAKE_BUILD} -DOF_PATH=${OPENFRAMEWORKS} "-DCMAKE_C_FLAGS=/I${GLEW}/include /I${GLEW}/include" ${OPENFRAMEWORKS})
UNIX_dk_command(${DKCMAKE_BUILD} -DOF_PATH=${OPENFRAMEWORKS} "-DCMAKE_C_FLAGS=-I${GLEW}/include -I${GLEW}/include" ${OPENFRAMEWORKS})
