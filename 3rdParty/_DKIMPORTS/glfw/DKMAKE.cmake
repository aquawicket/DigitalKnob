...
if(MSVC)
	WIN_TARGET_dk_libDebug		(${GLFW}/${OS}/${DEBUG_DIR}/src/glfw3.lib		GLFW_LIBRARY_DEBUG)
	WIN_TARGET_dk_libRelease	(${GLFW}/${OS}/${RELEASE_DIR}/src/glfw.lib		GLFW_LIBRARY_RELEASE)
elseif(MAC)
