...
EMSCRIPTEN_dk_queueShell		(chmod 777 configure)
EMSCRIPTEN_dk_queueShell		(chmod 777 build-aux/git-version-gen)
EMSCRIPTEN_dk_queueShell		(chmod 777 build-aux/install-sh)
EMSCRIPTEN_DEBUG_dk_setPath		(${GZIP}/${OS}/${DEBUG_DIR})
EMSCRIPTEN_DEBUG_dk_queueShell	(${GZIP_CONFIGURE})
EMSCRIPTEN_DEBUG_dk_queueShell	(make)
EMSCRIPTEN_RELEASE_dk_setPath	(${GZIP}/${OS}/${RELEASE_DIR})
EMSCRIPTEN_RELEASE_dk_queueShell(${GZIP_CONFIGURE})
