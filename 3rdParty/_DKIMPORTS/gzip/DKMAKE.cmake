...
WIN_DEBUG_dk_queueMsys	(${GZIP_CONFIGURE} --disable-dependency-tracking CFLAGS="-I${GZIP}/include -I${GZIP}/${OS}/${DEBUG_DIR}/lib")
WIN_DEBUG_dk_queueMsys	(make gzip)
WIN_RELEASE_dk_setPath	(${GZIP}/${OS}/${RELEASE_DIR})
WIN_RELEASE_dk_queueMsys(${GZIP_CONFIGURE} --disable-dependency-tracking CFLAGS="-I${GZIP}/include -I${GZIP}/${OS}/${RELEASE_DIR}/lib")
