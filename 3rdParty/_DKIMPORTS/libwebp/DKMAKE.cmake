...
APPLE_RELEASE_DKLIB(${WEBP}/${OS}/WebP.build/${RELEASE_DIR}/webpdsp.build/libwebpdsp.a)
APPLE_DEBUG_DKLIB(${WEBP}/${OS}/WebP.build/${DEBUG_DIR}/webpencode.build/libwebpencode.a)
APPLE_RELEASE_DKLIB(${WEBP}/${OS}/WebP.build/${RELEASE_DIR}/webpencode.build/libwebpencode.a)
APPLE_DEBUG_DKLIB(${WEBP}/${OS}/WebP.build/${DEBUG_DIR}/webputils.build/libwebputils.a)
APPLE_RELEASE_DKLIB(${WEBP}/${OS}/WebP.build/${RELEASE_DIR}/webputils.build/libwebputils.a)
LINUX_DEBUG_DKLIB(${WEBP}/${OS}/${DEBUG_DIR}/libwebp.a)
LINUX_RELEASE_DKLIB(${WEBP}/${OS}/${RELEASE_DIR}/libwebp.a)
RASPBERRY_DEBUG_DKLIB(${WEBP}/${OS}/${DEBUG_DIR}/libwebp.a)
RASPBERRY_RELEASE_DKLIB(${WEBP}/${OS}/${RELEASE_DIR}/libwebp.a)
ANDROID_DEBUG_DKLIB(${WEBP}/${OS}/${DEBUG_DIR}/libwebp.a)
ANDROID_RELEASE_DKLIB(${WEBP}/${OS}/${RELEASE_DIR}/libwebp.a)
