...
if(MSVC)
	WIN_TARGET_dk_libDebug			(${LIBWEBP}/${OS}/${DEBUG_DIR}/libwebp.lib									WEBP_LIBRARY_DEBUG)
	WIN_TARGET_dk_libRelease		(${LIBWEBP}/${OS}/${RELEASE_DIR}/libwebp.lib								WEBP_LIBRARY_RELEASE)
#elseif(APPLE)
