...
### COMPILE ###
WIN_PATH(${WEBP}/${OS})
WIN32_COMMAND(${DKCMAKE_BUILD} ${ZLIB_CMAKE} ${PNG_WIN} ${JPEG_WIN} ${TIFF_WIN} ${GIF_WIN} ${SDL2_WIN} ${WEBP})
WIN64_COMMAND(${DKCMAKE_BUILD} ${PNG_WIN64} ${JPEG_WIN64} ${TIFF_WIN64} ${GIF_WIN64} ${SDL2_WIN64} ${WEBP})
WIN_VS(${WEBP_NAME} WebP.sln webp)


MAC_PATH(${WEBP}/${OS})
MAC32_COMMAND(${DKCMAKE_BUILD} ${PNG_MAC32} ${JPEG_MAC32} ${TIFF_MAC32} ${GIF_MAC32} ${SDL2_MAC32} ${WEBP})
MAC64_COMMAND(${DKCMAKE_BUILD} ${PNG_MAC64} ${JPEG_MAC64} ${TIFF_MAC64} ${GIF_MAC64} ${SDL2_MAC64} ${WEBP})
MAC_XCODE(${WEBP_NAME} webp)


IOS_PATH(${WEBP}/${OS})
IOS32_COMMAND(${DKCMAKE_BUILD} ${WEBP})
IOS64_COMMAND(${DKCMAKE_BUILD} ${WEBP})
IOS_XCODE(${WEBP_NAME} webp)


IOSSIM_PATH(${WEBP}/${OS})
IOSSIM32_COMMAND(${DKCMAKE_BUILD} ${WEBP})
IOSSIM64_COMMAND(${DKCMAKE_BUILD} ${WEBP})
IOSSIM_XCODE(${WEBP_NAME} webp)


LINUX_DEBUG_PATH(${WEBP}/${OS}/${DEBUG_DIR})
LINUX_DEBUG_COMMAND(${DKCMAKE_BUILD} ${WEBP})
LINUX_DEBUG_COMMAND(make all)

LINUX_RELEASE_PATH(${WEBP}/${OS}/${RELEASE_DIR})
LINUX_RELEASE_COMMAND(${DKCMAKE_BUILD} ${WEBP})
LINUX_RELEASE_COMMAND(make all)


RASPBERRY_DEBUG_PATH(${WEBP}/${OS}/${DEBUG_DIR})
RASPBERRY_DEBUG_COMMAND(${DKCMAKE_BUILD} ${WEBP})
RASPBERRY_DEBUG_COMMAND(make all)

RASPBERRY_RELEASE_PATH(${WEBP}/${OS}/${RELEASE_DIR})
RASPBERRY_RELEASE_COMMAND(${DKCMAKE_BUILD} ${WEBP})
RASPBERRY_RELEASE_COMMAND(make all)


##ANDROID_NDK(${WEBP_NAME})
ANDROID_PATH(${WEBP}/${OS})
ANDROID32_COMMAND(${DKCMAKE_BUILD} ${PNG_ANDROID32} ${JPEG_ANDROID32} ${TIFF_ANDROID32} ${GIF_ANDROID32} ${SDL2_ANDROID32} ${WEBP})
ANDROID64_COMMAND(${DKCMAKE_BUILD} ${PNG_ANDROID64} ${JPEG_ANDROID64} ${TIFF_ANDROID64} ${GIF_ANDROID64} ${SDL2_ANDROID64} ${WEBP})
