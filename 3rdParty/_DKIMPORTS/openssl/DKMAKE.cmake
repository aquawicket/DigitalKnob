...
ANDROID_ARM32_DEBUG_dk_configure	(${OPENSSL} ../../Configure no-shared --debug android-arm -D__ANDROID_API__=31)
ANDROID_ARM64_DEBUG_dk_configure	(${OPENSSL} ../../Configure no-shared --debug android-arm64 -D__ANDROID_API__=31)
...
if(MINGW)
	DEBUG_dk_configure				(${OPENSSL} ../../Configure no-shared --debug)
endif()
...
ANDROID_ARM32_RELEASE_dk_configure	(${OPENSSL} ../../Configure no-shared --release android-arm -D__ANDROID_API__=31)
ANDROID_ARM64_RELEASE_dk_configure	(${OPENSSL} ../../Configure no-shared --release android-arm64 -D__ANDROID_API__=31)
...
LINUX_RELEASE_dk_configure			(../../Configure no-shared --release)
