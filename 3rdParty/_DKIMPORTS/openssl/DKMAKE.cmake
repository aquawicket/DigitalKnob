...
if(DEBUG)
	if(android_arm32)
		dk_configure		(${OPENSSL_DIR} ${PERL_EXE} ../../Configure no-shared --debug android-arm CC=clang -D__ANDROID_API__=${ANDROID_API})
	elseif(android_arm64)
		dk_configure		(${OPENSSL_DIR} ${PERL_EXE} ../../Configure no-shared --debug android-arm64 CC=clang -D__ANDROID_API__=${ANDROID_API})
	elseif(emscripten)
...
if(RELEASE)
	...
	elseif(win_x86_msvc)
		dk_configure	(${OPENSSL_DIR} ${PERL_EXE} ../../Configure no-shared --release msvc)
	elseif(win_x86_64_clang)
		dk_prependEnvPath(${MSYS2}/clang364/bin)
		dk_prependEnvPath(${MSYS2}/usr/bin)
		dk_configure	(${OPENSSL_DIR} ${PERL_EXE} ../../Configure no-shared --release mingw64 CC=clang)
	elseif(win_x86_64_msvc)
		dk_configure	(${OPENSSL_DIR} ${PERL_EXE} ../../Configure no-shared --release msvc64)
	endif()
endif()
