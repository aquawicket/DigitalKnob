...
if(Debug)
	list(APPEND OPENSSL_INCLUDE_DIR ${OPENSSL_DEBUG_INCLUDE_DIR})
endif()
if(Release)
	list(APPEND OPENSSL_INCLUDE_DIR ${OPENSSL_RELEASE_INCLUDE_DIR})
endif()
