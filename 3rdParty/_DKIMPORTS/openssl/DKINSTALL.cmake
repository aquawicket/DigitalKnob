...
dk_include				(${OPENSSL.Config_Dir}/include					OPENSSL_INCLUDE_DIR2)
dk_set					(OPENSSL_ROOT_DIR 								${OPENSSL.Config_Dir})
if(MSVC)
	if(Windows_X86)
	...
	dk_libDebug			(${OPENSSL.Config_Dir}/libcrypto.lib			OPENSSL_CRYPTO_DEBUG_LIBRARY)
	dk_libRelease		(${OPENSSL.Config_Dir}/libcrypto.lib			OPENSSL_CRYPTO_RELEASE_LIBRARY)
	dk_libDebug			(${OPENSSL.Config_Dir}/libssl.lib				OPENSSL_SSL_DEBUG_LIBRARY)
	dk_libRelease		(${OPENSSL.Config_Dir}/libssl.lib				OPENSSL_SSL_RELEASE_LIBRARY)
	dk_libDebug			(${OPENSSL.Config_Dir}/providers/liblegacy.lib	OPENSSL_LEGACY_DEBUG_LIBRARY)
	dk_libRelease		(${OPENSSL.Config_Dir}/providers/liblegacy.lib	OPENSSL_LEGACY_RELEASE_LIBRARY)
else()
	dk_libDebug			(${OPENSSL.Config_Dir}/libcrypto.a				OPENSSL_CRYPTO_DEBUG_LIBRARY)
	dk_libRelease		(${OPENSSL.Config_Dir}/libcrypto.a				OPENSSL_CRYPTO_RELEASE_LIBRARY)
	dk_libDebug			(${OPENSSL.Config_Dir}/libssl.a					OPENSSL_SSL_DEBUG_LIBRARY)
	dk_libRelease		(${OPENSSL.Config_Dir}/libssl.a					OPENSSL_SSL_RELEASE_LIBRARY)
	dk_libDebug			(${OPENSSL.Config_Dir}/providers/liblegacy.a	OPENSSL_LEGACY_DEBUG_LIBRARY)
	dk_libRelease		(${OPENSSL.Config_Dir}/providers/liblegacy.a	OPENSSL_LEGACY_RELEASE_LIBRARY)
endif()
dk_set					(OPENSSL_LIBRARIES								${OPENSSL.Config_Dir})
if(Debug)
...
dk_exec(${PERL_EXE} configdata.pm --dump WORKING_DIRECTORY ${OPENSSL.Config_Dir})
