...
ANDROID_TARGET_dk_include		(${TIDY_HTML5}/${OS}/$(BUILD_TYPE)/jni)

if(MSVC)
	WIN_TARGET_dk_libDebug		(${TIDY_HTML5}/${OS}/${DEBUG_DIR}/tidy_staticd.lib)
	WIN_TARGET_dk_libRelease	(${TIDY_HTML5}/${OS}/${RELEASE_DIR}/tidy_static.lib)
elseif(MINGW)
	WIN_TARGET_dk_libDebug		(${TIDY_HTML5}/${OS}/${DEBUG_DIR}/libtidy_static.a)
	WIN_TARGET_dk_libRelease	(${TIDY_HTML5}/${OS}/${RELEASE_DIR}/libtidy_static.a)
else()
