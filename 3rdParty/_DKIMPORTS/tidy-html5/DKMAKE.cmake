...
### COMPILE ###
WIN_PATH(${TIDY}/${OS})
WIN32_COMMAND(${DKCMAKE_WIN32} ${ZLIB_CMAKE} ${TIDY})
WIN64_COMMAND(${DKCMAKE_WIN64} ${ZLIB_CMAKE} ${TIDY})
WIN_VS(${TIDY_NAME} tidy.sln tidy-static)


MAC_PATH(${TIDY}/${OS})
MAC64_COMMAND(${DKCMAKE_MAC64} ${ZLIB_CMAKE} ${TIDY})
MAC_XCODE(${TIDY_NAME} tidy)


IOS_PATH(${TIDY}/${OS})
IOS64_COMMAND(${DKCMAKE_IOS64} ${ZLIB_CMAKE} ${TIDY})
IOS_XCODE(${TIDY_NAME} tidy)


IOSSIM_PATH(${TIDY}/${OS})
IOSSIM64_COMMAND(${DKCMAKE_IOSSIM64} ${ZLIB_CMAKE} ${TIDY})
IOSSIM_XCODE(${TIDY_NAME} tidy)


LINUX_DEBUG_PATH(${TIDY}/${OS}/${DEBUG_DIR})
LINUX_DEBUG_COMMAND(${DKCMAKE_LINUX_DEBUG} ${ZLIB_CMAKE} ${TIDY})
LINUX_DEBUG_COMMAND(make tidy)

LINUX_RELEASE_PATH(${TIDY}/${OS}/${RELEASE_DIR})
LINUX_RELEASE_COMMAND(${DKCMAKE_LINUX_RELEASE} ${ZLIB_CMAKE} ${TIDY})
LINUX_RELEASE_COMMAND(make tidy)


RASPBERRY_DEBUG_PATH(${TIDY}/${OS}/${DEBUG_DIR})
RASPBERRY_DEBUG_COMMAND(${DKCMAKE_RASPBERRY_DEBUG} ${ZLIB_CMAKE} ${TIDY})
RASPBERRY_DEBUG_COMMAND(make tidy)

RASPBERRY_RELEASE_PATH(${TIDY}/${OS}/${RELEASE_DIR})
RASPBERRY_RELEASE_COMMAND(${DKCMAKE_RASPBERRY_RELEASE} ${ZLIB_CMAKE} ${TIDY})
RASPBERRY_RELEASE_COMMAND(make tidy)


#ANDROID_NDK(${TIDY_NAME})
ANDROID_PATH(${TIDY}/${OS})
ANDROID32_COMMAND(${DKCMAKE_ANDROID32} ${ZLIB_CMAKE} ${TIDY})
ANDROID64_COMMAND(${DKCMAKE_ANDROID64} ${ZLIB_CMAKE} ${TIDY})
