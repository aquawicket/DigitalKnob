...
if(MSVC)
	...
	DEBUG_dk_set	(XZ_CMAKE "-DCMAKE_C_FLAGS=-DLZMA_API_STATIC" "-DCMAKE_CXX_FLAGS=-DLZMA_API_STATIC" -DLIBLZMA_INCLUDE_DIR=${LIBLZMA_INCLUDE_DIR} -DLIBLZMA_LIBRARY=${LIBLZMA_LIBRARY_DEBUG})
	RELEASE_dk_set	(XZ_CMAKE "-DCMAKE_C_FLAGS=-DLZMA_API_STATIC" "-DCMAKE_CXX_FLAGS=-DLZMA_API_STATIC" -DLIBLZMA_INCLUDE_DIR=${LIBLZMA_INCLUDE_DIR} -DLIBLZMA_LIBRARY=${LIBLZMA_LIBRARY_RELEASE})
endif()
