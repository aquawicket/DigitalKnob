...
if(MSVC)
	...
	DEBUG_dk_set	(XZ_CMAKE "-DCMAKE_C_FLAGS=-DLZMA_API_STATIC" "-DCMAKE_CXX_FLAGS=-DLZMA_API_STATIC" -DLIBLZMA_INCLUDE_DIR=${XZ}/src/liblzma/api -DLIBLZMA_LIBRARY=${XZ}/${OS}/${DEBUG_DIR}/liblzma.a)
	RELEASE_dk_set	(XZ_CMAKE "-DCMAKE_C_FLAGS=-DLZMA_API_STATIC" "-DCMAKE_CXX_FLAGS=-DLZMA_API_STATIC" -DLIBLZMA_INCLUDE_DIR=${XZ}/src/liblzma/api -DLIBLZMA_LIBRARY=${XZ}/${OS}/${RELEASE_DIR}/liblzma.a)
endif()
