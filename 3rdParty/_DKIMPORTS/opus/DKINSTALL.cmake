...
if(MSVC)
	dk_libDebug		(${OPUS.Debug_Dir}/opus.lib			OpusFile_LIBRARY_DEBUG)
	dk_libRelease	(${OPUS.Release_Dir}/opus.lib		OpusFile_LIBRARY_RELEASE)
else()
	dk_libDebug		(${OPUS.Debug_Dir}/libopus.a		OpusFile_LIBRARY_DEBUG)
	dk_libRelease	(${OPUS.Release_Dir}/libopus.a		OpusFile_LIBRARY_RELEASE)
endif()
if(Debug)
