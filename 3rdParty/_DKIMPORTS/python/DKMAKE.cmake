...
IF(WIN AND NOT EXISTS ${PYTHON_APP})
	...
	dk_command(cmd /c ${DKDOWNLOAD}/python-2.7.18.msi /passive PrependPath=1 TargetDir=${PYTHON})
...
IF(MAC AND NOT EXISTS ${PYTHON_APP})
	...
	dk_command(${DKDOWNLOAD}/python-2.7.18-macosx10.9.pkg)
	#TODO
ENDIF()
IF(LINUX AND NOT EXISTS ${PYTHON_APP})
	dk_download(${PYTHON_DL} ${DKDOWNLOAD}/Python-2.7.18.tgz)
	dk_command(${DKDOWNLOAD}/Python-2.7.18.tgz)
	#TODO
ENDIF()
