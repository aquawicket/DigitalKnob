...
### COMPILE ###
WIN_PATH(${SMPEG2}/${OS})
WIN32_COMMAND(${DKCMAKE_BUILD} ${SDL2_WIN} ${SMPEG2})
WIN64_COMMAND(${DKCMAKE_BUILD} ${SDL2_WIN} ${SMPEG2})
WIN_VS(${SMPEG2_NAME} SMPEG.sln SMPEG)


MAC_PATH(${SMPEG2}/${OS})
MAC64_COMMAND(${DKCMAKE_BUILD} ${SDL2_APPLE} ${SMPEG2})
MAC_XCODE(${SMPEG2_NAME} SMPEG)


IOS_PATH(${SMPEG2}/${OS})
IOS64_COMMAND(${DKCMAKE_BUILD} ${SDL2_APPLE} ${SMPEG2})
IOS_XCODE(${SMPEG2_NAME} SMPEG)


IOSSIM_PATH(${SMPEG2}/${OS})
IOSSIM64_COMMAND(${DKCMAKE_BUILD} ${SDL2_APPLE} ${SMPEG2})
IOSSIM_XCODE(${SMPEG2_NAME} SMPEG)


LINUX_DEBUG_PATH(${SMPEG2}/${OS}/${DEBUG_DIR})
LINUX_DEBUG_COMMAND(${DKCMAKE_BUILD} -DCMAKE_CXX_FLAGS=-Wno-narrowing ${SDL2_LINUX} ${SMPEG2})
LINUX_DEBUG_COMMAND(make SMPEG)

LINUX_RELEASE_PATH(${SMPEG2}/${OS}/${RELEASE_DIR})
LINUX_RELEASE_COMMAND(${DKCMAKE_BUILD} -DCMAKE_CXX_FLAGS=-Wno-narrowing ${SDL2_LINUX} ${SMPEG2})
LINUX_RELEASE_COMMAND(make SMPEG)


RASPBERRY_DEBUG_PATH(${SMPEG2}/${OS}/${DEBUG_DIR})
RASPBERRY_DEBUG_COMMAND(${DKCMAKE_BUILD} -DCMAKE_CXX_FLAGS=-Wno-narrowing ${SDL2_RASPBERRY} ${SMPEG2})
RASPBERRY_DEBUG_COMMAND(make SMPEG)

RASPBERRY_RELEASE_PATH(${SMPEG2}/${OS}/${RELEASE_DIR})
RASPBERRY_RELEASE_COMMAND(${DKCMAKE_BUILD} -DCMAKE_CXX_FLAGS=-Wno-narrowing ${SDL2_RASPBERRY} ${SMPEG2})
RASPBERRY_RELEASE_COMMAND(make SMPEG)


##ANDROID_NDK(${SMPEG2_NAME})
ANDROID_PATH(${SMPEG2}/${OS})
ANDROID32_COMMAND(${DKCMAKE_BUILD} ${SDL2_ANDROID} ${SMPEG2})
ANDROID64_COMMAND(${DKCMAKE_BUILD} ${SDL2_ANDROID} ${SMPEG2})
