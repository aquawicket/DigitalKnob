...
### COMPILE ###
WIN_DKSETPATH(${SMPEG2}/${OS})
WIN32_DKQCOMMAND(${DKCMAKE_BUILD} ${SDL2_WIN} ${SMPEG2})
WIN64_DKQCOMMAND(${DKCMAKE_BUILD} ${SDL2_WIN} ${SMPEG2})
WIN_VS(${SMPEG2_NAME} SMPEG.sln SMPEG)


MAC_DKSETPATH(${SMPEG2}/${OS})
MAC64_DKQCOMMAND(${DKCMAKE_BUILD} ${SDL2_APPLE} ${SMPEG2})
MAC_XCODE(${SMPEG2_NAME} SMPEG)


IOS_DKSETPATH(${SMPEG2}/${OS})
IOS64_DKQCOMMAND(${DKCMAKE_BUILD} ${SDL2_APPLE} ${SMPEG2})
IOS_XCODE(${SMPEG2_NAME} SMPEG)


IOSSIM_DKSETPATH(${SMPEG2}/${OS})
IOSSIM64_DKQCOMMAND(${DKCMAKE_BUILD} ${SDL2_APPLE} ${SMPEG2})
IOSSIM_XCODE(${SMPEG2_NAME} SMPEG)


LINUX_DEBUG_DKSETPATH(${SMPEG2}/${OS}/${DEBUG_DIR})
LINUX_DEBUG_DKQCOMMAND(${DKCMAKE_BUILD} -DCMAKE_CXX_FLAGS=-Wno-narrowing ${SDL2_LINUX} ${SMPEG2})
LINUX_DEBUG_DKQCOMMAND(make SMPEG)

LINUX_RELEASE_DKSETPATH(${SMPEG2}/${OS}/${RELEASE_DIR})
LINUX_RELEASE_DKQCOMMAND(${DKCMAKE_BUILD} -DCMAKE_CXX_FLAGS=-Wno-narrowing ${SDL2_LINUX} ${SMPEG2})
LINUX_RELEASE_DKQCOMMAND(make SMPEG)


RASPBERRY_DEBUG_DKSETPATH(${SMPEG2}/${OS}/${DEBUG_DIR})
RASPBERRY_DEBUG_DKQCOMMAND(${DKCMAKE_BUILD} -DCMAKE_CXX_FLAGS=-Wno-narrowing ${SDL2_RASPBERRY} ${SMPEG2})
RASPBERRY_DEBUG_DKQCOMMAND(make SMPEG)

RASPBERRY_RELEASE_DKSETPATH(${SMPEG2}/${OS}/${RELEASE_DIR})
RASPBERRY_RELEASE_DKQCOMMAND(${DKCMAKE_BUILD} -DCMAKE_CXX_FLAGS=-Wno-narrowing ${SDL2_RASPBERRY} ${SMPEG2})
RASPBERRY_RELEASE_DKQCOMMAND(make SMPEG)


##ANDROID_NDK(${SMPEG2_NAME})
ANDROID_DKSETPATH(${SMPEG2}/${OS})
ANDROID32_DKQCOMMAND(${DKCMAKE_BUILD} ${SDL2_ANDROID} ${SMPEG2})
ANDROID364_DKQCOMMAND(${DKCMAKE_BUILD} ${SDL2_ANDROID} ${SMPEG2})
