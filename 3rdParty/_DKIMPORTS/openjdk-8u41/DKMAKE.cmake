...
if(WIN_HOST)
	...
	set(registerJDK ${OPENJDK_8U41_DIR}/registerJDK.cmd)
	dk_getNativePath("${OPENJDK_8U41_DIR}" OPENJDK_8U41_WINDIR)
	...
	dk_fileAppend(${registerJDK} "set JAVA_HOME=${OPENJDK_8U41_WINDIR}\n")
	dk_fileAppend(${registerJDK} "setx JAVA_HOME ${OPENJDK_8U41_WINDIR}\n")
	dk_fileAppend(${registerJDK} "setx VS_JavaHome ${OPENJDK_8U41_WINDIR}\n")
	dk_fileAppend(${registerJDK} "setx STUDIO_JDK ${OPENJDK_8U41_WINDIR}\n")
	dk_fileAppend(${registerJDK} "setx STUDIO_GRADLE_JDK ${OPENJDK_8U41_WINDIR}\n")
	...
	dk_fileAppend(${registerJDK} "reg add \"HKLM\\SOFTWARE\\JavaSoft\\Java Runtime Environment\\${JAVA_VERSION}\" /v JavaHome /t REG_SZ /d \"${OPENJDK_8U41_WINDIR}\" /f\n")
	dk_fileAppend(${registerJDK} "reg add \"HKLM\\SOFTWARE\\JavaSoft\\Java Runtime Environment\\${JAVA_VERSION}\" /v RuntimeLib /t REG_SZ /d \"${OPENJDK_8U41_WINDIR}\\bin\\server\\jvm.dll\" /f\n")
	dk_executeProcess(${registerJDK})
	
	### Set Environment Variables ###
	dk_setEnv(JAVA_VERSION ${JAVA_VERSION})
	dk_setEnv(JAVA_HOME ${OPENJDK_8U41_WINDIR})
	dk_setEnv(VS_JavaHome ${OPENJDK_8U41_WINDIR})
	dk_setEnv(STUDIO_JDK ${OPENJDK_8U41_WINDIR})
	dk_setEnv(STUDIO_GRADLE_JDK ${OPENJDK_8U41_WINDIR})
endif()
