...
### GENERATE ###
Android_Debug_dk_configure		(${LIBVNCSERVER} "-DCMAKE_C_FLAGS=-I${LIBVNCSERVER} -I${LIBVNCSERVER_Debug_Dir}" ${libjpeg-turbo_CMAKE} ${libpng_CMAKE} ${openssl_CMAKE} ${sdl_CMAKE} ${zlib_CMAKE} -DWITH_JPEG=ON)
Android_Release_dk_configure	(${LIBVNCSERVER} "-DCMAKE_C_FLAGS=-I${LIBVNCSERVER} -I${LIBVNCSERVER_Release_Dir}" ${libjpeg-turbo_CMAKE} ${libpng_CMAKE} ${openssl_CMAKE} ${sdl_CMAKE} ${zlib_CMAKE} -DWITH_JPEG=ON)
...
Emscripten_Debug_dk_configure	(${LIBVNCSERVER} "-DCMAKE_C_FLAGS=-I${LIBVNCSERVER} -I${LIBVNCSERVER_Debug_Dir}" ${libjpeg-turbo_CMAKE} ${libpng_CMAKE} ${openssl_CMAKE} ${sdl_CMAKE} ${zlib_CMAKE} -DWITH_JPEG=ON)
Emscripten_Release_dk_configure	(${LIBVNCSERVER} "-DCMAKE_C_FLAGS=-I${LIBVNCSERVER} -I${LIBVNCSERVER_Release_Dir}" ${libjpeg-turbo_CMAKE} ${libpng_CMAKE} ${openssl_CMAKE} ${sdl_CMAKE} ${zlib_CMAKE} -DWITH_JPEG=ON)
Linux_Debug_dk_configure		(${LIBVNCSERVER} "-DCMAKE_C_FLAGS=-I${LIBVNCSERVER} -I${LIBVNCSERVER_Debug_Dir}" ${libjpeg-turbo_CMAKE} ${libpng_CMAKE} ${openssl_CMAKE} ${sdl_CMAKE} ${zlib_CMAKE} -DWITH_JPEG=ON)
Linux_Release_dk_configure		(${LIBVNCSERVER} "-DCMAKE_C_FLAGS=-I${LIBVNCSERVER} -I${LIBVNCSERVER_Release_Dir}" ${libjpeg-turbo_CMAKE} ${libpng_CMAKE} ${openssl_CMAKE} ${sdl_CMAKE} ${zlib_CMAKE} -DWITH_JPEG=ON)
Raspberry_Debug_dk_configure	(${LIBVNCSERVER} "-DCMAKE_C_FLAGS=-I${LIBVNCSERVER} -I${LIBVNCSERVER_Debug_Dir}" ${libjpeg-turbo_CMAKE} ${libpng_CMAKE} ${openssl_CMAKE} ${sdl_CMAKE} ${zlib_CMAKE} -DWITH_JPEG=ON)
Raspberry_Release_dk_configure	(${LIBVNCSERVER} "-DCMAKE_C_FLAGS=-I${LIBVNCSERVER} -I${LIBVNCSERVER_Release_Dir}" ${libjpeg-turbo_CMAKE} ${libpng_CMAKE} ${openssl_CMAKE} ${sdl_CMAKE} ${zlib_CMAKE} -DWITH_JPEG=ON)

if(MSVC)
	Windows_dk_configure			(${LIBVNCSERVER} "/DCMAKE_C_FLAGS=/I${LIBVNCSERVER} /I${LIBVNCSERVER}/${Target_Tuple}/include" ${libjpeg-turbo_CMAKE} ${libpng_CMAKE} ${openssl_CMAKE} ${sdl_CMAKE} ${zlib_CMAKE} /DWITH_JPEG=ON)
else()
	Windows_dk_configure			(${LIBVNCSERVER} "-DCMAKE_C_FLAGS=-I${LIBVNCSERVER} -I${LIBVNCSERVER}/${Target_Tuple}/include" ${libjpeg-turbo_CMAKE} ${libpng_CMAKE} ${openssl_CMAKE} ${sdl_CMAKE} ${zlib_CMAKE} -DWITH_JPEG=ON)
endif()
