...
DEBUG_dk_include		(${LIBVNCSERVER}/${OS}/${DEBUG_DIR})
RELEASE_dk_include		(${LIBVNCSERVER}/${OS}/${RELEASE_DIR})
DEBUG_dk_include		(${LIBVNCSERVER}/${OS}/${DEBUG_DIR}/include)
RELEASE_dk_include		(${LIBVNCSERVER}/${OS}/${RELEASE_DIR}/include)

# vncserver
if(MSVC)
	dk_libDebug		(${LIBVNCSERVER}/${OS}/${DEBUG_DIR}/vncserver.lib)
	dk_libRelease	(${LIBVNCSERVER}/${OS}/${RELEASE_DIR}/vncserver.lib)
else()
	dk_libDebug		(${LIBVNCSERVER}/${OS}/${DEBUG_DIR}/libvncserver.a)
	dk_libRelease	(${LIBVNCSERVER}/${OS}/${RELEASE_DIR}/libvncserver.a)
endif()

# vncclient
if(MSVC)
	dk_libDebug		(${LIBVNCSERVER}/${OS}/${DEBUG_DIR}/vncclient.lib)
	dk_libRelease	(${LIBVNCSERVER}/${OS}/${RELEASE_DIR}/vncclient.lib)
else()
	dk_libDebug		(${LIBVNCSERVER}/${OS}/${DEBUG_DIR}/libvncclient.a)
	dk_libRelease	(${LIBVNCSERVER}/${OS}/${RELEASE_DIR}/libvncclient.a)
endif()
...
if(MSVC)
	WIN_TARGET_dk_set				(LIBVNCSERVER_CMAKE "/DCMAKE_C_FLAGS=/I${LIBVNCSERVER} /I${LIBVNCSERVER}/${OS}" "/DCMAKE_CXX_FLAGS=/I${LIBVNCSERVER} /I${LIBVNCSERVER}/${OS}" /DLIBVNCSERVER_INCLUDE_DIR=${LIBVNCSERVER} /DLIBVNCSERVER_LIBRARY=${LIBVNCSERVER}/${OS}/${RELEASE_DIR}/vncserver.lib /DLIBVNCCLIENT_LIBRARY=${LIBVNCSERVER}/${OS}/${RELEASE_DIR}/vncclient.lib)
else()
	WIN_TARGET_dk_set				(LIBVNCSERVER_CMAKE "-DCMAKE_C_FLAGS=-I${LIBVNCSERVER} -I${LIBVNCSERVER}/${OS}" "-DCMAKE_CXX_FLAGS==I${LIBVNCSERVER} =I${LIBVNCSERVER}/${OS}" -DLIBVNCSERVER_INCLUDE_DIR=${LIBVNCSERVER} -DLIBVNCSERVER_LIBRARY=${LIBVNCSERVER}/${OS}/${RELEASE_DIR}/vncserver.lib -DLIBVNCCLIENT_LIBRARY=${LIBVNCSERVER}/${OS}/${RELEASE_DIR}/vncclient.lib)
endif()

### GENERATE ###
ANDROID_DEBUG_dk_configure		(${LIBVNCSERVER} "-DCMAKE_C_FLAGS=-I${LIBVNCSERVER} -I${LIBVNCSERVER}/${OS}/${DEBUG_DIR}" ${LIBJPEG_TURBO_CMAKE} ${LIBPNG_CMAKE} ${OPENSSL_CMAKE} ${SDL_CMAKE} ${ZLIB_CMAKE} -DWITH_JPEG=ON)
ANDROID_RELEASE_dk_configure	(${LIBVNCSERVER} "-DCMAKE_C_FLAGS=-I${LIBVNCSERVER} -I${LIBVNCSERVER}/${OS}/${RELEASE_DIR}" ${LIBJPEG_TURBO_CMAKE} ${LIBPNG_CMAKE} ${OPENSSL_CMAKE} ${SDL_CMAKE} ${ZLIB_CMAKE} -DWITH_JPEG=ON)
...
EMSCRIPTEN_TARGET_DEBUG_dk_configure	(${LIBVNCSERVER} "-DCMAKE_C_FLAGS=-I${LIBVNCSERVER} -I${LIBVNCSERVER}/${OS}/${DEBUG_DIR}" ${LIBJPEG_TURBO_CMAKE} ${LIBPNG_CMAKE} ${OPENSSL_CMAKE} ${SDL_CMAKE} ${ZLIB_CMAKE} -DWITH_JPEG=ON)
EMSCRIPTEN_RELEASE_dk_configure	(${LIBVNCSERVER} "-DCMAKE_C_FLAGS=-I${LIBVNCSERVER} -I${LIBVNCSERVER}/${OS}/${RELEASE_DIR}" ${LIBJPEG_TURBO_CMAKE} ${LIBPNG_CMAKE} ${OPENSSL_CMAKE} ${SDL_CMAKE} ${ZLIB_CMAKE} -DWITH_JPEG=ON)
LINUX_DEBUG_dk_configure		(${LIBVNCSERVER} "-DCMAKE_C_FLAGS=-I${LIBVNCSERVER} -I${LIBVNCSERVER}/${OS}/${DEBUG_DIR}" ${LIBJPEG_TURBO_CMAKE} ${LIBPNG_CMAKE} ${OPENSSL_CMAKE} ${SDL_CMAKE} ${ZLIB_CMAKE} -DWITH_JPEG=ON)
LINUX_RELEASE_dk_configure		(${LIBVNCSERVER} "-DCMAKE_C_FLAGS=-I${LIBVNCSERVER} -I${LIBVNCSERVER}/${OS}/${RELEASE_DIR}" ${LIBJPEG_TURBO_CMAKE} ${LIBPNG_CMAKE} ${OPENSSL_CMAKE} ${SDL_CMAKE} ${ZLIB_CMAKE} -DWITH_JPEG=ON)
RASPBERRY_DEBUG_dk_configure	(${LIBVNCSERVER} "-DCMAKE_C_FLAGS=-I${LIBVNCSERVER} -I${LIBVNCSERVER}/${OS}/${DEBUG_DIR}" ${LIBJPEG_TURBO_CMAKE} ${LIBPNG_CMAKE} ${OPENSSL_CMAKE} ${SDL_CMAKE} ${ZLIB_CMAKE} -DWITH_JPEG=ON)
RASPBERRY_RELEASE_dk_configure	(${LIBVNCSERVER} "-DCMAKE_C_FLAGS=-I${LIBVNCSERVER} -I${LIBVNCSERVER}/${OS}/${RELEASE_DIR}" ${LIBJPEG_TURBO_CMAKE} ${LIBPNG_CMAKE} ${OPENSSL_CMAKE} ${SDL_CMAKE} ${ZLIB_CMAKE} -DWITH_JPEG=ON)

if(MSVC)
	WIN_TARGET_dk_configure			(${LIBVNCSERVER} "/DCMAKE_C_FLAGS=/I${LIBVNCSERVER} /I${LIBVNCSERVER}/${OS}/include" ${LIBJPEG_TURBO_CMAKE} ${LIBPNG_CMAKE} ${OPENSSL_CMAKE} ${SDL_CMAKE} ${ZLIB_CMAKE} /DWITH_JPEG=ON)
else()
	WIN_TARGET_dk_configure			(${LIBVNCSERVER} "-DCMAKE_C_FLAGS=-I${LIBVNCSERVER} -I${LIBVNCSERVER}/${OS}/include" ${LIBJPEG_TURBO_CMAKE} ${LIBPNG_CMAKE} ${OPENSSL_CMAKE} ${SDL_CMAKE} ${ZLIB_CMAKE} -DWITH_JPEG=ON)
endif()
