...
WIN32_COMMAND(${DKCMAKE_BUILD} ${OPENSSL_WIN} ${PNG_WIN} -DWITH_JPEG=ON ${JPEG_WIN} ${ZLIB_CMAKE} ${VNCSERVER})
WIN64_COMMAND(${DKCMAKE_BUILD} ${OPENSSL_WIN} ${PNG_WIN} -DWITH_JPEG=ON ${JPEG_WIN} ${ZLIB_CMAKE} ${VNCSERVER})
WIN_VS(${VNCSERVER_NAME} LibVNCServer.sln vncserver)
WIN_VS(${VNCSERVER_NAME} LibVNCServer.sln vncclient)


MAC_PATH(${VNCSERVER}/${OS})
MAC64_COMMAND(${DKCMAKE_BUILD} -DWITH_JPEG=ON ${OPENSSL_APPLE} ${PNG_APPLE} ${JPEG_APPLE} ${ZLIB_CMAKE} ${VNCSERVER})
MAC_XCODE(${VNCSERVER_NAME} vncserver)
MAC_XCODE(${VNCSERVER_NAME} vncclient)

IOS_PATH(${VNCSERVER}/${OS})
IOS64_COMMAND(${DKCMAKE_BUILD} -DWITH_JPEG=ON ${OPENSSL_APPLE} ${PNG_APPLE} ${JPEG_APPLE} ${ZLIB_CMAKE} ${VNCSERVER})
IOS_XCODE(${VNCSERVER_NAME} vncserver)
IOS_XCODE(${VNCSERVER_NAME} vncclient)

IOSSIM_PATH(${VNCSERVER}/${OS})
IOSSIM64_COMMAND(${DKCMAKE_BUILD} -DWITH_JPEG=ON ${OPENSSL_APPLE} ${PNG_APPLE} ${JPEG_APPLE} ${ZLIB_CMAKE} ${VNCSERVER})
IOSSIM_XCODE(${VNCSERVER_NAME} vncserver)
IOSSIM_XCODE(${VNCSERVER_NAME} vncclient)

LINUX_DEBUG_PATH(${VNCSERVER}/${OS}/${DEBUG_DIR})
LINUX_DEBUG_COMMAND(${DKCMAKE_BUILD} -DWITH_JPEG=ON ${OPENSSL_LINUX} ${PNG_LINUX} ${JPEG_LINUX} ${ZLIB_CMAKE} ${VNCSERVER})
LINUX_DEBUG_COMMAND(make vncserver)
LINUX_DEBUG_COMMAND(make vncclient)

LINUX_RELEASE_PATH(${VNCSERVER}/${OS}/${RELEASE_DIR})
LINUX_RELEASE_COMMAND(${DKCMAKE_BUILD} -DWITH_JPEG=ON ${OPENSSL_LINUX} ${PNG_LINUX} ${JPEG_LINUX} ${ZLIB_CMAKE} ${VNCSERVER})
...
ANDROID32_COMMAND(${DKCMAKE_BUILD} -DWITH_JPEG=ON ${OPENSSL_ANDROID} ${PNG_ANDROID} ${JPEG_ANDROID} ${ZLIB_CMAKE} ${VNCSERVER})
ANDROID64_COMMAND(${DKCMAKE_BUILD} -DWITH_JPEG=ON ${OPENSSL_ANDROID} ${PNG_ANDROID} ${JPEG_ANDROID} ${ZLIB_CMAKE} ${VNCSERVER})
