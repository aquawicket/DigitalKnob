...
LINUX_DEBUG_dk_queueCommand		(${DKCMAKE_BUILD} "-DCMAKE_CXX_FLAGS=-I${LIBJPEG-TURBO}/${OS}/Debug" ${OPENSSL_CMAKE} ${LIBPNG_CMAKE} ${ZLIB_CMAKE} -DWITH_JPEG=ON ${LIBJPEG-TURBO_CMAKE} ${LIBVNCSERVER})
LINUX_RELEASE_dk_queueCommand	(${DKCMAKE_BUILD} "-DCMAKE_CXX_FLAGS=-I${LIBJPEG-TURBO}/${OS}/Release" ${OPENSSL_CMAKE} ${LIBPNG_CMAKE} ${ZLIB_CMAKE} -DWITH_JPEG=ON ${LIBJPEG-TURBO_CMAKE} ${LIBVNCSERVER})
