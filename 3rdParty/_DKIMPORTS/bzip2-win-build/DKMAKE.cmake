...
#	dk_copy(${BZIP2-WIN-BUILD} ${BZIP2-WIN-BUILD}/copy OVERWRITE)
#endif()
...
if(WIN_32)
	...
	dk_copy(${BZIP2-WIN-BUILD}/build-VS2019 ${BZIP2-WIN-BUILD}/${OS})
	...
	WIN32_dk_visualStudio(${BZIP2-WIN-BUILD_NAME} libbz2-static)
endif()
...
if(WIN_64)
	...
	WIN64_dk_visualStudio(${BZIP2-WIN-BUILD_NAME} libbz2-static x64)
endif()
