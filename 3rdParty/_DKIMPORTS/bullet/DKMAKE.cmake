...
### COMPILE ###
WIN_DKSETPATH(${BULLET}/${OS})
WIN32_DKQCOMMAND(${DKCMAKE_BUILD} -DBUILD_DEMOS=OFF -DBUILD_EXTRAS=OFF -DUSE_GLUT=OFF ${BULLET})
WIN64_DKQCOMMAND(${DKCMAKE_BUILD} -DBUILD_DEMOS=OFF -DBUILD_EXTRAS=OFF -DUSE_GLUT=OFF ${BULLET})
WIN_VS(${BULLET_NAME} BULLET_PHYSICS.sln)


MAC_DKSETPATH(${BULLET}/${OS})
MAC64_DKQCOMMAND(${DKCMAKE_BUILD} -DBUILD_DEMOS=OFF -DBUILD_EXTRAS=OFF -DUSE_GLUT=OFF ${BULLET})
MAC_XCODE(${BULLET_NAME})


IOS_DKSETPATH(${BULLET}/ios)
IOS64_DKQCOMMAND(${DKCMAKE_BUILD} -DBUILD_DEMOS=OFF -DBUILD_EXTRAS=OFF -DUSE_GLUT=OFF ${BULLET})
IOS_XCODE(${BULLET_NAME})


IOSSIM_DKSETPATH(${BULLET}/ios-simulator)
IOSSIM64_DKQCOMMAND(${DKCMAKE_BUILD} -DBUILD_DEMOS=OFF -DBUILD_EXTRAS=OFF -DUSE_GLUT=OFF ${BULLET})
IOSSIM_XCODE(${BULLET_NAME})


LINUX_DEBUG_DKSETPATH(${BULLET}/${OS}/${DEBUG_DIR})
LINUX_DEBUG_DKQCOMMAND(${DKCMAKE_BUILD} -DBUILD_DEMOS=OFF -DBUILD_EXTRAS=OFF -DUSE_GLUT=OFF ${BULLET})
LINUX_DEBUG_DKQCOMMAND(make)

LINUX_RELEASE_DKSETPATH(${BULLET}/${OS}/${RELEASE_DIR})
LINUX_RELEASE_DKQCOMMAND(${DKCMAKE_BUILD} -DBUILD_DEMOS=OFF -DBUILD_EXTRAS=OFF -DUSE_GLUT=OFF ${BULLET})
LINUX_RELEASE_DKQCOMMAND(make)


RASPBERRY_DEBUG_DKSETPATH(${BULLET}/${OS}/${DEBUG_DIR})
RASPBERRY_DEBUG_DKQCOMMAND(${DKCMAKE_BUILD} -DBUILD_DEMOS=OFF -DBUILD_EXTRAS=OFF -DUSE_GLUT=OFF ${BULLET})
RASPBERRY_DEBUG_DKQCOMMAND(make)

RASPBERRY_RELEASE_DKSETPATH(${BULLET}/${OS}/${RELEASE_DIR})
RASPBERRY_RELEASE_DKQCOMMAND(${DKCMAKE_BUILD} -DBUILD_DEMOS=OFF -DBUILD_EXTRAS=OFF -DUSE_GLUT=OFF ${BULLET})
