...
### COMPILE ###
WIN_PATH(${BULLET}/${OS})
WIN32_COMMAND(${DKCMAKE_BUILD} -DBUILD_DEMOS=OFF -DBUILD_EXTRAS=OFF -DUSE_GLUT=OFF ${BULLET})
WIN64_COMMAND(${DKCMAKE_BUILD} -DBUILD_DEMOS=OFF -DBUILD_EXTRAS=OFF -DUSE_GLUT=OFF ${BULLET})
WIN_VS(${BULLET_NAME} BULLET_PHYSICS.sln)


MAC_PATH(${BULLET}/${OS})
MAC64_COMMAND(${DKCMAKE_BUILD} -DBUILD_DEMOS=OFF -DBUILD_EXTRAS=OFF -DUSE_GLUT=OFF ${BULLET})
MAC_XCODE(${BULLET_NAME})


IOS_PATH(${BULLET}/ios)
IOS64_COMMAND(${DKCMAKE_BUILD} -DBUILD_DEMOS=OFF -DBUILD_EXTRAS=OFF -DUSE_GLUT=OFF ${BULLET})
IOS_XCODE(${BULLET_NAME})


IOSSIM_PATH(${BULLET}/ios-simulator)
IOSSIM64_COMMAND(${DKCMAKE_BUILD} -DBUILD_DEMOS=OFF -DBUILD_EXTRAS=OFF -DUSE_GLUT=OFF ${BULLET})
IOSSIM_XCODE(${BULLET_NAME})


LINUX_DEBUG_PATH(${BULLET}/${OS}/${DEBUG_DIR})
LINUX_DEBUG_COMMAND(${DKCMAKE_BUILD} -DBUILD_DEMOS=OFF -DBUILD_EXTRAS=OFF -DUSE_GLUT=OFF ${BULLET})
LINUX_DEBUG_COMMAND(make)

LINUX_RELEASE_PATH(${BULLET}/${OS}/${RELEASE_DIR})
LINUX_RELEASE_COMMAND(${DKCMAKE_BUILD} -DBUILD_DEMOS=OFF -DBUILD_EXTRAS=OFF -DUSE_GLUT=OFF ${BULLET})
LINUX_RELEASE_COMMAND(make)


RASPBERRY_DEBUG_PATH(${BULLET}/${OS}/${DEBUG_DIR})
RASPBERRY_DEBUG_COMMAND(${DKCMAKE_BUILD} -DBUILD_DEMOS=OFF -DBUILD_EXTRAS=OFF -DUSE_GLUT=OFF ${BULLET})
RASPBERRY_DEBUG_COMMAND(make)

RASPBERRY_RELEASE_PATH(${BULLET}/${OS}/${RELEASE_DIR})
RASPBERRY_RELEASE_COMMAND(${DKCMAKE_BUILD} -DBUILD_DEMOS=OFF -DBUILD_EXTRAS=OFF -DUSE_GLUT=OFF ${BULLET})
