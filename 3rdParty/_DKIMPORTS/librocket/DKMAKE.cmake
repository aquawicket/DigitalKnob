...
### COMPILE ###
WIN_DKSETPATH(${ROCKET}/${OS})
WIN32_DKQCOMMAND(${DKCMAKE_BUILD} "-DCMAKE_CXX_FLAGS=/DWIN32 /D_WINDOWS /W3 /nologo /GR /EHsc /I${ROCKET}/Include" ${FREETYPE_WIN} ${ROCKET}/Build)
WIN64_DKQCOMMAND(${DKCMAKE_BUILD} "-DCMAKE_CXX_FLAGS=/DWIN64 /D_WINDOWS /W3 /nologo /GR /EHsc /I${ROCKET}/Include" ${FREETYPE_WIN} ${ROCKET}/Build)
WIN_VS(${ROCKET_NAME} libRocket.sln)


MAC_DKSETPATH(${ROCKET}/${OS})
MAC64_DKQCOMMAND(${DKCMAKE_BUILD} ${FREETYPE_APPLE} ${ROCKET}/Build)
MAC_XCODE(${ROCKET_NAME})

IOS_DKSETPATH(${ROCKET}/${OS})
IOS64_DKQCOMMAND(${DKCMAKE_BUILD} ${FREETYPE_APPLE} ${ROCKET}/Build)
IOS_XCODE(${ROCKET_NAME})

IOSSIM_DKSETPATH(${ROCKET}/${OS})
IOSSIM64_DKQCOMMAND(${DKCMAKE_BUILD} ${FREETYPE_APPLE} ${ROCKET})
IOSSIM_XCODE(${ROCKET_NAME})


LINUX_DEBUG_DKSETPATH(${ROCKET}/${OS}/Debug)
LINUX_DEBUG_DKQCOMMAND(${DKCMAKE_BUILD} ${FREETYPE_LINUX} ${ROCKET}/Build)
LINUX_DEBUG_DKQCOMMAND(make)

LINUX_RELEASE_DKSETPATH(${ROCKET}/${OS}/${RELEASE_DIR})
LINUX_RELEASE_DKQCOMMAND(${DKCMAKE_BUILD} ${FREETYPE_LINUX} ${ROCKET}/Build)
