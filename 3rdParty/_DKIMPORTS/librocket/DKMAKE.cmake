...
### COMPILE ###
WIN_PATH(${ROCKET}/${OS})
WIN32_COMMAND(${DKCMAKE_BUILD} "-DCMAKE_CXX_FLAGS=/DWIN32 /D_WINDOWS /W3 /nologo /GR /EHsc /I${ROCKET}/Include" ${FREETYPE_WIN} ${ROCKET}/Build)
WIN64_COMMAND(${DKCMAKE_BUILD} "-DCMAKE_CXX_FLAGS=/DWIN64 /D_WINDOWS /W3 /nologo /GR /EHsc /I${ROCKET}/Include" ${FREETYPE_WIN} ${ROCKET}/Build)
WIN_VS(${ROCKET_NAME} libRocket.sln)


MAC_PATH(${ROCKET}/${OS})
MAC64_COMMAND(${DKCMAKE_BUILD} ${FREETYPE_APPLE} ${ROCKET}/Build)
MAC_XCODE(${ROCKET_NAME})

IOS_PATH(${ROCKET}/${OS})
IOS64_COMMAND(${DKCMAKE_BUILD} ${FREETYPE_APPLE} ${ROCKET}/Build)
IOS_XCODE(${ROCKET_NAME})

IOSSIM_PATH(${ROCKET}/${OS})
IOSSIM64_COMMAND(${DKCMAKE_BUILD} ${FREETYPE_APPLE} ${ROCKET})
IOSSIM_XCODE(${ROCKET_NAME})


LINUX_DEBUG_PATH(${ROCKET}/${OS}/Debug)
LINUX_DEBUG_COMMAND(${DKCMAKE_BUILD} ${FREETYPE_LINUX} ${ROCKET}/Build)
LINUX_DEBUG_COMMAND(make)

LINUX_RELEASE_PATH(${ROCKET}/${OS}/${RELEASE_DIR})
LINUX_RELEASE_COMMAND(${DKCMAKE_BUILD} ${FREETYPE_LINUX} ${ROCKET}/Build)
