...
WIN32_DKQCOMMAND(${DKCMAKE_BUILD} -DWITH_JPEG=ON ${OPENSSL_WIN} ${PNG_WIN} ${JPEG_WIN} ${ZLIB_CMAKE} ${VNCSERVER})
WIN64_DKQCOMMAND(${DKCMAKE_BUILD} -DWITH_JPEG=ON ${OPENSSL_WIN} ${PNG_WIN} ${JPEG_WIN} ${ZLIB_CMAKE} ${VNCSERVER})
