...
WIN32_COMMAND(${DKCMAKE_WIN32} -DWITH_JPEG=ON ${OPENSSL_WIN} ${PNG_WIN} ${JPEG_WIN} ${ZLIB_CMAKE} ${VNCSERVER})
WIN64_COMMAND(${DKCMAKE_WIN64} -DWITH_JPEG=ON ${OPENSSL_WIN} ${PNG_WIN} ${JPEG_WIN} ${ZLIB_CMAKE} ${VNCSERVER})
