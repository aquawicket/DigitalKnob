...
WIN32_COMMAND(${DKCMAKE_BUILD} -DWITH_JPEG=ON ${OPENSSL_WIN} ${PNG_WIN} ${JPEG_WIN} ${ZLIB_CMAKE} ${VNCSERVER})
WIN64_COMMAND(${DKCMAKE_BUILD} -DWITH_JPEG=ON ${OPENSSL_WIN} ${PNG_WIN} ${JPEG_WIN} ${ZLIB_CMAKE} ${VNCSERVER})
