...
LINUX_DEBUG_dk_queueCommand			(${DKCMAKE_BUILD} -DCMAKE_C_FLAGS=-fPIC -D0_BUILD_EXAMPLES_OALPP=OFF -D0_BUILD_EXAMPLES_OSGAUDIO=OFF -D0_BUILD_EXAMPLES_OSGAUDIO_LOWLEVEL=OFF -D0_ENABLE_SUBSYSTEM_OPENAL=ON -D0_ENABLE_SUBSYSTEM_FMOD=OFF -DFMOD_INCLUDE_DIR=OFF -DFMOD_LIBRARY=OFF -DOSGAUDIO_INSTALL_DATA=OFF ${OPENAL_CMAKE} ${FREEALUT_CMAKE} ${OGG_CMAKE} ${OPENSCENEGRAPH_CMAKE} ${VORBIS_CMAKE} ${OSGAUDIO})
LINUX_RELEASE_dk_queueCommand		(${DKCMAKE_BUILD} -DCMAKE_C_FLAGS=-fPIC -D0_BUILD_EXAMPLES_OALPP=OFF -D0_BUILD_EXAMPLES_OSGAUDIO=OFF -D0_BUILD_EXAMPLES_OSGAUDIO_LOWLEVEL=OFF -D0_ENABLE_SUBSYSTEM_OPENAL=ON -D0_ENABLE_SUBSYSTEM_FMOD=OFF -DFMOD_INCLUDE_DIR=OFF -DFMOD_LIBRARY=OFF -DOSGAUDIO_INSTALL_DATA=OFF ${OPENAL_CMAKE} ${FREEALUT_CMAKE} ${OGG_CMAKE} ${OPENSCENEGRAPH_CMAKE} ${VORBIS_CMAKE} ${OSGAUDIO})
RASPBERRY_DEBUG_dk_queueCommand		(${DKCMAKE_BUILD} -DCMAKE_C_FLAGS=-fPIC -D0_BUILD_EXAMPLES_OALPP=OFF -D0_BUILD_EXAMPLES_OSGAUDIO=OFF -D0_BUILD_EXAMPLES_OSGAUDIO_LOWLEVEL=OFF -D0_ENABLE_SUBSYSTEM_OPENAL=ON -D0_ENABLE_SUBSYSTEM_FMOD=OFF -DFMOD_INCLUDE_DIR=OFF -DFMOD_LIBRARY=OFF -DOSGAUDIO_INSTALL_DATA=OFF ${OPENAL_CMAKE} ${FREEALUT_CMAKE} ${OGG_CMAKE} ${OPENSCENEGRAPH_CMAKE} ${VORBIS_CMAKE} ${OSGAUDIO})
RASPBERRY_RELEASE_dk_queueCommand	(${DKCMAKE_BUILD} -DCMAKE_C_FLAGS=-fPIC -D0_BUILD_EXAMPLES_OALPP=OFF -D0_BUILD_EXAMPLES_OSGAUDIO=OFF -D0_BUILD_EXAMPLES_OSGAUDIO_LOWLEVEL=OFF -D0_ENABLE_SUBSYSTEM_OPENAL=ON -D0_ENABLE_SUBSYSTEM_FMOD=OFF -DFMOD_INCLUDE_DIR=OFF -DFMOD_LIBRARY=OFF -DOSGAUDIO_INSTALL_DATA=OFF ${OPENAL_CMAKE} ${FREEALUT_CMAKE} ${OGG_CMAKE} ${OPENSCENEGRAPH_CMAKE} ${VORBIS_CMAKE} ${OSGAUDIO})
ANDROID_dk_queueCommand				(${DKCMAKE_BUILD} -D0_BUILD_EXAMPLES_OALPP=OFF -D0_BUILD_EXAMPLES_OSGAUDIO=OFF -D0_BUILD_EXAMPLES_OSGAUDIO_LOWLEVEL=OFF -D0_ENABLE_SUBSYSTEM_OPENAL=ON -D0_ENABLE_SUBSYSTEM_FMOD=OFF -DFMOD_INCLUDE_DIR=OFF -DFMOD_LIBRARY=OFF -DOSGAUDIO_INSTALL_DATA=OFF ${OPENAL_CMAKE} ${FREEALUT_CMAKE} ${OGG_CMAKE} ${OPENSCENEGRAPH_CMAKE} ${VORBIS_CMAKE} ${OSGAUDIO})
