...
WIN_dk_queueCommand(${DKCMAKE_BUILD} "-DCMAKE_CXX_FLAGS=/DOSG_LIBRARY_STATIC /DAL_LIBTYPE_STATIC /I${OPENAL}/include" "-DOSGInstallType=Source And Build Tree" -DOSGBuildRoot=${OPENSCENEGRAPH}/${OS} -DOSGSourceRoot=${OPENSCENEGRAPH} ${FREEALUT_CMAKE} -D0_BUILD_EXAMPLES_OALPP=OFF -D0_BUILD_EXAMPLES_OSGAUDIO=OFF -D0_BUILD_EXAMPLES_OSGAUDIO_LOWLEVEL=OFF -D0_ENABLE_SUBSYSTEM_OPENAL=ON -D0_ENABLE_SUBSYSTEM_FMOD=OFF -DFMOD_INCLUDE_DIR=OFF -DFMOD_LIBRARY=OFF -DOSGAUDIO_INSTALL_DATA=OFF ${OPENAL_CMAKE} ${OGG_CMAKE} ${VORBIS_CMAKE} ${OSGAUDIO})

string(REPLACE "-std=c++17" "" OSGAUDIO_BUILD "${DKCMAKE_BUILD}")
string(REPLACE "  " " " OSGAUDIO_BUILD "${OSGAUDIO_BUILD}")
APPLE_dk_queueCommand(${OSGAUDIO_BUILD} "-DCMAKE_CXX_FLAGS=-I${OPENAL}/include -I${FREEALUT}/include" "-DOSGInstallType=Source And Build Tree" -DOSGBuildRoot=${OPENSCENEGRAPH}/${OS} -DOSGSourceRoot=${OPENSCENEGRAPH} -DALUT_INCLUDE_DIR=${OPENSCENEGRAPH}/include -DALUT_LIBRARY=${FREEALUT}/${OS}/${RELEASE_DIR}/libalut_static.a -DALUT_LIBRARY_DEBUG=${FREEALUT}/${OS}/${DEBUG_DIR}/libalut_static.a -D0_BUILD_EXAMPLES_OALPP=OFF -D0_BUILD_EXAMPLES_OSGAUDIO=OFF -D0_BUILD_EXAMPLES_OSGAUDIO_LOWLEVEL=OFF -D0_ENABLE_SUBSYSTEM_OPENAL=ON -D0_ENABLE_SUBSYSTEM_FMOD=OFF -DFMOD_INCLUDE_DIR=OFF -DFMOD_LIBRARY=OFF -DOSGAUDIO_INSTALL_DATA=OFF ${OPENAL} ${OGG_CMAKE} ${VORBIS_CMAKE} ${OSGAUDIO})

LINUX_DEBUG_dk_queueCommand(${DKCMAKE_BUILD} -DCMAKE_C_FLAGS=-fPIC "-DCMAKE_CXX_FLAGS=-I${OPENAL}/include -I${FREEALUT}/include" "-DOSGInstallType=Source And Build Tree" -DOSGBuildRoot=${OPENSCENEGRAPH}/${OS}/${DEBUG_DIR} -DOSGSourceRoot=${OPENSCENEGRAPH} -DALUT_INCLUDE_DIR=${OPENSCENEGRAPH}/include -DALUT_LIBRARY=${FREEALUT}/${OS}/${DEBUG_DIR}/libalut_static.a -DALUT_LIBRARY_DEBUG=${FREEALUT}/${OS}/${DEBUG_DIR}/libalut_static.a -D0_BUILD_EXAMPLES_OALPP=OFF -D0_BUILD_EXAMPLES_OSGAUDIO=OFF -D0_BUILD_EXAMPLES_OSGAUDIO_LOWLEVEL=OFF -D0_ENABLE_SUBSYSTEM_OPENAL=ON -D0_ENABLE_SUBSYSTEM_FMOD=OFF -DFMOD_INCLUDE_DIR=OFF -DFMOD_LIBRARY=OFF -DOSGAUDIO_INSTALL_DATA=OFF ${OPENAL_CMAKE} ${OGG_CMAKE} ${VORBIS_CMAKE} ${OSGAUDIO})

LINUX_RELEASE_dk_queueCommand(${DKCMAKE_BUILD} -DCMAKE_C_FLAGS=-fPIC "-DCMAKE_CXX_FLAGS=-I${OPENAL}/include -I${FREEALUT}/include" "-DOSGInstallType=Source And Build Tree" -DOSGBuildRoot=${OPENSCENEGRAPH}/${OS}/${RELEASE_DIR} -DOSGSourceRoot=${OPENSCENEGRAPH} -DALUT_INCLUDE_DIR=${OPENSCENEGRAPH}/include -DALUT_LIBRARY=${FREEALUT}/${OS}/${RELEASE_DIR}/libalut_static.a -DALUT_LIBRARY_DEBUG=${FREEALUT}/${OS}/${DEBUG_DIR}/libalut_static.a -D0_BUILD_EXAMPLES_OALPP=OFF -D0_BUILD_EXAMPLES_OSGAUDIO=OFF -D0_BUILD_EXAMPLES_OSGAUDIO_LOWLEVEL=OFF -D0_ENABLE_SUBSYSTEM_OPENAL=ON -D0_ENABLE_SUBSYSTEM_FMOD=OFF -DFMOD_INCLUDE_DIR=OFF -DFMOD_LIBRARY=OFF -DOSGAUDIO_INSTALL_DATA=OFF ${OPENAL_CMAKE} ${OGG_CMAKE} ${VORBIS_CMAKE} ${OSGAUDIO})
