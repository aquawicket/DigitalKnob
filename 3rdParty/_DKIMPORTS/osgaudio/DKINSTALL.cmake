...
Windows_dk_queueCommand					(${OSGAUDIO_BUILD} "-DCMAKE_CXX_FLAGS=/I${OSGAUDIO}/include" -D0_BUILD_EXAMPLES_OALPP=OFF -D0_BUILD_EXAMPLES_OSGAUDIO=OFF -D0_BUILD_EXAMPLES_OSGAUDIO_LOWLEVEL=OFF -D0_ENABLE_SUBSYSTEM_OPENAL=ON -D0_ENABLE_SUBSYSTEM_FMOD=OFF -DFMOD_INCLUDE_DIR=OFF -DFMOD_LIBRARY=OFF -DOSGAUDIO_INSTALL_DATA=OFF ${FREEALUT_CMAKE} ${OGG_CMAKE} ${OPENAL_CMAKE} ${OPENSCENEGRAPH_CMAKE} ${VORBIS_CMAKE} ${OSGAUDIO})
