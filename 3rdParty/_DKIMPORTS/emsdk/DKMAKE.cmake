...
dk_set				(EMSDK_TOOLCHAIN_FILE 		${EMSDK_DIR}/upstream/emscripten/cmake/Modules/Platform/Emscripten.cmake)
#if(WIN_HOST)
#	dk_set			(EMSDK_GENERATOR 			"MinGW Makefiles")
#else()
#	dk_set			(EMSDK_GENERATOR 			"Unix Makefiles")
#endif()
#dk_set				(EMSDK_AR 					"${EMSDK_DIR}/upstream/emscripten/emar${bat}")				# Name of archiving tool for static libraries.
#dk_set				(EMSDK_MAKE_PROGRAM			"${EMSDK_DIR}/upstream/emscripten/emmake${bat}")
#dk_set				(EMSDK_C_COMPILER		    "${EMSDK_DIR}/upstream/emscripten/emcc${bat}")
#dk_set				(EMSDK_C_COMPILER		    "${EMSDK_DIR}/upstream/bin/clang.exe")
#dk_set				(EMSDK_CXX_COMPILER	    	"${EMSDK_DIR}/upstream/emscripten/em++${bat}")
#dk_set				(EMSDK_CXX_COMPILER	    	"${EMSDK_DIR}/upstream/bin/clang++.exe")
#dk_set				(EMSDK_NM 					"${EMSDK_DIR}/upstream/emscripten/emnm${bat}")	
#dk_set				(EMSDK_RANLIB 				"${EMSDK_DIR}/upstream/emscripten/emranlib${bat}")
