...
dk_set(EMMAKE       "${EMSDK}/upstream/emscripten/emmake${bat}")
dk_set(EMNM         "${EMSDK}/upstream/emscripten/emnm${bat}")
...
dk_set			(CMAKE_C_COMPILER		    "${EMCC}")
dk_set			(CMAKE_CXX_COMPILER	    	"${EMXX}")
dk_set			(CMAKE_NM 					"${EMNM}")
dk_set			(CMAKE_AR 					"${EMAR}")
dk_set			(CMAKE_RANLIB 				"${EMRANLIB}")
