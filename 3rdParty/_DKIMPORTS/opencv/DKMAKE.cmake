...
### COMPILE ###
WIN_PATH(${OPENCV}/${OS})
WIN32_COMMAND(${DKCMAKE_WIN32} -DBUILD_SHARED_LIBS=OFF ${OPENCV})
WIN64_COMMAND(${DKCMAKE_WIN64} -DBUILD_SHARED_LIBS=OFF ${OPENCV})
...
RASPBERRY_DEBUG_COMMAND(${CMAKE_COMMAND} -G "Unix Makefiles" -DCMAKE_BUILD_TYPE=DEBUG -DBUILD_SHARED_LIBS=OFF -DCMAKE_C_FLAGS=-fPIC -DWITH_IPP=ON ${OPENCV})
...
RASPBERRY_RELEASE_COMMAND(${CMAKE_COMMAND} -G "Unix Makefiles" -DCMAKE_BUILD_TYPE=RELEASE -DBUILD_SHARED_LIBS=OFF -DCMAKE_C_FLAGS=-fPIC -DWITH_IPP=ON ${OPENCV})
...
ANDROID32_COMMAND(${DKCMAKE_ANDROID32} -DBUILD_SHARED_LIBS=OFF ${OPENCV})
ANDROID64_COMMAND(${DKCMAKE_ANDROID64} -DBUILD_SHARED_LIBS=OFF ${OPENCV})
