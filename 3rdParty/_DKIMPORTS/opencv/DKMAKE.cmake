...
WIN32_DEBUG_LIB(${OPENCV}/${OS}/3rdparty/ippicv/ippicv_win/icv/lib/ia32/ippicvmt.lib)
...
APPLE32_DEBUG_LIB(${OPENCV}/${OS}/3rdparty/ippicv/ippicv_mac/icv/lib/intel32/libippicv.a)
APPLE32_RELEASE_LIB(${OPENCV}/${OS}/3rdparty/ippicv/ippicv_mac/icv/lib/intel32/libippicv.a)
APPLE64_DEBUG_LIB(${OPENCV}/${OS}/3rdparty/ippicv/ippicv_mac/icv/lib/intel64/libippicv.a)
APPLE64_RELEASE_LIB(${OPENCV}/${OS}/3rdparty/ippicv/ippicv_mac/icv/lib/intel64/libippicv.a)
...
### COMPILE ###
WIN_PATH(${OPENCV}/${OS})
WIN32_COMMAND(${DKCMAKE_BUILD} ${OPENCV})
WIN64_COMMAND(${DKCMAKE_BUILD} -DCV_DISABLE_OPTIMIZATION=ON -DCPU_BASELINE="" -DCPU_DISPATCH="" ${OPENCV})
WIN_VS(${OPENCV_NAME} OpenCV.sln)


MAC_PATH(${OPENCV}/${OS})
MAC64_COMMAND(${DKCMAKE_BUILD} "-DCMAKE_CXX_FLAGS=-stdlib=libc++" ${OPENCV})
...
IOS_PATH(${OPENCV}/${OS})
IOS64_COMMAND(${DKCMAKE_BUILD} ${OPENCV})
...
IOSSIM64_COMMAND(${DKCMAKE_BUILD} ${OPENCV})
...
LINUX_DEBUG_COMMAND(${DKCMAKE_BUILD} ${OPENCV})
...
LINUX_RELEASE_COMMAND(${DKCMAKE_BUILD} ${OPENCV})
...
RASPBERRY_DEBUG_COMMAND(${DKCMAKE_BUILD} -DWITH_IPP=ON ${OPENCV})
...
RASPBERRY_RELEASE_COMMAND(${DKCMAKE_BUILD} -DWITH_IPP=ON ${OPENCV})
...
ANDROID32_COMMAND(${DKCMAKE_BUILD} ${OPENCV})
ANDROID64_COMMAND(${DKCMAKE_BUILD} ${OPENCV})
