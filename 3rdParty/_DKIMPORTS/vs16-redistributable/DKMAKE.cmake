...
DKSET(VS16REDIST_NAME vc_redist.${VS16REDIST_PLATFORM})
DKSET(VS16REDIST_DL https://aka.ms/vs/16/release/${VS16REDIST_NAME}.exe)
...
IF(NOT EXISTS "${VS16REDIST}")
	...
	DOWNLOAD(${VS16REDIST_DL} ${DKDOWNLOAD}/${VS16REDIST_NAME}.exe)
	DKCOMMAND(${DKDOWNLOAD}/${VS16REDIST_NAME}.exe)
ENDIF()
