...
::%setlocal%
	...
	if defined Windows_Arm64_Host   (set "POWERSHELL_IMPORT=https://github.com/PowerShell/PowerShell/releases/download/v7.4.2/PowerShell-7.4.2-win-arm64.zip")
    if defined Windows_X86_Host    	(set "POWERSHELL_IMPORT=https://github.com/PowerShell/PowerShell/releases/download/v7.4.2/PowerShell-7.4.2-win-x86.zip")
    if defined Windows_X86_64_Host	(set "POWERSHELL_IMPORT=https://github.com/PowerShell/PowerShell/releases/download/v7.4.2/PowerShell-7.4.2-win-x64.zip")
