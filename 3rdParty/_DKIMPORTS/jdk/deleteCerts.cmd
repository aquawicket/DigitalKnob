...
::"%KEYTOOL_EXE%" -delete -noprompt -alias google -file "%GOOGLE_CERT%" -storepass changeit
"%KEYTOOL_EXE%" -delete -noprompt -alias google -cacerts -file "%GOOGLE_CERT%" -storepass changeit
echo deleting "%MAVEN_CERT%"
::"%KEYTOOL_EXE%" -delete -noprompt -alias maven -file "%MAVEN_CERT%" -storepass changeit
