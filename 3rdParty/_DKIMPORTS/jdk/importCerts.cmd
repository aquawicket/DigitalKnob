...
::"%KEYTOOL_EXE%" -import -noprompt -alias google -file "%GOOGLE_CERT%" -storepass changeit
...
::"%KEYTOOL_EXE%" -import -noprompt -alias maven -file "%MAVEN_CERT%" -storepass changeit
