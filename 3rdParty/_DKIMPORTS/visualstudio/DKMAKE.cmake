...
if(EXISTS ${VISUALSTUDIO})
	...
	#dk_set(VISUALSTUDIO_GENERATOR_PLATFORM	"ARM64;Win32;x64"
...
elseif(win_x86_msvc)
	...
	set(CMAKE_C_COMPILER			${VISUALSTUDIO_X86_C_COMPILER})
	set(CMAKE_CXX_COMPILER			${VISUALSTUDIO_X86_CXX_COMPILER})
	set(CMAKE_LINKER				${VISUALSTUDIO_X86_LINKER})
	set(CMAKE_DUMPBIN				${VISUALSTUDIO_X86_DUMPBIN})
elseif(win_x86_64_msvc)
	set(CMAKE_GENERATOR_PLATFORM	x64)
	set(CMAKE_C_COMPILER			${VISUALSTUDIO_X64_C_COMPILER})
	set(CMAKE_CXX_COMPILER			${VISUALSTUDIO_X64_CXX_COMPILER})
	set(CMAKE_LINKER				${VISUALSTUDIO_X64_LINKER})
	set(CMAKE_DUMPBIN				${VISUALSTUDIO_X64_DUMPBIN})
else()
	dk_error("Could not determin CMAKE_GENERATOR_PLATFORM")
endif()
