...
%dk_call% dk_set VISUALSTUDIO_X86_64_COMPILER 				"%VISUALSTUDIO_COMMUNITY%\VC\Tools\MSVC\%VISUALSTUDIO_EDITION%\bin\Hostx64\x64\cl.exe"
...
%dk_call% dk_set VISUALSTUDIO_X86_64_LINKER 				"%VISUALSTUDIO_COMMUNITY%\VC\Tools\MSVC\%VISUALSTUDIO_EDITION%\bin\Hostx64\x64\link.exe"
...
%dk_call% dk_set VISUALSTUDIO_X86_64_DUMPBIN 				"%VISUALSTUDIO_COMMUNITY%\VC\Tools\MSVC\%VISUALSTUDIO_EDITION%\bin\Hostx86\x64\dumpbin.exe"
...
if defeind x86_64 {
	...
	%dk_call% dk_set VISUALSTUDIO_C_COMPILER			"%VISUALSTUDIO_X86_64_COMPILER%"
	%dk_call% dk_set VISUALSTUDIO_CXX_COMPILER			"%VISUALSTUDIO_X86_64_COMPILER%"
	%dk_call% dk_set VISUALSTUDIO_LINKER				"%VISUALSTUDIO_X86_64_LINKER%"
	%dk_call% dk_set VISUALSTUDIO_DUMPBIN				"%VISUALSTUDIO_X86_64_DUMPBIN%"
) else (
