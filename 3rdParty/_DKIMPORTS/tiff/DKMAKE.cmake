...
### COMPILE ###
WIN_PATH(${TIFF}/${OS})
WIN32_COMMAND(${DKCMAKE_BUILD} ${TIFF})
WIN64_COMMAND(${DKCMAKE_BUILD} ${TIFF})
WIN_VS(${TIFF_NAME} tiff.sln tiff-static)


MAC_PATH(${TIFF}/${OS})
MAC64_COMMAND(${DKCMAKE_BUILD} ${TIFF})
MAC_XCODE(${TIFF_NAME} tiff-static)


IOS_PATH(${TIFF}/${OS})
IOS64_COMMAND(${DKCMAKE_BUILD} ${TIFF})
IOS_XCODE(${TIFF_NAME} tiff-static)


IOSSIM_PATH(${TIFF}/${OS})
IOSSIM64_COMMAND(${DKCMAKE_BUILD} ${TIFF})
IOSSIM_XCODE(${TIFF_NAME} tiff-static)


LINUX_DEBUG_PATH(${TIFF}/${OS}/${DEBUG_DIR})
LINUX_DEBUG_COMMAND(${DKCMAKE_BUILD} ${ZLIB_CMAKE} ${TIFF})
LINUX_DEBUG_COMMAND(make)
LINUX_RELEASE_PATH(${TIFF}/${OS}/${RELEASE_DIR})
LINUX_RELEASE_COMMAND(${DKCMAKE_BUILD} ${ZLIB_CMAKE} ${TIFF})
LINUX_RELEASE_COMMAND(make)


RASPBERRY_DEBUG_PATH(${TIFF}/${OS}/${DEBUG_DIR})
RASPBERRY_DEBUG_COMMAND(${DKCMAKE_BUILD} ${TIFF})
RASPBERRY_DEBUG_COMMAND(make tiff-static)
RASPBERRY_RELEASE_PATH(${TIFF}/${OS}/${RELEASE_DIR})
RASPBERRY_RELEASE_COMMAND(${DKCMAKE_BUILD} ${TIFF})
