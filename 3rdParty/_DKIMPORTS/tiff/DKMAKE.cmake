...
DKSET(TIFF_LINUX "-DCMAKE_CXX_FLAGS=-I${TIFF}/libtiff -I${TIFF}/${OS}/${RELEASE}" -DTIFF_INCLUDE_DIR=${TIFF}/libtiff -DTIFF_INCLUDE_DIR2=${TIFF}/${OS}/${RELEASE} -DTIFF_LIBRARY_DEBUG=${TIFF}/${OS}/${DEBUG}/libtiff-static.a -DTIFF_LIBRARY_RELEASE=${TIFF}/${OS}/${RELEASE}/libtiff-static.a)
