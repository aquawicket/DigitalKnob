...
elseif(APPLE)
	...
	DEBUG_dk_set	(TIFF_CMAKE -DTIFF_INCLUDE_DIR=${TIFF_INCLUDE_DIR} -DTIFF_LIBRARY_DEBUG=${TIFF_LIBRARY_DEBUG} -DTIFF_LIBRARY_RELEASE=${TIFF_LIBRARY_RELEASE} -DTIFF_INCLUDE_DIR2=${TIFF}/${OS}/${DEBUG_DIR}/libtiff  "-DCMAKE_C_FLAGS=-I${TIFF}/${OS}/${DEBUG_DIR}/libtiff" "-DCMAKE_CXX_FLAGS=-I${TIFF}/${OS}/${DEBUG_DIR}/libtiff")
