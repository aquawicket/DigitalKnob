...
### COMPILE ###
#DKSETPATH(${TIFF}/${OS})
WIN32_COMMAND(${CMAKE_COMMAND} -G ${GENERATOR} -A Win32 "-DCMAKE_CXX_FLAGS=/DWIN32 /D_WINDOWS /W3 /nologo /GR /EHsc" "-DCMAKE_CXX_FLAGS_DEBUG=/MTd /Od /Ob0 /Zi /RTC1 /DDEBUG /D_DEBUG" "-DCMAKE_CXX_FLAGS_RELEASE=/MT /O2 /Ob2 /DNDEBUG" -S ${TIFF} -B ${TIFF}/${OS})
WIN32_VS_DEBUG(tiff-${TIFF_VERSION} tiff.sln tiff-static)
WIN32_VS_RELEASE(tiff-${TIFF_VERSION} tiff.sln tiff-static)
...
WIN64_VS_DEBUG(tiff-${TIFF_VERSION} tiff.sln tiff-static)
WIN64_VS_RELEASE(tiff-${TIFF_VERSION} tiff.sln tiff-static)
