...
dk_include					(${TIFF.Config_Dir}/libtiff								TIFF_INCLUDE_DIRS)
#Debug_dk_include			(${TIFF.Config_Dir}/libtiff/${Debug_Dir}				TIFF_INCLUDE_DIRS)
#Release_dk_include			(${TIFF.Config_Dir}/libtiff/${Release_Dir}				TIFF_INCLUDE_DIRS)
if(MULTI_CONFIG)
	if(MSVC)
		dk_libDebug			(${TIFF.Config_Dir}/libtiff/${Debug_Dir}/tiffd.lib		TIFF_LIBRARY_DEBUG)
		dk_libRelease		(${TIFF.Config_Dir}/libtiff/${Release_Dir}/tiff.lib		TIFF_LIBRARY_RELEASE)
	else()
		dk_libDebug			(${TIFF.Config_Dir}/libtiff/${Debug_Dir}/libtiff.a		TIFF_LIBRARY_DEBUG)
		dk_libRelease		(${TIFF.Config_Dir}/libtiff/${Release_Dir}/libtiff.a	TIFF_LIBRARY_RELEASE)
	endif()
else()	
		dk_libDebug			(${TIFF.Config_Dir}/libtiff/libtiff.a					TIFF_LIBRARY_DEBUG)
		dk_libRelease		(${TIFF.Config_Dir}/libtiff/libtiff.a					TIFF_LIBRARY_RELEASE)
endif()
