...
### GENERATE ###
dk_queueCommand	(${DKCMAKE_BUILD} -DSDL2MIXER_DEPS_SHARED=OFF -DSDL2MIXER_OPUS=OFF -DSDL2MIXER_VENDORED=OFF ${OGG_CMAKE} ${SDL_CMAKE} ${SMPEG2_CMAKE} ${VORBIS_CMAKE} ${SDL_MIXER})
