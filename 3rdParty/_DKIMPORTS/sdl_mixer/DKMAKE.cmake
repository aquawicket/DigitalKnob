...
WIN_dk_libDebug			(${SDL_MIXER}/${OS}/lib/${DEBUG_DIR}/SDL2_mixer-staticd.lib)
WIN_dk_libRelease		(${SDL_MIXER}/${OS}/lib/${RELEASE_DIR}/SDL2_mixer-static.lib)
...
### GENERATE ###
dk_queueCommand	(${DKCMAKE_BUILD} -DSDL2MIXER_DEPS_SHARED=OFF -DSDL2MIXER_FLAC=OFF -DSDL2MIXER_MIDI=OFF -DSDL2MIXER_MOD=OFF -DSDL2MIXER_OPUS=OFF -DSDL2MIXER_VENDORED=OFF ${FLAC_CMAKE} ${OGG_CMAKE} ${SDL_CMAKE} ${SMPEG2_CMAKE} ${VORBIS_CMAKE} ${SDL_MIXER})
