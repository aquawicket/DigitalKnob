...
if(MSVC)
	WIN_TARGET_dk_libDebug			(${SDL_MIXER}/${OS}/${DEBUG_DIR}/SDL2_mixer-staticd.lib		SDL_MIXER_LIBRARY_DEBUG)
	WIN_TARGET_dk_libRelease		(${SDL_MIXER}/${OS}/${RELEASE_DIR}/SDL2_mixer-static.lib	SDL_MIXER_LIBRARY_RELEASE)
elseif(ANDROID)
	ANDROID_TARGET_dk_libDebug		(${SDL_MIXER}/${OS}/${DEBUG_DIR}/libSDL2_mixer.a			SDL_MIXER_LIBRARY_DEBUG)
	ANDROID_TARGET_dk_libRelease	(${SDL_MIXER}/${OS}/${RELEASE_DIR}/libSDL2_mixer.a			SDL_MIXER_LIBRARY_RELEASE)
else()
