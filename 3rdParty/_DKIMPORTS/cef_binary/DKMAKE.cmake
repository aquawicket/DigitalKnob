...
# libcef_dll_wrapper
ANDROID_dk_libDebug		(${CEF_BINARY}/${triple}/libcef_dll_wrapper/${DEBUG_DIR}/libcef_dll_wrapper.a)
ANDROID_dk_libRelease	(${CEF_BINARY}/${triple}/libcef_dll_wrapper/${RELEASE_DIR}/libcef_dll_wrapper.a)
APPLE_dk_libDebug		(${CEF_BINARY}/${triple}/libcef_dll_wrapper/${DEBUG_DIR}/libcef_dll_wrapper.a)
APPLE_dk_libRelease		(${CEF_BINARY}/${triple}/libcef_dll_wrapper/${RELEASE_DIR}/libcef_dll_wrapper.a)
LINUX_dk_libDebug		(${CEF_BINARY}/${triple}/${DEBUG_DIR}/libcef_dll_wrapper/libcef_dll_wrapper.a)
LINUX_dk_libRelease		(${CEF_BINARY}/${triple}/${RELEASE_DIR}/libcef_dll_wrapper/libcef_dll_wrapper.a)
RASPBERRY_dk_libDebug	(${CEF_BINARY}/${triple}/${DEBUG_DIR}/libcef_dll_wrapper/libcef_dll_wrapper.a)
RASPBERRY_dk_libRelease	(${CEF_BINARY}/${triple}/${RELEASE_DIR}/libcef_dll_wrapper/libcef_dll_wrapper.a)
WIN_dk_libDebug			(${CEF_BINARY}/${triple}/libcef_dll_wrapper/${DEBUG_DIR}/libcef_dll_wrapper.lib)
WIN_dk_libRelease		(${CEF_BINARY}/${triple}/libcef_dll_wrapper/${RELEASE_DIR}/libcef_dll_wrapper.lib)
