...
LINUX_TARGET_dk_libRelease		(${CEF_BINARY}/${RELEASE_DIR}/libcef.so)
RASPBERRY_TARGET_dk_libDebug	(${CEF_BINARY}/${DEBUG_DIR}/libcef.so)
RASPBERRY_TARGET_dk_libRelease	(${CEF_BINARY}/${RELEASE_DIR}/libcef.so)
WIN_TARGET_dk_libDebug			(${CEF_BINARY}/${DEBUG_DIR}/libcef.lib)
WIN_TARGET_dk_libRelease		(${CEF_BINARY}/${RELEASE_DIR}/libcef.lib)
...
LINUX_TARGET_dk_libRelease		(${CEF_BINARY}/${OS}/${RELEASE_DIR}/libcef_dll_wrapper/libcef_dll_wrapper.a)
RASPBERRY_TARGET_dk_libDebug	(${CEF_BINARY}/${OS}/${DEBUG_DIR}/libcef_dll_wrapper/libcef_dll_wrapper.a)
RASPBERRY_TARGET_dk_libRelease	(${CEF_BINARY}/${OS}/${RELEASE_DIR}/libcef_dll_wrapper/libcef_dll_wrapper.a)
WIN_TARGET_dk_libDebug			(${CEF_BINARY}/${OS}/libcef_dll_wrapper/${DEBUG_DIR}/libcef_dll_wrapper.lib)
WIN_TARGET_dk_libRelease		(${CEF_BINARY}/${OS}/libcef_dll_wrapper/${RELEASE_DIR}/libcef_dll_wrapper.lib)

# cef_sandbox
#ANDROID_TARGET_dk_libDebug	(${CEF_BINARY}/${DEBUG_DIR}/cef_sandbox.a)
#ANDROID_TARGET_dk_libRelease	(${CEF_BINARY}/${RELEASE_DIR}/cef_sandbox.a)
#APPLE_dk_libDebug		(${CEF_BINARY}${DEBUG_DIR}/cef_sandbox.a)
#APPLE_dk_libRelease	(${CEF_BINARY}/${RELEASE_DIR}/cef_sandbox.a)
#LINUX_TARGET_dk_libDebug		(${CEF_BINARY}/${DEBUG_DIR}/cef_sandbox.a)
#LINUX_TARGET_dk_libRelease	(${CEF_BINARY}/${RELEASE_DIR}/cef_sandbox.a)
#RASPBERRY_TARGET_dk_libDebug	(${CEF_BINARY}/${DEBUG_DIR}/cef_sandbox.a)
#RASPBERRY_TARGET_dk_libRelease(${CEF_BINARY}/${RELEASE_DIR}/cef_sandbox.a)
#WIN_TARGET_dk_libDebug		(${CEF_BINARY}/${DEBUG_DIR}/cef_sandbox.lib)
#WIN_TARGET_dk_libRelease		(${CEF_BINARY}/${RELEASE_DIR}/cef_sandbox.lib)
