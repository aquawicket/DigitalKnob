...
LINUX_DEBUG_COMMAND(make cefsimple)
...
LINUX_RELEASE_COMMAND(make cefsimple)


RASPBERRY_DEBUG_PATH(${CEF}/${OS}/${DEBUG_DIR})
RASPBERRY_DEBUG_COMMAND(${DKCMAKE_RASPBERRY_DEBUG} -DPROJECT_ARCH="linuxarm" ${CEF})
RASPBERRY_DEBUG_COMMAND(make libcef_dll_wrapper)
RASPBERRY_DEBUG_COMMAND(make cefsimple)
RASPBERRY_RELEASE_PATH(${CEF}/${OS}/${RELEASE_DIR})
RASPBERRY_RELEASE_COMMAND(${DKCMAKE_RASPBERRY_RELEASE} -DPROJECT_ARCH="linuxarm" ${CEF})
RASPBERRY_RELEASE_COMMAND(make libcef_dll_wrapper)
RASPBERRY_RELEASE_COMMAND(make cefsimple)
