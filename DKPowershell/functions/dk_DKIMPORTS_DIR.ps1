...
function Global:DKTEST() {
	...
	dk_call dk_DKIMPORTS_DIR "${ENV:USERPROFILE}/Digital Knob/3rdParty/_DKIMPORTS"
	dk_call dk_echo "env:DKIMPORTS_DIR = ${env:DKIMPORTS_DIR}"
	dk_call dk_echo "dk_DKIMPORTS_DIR = '$(dk_call dk_DKIMPORTS_DIR '${ENV:USERPROFILE}/Digital Knob/3rdParty/_DKIMPORTS')'\n";
}
