...
function Global:DKTEST() { 
	...
	Write-Host "PLUGIN[GIT_Filename]      = "$PLUGIN["GIT_Filename"];
	Write-Host "PLUGIN[GIT_Name]          = "$PLUGIN["GIT_Name"];
	Write-Host "PLUGIN[GIT_Lower]         = "$PLUGIN["GIT_Lower"];
	Write-Host "PLUGIN[GIT_Tag]           = "$PLUGIN["GIT_Tag"];
	...
	Write-Host "PLUGIN[INSTALL_Name]      = "$PLUGIN["INSTALL_Name"];
	Write-Host "PLUGIN[INSTALL_Path]      = "$PLUGIN["INSTALL_Path"];
	Write-Host "PLUGIN[INSTALL_Root]      = "$PLUGIN["INSTALL_Root"];
	Write-Host "PLUGIN[INSTALL_Version]   = "$PLUGIN["INSTALL_Version"];
	Write-Host "PLUGIN[URL]               = "$PLUGIN["URL"];
	Write-Host "PLUGIN[URL_Array]         = "$PLUGIN["URL_Array"];
	Write-Host "PLUGIN[URL_Extension]     = "$PLUGIN["URL_Extension"];
	Write-Host "PLUGIN[URL_File]          = "$PLUGIN["URL_File"];
	Write-Host "PLUGIN[URL_Filename]      = "$PLUGIN["URL_Filename"];
	Write-Host "PLUGIN[URL_Length]        = "$PLUGIN["URL_Length"];
	Write-Host "PLUGIN[URL_List]          = "$PLUGIN["URL_List"];
	Write-Host "PLUGIN[Branch]            = "$PLUGIN["Branch"];
	Write-Host "PLUGIN[Build_Dir]         = "$PLUGIN["Build_Dir"];
	Write-Host "PLUGIN[Config_Dir]        = "$PLUGIN["Config_Dir"];
	Write-Host "PLUGIN[Debug_Dir]         = "$PLUGIN["Debug_Dir"];
	Write-Host "PLUGIN[Dir]               = "$PLUGIN["Dir"];
	Write-Host "PLUGIN[Folder]            = "$PLUGIN["Folder"];
	Write-Host "PLUGIN[Import_File]       = "$PLUGIN["Import_File"];
	Write-Host "PLUGIN[Import_Name]       = "$PLUGIN["Import_Name"];
	Write-Host "PLUGIN[Release_Dir]       = "$PLUGIN["Release_Dir"];
	Write-Host "PLUGIN[Tag]               = "$PLUGIN["Tag"];
