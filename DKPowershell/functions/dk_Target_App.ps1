...
function Global:dk_Target_App() {
	...
	#    :endloop1
		...
		dk_call dk_keyboardInput;
			if($dk_keyboardInput -eq  "1"){ ${Target_App} = "HelloWorld"; }
		elseif($dk_keyboardInput -eq  "2"){ ${Target_App} = "DKCore"; }
		elseif($dk_keyboardInput -eq  "3"){ ${Target_App} = "DKJavascript"; }
		elseif($dk_keyboardInput -eq  "4"){ ${Target_App} = "DKSDL"; }
		elseif($dk_keyboardInput -eq  "5"){ ${Target_App} = "DKSDLRml"; }
		elseif($dk_keyboardInput -eq  "6"){ ${Target_App} = "DKDomTest"; }
		elseif($dk_keyboardInput -eq  "7"){ ${Target_App} = "DKTestAll"; }
