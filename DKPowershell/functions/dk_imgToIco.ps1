...
#
#    Convert an image to a .ico (icon) file
#
#    @imgFile	- The image file to Convert
#	 @icoFile	- The output .ico file to create
#
$ImagingHelper = @'
...
'@
Add-Type -TypeDefinition $ImagingHelper -ReferencedAssemblies 'System.Drawing','System.IO','System.Collections'


function Global:dk_imgToIco() {
	dk_debugFunc 0 2
...
function Global:DKTEST() { 
	...
	$imgFile = "C:\Users\Administrator\digitalknob\Development\DKCpp\DKApps\DKCef\icons\icon.png"
	$icoFile = "C:\Users\Administrator\digitalknob\Development\DKCpp\DKApps\DKCef\icons\icon.ico"
