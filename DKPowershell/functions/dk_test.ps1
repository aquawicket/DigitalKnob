...
function GLOBAL:dk_test($argA, $argB, $argC) {
	...
	if($(${bound}.Values)[1])      		{ dk_call dk_echo "           bound[1]         =  $($(${bound}.Keys)[1]):'$($(${bound}.Values)[0])'" }
	if($(${bound}.Values)[2])     		{ dk_call dk_echo "           bound[2]         =  $($(${bound}.Keys)[2]):'$($(${bound}.Values)[0])'" }
	if($(${bound}.Values)[3])      		{ dk_call dk_echo "           bound[3]         =  $($(${bound}.Keys)[3]):'$($(${bound}.Values)[0])'" }
	if($(${bound}.Values)[4])      		{ dk_call dk_echo "           bound[4]         =  $($(${bound}.Keys)[4]):'$($(${bound}.Values)[0])'" }
	if($(${bound}.Values)[5])     		{ dk_call dk_echo "           bound[5]         =  $($(${bound}.Keys)[5]):'$($(${bound}.Values)[0])'" }
	if($(${bound}.Values)[6])     		{ dk_call dk_echo "           bound[6]         =  $($(${bound}.Keys)[6]):'$($(${bound}.Values)[0])'" }
	if($(${bound}.Values)[7])      		{ dk_call dk_echo "           bound[7]         =  $($(${bound}.Keys)[7]):'$($(${bound}.Values)[0])'" }
	if($(${bound}.Values)[8])     		{ dk_call dk_echo "           bound[8]         =  $($(${bound}.Keys)[8]):'$($(${bound}.Values)[0])'" }
	if($(${bound}.Values)[9])      		{ dk_call dk_echo "           bound[9]         =  $($(${bound}.Keys)[9]):'$($(${bound}.Values)[0])'" }
										  dk_call dk_echo ""
	...
	if($(${unbound}.Values)[0])      	{ dk_call dk_echo "         unbound.Values[0]  = '$($(${unbound}.Values)[0])'"           }
	if($(${unbound}.Values)[1])      	{ dk_call dk_echo "         unbound.Values[1]  = '$($(${unbound}.Values)[1])'"           }
	if($(${unbound}.Values)[2])      	{ dk_call dk_echo "         unbound.Values[2]  = '$($(${unbound}.Values)[2])'"           }
	if($(${unbound}.Values)[3])      	{ dk_call dk_echo "         unbound.Values[3]  = '$($(${unbound}.Values)[3])'"           }
	if($(${unbound}.Values)[4])      	{ dk_call dk_echo "         unbound.Values[4]  = '$($(${unbound}.Values)[4])'"           }
	if($(${unbound}.Values)[5])      	{ dk_call dk_echo "         unbound.Values[5]  = '$($(${unbound}.Values)[5])'"           }
	if($(${unbound}.Values)[6])      	{ dk_call dk_echo "         unbound.Values[6]  = '$($(${unbound}.Values)[6])'"           }
	if($(${unbound}.Values)[7])      	{ dk_call dk_echo "         unbound.Values[7]  = '$($(${unbound}.Values)[7])'"           }
	if($(${unbound}.Values)[8])      	{ dk_call dk_echo "         unbound.Values[8]  = '$($(${unbound}.Values)[8])'"           }
	if($(${unbound}.Values)[9])      	{ dk_call dk_echo "         unbound.Values[9]  = '$($(${unbound}.Values)[9])'"           }
										  dk_call dk_echo ""
	...
	if($(${all}.Values)[0])      		{ dk_call dk_echo "             all.Values[0]  = '$($(${all}.Values)[0])'"               }
	if($(${all}.Values)[1])      		{ dk_call dk_echo "             all.Values[1]  = '$($(${all}.Values)[1])'"               }
	if($(${all}.Values)[2])      		{ dk_call dk_echo "             all.Values[2]  = '$($(${all}.Values)[2])'"               }
	if($(${all}.Values)[3])      		{ dk_call dk_echo "             all.Values[3]  = '$($(${all}.Values)[3])'"               }
	if($(${all}.Values)[4])      		{ dk_call dk_echo "             all.Values[4]  = '$($(${all}.Values)[4])'"               }
	if($(${all}.Values)[5])      		{ dk_call dk_echo "             all.Values[5]  = '$($(${all}.Values)[5])'"               }
	if($(${all}.Values)[6])      		{ dk_call dk_echo "             all.Values[6]  = '$($(${all}.Values)[6])'"               }
	if($(${all}.Values)[7])      		{ dk_call dk_echo "             all.Values[7]  = '$($(${all}.Values)[7])'"               }
	if($(${all}.Values)[8])      		{ dk_call dk_echo "             all.Values[8]  = '$($(${all}.Values)[8])'"               }
	if($(${all}.Values)[9])      		{ dk_call dk_echo "             all.Values[9]  = '$($(${all}.Values)[9])'"               }
										  dk_call dk_echo ""
