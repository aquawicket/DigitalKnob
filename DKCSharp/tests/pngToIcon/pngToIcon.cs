public class PngIconConverter {
	public bool Convert(System.IO.Stream input_stream, System.IO.Stream output_stream, int size, bool keep_aspect_ratio = false) {
	...
	public bool Convert(string input_image, string output_icon, int size, bool keep_aspect_ratio = false) {
	...
	public static void Main() {
		PngIconConverter pngToIcon = new PngIconConverter();
		pngToIcon.Convert("icon.png", "icon.ico", 100, true);
	}
}
