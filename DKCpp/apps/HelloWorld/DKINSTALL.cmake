...
set(ENV{CURRENT_PLUGIN} ${Target_App})
dk_set($ENV{CURRENT_PLUGIN} ${CMAKE_SOURCE_DIR})
dk_set($ENV{CURRENT_PLUGIN}_CONFIG_DIR ${CMAKE_CURRENT_LIST_DIR}/${CONFIG_PATH})
dk_printVar($ENV{CURRENT_PLUGIN}_CONFIG_DIR)
dk_configure(${CMAKE_CURRENT_LIST_DIR} -DDKCMAKE_FUNCTIONS_DIR=$ENV{DKCMAKE_FUNCTIONS_DIR} -DTUPLE=${TUPLE})
