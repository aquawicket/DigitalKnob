...
if(WIN)
	if(DEBUG)
		dk_copy(${DKCPP_PLUGINS_DIR}/DKRestart/${triple}/${DEBUG_DIR}/DKRestart.exe ${DK_Project_Dir}/assets/DKRestart/${triple}Debug OVERWRITE)
	endif()
	if(RELEASE)
		dk_copy(${DKCPP_PLUGINS_DIR}/DKRestart/${triple}/${RELEASE_DIR}/DKRestart.exe ${DK_Project_Dir}/assets/DKRestart/${triple}Release OVERWRITE)
	endif()
endif()
...
if(MAC)
	if(DEBUG)
		dk_copy(${DKCPP_PLUGINS_DIR}/DKRestart/${triple}/${DEBUG_DIR}/DKRestart.app ${DK_Project_Dir}/assets/DKRestart/${triple}Debug/DKRestart.app OVERWRITE)
	endif()
	if(RELEASE)
		dk_copy(${DKCPP_PLUGINS_DIR}/DKRestart/${triple}/${RELEASE_DIR}/DKRestart.app ${DK_Project_Dir}/assets/DKRestart/${triple}Release/DKRestart.app OVERWRITE)
	endif()
endif()
...
if(LINUX)
	if(DEBUG)
		dk_copy(${DKCPP_PLUGINS_DIR}/DKRestart/${triple}/${DEBUG_DIR}/DKRestart ${DK_Project_Dir}/assets/${triple}Debug/DKRestart OVERWRITE)
	endif()
	if(RELEASE)
		dk_copy(${DKCPP_PLUGINS_DIR}/DKRestart/${triple}/${RELEASE_DIR}/DKRestart ${DK_Project_Dir}/assets/${triple}Release/DKRestart OVERWRITE)
	endif()
endif()
