...
if(Windows)
	...
	if(Debug)
		dk_copy(${DKCPP_PLUGINS_DIR}/DKCefChild/${Target_Tuple}/${Debug_Dir}/DKCefChild.exe ${Target_App_Dir}/assets/DKCef/${Target_Tuple}Debug OVERWRITE)
	endif()
	if(Release)
		dk_copy(${DKCPP_PLUGINS_DIR}/DKCefChild/${Target_Tuple}/${Release_Dir}/DKCefChild.exe ${Target_App_Dir}/assets/DKCef/${Target_Tuple}Release OVERWRITE)
	endif()
endif()

if(Mac_X86_64)
#	if(Debug)
#		dk_copy(${DKCPP_PLUGINS_DIR}/DKCefChild/${Target_Tuple}/${Debug_Dir}/DKCefChild.app "${Target_App_Dir}/assets/DKCef/${Target_Tuple}Debug/${AppName} Helper.app" OVERWRITE)
#		dk_rename(${Target_App_Dir}/${Target_Tuple}/${Debug_Dir}/${AppName}.app/Contents/Frameworks/DKCefChild.app/Contents/MacOS/DKCefChild "${Target_App_Dir}/${Target_Tuple}/${Debug_Dir}/${AppName}.app/Contents/Frameworks/DKCefChild.app/Contents/MacOS/${AppName} Helper")
#		dk_rename(${Target_App_Dir}/${Target_Tuple}/${Debug_Dir}/${AppName}.app/Contents/Frameworks/DKCefChild.app "${Target_App_Dir}/${Target_Tuple}/${Debug_Dir}/${AppName}.app/Contents/Frameworks/${AppName} Helper.app")
#	endif()
#	if(Release)
#		dk_copy(${DKCPP_PLUGINS_DIR}/DKCefChild/${Target_Tuple}/${Release_Dir}/DKCefChild.app "${Target_App_Dir}/assets/DKCef/${Target_Tuple}Release/${AppName} Helper.app" OVERWRITE)
...
if(Linux)
	dk_delete(${Target_App_Dir}/assets/DKCef/DKCefChild)
	if(Debug)
		dk_copy(${DKCPP_PLUGINS_DIR}/DKCefChild/${Target_Tuple}/${Debug_Dir}/DKCefChild ${Target_App_Dir}/assets/DKCef OVERWRITE)
	endif()
	if(Release)
		dk_copy(${DKCPP_PLUGINS_DIR}/DKCefChild/${Target_Tuple}/${Release_Dir}/DKCefChild ${Target_App_Dir}/assets/DKCef OVERWRITE)
	endif()
endif()
...
## DKCefChild win
if(Windows)
	dk_fileWrite(${PLUGIN_Install_Path}/CMakeLists.txt "### This file is generated by DKCMake. Any Changes here, will be overwritten. ###\n")
	dk_appendCmake("###### ${name} ######\n")
