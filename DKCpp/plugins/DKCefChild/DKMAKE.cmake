...
if(WIN)
	...
	if(DEBUG)
		dk_copy(${DKCPP_PLUGINS_DIR}/DKCefChild/${target_triple}/${DEBUG_DIR}/DKCefChild.exe ${DK_Project_Dir}/assets/DKCef/${target_triple}Debug OVERWRITE)
	endif()
	if(RELEASE)
		dk_copy(${DKCPP_PLUGINS_DIR}/DKCefChild/${target_triple}/${RELEASE_DIR}/DKCefChild.exe ${DK_Project_Dir}/assets/DKCef/${target_triple}Release OVERWRITE)
	endif()
endif()

if(MAC_X86_64)
#	if(DEBUG)
#		dk_copy(${DKCPP_PLUGINS_DIR}/DKCefChild/${target_triple}/${DEBUG_DIR}/DKCefChild.app "${DK_Project_Dir}/assets/DKCef/${target_triple}Debug/${AppName} Helper.app" OVERWRITE)
#		dk_rename(${DK_Project_Dir}/${target_triple}/${DEBUG_DIR}/${AppName}.app/Contents/Frameworks/DKCefChild.app/Contents/MacOS/DKCefChild "${DK_Project_Dir}/${target_triple}/${DEBUG_DIR}/${AppName}.app/Contents/Frameworks/DKCefChild.app/Contents/MacOS/${AppName} Helper")
#		dk_rename(${DK_Project_Dir}/${target_triple}/${DEBUG_DIR}/${AppName}.app/Contents/Frameworks/DKCefChild.app "${DK_Project_Dir}/${target_triple}/${DEBUG_DIR}/${AppName}.app/Contents/Frameworks/${AppName} Helper.app")
#	endif()
#	if(RELEASE)
#		dk_copy(${DKCPP_PLUGINS_DIR}/DKCefChild/${target_triple}/${RELEASE_DIR}/DKCefChild.app "${DK_Project_Dir}/assets/DKCef/${target_triple}Release/${AppName} Helper.app" OVERWRITE)
#		dk_rename(${DK_Project_Dir}/${target_triple}/${RELEASE_DIR}/${AppName}.app/Contents/Frameworks/DKCefChild.app/Contents/MacOS/DKCefChild "${DK_Project_Dir}/${target_triple}/${RELEASE_DIR}/${AppName}.app/Contents/Frameworks/DKCefChild.app/Contents/MacOS/${AppName} Helper")
#		dk_rename(${DK_Project_Dir}/${target_triple}/${RELEASE_DIR}/${AppName}.app/Contents/Frameworks/DKCefChild.app "${DK_Project_Dir}/${target_triple}/${RELEASE_DIR}/${AppName}.app/Contents/Frameworks/${AppName} Helper.app")
#	endif()
#	MAC_dk_queueCommand(install_name_tool -change "@executable_path/Chromium Embedded Framework" "@executable_path/../../../../Frameworks/Chromium Embedded Framework.framework/Chromium Embedded Framework" "${DK_Project_Dir}/${target_triple}/${DEBUG_DIR}/${AppName}.app/Contents/Frameworks/${AppName} Helper.app/Contents/MacOS/${AppName} Helper")
#	
#	FIXME - command does not work because app does not exist yet
#	MAC_dk_queueCommand(install_name_tool -change "@executable_path/Chromium Embedded Framework" "@executable_path/../Frameworks/Chromium Embedded Framework.framework/Chromium Embedded Framework" "${DK_Project_Dir}/${target_triple}/${DEBUG_DIR}/${AppName}.app/Contents/MacOS/${AppName}")
endif()

if(LINUX)
	dk_delete(${DK_Project_Dir}/assets/DKCef/DKCefChild)
	if(DEBUG)
		dk_copy(${DKCPP_PLUGINS_DIR}/DKCefChild/${target_triple}/${DEBUG_DIR}/DKCefChild ${DK_Project_Dir}/assets/DKCef OVERWRITE)
	endif()
	if(RELEASE)
		dk_copy(${DKCPP_PLUGINS_DIR}/DKCefChild/${target_triple}/${RELEASE_DIR}/DKCefChild ${DK_Project_Dir}/assets/DKCef OVERWRITE)
	endif()
endif()
...
include("$ENV{DKCMAKE_FUNCTIONS_DIR_}DK.cmake")\n")
	...
	dk_appendCmake("find_library(libcef_dll_wrapperD libcef_dll_wrapper.lib ${CEF_BINARY}/${target_triple}/libcef_dll_wrapper/${DEBUG_DIR})\n")
	...
	dk_appendCmake("find_library(libcef_dll_wrapperR libcef_dll_wrapper.lib ${CEF_BINARY}/${target_triple}/libcef_dll_wrapper/${RELEASE_DIR})\n")
...
include("$ENV{DKCMAKE_FUNCTIONS_DIR_}DK.cmake")\n")
	...
	dk_appendCmake("include_directories(${DKCPP_PLUGINS_DIR})\n")
		...
		dk_appendCmake("find_library(libcef_dll_wrapperD libcef_dll_wrapper.a ${CEF_BINARY}/${target_triple}/libcef_dll_wrapper/${DEBUG_DIR})\n")
		dk_appendCmake("list(APPEND CEF_BINARY_DEBUG_DKLIBS debug \${libcef_dll_wrapperD})\n")
		...
		dk_appendCmake("find_library(libcef_dll_wrapperR libcef_dll_wrapper.a ${CEF_BINARY}/${target_triple}/libcef_dll_wrapper/${RELEASE_DIR})\n")
		dk_appendCmake("list(APPEND CEF_BINARY_RELEASE_DKLIBS optimized \${libcef_dll_wrapperR})\n")
...
include("$ENV{DKCMAKE_FUNCTIONS_DIR_}DK.cmake")\n")
	...
	if(DEBUG)
		dk_appendCmake("find_library(libcef_dll_wrapperD libcef_dll_wrapper.a ${CEF_BINARY}/${target_triple}/${DEBUG_DIR}/libcef_dll_wrapper)\n")
		dk_appendCmake("list(APPEND CEF_BINARY_DEBUG_DKLIBS debug \${libcef_dll_wrapperD})\n")
	...
	elseif(RELEASE)
		dk_appendCmake("find_library(libcef_dll_wrapperR libcef_dll_wrapper.a ${CEF_BINARY}/${target_triple}/${RELEASE_DIR}/libcef_dll_wrapper)\n")
		dk_appendCmake("list(APPEND CEF_BINARY_RELEASE_DKLIBS optimized \${libcef_dll_wrapperR})\n")
