...
var log_debug;
// = DKFile_GetSetting(local_assets+"settings.txt", "[LOG_DEBUG]");
//if(log_debug === "ON"){ LOG_DEBUG = true; }

var log_info;
// = DKFile_GetSetting(local_assets+"settings.txt", "[LOG_INFO]");
//if(log_info === "OFF"){ LOG_INFO = false; }

var log_warnings;
// = DKFile_GetSetting(local_assets+"settings.txt", "[LOG_WARNINGS]");
//if(log_warnings === "OFF"){ LOG_WARNINGS = false; }

var log_errors;
// = DKFile_GetSetting(local_assets+"settings.txt", "[LOG_ERRORS]");
//if(log_errors === "OFF"){ LOG_ERRORS = false; }

var log_file;
// = DKFile_GetSetting(local_assets+"settings.txt", "[LOG_FILE]");
...
var log_lines;
// = DKFile_GetSetting(local_assets+"settings.txt", "[LOG_LINES]");
...
<<<<<<< HEAD:DKPlugins/DKAssets/DKAssets.js
if (!hostname) {
=======
if (!hostname){
>>>>>>> Development:DKCpp/plugins/DKAssets/DKAssets.js
    hostname = "127.0.0.1";
}

var pathname;
// = DKFile_GetSetting(local_assets+"settings.txt", "[PATHNAME]");
