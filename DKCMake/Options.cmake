...
if(TARGET)
	...
	set(CMAKE_ARCHIVE_OUTPUT_DIRECTORY "${target_path}/${OS}")
	set(CMAKE_LIBRARY_OUTPUT_DIRECTORY "${target_path}/${OS}")
	set(CMAKE_RUNTIME_OUTPUT_DIRECTORY "${target_path}/${OS}")
	set(EXECUTABLE_OUTPUT_PATH "${target_path}/${OS}")
	set(CMAKE_CURRENT_BINARY_DIR "${target_path}/${OS}")
	set(PROJECT_BINARY_DIR "${target_path}/${OS}")
	set(DigitalKnob_BINARY_DIR "${target_path}/${OS}")
	set(CMAKE_CACHEFILE_DIR "${target_path}/${OS}")
	...
	if(NOT "${target_type}" STREQUAL "DKAPP")
		...
		DKSET(DKAPP 1)
		file(WRITE ${DKCMAKE}/temp/${TARGET}.cmd "\"${MSBUILD}\" ${DKCMAKE}/temp/DigitalKnob.sln /p:Configuration=Release\n")
		file(APPEND ${DKCMAKE}/temp/${TARGET}.cmd ${DKCMAKE}/temp/${RELEASE_DIR}/${TARGET}.exe)
	endif()
endif()
