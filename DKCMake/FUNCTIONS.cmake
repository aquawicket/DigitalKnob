...
FUNCTION(UPX_COMPRESS file)
	...
	IF(UPX)
		...
		MESSAGE("Please wait...")
		EXECUTE_PROCESS(COMMAND cmd /c "${UPX_EXE}/upx.exe -9 -v ${file}")
	ENDIF()
	ENDIF()
ENDFUNCTION()
...
FUNCTION(DKUPDATE_ANDROID_NAME arg)
	...
	IF(ANDROID AND DEBUG)
		...
		FILE(GLOB_RECURSE allfiles RELATIVE "${DKPROJECT}/${OS}/${DEBUG}/" "${DKPROJECT}/${OS}/${DEBUG}/*")
		FOREACH(each_file ${allfiles})
	...
	IF(ANDROID AND RELEASE)
		...
		## update all files recursivley
		FILE(GLOB_RECURSE allfiles RELATIVE "${DKPROJECT}/${OS}/${RELEASE}/" "${DKPROJECT}/${OS}/${RELEASE}/*")
		FOREACH(each_file ${allfiles})
