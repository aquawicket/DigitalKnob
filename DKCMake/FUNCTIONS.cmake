...
FUNCTION(IOSSIM_XCODE_DEBUG arg)
	...
	IF(DEBUG)
		...
		IF(${num_extra_args} GREATER 0)
			LIST(GET extra_args 0 arg2)
			EXECUTE_PROCESS(COMMAND xcodebuild -target ${arg2} -configuration Debug build -arch x86_64 -sdk iphonesimulator11.2 WORKING_DIRECTORY ${3RDPARTY}/${arg}/${OS})
		ELSE()
			EXECUTE_PROCESS(COMMAND xcodebuild -configuration Debug build -arch x86_64 -sdk iphonesimulator11.2 WORKING_DIRECTORY ${3RDPARTY}/${arg}/${OS})
		ENDIF()
	ENDIF()
	ENDIF()
ENDFUNCTION()
...
FUNCTION(IOSSIM_XCODE_RELEASE arg)
	...
	IF(RELEASE)
		...
		IF(${num_extra_args} GREATER 0)
			LIST(GET extra_args 0 arg2)
			EXECUTE_PROCESS(COMMAND xcodebuild -target ${arg2} -configuration Release build -arch x86_64 -sdk iphonesimulator11.2 WORKING_DIRECTORY ${3RDPARTY}/${arg}/${OS})
		ELSE()
			EXECUTE_PROCESS(COMMAND xcodebuild -configuration Release build -arch x86_64 -sdk iphonesimulator11.2 WORKING_DIRECTORY ${3RDPARTY}/${arg}/${OS})
		ENDIF()
	ENDIF()
	ENDIF()
ENDFUNCTION()
...
FUNCTION(IOSSIM32_XCODE_RELEASE arg)
	...
	IF(RELEASE)
		...
		IF(${num_extra_args} GREATER 0)
			LIST(GET extra_args 0 arg2)
			EXECUTE_PROCESS(COMMAND xcodebuild -target ${arg2} -configuration Release build -arch i386 -sdk iphonesimulator11.2 WORKING_DIRECTORY ${3RDPARTY}/${arg}/${OS})
		ELSE()
			EXECUTE_PROCESS(COMMAND xcodebuild -configuration Release build -arch i386 -sdk iphonesimulator11.2 WORKING_DIRECTORY ${3RDPARTY}/${arg}/${OS})
		ENDIF()
	ENDIF()
	ENDIF()
ENDFUNCTION()
