...
function(DKINSTALL url import_path destination_path)
	...
	if(NOT ${import_path} STREQUAL ${import_path_lower})
		message(FATAL_ERROR "ERROR: the import_path ${import_path}) in DKINSTALL() must be all lowercase")
	endif()
	if(NOT EXISTS ${DKIMPORTS}/${import_path})
		message(FATAL_ERROR "ERROR: the import_path (${DKIMPORTS}/${import_path}) in DKINSTALL() does not exist")
	endif()
...
function(DKDLL name)
	...
	if(DLL_DEBUG_LIBS AND DLL_RELEASE_LIBS)
		...
		DKSET(CMAKE_FILE "${CMAKE_FILE}TARGET_LINK_LIBRARIES(${name} ${DLL_DEBUG_LIBS} ${DLL_RELEASE_LIBS} ${DLL_WIN_LIBS}) \n")
	endif()
	DKSET(CMAKE_FILE "${CMAKE_FILE}if(CMAKE_HOST_WIN32)\n")
