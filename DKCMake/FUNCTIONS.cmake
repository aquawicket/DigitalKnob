...
FUNCTION(LINUX_COMMAND arg)
	IF(NOT RASPBERRY AND LINUX AND QUEUE_BUILD)
		SET(arg2 ${arg} ${ARGN}) # Merge them together
		MESSAGE("COMMAND-> ${arg2}")
		EXECUTE_PROCESS(COMMAND ${arg2} WORKING_DIRECTORY ${CURRENT_DIR})
	ENDIF()
...
FUNCTION(LINUX_DEBUG_COMMAND arg)
	IF(NOT RASPBERRY AND LINUX AND DEBUG AND QUEUE_BUILD)
		SET(arg2 ${arg} ${ARGN}) # Merge them together
		LINUX_COMMAND(${arg2})
	ENDIF()
ENDFUNCTION()
...
FUNCTION(LINUX_RELEASE_COMMAND arg)
	IF(NOT RASPBERRY AND LINUX AND RELEASE AND QUEUE_BUILD)
		SET(arg2 ${arg} ${ARGN}) # Merge them together
		LINUX_COMMAND(${arg2})
	ENDIF()
ENDFUNCTION()
...
FUNCTION(LINUX32_COMMAND arg)
	IF(NOT RASPBERRY AND LINUX_32 AND QUEUE_BUILD)
		SET(arg2 ${arg} ${ARGN}) # Merge them together
		LINUX_COMMAND(${arg2})
	ENDIF()
ENDFUNCTION()
...
FUNCTION(LINUX32_DEBUG_COMMAND arg)
	IF(NOT RASPBERRY AND LINUX_32 AND DEBUG AND QUEUE_BUILD)
		SET(arg2 ${arg} ${ARGN}) # Merge them together
		LINUX_COMMAND(${arg2})
	ENDIF()
ENDFUNCTION()
...
FUNCTION(LINUX32_RELEASE_COMMAND arg)
	IF(NOT RASPBERRY AND LINUX_32 AND RELEASE AND QUEUE_BUILD)
		SET(arg2 ${arg} ${ARGN}) # Merge them together
		LINUX_COMMAND(${arg2})
	ENDIF()
ENDFUNCTION()
...
FUNCTION(LINUX64_COMMAND arg)
	IF(NOT RASPBERRY AND LINUX_64 AND QUEUE_BUILD)
		SET(arg2 ${arg} ${ARGN}) # Merge them together
		LINUX_COMMAND(${arg2})
	ENDIF()
ENDFUNCTION()
...
FUNCTION(LINUX64_DEBUG_COMMAND arg)
	IF(NOT RASPBERRY AND LINUX_64 AND DEBUG AND QUEUE_BUILD)
		SET(arg2 ${arg} ${ARGN}) # Merge them together
		LINUX_COMMAND(${arg2})
	ENDIF()
ENDFUNCTION()
...
FUNCTION(LINUX64_RELEASE_COMMAND arg)
	IF(NOT RASPBERRY AND LINUX_64 AND RELEASE AND QUEUE_BUILD)
		SET(arg2 ${arg} ${ARGN}) # Merge them together
		LINUX_COMMAND(${arg2})
	ENDIF()
ENDFUNCTION()
...
FUNCTION(LINUX_DEBUG_LIB arg)
	IF(NOT RASPBERRY AND LINUX AND DEBUG)
		DKDEBUG_LIB(${arg})
	ENDIF()
ENDFUNCTION()
...
FUNCTION(LINUX_RELEASE_LIB arg)
	IF(NOT RASPBERRY AND LINUX AND RELEASE)
		DKRELEASE_LIB(${arg})
	ENDIF()
ENDFUNCTION()
...
FUNCTION(LINUX32_DEBUG_LIB arg)
	IF(NOT RASPBERRY AND LINUX32 AND DEBUG)
		DKDEBUG_LIB(${arg})
	ENDIF()
ENDFUNCTION()
...
FUNCTION(LINUX32_RELEASE_LIB arg)
	IF(NOT RASPBERRY AND LINUX32 AND RELEASE)
		DKRELEASE_LIB(${arg})
	ENDIF()
ENDFUNCTION()
...
FUNCTION(LINUX64_DEBUG_LIB arg)
	IF(NOT RASPBERRY AND LINUX64 AND DEBUG)
		DKDEBUG_LIB(${arg})
	ENDIF()
ENDFUNCTION()
...
FUNCTION(LINUX64_RELEASE_LIB arg)
	IF(NOT RASPBERRY AND LINUX64 AND RELEASE)
		DKRELEASE_LIB(${arg})
	ENDIF()
ENDFUNCTION()
...
FUNCTION(LINUX32_DEBUG_INCLUDE arg)
	IF(NOT RASPBERRY AND LINUX_32 AND DEBUG)
		DKINCLUDE(${arg})
	ENDIF()
ENDFUNCTION()
...
FUNCTION(LINUX32_RELEASE_INCLUDE arg)
	IF(NOT RASPBERRY AND LINUX_32 AND RELEASE)
		DKINCLUDE(${arg})
	ENDIF()
ENDFUNCTION()
...
FUNCTION(LINUX64_DEBUG_INCLUDE arg)
	IF(NOT RASPBERRY AND LINUX_64 AND DEBUG)
		DKINCLUDE(${arg})
	ENDIF()
ENDFUNCTION()
...
FUNCTION(LINUX64_RELEASE_INCLUDE arg)
	IF(NOT RASPBERRY AND LINUX_64 AND RELEASE)
		DKINCLUDE(${arg})
	ENDIF()
ENDFUNCTION()
