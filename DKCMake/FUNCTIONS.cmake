...
FUNCTION(ANDROID_NDK_DEBUG arg)
	...
	IF(NOT CMAKE_HOST_UNIX)
		...
		##EXECUTE_PROCESS(COMMAND ${3RDPARTY}/android-ndk-r20b/ndk-build.cmd WORKING_DIRECTORY ${3RDPARTY}/${arg}/${OS}/Debug)
	ENDIF()
	IF(CMAKE_HOST_UNIX)
		EXECUTE_PROCESS(COMMAND ${ANDROID_NDK}/ndk-build WORKING_DIRECTORY ${3RDPARTY}/${arg}/${OS}/Debug)
		##EXECUTE_PROCESS(COMMAND ${3RDPARTY}/android-ndk-r20b/ndk-build WORKING_DIRECTORY ${3RDPARTY}/${arg}/${OS}/Debug)
	ENDIF()
	ENDIF()
	ENDIF()
ENDFUNCTION()
...
FUNCTION(ANDROID_NDK_RELEASE arg)
	...
	IF(NOT CMAKE_HOST_UNIX)
		...
		##EXECUTE_PROCESS(COMMAND ${3RDPARTY}/android-ndk-r20b/ndk-build.cmd WORKING_DIRECTORY ${3RDPARTY}/${arg}/${OS}/Release)
	ENDIF()
	IF(CMAKE_HOST_UNIX)
		EXECUTE_PROCESS(COMMAND ${ANDROID_NDK}/ndk-build WORKING_DIRECTORY ${3RDPARTY}/${arg}/${OS}/Release)
		##EXECUTE_PROCESS(COMMAND ${3RDPARTY}/android-ndk-r20b/ndk-build WORKING_DIRECTORY ${3RDPARTY}/${arg}/${OS}/Release)
	ENDIF()
	ENDIF()
	ENDIF()
ENDFUNCTION()
