...
FUNCTION(DKINSTALL url import_folder 3rdparty_folder)
	...
	ELSE()
		...
		MESSAGE("The Downloaded file (${filename}) is a ${FILETYPE} file")
		
		if(${FILETYPE} STREQUAL "UNKNOWN")
			DKSET(FILETYPE "Archive")
			MESSAGE("We will try to extract it but it will probobly fail.")
			MESSAGE("If it's not an archive, you should be good to go anyway")
		endif()
		...
		if(${FILETYPE} STREQUAL "Archive")
			...
			ENDIF()
		ELSE() #NOT ARCHIVE
			FILE(COPY ${DIGITALKNOB}/Download/${filename} ${3RDPARTY}/${3rdparty_folder})
		ENDIF()
	ENDIF()
