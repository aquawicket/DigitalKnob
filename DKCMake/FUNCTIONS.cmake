	...
	#	set(dest_path ${ARGV1})
		...
		if(IS_DIRECTORY ${dest_path})
			...
			if(NOT dest_filename STREQUAL src_filename)
				#message(STATUS "DKDOWNLOAD(${url}): The filenames are different")
...
function(generateCmake name)
	...
	#file(APPEND ${plugin_path}/CMakeLists.txt "if(ANDROID)\n")
	#file(APPEND ${plugin_path}/CMakeLists.txt "	set(CMAKE_CXX_STANDARD_REQUIRED OFF)\n")
	#file(APPEND ${plugin_path}/CMakeLists.txt "	set(CMAKE_SYSTEM_NAME Android)\n")
	#file(APPEND ${plugin_path}/CMakeLists.txt "	set(CMAKE_SYSTEM_VERSION 26)\n")
	#file(APPEND ${plugin_path}/CMakeLists.txt "	set(CMAKE_ANDROID_ARCH_ABI armeabi-v7a)\n")
	#file(APPEND ${plugin_path}/CMakeLists.txt "	set(CMAKE_ANDROID_NDK ${ANDROIDNDK})\n")
	#file(APPEND ${plugin_path}/CMakeLists.txt "	set(CMAKE_ANDROID_STL_TYPE c++_static)\n")
	#file(APPEND ${plugin_path}/CMakeLists.txt "	set(CMAKE_CXX_STANDARD 17)\n")
	#file(APPEND ${plugin_path}/CMakeLists.txt "	set(CMAKE_CXX_EXTENSIONS OFF)\n")
	...
	file(APPEND ${plugin_path}/CMakeLists.txt "if(IOSSIM)\n")
	file(APPEND ${plugin_path}/CMakeLists.txt "		file(GLOB IOSSIM_SRC\n")
	file(APPEND ${plugin_path}/CMakeLists.txt "			${plugin_path}/*.mm\n")
	file(APPEND ${plugin_path}/CMakeLists.txt "		)\n")
	file(APPEND ${plugin_path}/CMakeLists.txt "		list(APPEND ${name}_SRC \${IOSSIM_SRC})\n")
	file(APPEND ${plugin_path}/CMakeLists.txt "endif()\n")

	file(APPEND ${plugin_path}/CMakeLists.txt "add_library(${name} STATIC \${${name}_SRC})\n")
	file(APPEND ${plugin_path}/CMakeLists.txt "target_compile_options(${name} PRIVATE ${FLAGS})\n")
...
function(dk_sublibrary name sublibrary)
	if(${name}_libs)
		DKSET(${name}_libs ${${name}_libs} ${sublibrary})
	else()
		DKSET(${name}_libs ${sublibrary})
	endif()
	if(${name}_all)
		DKSET(${name}_${sublibrary} 1)
	endif()
endfunction()