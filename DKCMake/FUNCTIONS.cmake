...
function(dk_printSettings)
	...
	DKBUILD_LOG("HAVE_SHADERS:             ${HAVE_SHADERS}")
...
function(dk_addTarget lib sublib)
	...
	if(${LIB}_subLibs)
		DKSET(${LIB}_subLibs ${${LIB}_subLibs} ${subLib})
	else()
		DKSET(${LIB}_subLibs ${subLib})
	endif()
	if(${LIB}_all)
		DKSET(${LIB}_${subLib} 1)
	endif()
endfunction()

function(dk_removeTarget LIB subLib)
	if(${LIB}_subLibs)
		list(REMOVE_ITEM ${LIB}_subLibs ${subLib})
	endif()
	if(${LIB}_subLibs_OFF)
		DKSET(${LIB}_subLibs_OFF ${${LIB}_subLibs_OFF} ${subLib})
	else()
		DKSET(${LIB}_subLibs_OFF ${subLib})
	endif()
	DKSET(${LIB}_${subLib} 0)
	DKUNSET(${LIB}_${subLib})
endfunction()
