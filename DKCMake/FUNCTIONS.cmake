...
function(DOWNLOAD url dest_path) # ARGV1 = dest_path
	...
	#	set(dest_path ${ARGV1})
		...
		if(IS_DIRECTORY ${dest_path})
			...
			message(STATUS "DOWNLOAD(): IS NOT DIRECTORY: ${dest_path}")
			...
			if(NOT dest_filename STREQUAL src_filename)
				message(STATUS "DKDOWNLOAD(): The filenames are different")
				message(STATUS "DKDOWNLOAD(): src_filename = ${src_filename}")
				message(STATUS "DKDOWNLOAD(): dest_filename = ${dest_filename}")
				message(STATUS "DKDOWNLOAD(): dest_dir = ${dest_dir}")
