...
function(DKPLUGIN name)
	...
	DKSET(CMAKE_FILE "${CMAKE_FILE}		set(PLATFORM SIMULATOR64)\n")
	DKSET(CMAKE_FILE "${CMAKE_FILE}		include(${DKCMAKE}/ios.toolchain.cmake)\n")
	DKSET(CMAKE_FILE "${CMAKE_FILE}		add_definitions(-DIOS)\n")
	DKSET(CMAKE_FILE "${CMAKE_FILE}endif()\n")
	...
	DKSET(CMAKE_FILE "${CMAKE_FILE}if(IOSSIM)\n")
	DKSET(CMAKE_FILE "${CMAKE_FILE}file(GLOB IOSSIM_SRC\n")
	DKSET(CMAKE_FILE "${CMAKE_FILE}		${plugin_path}/*.mm\n")
	DKSET(CMAKE_FILE "${CMAKE_FILE})\n")
	DKSET(CMAKE_FILE "${CMAKE_FILE}list(APPEND ${name}_SRC \${IOSSIM_SRC})\n")
	DKSET(CMAKE_FILE "${CMAKE_FILE}endif()\n")
