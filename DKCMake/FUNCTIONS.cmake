...
function(WIN_VS_DEBUG arg arg2)
	if(WIN AND DEBUG AND QUEUE_BUILD)
		...
		DKEXECUTE_PROCESS(COMMAND cmd /c "set _CL_=/MTd" WORKING_DIRECTORY ${3RDPARTY}/${arg}/${OS})
		set(extra_args ${ARGN})
		list(LENGTH extra_args num_extra_args)
		if(${num_extra_args} GREATER 0)
			list(GET extra_args 0 arg3)
...
function(WIN_VS_RELEASE arg arg2)
	if(WIN AND RELEASE AND QUEUE_BUILD)
		...
		DKEXECUTE_PROCESS(COMMAND cmd /c "set _CL_=/MT" WORKING_DIRECTORY ${3RDPARTY}/${arg}/${OS})
		set(extra_args ${ARGN})
		list(LENGTH extra_args num_extra_args)
		if(${num_extra_args} GREATER 0)
			list(GET extra_args 0 arg3)
