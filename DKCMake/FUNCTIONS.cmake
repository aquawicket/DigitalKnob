...
FUNCTION(DKSETPATHTOPLUGIN arg)
	...
	FILE(GLOB children RELATIVE ${DIGITALKNOB} ${DIGITALKNOB}/*)
  	FOREACH(child ${children})
		IF(EXISTS ${DIGITALKNOB}/${child}/${arg}/DKCMake.txt)
			MESSAGE("FOUND ${arg} Plugin at ${DIGITALKNOB}/${child}/${arg}")
			DKSET(PATHTOPLUGIN "${DIGITALKNOB}/${child}/${arg}")
			RETURN()
    	ENDIF()
		IF(EXISTS ${DIGITALKNOB}/${child}/DKPlugins/${arg}/DKCMake.txt)
			MESSAGE("FOUND ${arg} Plugin at ${DIGITALKNOB}/${child}/DKPlugins/${arg}")
			DKSET(PATHTOPLUGIN "${DIGITALKNOB}/${child}/DKPlugins/${arg}")
			RETURN()
    	ENDIF()
		IF(EXISTS ${DIGITALKNOB}/${child}/_DKIMPORTS/${arg}/DKCMake.txt)
			MESSAGE("FOUND ${arg} Plugin at ${DIGITALKNOB}/${child}/_DKIMPORTS/${arg}")
			DKSET(PATHTOPLUGIN "${DIGITALKNOB}/${child}/_DKIMPORTS/${arg}")
			RETURN()
    	ENDIF()
  	ENDFOREACH()
