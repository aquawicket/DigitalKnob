...
:DKINSTALL
	...
	::########## Method 1: Use this as rgistry callback file to evaluate variables ##########
	::## This method will call back to this file from the registry. And this will leave variable created here, in tact to be picked up
	::## by cmake using $ENV{Var}. 
	ftype DKCmake=%ComSpec% /V:ON /K call "%~f0" "%cmake_exe%" "%DKCMAKE_FUNCTIONS_DIR_%" "%%1" %*

	::########## Method 2: Evaluate all variables in regestry code ##########
	::## This method does not call back to this file. It will call cmake with the chosen file directly. This means that any variables that
	::## need to be passed to cmake will have to be present within the regisry code. 
