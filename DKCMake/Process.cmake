...
DKBUILD_LOG("\n\n *** Post-Generated Compiler Options and Flags *** \n")
...
foreach(the_lib ${LIBS})
	DKBUILD_LOG(${the_lib})
endforeach()
DKBUILD_LOG("\n ** Debug libraries ** \n")
foreach(the_lib ${DEBUG_LIBS})
	if(NOT "${the_lib}" STREQUAL "debug")
		DKBUILD_LOG(${the_lib})
	endif()
endforeach()
foreach(the_lib ${RELEASE_LIBS})
	if(NOT "${the_lib}" STREQUAL "optimized")
		DKBUILD_LOG(${the_lib})
	endif()
endforeach()
