...
foreach(plugin ${dkdepend_list})
	...
	if(${isDKPlugin} GREATER -1)
		...
		if(1)
			...
			if(WIN_32)
				#WIN_COMMAND(${DKCMAKE_WIN32} -DWIN_32=ON -DDEBUG=ON -DRELEASE=ON -DREBUILD=ON ${plugin_path})
				WIN_COMMAND(${DKCMAKE_BUILD} -DWIN_32=ON -DDEBUG=ON -DRELEASE=ON -DREBUILD=ON ${plugin_path})
				if(DEBUG)
			...
			if(WIN_64)
				#WIN_COMMAND(${DKCMAKE_WIN64} -DWIN_64=ON -DDEBUG=ON -DRELEASE=ON -DREBUILD=ON ${plugin_path})
				WIN_COMMAND(${DKCMAKE_BUILD} -DWIN_64=ON -DDEBUG=ON -DRELEASE=ON -DREBUILD=ON ${plugin_path})
				if(DEBUG)
			...
			if(MAC_32)
				#MAC_COMMAND(${DKCMAKE_MAC32} -DMAC_32=ON -DDEBUG=ON -DRELEASE=ON -DREBUILD=ON ${plugin_path})
				MAC_COMMAND(${DKCMAKE_BUILD} -DMAC_32=ON -DDEBUG=ON -DRELEASE=ON -DREBUILD=ON ${plugin_path})
				if(DEBUG)
			...
			if(MAC_64)
				#MAC_COMMAND(${DKCMAKE_MAC64} -DMAC_64=ON -DDEBUG=ON -DRELEASE=ON -DREBUILD=ON ${plugin_path})
				MAC_COMMAND(${DKCMAKE_BUILD} -DMAC_64=ON -DDEBUG=ON -DRELEASE=ON -DREBUILD=ON ${plugin_path})
				if(DEBUG)
					MAC_COMMAND(xcodebuild -configuration Debug build)
				endif()
				if(RELEASE)
					MAC_COMMAND(xcodebuild -configuration Release build)
				endif()
			endif()
			if(IOS_32)
				#IOS_COMMAND(${DKCMAKE_IOS32} -DIOS_32=ON -DDEBUG=ON -DRELEASE=ON -DREBUILD=ON ${plugin_path})
				IOS_COMMAND(${DKCMAKE_BUILD} -DIOS_32=ON -DDEBUG=ON -DRELEASE=ON -DREBUILD=ON ${plugin_path})
				if(DEBUG)
					IOS_COMMAND(xcodebuild -configuration Debug build) #-sdk iphoneos13.0)
				endif()
				if(RELEASE)
					IOS_COMMAND(xcodebuild -configuration Release build)
				endif()
			endif()
			if(IOS_64)
				#IOS_COMMAND(${DKCMAKE_IOS64} -DIOS_64=ON -DDEBUG=ON -DRELEASE=ON -DREBUILD=ON ${plugin_path})
				IOS_COMMAND(${DKCMAKE_BUILD} -DIOS_64=ON -DDEBUG=ON -DRELEASE=ON -DREBUILD=ON ${plugin_path})
				if(DEBUG)
					IOS_COMMAND(xcodebuild -configuration Debug build)
				endif()
				if(RELEASE)
					IOS_COMMAND(xcodebuild -configuration Release build)
				endif()
			...
			if(IOSSIM_32)
				#IOSSIM_COMMAND(${DKCMAKE_IOSSIM32} -DIOSSIM_32=ON -DDEBUG=ON -DRELEASE=ON -DREBUILD=ON ${plugin_path})
				IOSSIM_COMMAND(${DKCMAKE_BUILD} -DIOSSIM_32=ON -DDEBUG=ON -DRELEASE=ON -DREBUILD=ON ${plugin_path})
				if(DEBUG)
					IOSSIM_COMMAND(xcodebuild -configuration Debug build)
				endif()
				if(RELEASE)
					IOSSIM_COMMAND(xcodebuild -configuration Release build)
				endif()
			endif()
			if(IOSSIM_64)
				#IOSSIM_COMMAND(${DKCMAKE_IOSSIM64} -DIOSSIM_64=ON -DDEBUG=ON -DRELEASE=ON -DREBUILD=ON ${plugin_path})
				IOSSIM_COMMAND(${DKCMAKE_BUILD} -DIOSSIM_64=ON -DDEBUG=ON -DRELEASE=ON -DREBUILD=ON ${plugin_path})
				if(DEBUG)
					IOSSIM_COMMAND(xcodebuild -configuration Debug build)
				endif()
				if(RELEASE)
			...
			if(LINUX_32)
				if(DEBUG)
					...
					#dk_makeDirectory(${CURRENT_DIR})
					#LINUX_COMMAND(${DKCMAKE_LINUX_DEBUG} -DLINUX_32=ON -DDEBUG=ON -DREBUILD=ON ${plugin_path})
					LINUX_COMMAND(${DKCMAKE_BUILD} -DLINUX_32=ON -DDEBUG=ON -DREBUILD=ON ${plugin_path})
					LINUX_COMMAND(make)
				elseif(RELEASE)
					#DKSET(CURRENT_DIR ${plugin_path}/${OS}/${RELEASE_DIR})
					#dk_makeDirectory(${CURRENT_DIR})
					#LINUX_COMMAND(${DKCMAKE_LINUX_RELEASE} -DLINUX_32=ON -DREBUILD=ON -DRELEASE=ON ${plugin_path})
					LINUX_COMMAND(${DKCMAKE_BUILD} -DLINUX_32=ON -DREBUILD=ON -DRELEASE=ON ${plugin_path})
					LINUX_COMMAND(make)
				endif()
			endif()
			if(LINUX_64)
				if(DEBUG)
					#DKSET(CURRENT_DIR ${plugin_path}/${OS}/${DEBUG_DIR})
					#dk_makeDirectory(${CURRENT_DIR})
					#LINUX_COMMAND(${DKCMAKE_LINUX_DEBUG} -DLINUX_64=ON -DDEBUG=ON -DREBUILD=ON ${plugin_path})
					LINUX_COMMAND(${DKCMAKE_BUILD} -DLINUX_64=ON -DDEBUG=ON -DREBUILD=ON ${plugin_path})
					LINUX_COMMAND(make)
				elseif(RELEASE)
					#DKSET(CURRENT_DIR ${plugin_path}/${OS}/${RELEASE_DIR})
					#dk_makeDirectory(${CURRENT_DIR})
					#LINUX_COMMAND(${DKCMAKE_LINUX_RELEASE} -DLINUX_64=ON -DRELEASE=ON -DREBUILD=ON ${plugin_path})
					LINUX_COMMAND(${DKCMAKE_BUILD} -DLINUX_64=ON -DRELEASE=ON -DREBUILD=ON ${plugin_path})
					LINUX_COMMAND(make)
				endif()
			endif()
			if(RASPBERRY_32)
				if(DEBUG)
					#DKSET(CURRENT_DIR ${plugin_path}/${OS}/${DEBUG_DIR})
					#dk_makeDirectory(${CURRENT_DIR})
					#RASPBERRY_COMMAND(${DKCMAKE_RASPBERRY_DEBUG} -DRASPBERRY_32=ON -DDEBUG=ON -DREBUILD=ON ${plugin_path})
					RASPBERRY_COMMAND(${DKCMAKE_BUILD} -DRASPBERRY_32=ON -DDEBUG=ON -DREBUILD=ON ${plugin_path})
					RASPBERRY_COMMAND(make)
				elseif(RELEASE)
					#DKSET(CURRENT_DIR ${plugin_path}/${OS}/${RELEASE_DIR})
					#dk_makeDirectory(${CURRENT_DIR})
					#RASPBERRY_COMMAND(${DKCMAKE_RASPBERRY_RELEASE} -DRASPBERRY_32=ON -DRELEASE=ON -DREBUILD=ON ${plugin_path})
					RASPBERRY_COMMAND(${DKCMAKE_BUILD} -DRASPBERRY_32=ON -DRELEASE=ON -DREBUILD=ON ${plugin_path})
					RASPBERRY_COMMAND(make)
				endif()
			endif()
			if(RASPBERRY_64)
				if(DEBUG)
					...
					RASPBERRY_COMMAND(${DKCMAKE_BUILD} -DRASPBERRY_64=ON -DDEBUG=ON -DREBUILD=ON ${plugin_path})
					RASPBERRY_COMMAND(make)
				elseif(RELEASE)
					#DKSET(CURRENT_DIR ${plugin_path}/${OS}/${RELEASE_DIR})
					#dk_makeDirectory(${CURRENT_DIR})
					#RASPBERRY64_COMMAND(${DKCMAKE_RASPBERRY_RELEASE} -DRASPBERRY_64=ON -DRELEASE=ON -DREBUILD=ON ${plugin_path})
					RASPBERRY_COMMAND(${DKCMAKE_BUILD} -DRASPBERRY_64=ON -DRELEASE=ON -DREBUILD=ON ${plugin_path})
					RASPBERRY_COMMAND(make)
				endif()
			endif()
			if(ANDROID_32)
				#ANDROID32_COMMAND(${DKCMAKE_ANDROID32} -DANDROID_32=ON -DDEBUG=ON -DRELEASE=ON -DREBUILD=ON ${plugin_path})
				ANDROID_COMMAND(${DKCMAKE_BUILD} -DANDROID_32=ON -DDEBUG=ON -DRELEASE=ON -DREBUILD=ON ${plugin_path})
				if(DEBUG)
			...
			if(ANDROID_64)
				...
				ANDROID_COMMAND(${DKCMAKE_BUILD} -DANDROID_64=ON -DDEBUG=ON -DRELEASE=ON -DREBUILD=ON ${plugin_path})
				if(DEBUG)
