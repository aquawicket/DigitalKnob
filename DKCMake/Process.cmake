...
if(IOSSIM)
	...
	DKSET(BUNDLE_DEVELOPMENT_REGION en)
	DKSET(BUNDLE_DISPLAY_NAME ${APP_NAME})
	DKSET(BUNDLE_EXECUTBALE ${APP_NAME})
	DKSET(BUNDLE_ICON_FILES icon.png)
	DKSET(BUNDLE_IDENTIFIER com.digitalknob.${APP_NAME})
	DKSET(BUNDLE_INFO_DICTIONARY_VERSION 6.0)
	DKSET(BUNDLE_PACKAGE_TYPE APPL)
	DKSET(BUNDLE_VERSION 1.0)
	#DKSET(LS_REQUIRES_IPHONEOS NO)
	DKSET(MAIN_STORYBOARD_FILE dk.storyboard)
	DKSET(PRODUCT_NAME ${APP_NAME})
