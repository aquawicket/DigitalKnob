...
WIN32_DKSET(DKCONFIGURE_CFLAGS           "-march=i686 -DWIN32 -D_WINDOWS -D_CRT_SECURE_NO_WARNINGS -D_USING_V110_SDK71_ -std=gnu17 -fexceptions") #-D_WIN32_WINNT=0x0600 
...
WIN32_DKSET(DKCONFIGURE_CXXFLAGS         "-march=i686 -DWIN32 -D_WINDOWS -D_CRT_SECURE_NO_WARNINGS -D_USING_V110_SDK71_ -std=gnu++17 -frtti -fexceptions") #-D_WIN32_WINNT=0x0600
...
MAC64_DKSET(DKCONFIGURE_CFLAGS            "-DMAC -DMAC64 -std=c17 -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include -L/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/lib") #-x objective-c") # https://stackoverflow.com/questions/28756343/clang-link-failure-error-source-file-is-not-valid-utf-8
...
MAC64_DKSET(DKCONFIGURE_CXXFLAGS          "-DMAC -DMAC64 -std=c++17 -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include -L/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/lib") #-x objective-c++") #https://stackoverflow.com/questions/28756343/clang-link-failure-error-source-file-is-not-valid-utf-8
MAC64_DKSET(DKCONFIGURE_CXXFLAGS_DEBUG    "-DDEBUG -D_DEBUG")
MAC64_DKSET(DKCONFIGURE_CXXFLAGS_RELEASE  "-DNDEBUG")
...
IOS32_DKSET(DKCONFIGURE_CFLAGS_DEBUG      "-DDEBUG -D_DEBUG")
IOS32_DKSET(DKCONFIGURE_CFLAGS_RELEASE    "-DNDEBUG")
...
IOS32_DKSET(DKCONFIGURE_CXXFLAGS_DEBUG    "-DDEBUG -D_DEBUG")
IOS32_DKSET(DKCONFIGURE_CXXFLAGS_RELEASE  "-DNDEBUG")
...
IOS64_DKSET(DKCONFIGURE_CFLAGS_DEBUG      "-DDEBUG -D_DEBUG")
IOS64_DKSET(DKCONFIGURE_CFLAGS_RELEASE    "-DNDEBUG")
...
IOS64_DKSET(DKCONFIGURE_CXXFLAGS_DEBUG    "-DDEBUG -D_DEBUG")
IOS64_DKSET(DKCONFIGURE_CXXFLAGS_RELEASE  "-DNDEBUG")
...
LINUX32_DKSET(DKCONFIGURE_CFLAGS_DEBUG      "-DDEBUG -D_DEBUG")
LINUX32_DKSET(DKCONFIGURE_CFLAGS_RELEASE    "-DNDEBUG")
...
LINUX32_DKSET(DKCONFIGURE_CXXFLAGS_DEBUG    "-DDEBUG -D_DEBUG")
LINUX32_DKSET(DKCONFIGURE_CXXFLAGS_RELEASE  "-DNDEBUG")
...
LINUX64_DKSET(DKCONFIGURE_CFLAGS_DEBUG      "-DDEBUG -D_DEBUG")
LINUX64_DKSET(DKCONFIGURE_CFLAGS_RELEASE    "-DNDEBUG")
...
LINUX64_DKSET(DKCONFIGURE_CXXFLAGS_DEBUG    "-DDEBUG -D_DEBUG")
LINUX64_DKSET(DKCONFIGURE_CXXFLAGS_RELEASE  "-DNDEBUG")
...
RASPBERRY32_DKSET(DKCONFIGURE_CFLAGS            "-march=armv7l -DLINUX -DLINUX32 -DRASPBERRY -DRASPBERRY32 -std=gnu11 -no-pie -fPIC")
RASPBERRY32_DKSET(DKCONFIGURE_CFLAGS_DEBUG      "-DDEBUG -D_DEBUG")
RASPBERRY32_DKSET(DKCONFIGURE_CFLAGS_RELEASE    "-DNDEBUG")
RASPBERRY32_DKSET(DKCONFIGURE_CXX               ${LINUX_GXX})
RASPBERRY32_DKSET(DKCONFIGURE_CXXFLAGS          "-march=armv7l -DLINUX -DLINUX32 -DRASPBERRY -DRASPBERRY32 -std=gnu++17 -lstdc++fs -no-pie -fPIC")
RASPBERRY32_DKSET(DKCONFIGURE_CXXFLAGS_DEBUG    "-DDEBUG -D_DEBUG")
RASPBERRY32_DKSET(DKCONFIGURE_CXXFLAGS_RELEASE  "-DNDEBUG")
...
RASPBERRY64_DKSET(DKCONFIGURE_CFLAGS_DEBUG      "-DDEBUG -D_DEBUG")
RASPBERRY64_DKSET(DKCONFIGURE_CFLAGS_RELEASE    "-DNDEBUG")
...
RASPBERRY64_DKSET(DKCONFIGURE_CXXFLAGS_DEBUG    "-DDEBUG -D_DEBUG")
RASPBERRY64_DKSET(DKCONFIGURE_CXXFLAGS_RELEASE  "-DNDEBUG")
