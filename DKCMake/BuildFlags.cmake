...
WIN32_DKSET(DKCMAKE_BUILD ${CMAKE_COMMAND} -G ${VS_GENERATOR} -A Win32 ${DKCMAKE_FLAGS})
WIN64_DKSET(DKCMAKE_BUILD ${CMAKE_COMMAND} -G ${VS_GENERATOR} -A x64 ${DKCMAKE_FLAGS})
...
if(WIN_HOST)
	ANDROID32_DKSET(DKCMAKE_BUILD ${CMAKE_COMMAND} -G ${VS_GENERATOR} -A ARM ${DKCMAKE_FLAGS})
	ANDROID64_DKSET(DKCMAKE_BUILD ${CMAKE_COMMAND} -G ${VS_GENERATOR} -A ARM64 ${DKCMAKE_FLAGS})
endif()
