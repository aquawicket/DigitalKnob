...
if(CMAKE_HOST_WIN32 AND ANDROID)
	...
	if(ANDROID_32)
		...
		DKSET(DKCMAKE_C_BUILD ${CMAKE_EXE} -G ${VS_GENERATOR} -A ARM -DCMAKE_C_FLAGS=${DKCMAKE_C_FLAGS} -DCMAKE_C_FLAGS_DEBUG=${DKCMAKE_C_FLAGS_DEBUG} -DCMAKE_C_FLAGS_RELEASE=${DKCMAKE_C_FLAGS_RELEASE}))
	endif()
	if(ANDROID_64)
