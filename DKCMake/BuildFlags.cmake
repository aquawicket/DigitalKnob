...
WIN64_DKSET(DKCMAKE_CXX_FLAGS         "/DWIN32 /D_WINDOWS /D_CRT_SECURE_NO_WARNINGS /D_WIN32_WINNT=0x0600 /D_USING_V110_SDK71_ /std:c++17 /nologo /GR /EHsc /Zm500 /Zc:__cplusplus /MACHINE:X64")
...
#MAC32_DKSET(DKCMAKE_C_COMPILER         "")
...
#MAC32_DKSET(DKCMAKE_CXX_COMPILER      "")
...
MAC32_DKSET(DKCONFIGURE_CFLAGS        "-arch i686")
MAC32_DKSET(DKCONFIGURE_CXX            ${XCODE_CLANGXX})
MAC32_DKSET(DKCONFIGURE_CXXFLAGS      "-arch i686")

# Moc 64
MAC64_DKSET(DKCMAKE_FLAGS              -DCMAKE_OSX_ARCHITECTURES=x86_64 -DBUILD_SHARED_LIBS=OFF -DBUILD_STATIC_LIBS=ON)
#MAC64_DKSET(DKCMAKE_C_COMPILER         "")
MAC64_DKSET(DKCMAKE_C_FLAGS            "-arch x86-64 -DMAC -DMAC64 -std=c17 -x objective-c")
MAC64_DKSET(DKCMAKE_C_FLAGS_DEBUG      "-DDEBUG -D_DEBUG")
MAC64_DKSET(DKCMAKE_C_FLAGS_RELEASE    "-DNDEBUG")
#WIN64_DKSET(DKCMAKE_CXX_COMPILER      "")
MAC64_DKSET(DKCMAKE_CXX_FLAGS          "-arch x86-64 -DMAC -DMAC64 -std=c++17 -x objective-c++")
