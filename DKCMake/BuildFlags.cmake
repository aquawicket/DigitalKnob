...
LINUX32_DKSET(DKCMAKE_C_FLAGS               "-march=i686 -DLINUX=1 -DLINUX32 -std=gnu11 -no-pie -fPIC")
...
LINUX32_DKSET(DKCONFIGURE_CFLAGS            "-march=i686 -DLINUX=1 -DLINUX32 -std=gnu11 -no-pie -fPIC")
...
################################################################
## First, finnish building out the DK variables 

## Add Extra Optioons to Command sent variables
...
# These flasg will now go to the cmake internal variabels and to the command line variables
message(STATUS "\n")
message(STATUS "########## Original Input Variables ###################")
...
## append the DK variable to the internal cmake variables
...
message(STATUS "\n")
message(STATUS "########## CMake internal Variables ###################")
...
list(REMOVE_DUPLICATES DKCMAKE_FLAGS)
list(REMOVE_DUPLICATES DKCONFIGURE_FLAGS)
message(STATUS "\n")
message(STATUS "########## Output cmd line variables ###################")
message(STATUS "DKCMAKE_FLAGS = ${DKCMAKE_FLAGS}")
message(STATUS "DKCONFIGURE_FLAGS = ${DKCONFIGURE_FLAGS}")
message(STATUS "########## Output cmd line variables ###################")
message(STATUS "\n")
...
# Finalize the command line flags into singe build command line flags
############ CORE DEPENDENCIES ############
DKDEPEND(git)
DKDEPEND(cmake)
...
list(REMOVE_DUPLICATES DKCMAKE_BUILD)
list(REMOVE_DUPLICATES DKCONFIGURE_BUILD)
message(STATUS "\n")
message(STATUS "########## Final output cmd line variables ###################")
message(STATUS "DKCMAKE_BUILD = ${DKCMAKE_BUILD}")
message(STATUS "DKCONFIGURE_BUILD = ${DKCONFIGURE_BUILD}")
message(STATUS "########## Final output cmd line variables ###################")
message(STATUS "\n")