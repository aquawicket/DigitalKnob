...
macro(dk_load var)
	...
	#if(COMMAND ${fn})
	#	message("fn:${fn}  dk_load(${fn}) function already loaded")
	#if(COMMAND ${var})
	#	message("var:${var}    dk_load(${var}) function already loaded")
	#else()
...
macro(dk_parseFunctionsAndLoad fn fpath)
	...
	if(${${fn}_file} IN_LIST dk_load_list)
		...
		if(NOT "${${fn}_file}" STREQUAL "${DKSCRIPT_PATH}")
			message(VERBOSE "${fn} -> include(${${fn}_file})")
			include(${${fn}_file})
		endif()
