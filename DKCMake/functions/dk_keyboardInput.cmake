...
function(dk_keyboardInput input) 
	...
	if(CMD_EXE)
		...
		#	set /p "input="
		#	echo %input%
		dk_fileWrite(keyboardInput.cmd "@echo off & set /p \"input=\"\necho %input%")
		execute_process(COMMAND cmd /c keyboardInput.cmd OUTPUT_VARIABLE output OUTPUT_STRIP_TRAILING_WHITESPACE)
