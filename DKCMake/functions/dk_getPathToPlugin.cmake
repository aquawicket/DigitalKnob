...
function(dk_getPathToPlugin plugin rtn_var)
	...
	#file(GLOB children RELATIVE $ENV{DIGITALKNOB_DIR} $ENV{DIGITALKNOB_DIR}/*)
 	#foreach(child ${children})
		#dk_printVar(child)
		#if(EXISTS $ENV{DIGITALKNOB_DIR}/${child}/3rdParty/_DKIMPORTS/${plugin}/DKMAKE.cmake)
		#	set(${rtn_var} "$ENV{DIGITALKNOB_DIR}/${child}/3rdParty/_DKIMPORTS/${plugin}" PARENT_SCOPE)
		#	return()
    	#endif()
		#dk_debug($ENV{DKIMPORTS_DIR}/${plugin}/DKMAKE.cmake)
		dk_validate(ENV{DKIMPORTS_DIR} "dk_DKIMPORTS_DIR()")
		if(EXISTS $ENV{DKIMPORTS_DIR}/${plugin}/DKMAKE.cmake)
			set(${rtn_var} "$ENV{DKIMPORTS_DIR}/${plugin}" PARENT_SCOPE)
			return()
    	endif()
		#if(EXISTS $ENV{DIGITALKNOB_DIR}/${child}/plugins/${plugin}/DKMAKE.cmake)
