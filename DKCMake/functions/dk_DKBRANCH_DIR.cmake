...
function(dk_DKBRANCH_DIR)
	...
	dk_set(ENV{DKBRANCH_DIR} "$ENV{DIGITALKNOB_DIR}/${DKBRANCH}")
		...
		set(ENV{DKPOWERSHELL_DIR} "$ENV{DKBRANCH_DIR}/DKPowershell")
		...
		set(ENV{DKPYTHON_DIR} "$ENV{DKBRANCH_DIR}/DKPython")
