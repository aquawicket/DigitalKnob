...
function(dk_DKBRANCH_DIR)
	...
	dk_set(ENV{DKBRANCH_DIR} "$ENV{DIGITALKNOB_DIR}/${DKBRANCH}")
		...
		dk_set(ENV{DKBASH_DIR} "$ENV{DKBRANCH_DIR}/DKBash")
			...
			dk_set(ENV{DKBATCH_FUNCTIONS_DIR} "$ENV{DKBASH_DIR}/functions")

			dk_set(ENV{DKBATCH_FUNCTIONS_DIR}_ "$ENV{DKBATCH_FUNCTIONS_DIR}/")

		dk_set($ENV{DKBATCH_DIR} "$ENV{DKBRANCH_DIR}/DKBatch")

			dk_set(ENV{DKBATCH_FUNCTIONS_DIR} "$ENV{DKBATCH_DIR}/functions")
			set(ENV{DKBATCH_FUNCTIONS_DIR} "$ENV{DKBATCH_DIR}/functions")

			dk_set(ENV{DKBATCH_FUNCTIONS_DIR}_ "$ENV{DKBATCH_FUNCTIONS_DIR}/")
			set(ENV{DKBATCH_FUNCTIONS_DIR_} "$ENV{DKBATCH_FUNCTIONS_DIR}/")

		dk_set(DKC_DIR "$ENV{DKBRANCH_DIR}/DKC")
		set(ENV{DKC_DIR} "$ENV{DKBRANCH_DIR}/DKC")
		...
		set(ENV{DKCMAKE_DIR} "$ENV{DKBRANCH_DIR}/DKCMake")
		...
		set(ENV{DKCPP_DIR} "$ENV{DKBRANCH_DIR}/DKCpp")
		...
		set(ENV{DKCSHARP_DIR} "$ENV{DKBRANCH_DIR}/DKCSharp")
		...
		set(ENV{DKHTA_DIR} "$ENV{DKBRANCH_DIR}/DKHta")
		...
		set(ENV{DKHTML_DIR} "$ENV{DKBRANCH_DIR}/DKHtml")
		...
		set(ENV{DKJAVA_DIR} "$ENV{DKBRANCH_DIR}/DKJava")
		...
		set(ENV{DKJAVASCRIPT_DIR} "$ENV{DKBRANCH_DIR}/DKJavascript")
		...
		set(ENV{DKPHP_DIR} "$ENV{DKBRANCH_DIR}/DKPhp")
