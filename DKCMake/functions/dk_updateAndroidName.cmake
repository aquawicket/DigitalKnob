...
function(dk_updateAndroidName app_name)
	...
	if(Android)
		...
		file(GLOB_RECURSE allfiles LIST_DIRECTORIES true RELATIVE "${DK_Project_Dir}/${Target_Tuple}/" "${DK_Project_Dir}/${Target_Tuple}/*")
		dk_verbose("Getting a list of files in ${DK_Project_Dir}/${Target_Tuple}")
		list(REVERSE allfiles)
		foreach(each_file ${allfiles})
			dk_verbose(each_file)
			set(filepath "${DK_Project_Dir}/${Target_Tuple}/${each_file}")
			...
			if(fname MATCHES "dkapp")
				...
				dk_rename(${DK_Project_Dir}/${Target_Tuple}/${each_file} ${DK_Project_Dir}/${Target_Tuple}/${new_name} OVERWRITE)
			endif()
		endforeach()
	endif()
endfunction()
