...
function(dk_bashEnv)
	...
	if(cosmo)
		dk_assertVar(COSMO_BASH_EXPORTS)
		list(APPEND BASH_COMMANDS ${COSMO_BASH_EXPORTS})
	elseif(ANDROID)
	...
	### FIXME: we need to determin when it is appropriat to add msys2/urs/bin to the path enviroment
	#if(WIN_HOST)
	#	dk_assertVar(MSYS2_BASH_EXPORTS)
	#	list(APPEND BASH_COMMANDS ${MSYS2_BASH_EXPORTS})
	#endif()
