...
function(dk_createWindowsIcon)
	...
	dk_nativePath("${magick_exe}" magick_exe_WIN)
	dk_nativePath("${inpath}" inpath_WIN)
	dk_nativePath("${outpath}" outpath_WIN)
...
function(DKTEST)
	...
	dk_createWindowsIcon("$ENV{DKCPP_APPS_DIR}/DKCore/icon.png" "$ENV{DKCPP_APPS_DIR}/DKCore/icon.ico")
endfunction()