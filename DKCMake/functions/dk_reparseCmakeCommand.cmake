...
function(dk_reparseCmakeCommand CMD_LIST)
	...
	string(FIND "${_ARGV_}" "cmake.exe" cmake_pos)
	if(${cmake_pos} LESS 0)
		dk_return()
	endif()
	
	list(FIND _ARGV_ "-G" g_pos)
	if(${g_pos} LESS 0)
		dk_return()
	endif()
	...
	list(REMOVE_ITEM _ARGV_ COMMAND)
	foreach(item IN LISTS _ARGV_)
		if(${item} MATCHES "=")
			list(REMOVE_ITEM _ARGV_ ${item})
...
function(DKTEST)
	...
	dk_echo("myCmakeCommand = ${myCmakeCommand}\n")
