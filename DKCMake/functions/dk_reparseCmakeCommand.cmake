	...
	foreach(item IN LISTS ARGV)
		if(${item} MATCHES "=")
			...
			if(d_pos GREATER_EQUAL 0)
				...
				message("first_part = ${first_part}")
				message("second_part = ${second_part}")
			...
			if(e_pos GREATER_EQUAL 0)
				string(SUBSTRING "${item}" 0 ${e_pos} firstB_part)
				string(SUBSTRING "${item}" ${e_pos_end} -1 secondB_part)
				message("firstB_part = ${firstB_part}")
				message("secondB_part = ${secondB_part}")
				set(item "${firstB_part} ${secondB_part}")
			endif()
