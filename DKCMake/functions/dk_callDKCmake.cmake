...
function(dk_callDKCmake func rtn_var)
    ...
    set(DKCMAKE_COMMAND "${CMAKE_EXE} -DDKCOMMAND=${DKCOMMAND} -DDKSCRIPT_PATH=${DKSCRIPT_PATH} -DQUEUE_BUILD=ON -DDKCMAKE_FUNCTIONS_DIR_=$ENV{DKCMAKE_FUNCTIONS_DIR_} -P $ENV{DKCMAKE_DIR}/DKEval.cmake")
