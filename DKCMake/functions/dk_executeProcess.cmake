...
function(dk_executeProcess)
	DKDEBUGFUNC(${ARGV})
	dk_getOption_values(COMMAND 					${ARGV})
	dk_getOption_value(WORKING_DIRECTORY 			${ARGV})
	dk_getOption_value(TIMEOUT 					${ARGV})
