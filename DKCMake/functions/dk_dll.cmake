...
function(dk_dll plugin_name)
	...
	if(NOT EXISTS "${plugin_path}/CMakeLists.txt")
		...
		if(DLL_DEBUG_LIBS AND DLL_RELEASE_LIBS)
			#dk_fileAppend(${plugin_path}/CMakeLists.txt "target_link_libraries(${plugin_name} debug ${DKCPP_PLUGINS_DIR}/DK/${Target_Triple}/${DEBUG_DIR}/DK.lib optimized ${DKCPP_PLUGINS_DIR}/DK/${Target_Triple}/${RELEASE_DIR}/DK.lib) \n")
