...
#   endforeach()
	...
	if(dk_isUrl)
		...
		#dk_getUrl(${PLUGIN_Url} PLUGIN_Url)	
	endif()
...
function(PLUGIN_DKConfig)
	...
	if(EXISTS "${PLUGIN_Import_Path}/dkconfig.txt")
		...
		dk_debug("${PLUGIN_Import_Name}_Type = ${${PLUGIN_Import_Name}_Type}")
		
		#dk_getParameter(APP)
		if("${${PLUGIN_Import_Name}_Type}" STREQUAL "APP")
			dk_echo("Importing App to DKTools directory")
		...
		elseif(${PLUGIN}_Import)													# ZLIB_Import
			...
			dk_notice("No Import found for ${PLUGIN_Import_Name}:${PLUGIN_Import_Path}")
		endif()
...
function(PLUGIN_Url_Basename)
	...
	set(PLUGIN_Url_Basename "${dk_basename}")				# basename, filename
	string(REPLACE "?" "" PLUGIN_Url_Basename "${PLUGIN_Url_Basename}")
	string(REPLACE "=" "" PLUGIN_Url_Basename "${PLUGIN_Url_Basename}")
	if(NOT PLUGIN_Url_Basename)
		dk_notice("PLUGIN_Url_Basename is invalid")
	endif()
...
#	endif()
	...
	#dk_convertToCIdentifier("${PLUGIN_Import_Name}" PLUGIN)
...
function(DKTEST)
	...
	set(PLUGIN_Import_Path "${DKIMPORTS_DIR}/php-src")
