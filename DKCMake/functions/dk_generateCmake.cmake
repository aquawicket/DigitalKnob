...
<<<<<<< HEAD
	...
	dk_fileAppend(${plugin_path}/CMakeLists.txt "### This file is generated by DKCMake. Any Changes here, will be overwritten. ###\n")
...
=======
	...
	#dk_fileAppend(${plugin_path}/CMakeLists.txt "cmake_policy(SET CMP0054 NEW)\n")
	dk_fileAppend(${plugin_path}/CMakeLists.txt "project(${plugin_name})\n")
	dk_fileAppend(${plugin_path}/CMakeLists.txt "include_directories(${DKCPP_PLUGINS_DIR})\n")
>>>>>>> Development
...
=======
	#dk_fileAppend(${plugin_path}/CMakeLists.txt "install(TARGETS ${plugin_name} DESTINATION lib/\${target_triple})\n")
>>>>>>> Development
...
=======
		file(GLOB HEADER_FILES RELATIVE ${DKCPP_PLUGINS_DIR} ${plugin_path}/*.h)
>>>>>>> Development
...
=======
		dk_if(WIN			"dk_libDebug(${plugin_path}/${target_triple}/${DEBUG_DIR}/${plugin_name}.lib)")
		dk_if(WIN			"dk_libRelease(${plugin_path}/${target_triple}/${RELEASE_DIR}/${plugin_name}.lib)")
	else()
		dk_if(WIN			"dk_libDebug(${plugin_path}/${target_triple}/${DEBUG_DIR}/lib${plugin_name}.a)")
		dk_if(WIN			"dk_libRelease(${plugin_path}/${target_triple}/${RELEASE_DIR}/lib${plugin_name}.a)")
	endif()
	dk_if(MAC				"dk_libDebug(${plugin_path}/${target_triple}/${DEBUG_DIR}/lib${plugin_name}.a)")
	dk_if(MAC				"dk_libRelease(${plugin_path}/${target_triple}/${RELEASE_DIR}/lib${plugin_name}.a)")
	dk_if(IOS				"dk_libDebug(${plugin_path}/${target_triple}/Debug-iphoneos/lib${plugin_name}.a)")
	dk_if(IOS				"dk_libRelease(${plugin_path}/${target_triple}/Release-iphoneos/lib${plugin_name}.a)")
	dk_if(IOSSIM			"dk_libDebug(${plugin_path}/${target_triple}/Debug-iphonesimulator/lib${plugin_name}.a)")
	dk_if(IOSSIM			"dk_libRelease(${plugin_path}/${target_triple}/Release-iphonesimulator/lib${plugin_name}.a)")
	dk_if(LINUX				"dk_libDebug(${plugin_path}/${target_triple}/${DEBUG_DIR}/lib${plugin_name}.a)")
	dk_if(LINUX				"dk_libRelease(${plugin_path}/${target_triple}/${RELEASE_DIR}/lib${plugin_name}.a)")
	dk_if(RASPBERRY			"dk_libDebug(${plugin_path}/${target_triple}/${DEBUG_DIR}/lib${plugin_name}.a)")
	dk_if(RASPBERRY			"dk_libRelease(${plugin_path}/${target_triple}/${RELEASE_DIR}/lib${plugin_name}.a)")
	dk_if(ANDROID			"dk_libDebug(${plugin_path}/${target_triple}/${DEBUG_DIR}/lib${plugin_name}.a)")
	dk_if(ANDROID			"dk_libRelease(${plugin_path}/${target_triple}/${RELEASE_DIR}/lib${plugin_name}.a)")
	dk_if(EMSCRIPTEN		"dk_libDebug(${plugin_path}/${target_triple}/${DEBUG_DIR}/lib${plugin_name}.a)")
	dk_if(EMSCRIPTEN		"dk_libRelease(${plugin_path}/${target_triple}/${RELEASE_DIR}/lib${plugin_name}.a)")
>>>>>>> Development
