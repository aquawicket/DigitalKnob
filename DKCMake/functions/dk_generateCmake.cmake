...
function(dk_generateCmake plugin_name)
	...
	dk_fileAppend(${plugin_path}/CMakeLists.txt "endif()\n")
	#dk_fileAppend(${plugin_path}/CMakeLists.txt "install(TARGETS ${plugin_name} DESTINATION lib/\${OS})\n")
	...
	if(MSVC)
		WIN_TARGET_dk_libDebug		(${plugin_path}/${OS}/${DEBUG_DIR}/${plugin_name}.lib)
		WIN_TARGET_dk_libRelease	(${plugin_path}/${OS}/${RELEASE_DIR}/${plugin_name}.lib)
	else()
		WIN_TARGET_dk_libDebug		(${plugin_path}/${OS}/${DEBUG_DIR}/lib${plugin_name}.a)
		WIN_TARGET_dk_libRelease	(${plugin_path}/${OS}/${RELEASE_DIR}/lib${plugin_name}.a)
	endif()
	MAC_TARGET_dk_libDebug			(${plugin_path}/${OS}/${DEBUG_DIR}/lib${plugin_name}.a)
	MAC_TARGET_dk_libRelease		(${plugin_path}/${OS}/${RELEASE_DIR}/lib${plugin_name}.a)
	IOS_TARGET_dk_libDebug			(${plugin_path}/${OS}/Debug-iphoneos/lib${plugin_name}.a)
	IOS_TARGET_dk_libRelease		(${plugin_path}/${OS}/Release-iphoneos/lib${plugin_name}.a)
	IOSSIM_TARGET_dk_libDebug		(${plugin_path}/${OS}/Debug-iphonesimulator/lib${plugin_name}.a)
	IOSSIM_TARGET_dk_libRelease	(${plugin_path}/${OS}/Release-iphonesimulator/lib${plugin_name}.a)
	LINUX_TARGET_dk_libDebug		(${plugin_path}/${OS}/${DEBUG_DIR}/lib${plugin_name}.a)
	LINUX_TARGET_dk_libRelease		(${plugin_path}/${OS}/${RELEASE_DIR}/lib${plugin_name}.a)
	RASPBERRY_TARGET_dk_libDebug	(${plugin_path}/${OS}/${DEBUG_DIR}/lib${plugin_name}.a)
	RASPBERRY_TARGET_dk_libRelease	(${plugin_path}/${OS}/${RELEASE_DIR}/lib${plugin_name}.a)
	ANDROID_TARGET_dk_libDebug		(${plugin_path}/${OS}/${DEBUG_DIR}/lib${plugin_name}.a)
	ANDROID_TARGET_dk_libRelease	(${plugin_path}/${OS}/${RELEASE_DIR}/lib${plugin_name}.a)
	EMSCRIPTEN_TARGET_dk_libDebug	(${plugin_path}/${OS}/${DEBUG_DIR}/lib${plugin_name}.a)
	EMSCRIPTEN_TARGET_dk_libRelease(${plugin_path}/${OS}/${RELEASE_DIR}/lib${plugin_name}.a)
