...
function(dk_generateCmake plugin_name)
	...
	dk_fileAppend(${Plugin_Path}/CMakeLists.txt "if(Windows)\n")
	...
	dk_fileAppend(${Plugin_Path}/CMakeLists.txt "endif()\n")
	#dk_fileAppend(${Plugin_Path}/CMakeLists.txt "install(TARGETS ${plugin_name} DESTINATION lib/\${Target_Tuple})\n")
	...
	if(MSVC)
		dk_if(Windows			"dk_libDebug(${Plugin_Path}/${Target_Tuple}/${DEBUG_DIR}/${plugin_name}.lib)")
		dk_if(Windows			"dk_libRelease(${Plugin_Path}/${Target_Tuple}/${RELEASE_DIR}/${plugin_name}.lib)")
	else()
		dk_if(Windows			"dk_libDebug(${Plugin_Path}/${Target_Tuple}/${DEBUG_DIR}/lib${plugin_name}.a)")
		dk_if(Windows			"dk_libRelease(${Plugin_Path}/${Target_Tuple}/${RELEASE_DIR}/lib${plugin_name}.a)")
	endif()
	dk_if(Mac				"dk_libDebug(${Plugin_Path}/${Target_Tuple}/${DEBUG_DIR}/lib${plugin_name}.a)")
	dk_if(Mac				"dk_libRelease(${Plugin_Path}/${Target_Tuple}/${RELEASE_DIR}/lib${plugin_name}.a)")
	dk_if(Ios				"dk_libDebug(${Plugin_Path}/${Target_Tuple}/Debug-iphoneos/lib${plugin_name}.a)")
	dk_if(Ios				"dk_libRelease(${Plugin_Path}/${Target_Tuple}/Release-iphoneos/lib${plugin_name}.a)")
	dk_if(Iossim			"dk_libDebug(${Plugin_Path}/${Target_Tuple}/Debug-iphonesimulator/lib${plugin_name}.a)")
	dk_if(Iossim			"dk_libRelease(${Plugin_Path}/${Target_Tuple}/Release-iphonesimulator/lib${plugin_name}.a)")
	dk_if(Linux				"dk_libDebug(${Plugin_Path}/${Target_Tuple}/${DEBUG_DIR}/lib${plugin_name}.a)")
	dk_if(Linux				"dk_libRelease(${Plugin_Path}/${Target_Tuple}/${RELEASE_DIR}/lib${plugin_name}.a)")
	dk_if(Raspberry			"dk_libDebug(${Plugin_Path}/${Target_Tuple}/${DEBUG_DIR}/lib${plugin_name}.a)")
	dk_if(Raspberry			"dk_libRelease(${Plugin_Path}/${Target_Tuple}/${RELEASE_DIR}/lib${plugin_name}.a)")
	dk_if(Android			"dk_libDebug(${Plugin_Path}/${Target_Tuple}/${DEBUG_DIR}/lib${plugin_name}.a)")
