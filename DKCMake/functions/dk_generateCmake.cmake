...
function(dk_generateCmake plugin_name)
	...
	if(MSVC)
		WIN_dk_libDebug		(${plugin_path}/${triple}/${DEBUG_DIR}/${plugin_name}.lib)
		WIN_dk_libRelease	(${plugin_path}/${triple}/${RELEASE_DIR}/${plugin_name}.lib)
	else()
		WIN_dk_libDebug		(${plugin_path}/${triple}/${DEBUG_DIR}/lib${plugin_name}.a)
		WIN_dk_libRelease	(${plugin_path}/${triple}/${RELEASE_DIR}/lib${plugin_name}.a)
	endif()
	MAC_dk_libDebug			(${plugin_path}/${triple}/${DEBUG_DIR}/lib${plugin_name}.a)
	MAC_dk_libRelease		(${plugin_path}/${triple}/${RELEASE_DIR}/lib${plugin_name}.a)
	IOS_dk_libDebug			(${plugin_path}/${triple}/Debug-iphoneos/lib${plugin_name}.a)
	IOS_dk_libRelease		(${plugin_path}/${triple}/Release-iphoneos/lib${plugin_name}.a)
	IOSSIM_dk_libDebug		(${plugin_path}/${triple}/Debug-iphonesimulator/lib${plugin_name}.a)
	IOSSIM_dk_libRelease	(${plugin_path}/${triple}/Release-iphonesimulator/lib${plugin_name}.a)
	LINUX_dk_libDebug		(${plugin_path}/${triple}/${DEBUG_DIR}/lib${plugin_name}.a)
	LINUX_dk_libRelease		(${plugin_path}/${triple}/${RELEASE_DIR}/lib${plugin_name}.a)
	RASPBERRY_dk_libDebug	(${plugin_path}/${triple}/${DEBUG_DIR}/lib${plugin_name}.a)
	RASPBERRY_dk_libRelease	(${plugin_path}/${triple}/${RELEASE_DIR}/lib${plugin_name}.a)
	ANDROID_dk_libDebug		(${plugin_path}/${triple}/${DEBUG_DIR}/lib${plugin_name}.a)
	ANDROID_dk_libRelease	(${plugin_path}/${triple}/${RELEASE_DIR}/lib${plugin_name}.a)
	EMSCRIPTEN_dk_libDebug	(${plugin_path}/${triple}/${DEBUG_DIR}/lib${plugin_name}.a)
	EMSCRIPTEN_dk_libRelease(${plugin_path}/${triple}/${RELEASE_DIR}/lib${plugin_name}.a)
