...
macro(dk_debugFunc)
	...
	###### PARGV/PARGC - Parent Function args/count ######
	unset(PARGV)
	set(PARGC 0)
	...
	if(PARGV)
		string(STRIP "${PARGV}" __ARGV__)
		string(REPLACE ";" "', '" __ARGV__ "${PARGV}")
	...
	if(${ARGC} EQUAL 1)
		if(${PARGC} LESS ${ARGV0})
			dk_fatal("${__FUNCTION__}(${__ARGV__}) requires at least ${ARGV0} argments: got ${PARGC}")
		elseif(${PARGC} GREATER ${ARGV0})
			dk_fatal("${__FUNCTION__}(${__ARGV__}) takes ${ARGV0} argments max: got ${PARGC}")
		endif()
	elseif(${ARGC} EQUAL 2)
		if(${PARGC} LESS ${ARGV0})
			dk_fatal("${__FUNCTION__}(${__ARGV__}) requires at least ${ARGV0} argments: got ${PARGC}")
		elseif(${PARGC} GREATER ${ARGV1})
			dk_fatal("${__FUNCTION__}(${__ARGV__}) takes ${ARGV1} argments max: got ${PARGC}")
		endif()
	endif()
