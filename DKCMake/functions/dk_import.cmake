...
#	dk_debug("PLUGIN_Import_Name = ${${CURRENT_PLUGIN}_Import_Name}")
	
	#dk_set(PLUGIN "${dk_basename}")								# PLUGIN									zlib
	
#	dk_set(PLUGIN_Id "${dk_basename}")								# PLUGIN_id									zlib
#	dk_debug("PLUGIN_Id = ${${CURRENT_PLUGIN}_Id}")
	
#	dk_toUpper("${dk_basename}" PLUGIN)
#	dk_convertToCIdentifier(${${CURRENT_PLUGIN}} PLUGIN)
#	dk_set(PLUGIN "${${CURRENT_PLUGIN}}")										# PLUGIN									ZLIB
#	dk_debug("PLUGIN = ${${CURRENT_PLUGIN}}")
	
																	########## ${PLUGIN}_variables ##########
#	dk_set(${PLUGIN} "${PLUGIN_Install_Path}")						# <PLUGIN>									ZLIB
