...
function(dk_import)
	...
	set(Import_Path "${${CURRENT_PLUGIN}.Import_Path}")
	...
	if(EXISTS "${PLUGIN.Install_Path}")
		dk_echo("${PLUGIN.Install_Name} already installed")
		return()
	endif()
	
	if(PLUGIN.Url)
		dk_download("${PLUGIN.Url}")
		if("${PLUGIN.Url_Extension}" STREQUAL ".7z")
		...
		elseif("${PLUGIN.Url_Extension}" STREQUAL ".rar")		
			set(FileType "Archive")
		elseif("${PLUGIN.Url_Extension}" STREQUAL ".sfx.exe")	
			set(FileType "Archive")
		elseif("${PLUGIN.Url_Extension}" STREQUAL ".tar")		
			set(FileType "Archive")
		elseif("${PLUGIN.Url_Extension}" STREQUAL ".tar.gz")	
			set(FileType "Archive")
		elseif("${PLUGIN.Url_Extension}" STREQUAL ".tar.xz")	
			set(FileType "Archive")
