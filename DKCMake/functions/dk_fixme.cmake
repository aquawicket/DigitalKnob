...
function(dk_fixme msg)
	...
	#dk_updateLogInfo()
	#message("${BLACK}${STACK_HEADER}${clr}${yellow}${msg}${clr}")	
	if(HALT_ON_FIXME OR HALT AND NOT NO_HALT)
		message("${yellow}*** HALT_ON_FIXME ***")
		message(FATAL_ERROR "FIXME: ${YELLOW}${msg}${clr}")
		#dk_exit(1)
	elseif(TRACE_ON_FIXME OR TRACE AND NOT NO_TRACE)
		message("${yellow}*** TRACE_ON_FIXME ***")
		message(WARNING "FIXME: ${YELLOW}${msg}${clr}")
	else()
		message("${yellow}FIXME:${YELLOW}${msg}${clr}")
	endif()
