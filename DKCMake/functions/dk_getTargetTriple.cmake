...
function(dk_getTargetTriple)
	...
	if(NOT CMAKE_SCRIPT_MODE_FILE)
		...
		### Get DK_TARGET_ENV
		if(DK_TARGET_TRIPLE MATCHES "android")
			dk_set(DK_TARGET_OS android)
		elseif(DK_TARGET_TRIPLE MATCHES "emscripten")
			dk_set(DK_TARGET_OS emscripten)
		elseif(DK_TARGET_TRIPLE MATCHES "iossim")
			dk_set(DK_TARGET_OS iossim)
		elseif(DK_TARGET_TRIPLE MATCHES "ios")
			dk_set(DK_TARGET_OS ios)
		elseif(DK_TARGET_TRIPLE MATCHES "linux")
			dk_set(DK_TARGET_OS linux)
		elseif(DK_TARGET_TRIPLE MATCHES "mac")
			dk_set(DK_TARGET_OS mac)
		elseif(DK_TARGET_TRIPLE MATCHES "rasp")
			dk_set(DK_TARGET_OS raspberry)
		elseif(DK_TARGET_TRIPLE MATCHES "win")
		...
		elseif(DK_TARGET_TRIPLE MATCHES "arm32")
			dk_set(DK_TARGET_ARCH arm32)
		elseif(DK_TARGET_TRIPLE MATCHES "x86_64")
			dk_set(DK_TARGET_ARCH x86_64)
		elseif(DK_TARGET_TRIPLE MATCHES "x86")
			dk_set(DK_TARGET_ARCH x86)
		else()
			dk_error("The DK_TARGET_TRIPLE:${DK_TARGET_TRIPLE} does not contain info to set DK_TARGET_ARCH")
		endif()
		
		
		### Get DK_TARGET_ENV
		if(DK_TARGET_TRIPLE MATCHES "clang")
			dk_set(DK_TARGET_ENV clang)
		elseif(DK_TARGET_TRIPLE MATCHES "mingw")
			dk_set(DK_TARGET_ENV mingw)
		elseif(DK_TARGET_TRIPLE MATCHES "ucrt")
			dk_set(DK_TARGET_ENV ucrt)
		elseif(DK_TARGET_TRIPLE MATCHES "msvc")
			dk_set(DK_TARGET_ENV msvc)
		else()
			dk_warning("The DK_TARGET_TRIPLE:${DK_TARGET_TRIPLE} does not contain info to set DK_TARGET_ENV")
		endif()
		...
		if(DK_TARGET_ENV)
			...
			elseif(DK_TARGET_ARCH MATCHES "x86")
				...
				dk_error("The DK_TARGET_TRIPLE:${DK_TARGET_TRIPLE} does not contain info to set MSYSTEM")
			endif()
			dk_set(${MSYSTEM} ON)
		endif()
