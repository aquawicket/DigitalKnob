...
function(dk_pickUpdate) 
	...
	if(${behind} LESS 1)
		...
		dk_echo(" 9) Reload")
		dk_echo("10) Exit")
		dk_validate(DKBRANCH_DIR "dk_call dk_DKBRANCH_DIR()")
		if(EXISTS "${DKBRANCH_DIR}/build_list.txt")
		...
		if(DEFINED ENV{_APP_} AND DEFINED ENV{_target_triple_} AND DEFINED ENV{_DKBUILD_TYPE_})
			dk_echo(" 0) Repeat DKBuilder.cache [$ENV{_APP_} - $ENV{_target_triple_} - $ENV{_DKBUILD_TYPE_}]")
		endif()
		dk_echo("$ENV{green}")
		dk_echo(" 1) Git Update")
		dk_echo("$ENV{red}")
		...
		if("${choice}" STREQUAL "11")
			set(BUILD_LIST_FILE "${DKBRANCH_DIR}/build_list.txt")
			return()
		endif()
		dk_echo()
		dk_echo("Press Enter To Skip")
