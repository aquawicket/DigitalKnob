...
function(dk_pickUpdate) 
	...
	if(${behind} LESS 1)
		if(ENV{_APP_} AND ENV{_target_triple_ENV} AND ENV{_BUILD_TYPE_})
			dk_echo(" 0) Repeat cache [$ENV{_APP_} - $ENV{_target_triple_} - $ENV{_BUILD_TYPE_}]")
		endif()
		...
		dk_echo()
		dk_echo("$ENV{red}") 
		if(ENV{_APP_} AND ENV{_target_triple_} AND ENV{_BUILD_TYPE_})
			dk_echo(" 0) Repeat cache [$ENV{_APP_} - $ENV{_target_triple_} - $ENV{_BUILD_TYPE_}]")
		endif()
		dk_echo("$ENV{green}")
		dk_echo(" 1) Git Update")
	...
	if("${input}" EQUAL "0")
		...
		dk_set(DKBUILD_TYPE $ENV{_BUILD_TYPE_})
		set(ENV{UPDATE} 1)
