...
function(dk_pickUpdate) 
	...
	dk_readCache(_APP_ _target_triple_ _BUILD_TYPE_)
	#dk_printVar(_APP_)
	#dk_printVar(_target_triple_) 
	#dk_printVar(_BUILD_TYPE_)
	...
	if(${behind} LESS 1)
		if(_APP_ AND _target_triple_ AND _BUILD_TYPE_)
			dk_echo(" 0) Repeat cache [${_APP_} - ${_target_triple_} - ${_BUILD_TYPE_}]")
		endif()
