...
function(dk_pickUpdate) 
	...
	unset(Target_Tuple)
	unset(Target_Type)
	dk_readCache(Target_App_Cache Target_Tuple_Cache Target_Type_Cache)
	
	if(${behind} LESS 1)
		if((DEFINED Target_App_Cache) AND (DEFINED Target_Tuple_Cache) AND (DEFINED Target_Type_Cache))
		...
		dk_echo()
		dk_echo("$ENV{red}") 
		if(DEFINED ENV{Target_App_Cache} AND DEFINED ENV{Target_Tuple_Cache} AND DEFINED ENV{Target_Type_Cache})
			dk_echo(" 0) Repeat DKBuilder.cache [$ENV{Target_App_Cache} - $ENV{Target_Tuple_Cache} - $ENV{Target_Type_Cache}]")
		endif()
		dk_echo("$ENV{green}")
		dk_echo(" 1) Git Update")
		dk_echo("$ENV{red}")
	...
	if("${input}" EQUAL "0")
		...
		dk_set(Target_App $ENV{Target_App_Cache})
		dk_set(Target_Tuple $ENV{Target_Tuple_Cache})
		dk_set(Target_Type $ENV{Target_Type_Cache})
		set(ENV{UPDATE} 1)
