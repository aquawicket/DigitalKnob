...
function(dk_pickUpdate) 
	...
	if(${behind} LESS 1)
		...
		dk_echo()
		dk_echo("$ENV{red}") 
		if(DEFINED ENV{_target_app_} AND DEFINED ENV{_Target_Tuple_} AND DEFINED ENV{_DKBUILD_TYPE_})
			dk_echo(" 0) Repeat DKBuilder.cache [$ENV{_target_app_} - $ENV{_Target_Tuple_} - $ENV{_DKBUILD_TYPE_}]")
		endif()
		dk_echo("$ENV{green}")
		dk_echo(" 1) Git Update")
		dk_echo("$ENV{red}")
	...
	if("${input}" EQUAL "0")
		...
		dk_set(Target_Tuple $ENV{_Target_Tuple_})
