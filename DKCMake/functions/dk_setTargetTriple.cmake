...
function(dk_setTargetTriple)
	...
	elseif("${input}" STREQUAL "1")
		dk_set(DK_TARGET_TRIPLE 	"${DK_HOST_TRIPLE}")
		dk_set(DK_TARGET_OS     	"${DK_HOST_OS}")
		dk_set(DK_TARGET_ARCH  		"${DK_HOST_ARCH}")
		if(DK_HOST_ENV)
			dk_set(DK_TARGET_ENV    "${DK_HOST_ENV}")
		endif()
