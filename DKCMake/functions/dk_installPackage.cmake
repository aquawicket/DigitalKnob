...
function(dk_installPackage)
	...
	if(EXISTS ${${PACKAGE}_exe})
		dk_notice("${PACKAGE}_exe:${${PACKAGE}_exe} already exists")
		return()
	endif()
...
#	
	...
	#dk_validate(apt-get  "dk_depend(apt-get_exe)")
	if(apt-get_exe)
		dk_validate(sudo_exe "dk_depend(sudo_exe)")
		set(DKSudo_pass 2393)
		if(DEFINED DKSudo_pass AND DEFINED sudo_exe)
			set(sudo_exe builtin echo ${DKSudo_pass} | ${sudo_exe} --stdin)
		endif()
		#set(comand		builtin echo ${DKSudo_pass} | ${sudo_exe} --stdin ${apt-get_exe} -y install ${package})
