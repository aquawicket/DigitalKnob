...
function(dk_test)
    ...
    dk_echo( "        DKSCRIPT_PATH = $ENV{DKSCRIPT_PATH}")
    dk_echo( "         DKSCRIPT_DIR = $ENV{DKSCRIPT_DIR}")
    dk_echo( "        DKSCRIPT_FILE = $ENV{DKSCRIPT_FILE}")
    dk_echo( "        DKSCRIPT_NAME = $ENV{DKSCRIPT_NAME}")
    dk_echo( "         DKSCRIPT_EXT = $ENV{DKSCRIPT_EXT}")
    dk_echo( "        DKSCRIPT_ARGS = $ENV{DKSCRIPT_ARGS}")
    dk_echo( "           DKHOME_DIR = $ENV{DKHOME_DIR}")
    dk_echo( "          DKCACHE_DIR = $ENV{DKCACHE_DIR}")
    dk_echo( "        DKDESKTOP_DIR = $ENV{DKDESKTOP_DIR}")
    dk_echo( "          DIGITALKNOB = $ENV{DIGITALKNOB}")
    dk_echo( "      DIGITALKNOB_DIR = $ENV{DIGITALKNOB_DIR}")
    dk_echo( "       DKDOWNLOAD_DIR = $ENV{DKDOWNLOAD_DIR}")
    dk_echo( "          DKTOOLS_DIR = $ENV{DKTOOLS_DIR}")
    dk_echo( "             DKBRANCH = $ENV{DKBRANCH}")
    dk_echo( "         DKBRANCH_DIR = $ENV{DKBRANCH_DIR}")
    dk_echo( "       DK3RDPARTY_DIR = $ENV{DK3RDPARTY_DIR}")
    dk_echo( "       DKCPP_APPS_DIR = $ENV{DKCPP_APPS_DIR}")
    dk_echo( "           DKBASH_DIR = $ENV{DKCMAKE_DIR}")
    dk_echo( " DKBASH_FUNCTIONS_DIR = $ENV{DKCMAKE_FUNCTIONS_DIR}")
