...
function(dk_createIcons)
	...
	if(Android)
		if(Debug)
			dk_resizeImage("${ARGV0}" 36 36   "${DK_Project_Dir}/${Target_Tuple}/Debug/app/src/main/res/mipmap-ldpi/ic_launcher.png")
			dk_resizeImage("${ARGV0}" 48 48   "${DK_Project_Dir}/${Target_Tuple}/Debug/app/src/main/res/mipmap-mdpi/ic_launcher.png")
			dk_resizeImage("${ARGV0}" 72 72   "${DK_Project_Dir}/${Target_Tuple}/Debug/app/src/main/res/mipmap-hdpi/ic_launcher.png")
			dk_resizeImage("${ARGV0}" 96 96   "${DK_Project_Dir}/${Target_Tuple}/Debug/app/src/main/res/mipmap-xhdpi/ic_launcher.png")
			dk_resizeImage("${ARGV0}" 144 144 "${DK_Project_Dir}/${Target_Tuple}/Debug/app/src/main/res/mipmap-xxhdpi/ic_launcher.png")
			dk_resizeImage("${ARGV0}" 192 192 "${DK_Project_Dir}/${Target_Tuple}/Debug/app/src/main/res/mipmap-xxxhdpi/ic_launcher.png")
		endif()
		if(Release)
			dk_resizeImage("${ARGV0}" 36 36   "${DK_Project_Dir}/${Target_Tuple}/Release/app/src/main/res/mipmap-ldpi/ic_launcher.png")
			dk_resizeImage("${ARGV0}" 48 48   "${DK_Project_Dir}/${Target_Tuple}/Release/app/src/main/res/mipmap-mdpi/ic_launcher.png")
			dk_resizeImage("${ARGV0}" 72 72   "${DK_Project_Dir}/${Target_Tuple}/Release/app/src/main/res/mipmap-hdpi/ic_launcher.png")
			dk_resizeImage("${ARGV0}" 96 96   "${DK_Project_Dir}/${Target_Tuple}/Release/app/src/main/res/mipmap-xhdpi/ic_launcher.png")
			dk_resizeImage("${ARGV0}" 144 144 "${DK_Project_Dir}/${Target_Tuple}/Release/app/src/main/res/mipmap-xxhdpi/ic_launcher.png")
			dk_resizeImage("${ARGV0}" 192 192 "${DK_Project_Dir}/${Target_Tuple}/Release/app/src/main/res/mipmap-xxxhdpi/ic_launcher.png")
		endif()
