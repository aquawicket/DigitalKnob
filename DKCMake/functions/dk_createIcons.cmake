...
function(dk_createIcons)
	...
	if(NOT EXISTS "${ARGV0}")
		dk_warning("dk_createIcons(): image:${ARGV0} not found.")
		return()
	endif()
	...
	if(ANDROID)
		...
		if(RELEASE)
			dk_resizeImage("${ARGV0}/icons/icon.png" 36 36   "${DK_PROJECT_DIR}/${triple}/Release/app/src/main/res/mipmap-ldpi/ic_launcher.png")
			dk_resizeImage("${ARGV0}/icons/icon.png" 48 48   "${DK_PROJECT_DIR}/${triple}/Release/app/src/main/res/mipmap-mdpi/ic_launcher.png")
			dk_resizeImage("${ARGV0}/icons/icon.png" 72 72   "${DK_PROJECT_DIR}/${triple}/Release/app/src/main/res/mipmap-hdpi/ic_launcher.png")
			dk_resizeImage("${ARGV0}/icons/icon.png" 96 96   "${DK_PROJECT_DIR}/${triple}/Release/app/src/main/res/mipmap-xhdpi/ic_launcher.png")
			dk_resizeImage("${ARGV0}/icons/icon.png" 144 144 "${DK_PROJECT_DIR}/${triple}/Release/app/src/main/res/mipmap-xxhdpi/ic_launcher.png")
			dk_resizeImage("${ARGV0}/icons/icon.png" 192 192 "${DK_PROJECT_DIR}/${triple}/Release/app/src/main/res/mipmap-xxxhdpi/ic_launcher.png")
		endif()
