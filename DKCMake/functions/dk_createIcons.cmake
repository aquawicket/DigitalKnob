...
function(dk_createIcons)
	...
	if(Apple)
		dk_mkdir("${Target_App_Dir}/Apple")
		dk_mkdir("${Target_App_Dir}/Apple/icons.iconset")
		dk_resizeImage("${ARGV0}" 16 16     "${Target_App_Dir}/Apple/icons.iconset/icon_16x16.png")
		dk_resizeImage("${ARGV0}" 32 32     "${Target_App_Dir}/Apple/icons.iconset/icon_16x16@2x.png")
		dk_resizeImage("${ARGV0}" 32 32     "${Target_App_Dir}/Apple/icons.iconset/icon_32x32.png")
		dk_resizeImage("${ARGV0}" 64 64     "${Target_App_Dir}/Apple/icons.iconset/icon_32x32@2x.png")
		dk_resizeImage("${ARGV0}" 128 128   "${Target_App_Dir}/Apple/icons.iconset/icon_128x128.png")
		dk_resizeImage("${ARGV0}" 256 256   "${Target_App_Dir}/Apple/icons.iconset/icon_128x128@2x.png")
		dk_resizeImage("${ARGV0}" 256 256   "${Target_App_Dir}/Apple/icons.iconset/icon_256x256.png")
		dk_resizeImage("${ARGV0}" 512 512   "${Target_App_Dir}/Apple/icons.iconset/icon_256x256@2x.png")
		dk_resizeImage("${ARGV0}" 512 512   "${Target_App_Dir}/Apple/icons.iconset/icon_512x512.png")
		dk_resizeImage("${ARGV0}" 1024 1024 "${Target_App_Dir}/Apple/icons.iconset/icon_512x512@2x.png")
		dk_exec(iconutil -c icns -o "${Target_App_Dir}/Apple/icons.icns" "${Target_App_Dir}/Apple/icons.iconset")
		set(MACOSX_BUNDLE_ICON_FILE icons.icns)
		set(app_ICONS "${Target_App_Dir}/Apple/icons.icns")
