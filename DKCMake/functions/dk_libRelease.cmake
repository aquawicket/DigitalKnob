...
function(dk_libRelease lib_path)
	...
	if(NOT EXISTS "${lib_path}")
		dk_echo("${lyellow}dk_libRelease(): ${yellow}MISSING ${lib_path}${clr}")
	endif()
	...
	set(ENV{RELEASE_LIBS} "${RELEASE_LIBS}")  # Export an enviromnent variable so the App's CMakeLists.txt can import it
