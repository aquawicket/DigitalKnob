...
function(dk_Target_Os)
	...
	dk_set(${Target_Os} 1)  # TODO:  remove this in favor of ${Target_Os}_Target instead
	
	###### VALIDATE RESULT ######
	if(Android_Target)
		dk_set(Unix_Target 1)
		dk_set(Google_Target 1)
	elseif(Emscripten_Target)
		dk_set(Unix_Target 1)
	elseif(Ios_Target)
		dk_set(Unix_Target 1)
		dk_set(Apple_Target 1)
