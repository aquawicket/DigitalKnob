...
function(dk_build path) #target NO_HALT
	...
	#list(APPEND BUILD_MODE single_config)
		...
		if(EXISTS ${path}/${Target_Config}/Makefile)
			...
			dk_echo("\n###### Building $ENV{CURRENT_PLUGIN} with ${path}/${Target_Config}/Makefile ######")
			dk_make(${ARGV})
			dk_return()
		endif()
		if(EXISTS ${path}/Makefile)
			dk_chdir("${path}")
			dk_echo("\n###### Building $ENV{CURRENT_PLUGIN} with ${path}/Makefile ######")
			dk_make(${ARGV})
			dk_return()
		endif()
		...
		if(MULTI_CONFIG)
			if(Debug)
				if(EXISTS "${path}/${Target_Tuple}/${Debug_Dir}/Makefile")
					...
					dk_echo("\n###### Building $ENV{CURRENT_PLUGIN} with ${path}/${Target_Tuple}/${Debug_Dir}/Makefile ######")
					dk_make(${ARGV})
					dk_chdir("${path}/${Target_Config}")
					dk_return()
				endif()
			elseif(Release)
				if(EXISTS "${path}/${Target_Tuple}/${Release_Dir}/Makefile")
					...
					dk_echo("\n###### Building $ENV{CURRENT_PLUGIN} with ${path}/${Target_Tuple}/${Release_Dir}/Makefile ######")
					dk_make(${ARGV})
					dk_chdir("${path}/${Target_Config}")
					dk_return()
				endif()
