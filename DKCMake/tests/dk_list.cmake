...
function(DKTEST)
	...
	dk_echo()
	dk_echo("    dk_list(PLUGIN PUSH \"abc\")")
	dk_list(PLUGIN PUSH "abc")
	dk_echo("        CURRENT_PLUGIN = ${CURRENT_PLUGIN}")
	
	dk_echo()
	dk_echo("    dk_list(PLUGIN PUSH \"123\")")
	dk_list(PLUGIN PUSH "123")
	dk_echo("        CURRENT_PLUGIN = ${CURRENT_PLUGIN}")
	
	dk_echo()
	dk_echo("    dk_list(PLUGIN PUSH \"def\")")
	dk_list(PLUGIN PUSH "def")
	dk_echo("        CURRENT_PLUGIN = ${CURRENT_PLUGIN}")
	
	dk_echo()
	dk_echo("    dk_list(PLUGIN PUSH \"456\")")
	dk_list(PLUGIN PUSH "456")
	dk_echo("        CURRENT_PLUGIN = ${CURRENT_PLUGIN}")
