...
FOREACH(plugin ${DKPLUGS})
	...
	IF(QUEUE_BUILD AND CMAKE_FILE)
		...
		IF(IOS_32)
			...
			IF(DEBUG)
				IOS32_COMMAND(xcodebuild -configuration Debug build -arch i386 -sdk iphonesimulator11.2)
			ENDIF()
			IF(RELEASE)
				IOS32_COMMAND(xcodebuild -configuration Release build -arch i386 -sdk iphonesimulator11.2)
			ENDIF()
		ENDIF()
		IF(IOS_64)
			...
			IF(DEBUG)
				IOS64_COMMAND(xcodebuild -configuration Debug build -arch x86_64 -sdk iphonesimulator11.2)
			ENDIF()
			IF(RELEASE)
				IOS64_COMMAND(xcodebuild -configuration Release build -arch x86_64 -sdk iphonesimulator11.2)
			ENDIF()
		ENDIF()
		IF(IOSSIM_32)
			...
			IF(DEBUG)
				IOSSIM32_COMMAND(xcodebuild -configuration Debug build -arch i386 -sdk iphonesimulator11.2)
			ENDIF()
			IF(RELEASE)
				IOSSIM32_COMMAND(xcodebuild -configuration Release build -arch i386 -sdk iphonesimulator11.2)
			ENDIF()
		ENDIF()
		IF(IOSSIM_64)
			...
			IF(DEBUG)
				IOSSIM64_COMMAND(xcodebuild -configuration Debug build -arch x86_64 -sdk iphonesimulator11.2)
			ENDIF()
			IF(RELEASE)
				IOSSIM64_COMMAND(xcodebuild -configuration Release build -arch x86_64 -sdk iphonesimulator11.2)
			ENDIF()
		ENDIF()
		IF(LINUX_32)
