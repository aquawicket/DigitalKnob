...
DKSET(DKINCLUDES "")
DKSET(DKLIBRARIES "")
ANDROID_DEBUG_LIB(${3RDPARTY}/android-ndk-r10e/sources/cxx-stl/gnu-libstdc++/4.8/libs/armeabi-v7a/libgnustl_static.a)
ANDROID_RELEASE_LIB(${3RDPARTY}/android-ndk-r10e/sources/cxx-stl/gnu-libstdc++/4.8/libs/armeabi-v7a/libgnustl_static.a)
FOREACH(plugin ${DKPLUGS})
	...
	IF(ANDROID_LIBMK)
		...
		IF(DEBUG)
			...
			EXECUTE_PROCESS(COMMAND ${3RDPARTY}/android-ndk-r10e/ndk-build.cmd NDK_DEBUG=1 WORKING_DIRECTORY ${CURRENT_DIR})
		ENDIF()
		IF(RELEASE)
			...
			EXECUTE_PROCESS(COMMAND ${3RDPARTY}/android-ndk-r10e/ndk-build.cmd NDK_DEBUG=0 WORKING_DIRECTORY ${CURRENT_DIR})
		ENDIF()
	ENDIF()
