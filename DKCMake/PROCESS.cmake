...
foreach(plugin ${dkdepend_list})
	...
	if(QUEUE_BUILD AND CMAKE_FILE)
		...
		if(MAC_64)
			...
			#	dk_makeDirectory(${CURRENT_DIR})
			#	MAC64_COMMAND(${DKCMAKE_MAC64_DEBUG} -DMAC_64=ON -DDEBUG=ON -DREBUILD=ON ${plugin_path})
			#	MAC64_COMMAND(make)
			#endif()
			#if(RELEASE)
			#	DKSET(CURRENT_DIR ${plugin_path}/${OS}/${RELEASE_DIR})
			#	dk_makeDirectory(${CURRENT_DIR})
			#	MAC64_COMMAND(${DKCMAKE_MAC64_RELEASE} -DMAC_64=ON -DREBUILD=ON -DRELEASE=ON ${plugin_path})
			#	MAC64_COMMAND(make)
			#endif()
		endif()
		if(IOS_32)
