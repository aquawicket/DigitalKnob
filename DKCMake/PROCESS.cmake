...
DKSET(DKINCLUDES "")
DKSET(DKLIBRARIES "")
ANDROID_DEBUG_LIB(C:/android-ndk-r10d/sources/cxx-stl/gnu-libstdc++/4.8/libs/armeabi-v7a/libgnustl_static.a)
...
FOREACH(plugin ${DKPLUGS})
	...
	IF(ANDROID_LIBMK)
		...
		IF(DEBUG)
			...
			EXECUTE_PROCESS(COMMAND C:/android-ndk-r10d/ndk-build.cmd NDK_DEBUG=1 WORKING_DIRECTORY ${CURRENT_DIR})
		ENDIF()
		IF(RELEASE)
			...
			EXECUTE_PROCESS(COMMAND C:/android-ndk-r10d/ndk-build.cmd NDK_DEBUG=0 WORKING_DIRECTORY ${CURRENT_DIR})
		ENDIF()
	ENDIF()
...
IF(MAC)
	...
	IF(DEBUG)
		...
		DKCOPY(${DKPROJECT}/assets/ ${DKPROJECT}/${OS}/Debug/${AppName}.app/Contents/MacOS/Resources TRUE)
	...
	IF(RELEASE)
		...
		DKCOPY(${DKPROJECT}/assets/ ${DKPROJECT}/${OS}/Release/${AppName}.app/Contents/MacOS/Resources TRUE)
