...
foreach(plugin ${dkdepend_list})
	...
	if(QUEUE_BUILD AND CMAKE_FILE)
		...
		if(WIN_32)
			...
			if(DEBUG)
				WIN32_COMMAND(${VC_EXE} ${CURRENT_DIR}/${plugin}.sln /p:Configuration=Debug /p:PreferredToolArchitecture=x86)
			endif()
			if(RELEASE)
				WIN32_COMMAND(${VC_EXE} ${CURRENT_DIR}/${plugin}.sln /p:Configuration=Release /p:PreferredToolArchitecture=x86)
			endif()
		endif()
		...
		if(WIN_64)
			...
			if(DEBUG)
				WIN64_COMMAND(${VC_EXE} ${CURRENT_DIR}/${plugin}.sln /p:Configuration=Debug /p:PreferredToolArchitecture=x64)
			endif()
			if(RELEASE)
				WIN64_COMMAND(${VC_EXE} ${CURRENT_DIR}/${plugin}.sln /p:Configuration=Release /p:PreferredToolArchitecture=x64)
			endif()
		endif()
