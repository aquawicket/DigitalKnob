	...
	IF(QUEUE_BUILD AND CMAKE_FILE)
		...
		IF(ANDROID_32)
			...
			IF(DEBUG)
				DKSET(CURRENT_DIR ${PATHTOPLUGIN}/${OS}/Debug)
				FILE(MAKE_DIRECTORY ${CURRENT_DIR})
				ANDROID32_COMMAND(${CMAKE_COMMAND} -G ${GENERATOR} -A ARM -DANDROID_32=ON -DREBUILD=ON -DDEBUG=ON -DCMAKE_TOOLCHAIN_FILE=${ANDROID_NDK}/build/cmake/android.toolchain.cmake -DANDROID_NDK=${ANDROID_NDK} -DANDROID_STL=c++_static ${PATHTOPLUGIN})
				ANDROID32_COMMAND(make)
			ENDIF()
			IF(RELEASE)
				DKSET(CURRENT_DIR ${PATHTOPLUGIN}/${OS}/Release)
				FILE(MAKE_DIRECTORY ${CURRENT_DIR})
				ANDROID32_COMMAND(${CMAKE_COMMAND} -G ${GENERATOR} -A ARM -DANDROID_32=ON -DREBUILD=ON -DRELEASE=ON -DCMAKE_TOOLCHAIN_FILE=${ANDROID_NDK}/build/cmake/android.toolchain.cmake -DANDROID_NDK=${ANDROID_NDK} -DANDROID_ABI=armeabi-v7a -DANDROID_ARM_NEON=ON -DANDROID_NATIVE_API_LEVEL=29 -DANDROID_STL=c++_static ${PATHTOPLUGIN})
				ANDROID32_COMMAND(make)
			ENDIF()
		ENDIF()
