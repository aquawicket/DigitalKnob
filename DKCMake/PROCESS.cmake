...
DKSET(DKINCLUDES "")
DKSET(DKLIBRARIES "")
SET(ANDROID_NDK ${3RDPARTY}/android-ndk-r20b)
ANDROID_DEBUG_LIB(${ANDROID_NDK}/sources/cxx-stl/gnu-libstdc++/4.8/libs/armeabi-v7a/libgnustl_static.a)
ANDROID_RELEASE_LIB(${ANDROID_NDK}/sources/cxx-stl/gnu-libstdc++/4.8/libs/armeabi-v7a/libgnustl_static.a)
FOREACH(plugin ${DKPLUGS})
	...
	IF(QUEUE_BUILD AND CMAKE_FILE)
		...
		IF(ANDROID_32)
			...
			IF(DEBUG)
				DKSET(CURRENT_DIR ${PATHTOPLUGIN}/${OS}/Debug)
				FILE(MAKE_DIRECTORY ${CURRENT_DIR})
				ANDROID32_COMMAND(${CMAKE_COMMAND} -G ${GENERATOR} -A ARM -DANDROID_32=ON -DREBUILD=ON -DDEBUG=ON -DCMAKE_TOOLCHAIN_FILE=${ANDROID_NDK}/build/cmake/android.toolchain.cmake -DANDROID_NDK=${ANDROID_NDK} ${PATHTOPLUGIN})
				ANDROID32_COMMAND(make)
			ENDIF()
			IF(RELEASE)
				DKSET(CURRENT_DIR ${PATHTOPLUGIN}/${OS}/Release)
				FILE(MAKE_DIRECTORY ${CURRENT_DIR})
				ANDROID32_COMMAND(${CMAKE_COMMAND} -G ${GENERATOR} -A ARM -DANDROID_32=ON -DREBUILD=ON -DRELEASE=ON -DCMAKE_TOOLCHAIN_FILE=${ANDROID_NDK}/build/cmake/android.toolchain.cmake -DANDROID_NDK=${ANDROID_NDK} ${PATHTOPLUGIN})
				ANDROID32_COMMAND(make)
			ENDIF()
		ENDIF()
		...
		IF(ANDROID_64)
			...
			IF(DEBUG)
				DKSET(CURRENT_DIR ${PATHTOPLUGIN}/${OS}/Debug)
				FILE(MAKE_DIRECTORY ${CURRENT_DIR})
				ANDROID64_COMMAND(${CMAKE_COMMAND} -G ${GENERATOR} -A ARM64 -DANDROID_64=ON -DREBUILD=ON -DDEBUG=ON -DCMAKE_TOOLCHAIN_FILE=${ANDROID_NDK}/build/cmake/android.toolchain.cmake -DANDROID_NDK=${ANDROID_NDK} ${PATHTOPLUGIN})
				ANDROID64_COMMAND(make)
			ENDIF()
			IF(RELEASE)
				DKSET(CURRENT_DIR ${PATHTOPLUGIN}/${OS}/Release)
				FILE(MAKE_DIRECTORY ${CURRENT_DIR})
				ANDROID64_COMMAND(${CMAKE_COMMAND} -G ${GENERATOR} -A ARM64 -DANDROID_32=ON -DREBUILD=ON -DRELEASE=ON -DCMAKE_TOOLCHAIN_FILE=${ANDROID_NDK}/build/cmake/android.toolchain.cmake -DANDROID_NDK=${ANDROID_NDK} ${PATHTOPLUGIN})
				ANDROID64_COMMAND(make)
			ENDIF()
		ENDIF()
