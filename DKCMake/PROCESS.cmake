	...
	if(QUEUE_BUILD AND CMAKE_FILE)
		...
		if(LINUX_64)
			if(DEBUG)
				...
				#LINUX64_COMMAND(${CMAKE_COMMAND} -G "Unix Makefiles" -DLINUX_64=ON -DDEBUG=ON -DREBUILD=ON ${PATHTOPLUGIN})
			...
			if(RELEASE)
				...
				#LINUX64_COMMAND(${CMAKE_COMMAND} -G "Unix Makefiles" -DLINUX_64=ON -DRELEASE=ON -DREBUILD=ON ${PATHTOPLUGIN})
				LINUX64_COMMAND(make)
			endif()
		endif()
...
if(WIN_64)
	...
	target_link_libraries(${APP_NAME}_64 ${WIN_LIBS} ${DEBUG_LIBS} ${RELEASE_LIBS})
	##set_source_files_properties(${DIGITALKNOB}/stdafx.cpp PROPERTIES COMPILE_FLAGS "/Ycstdafx.h")
...
if(LINUX)
	...
	if(DEBUG)
		...
		target_link_libraries(${APP_NAME}d ${LINUX_LIBS} ${DEBUG_LIBS})
	endif()
	
	if(RELEASE)
		message("${RELEASE_LIBS}")
		target_link_libraries(${APP_NAME} ${LINUX_LIBS} ${RELEASE_LIBS})
	endif()
endif()
...
if(ANDROID)
	...
	#list(APPEND DEBUG_LIBS GLESv1_CM)
	#list(APPEND RELEASE_LIBS GLESv1_CM)
	list(APPEND ANDROID_LIBS GLESv2)
	#list(APPEND DEBUG_LIBS GLESv2)
	#list(APPEND RELEASE_LIBS GLESv2)
	list(APPEND ANDROID_LIBS log)
	#list(APPEND DEBUG_LIBS log)
	#list(APPEND RELEASE_LIBS log)
	list(APPEND ANDROID_LIBS android)
	#list(APPEND DEBUG_LIBS android)
