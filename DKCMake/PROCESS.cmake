...
foreach(plugin ${dkdepend_list})
	...
	if(QUEUE_BUILD AND CMAKE_FILE)
		...
		if(ANDROID_32)
			...
			file(MAKE_DIRECTORY ${CURRENT_DIR})
			ANDROID32_COMMAND(${CMAKE_COMMAND} -G ${GENERATOR} -A ARM -DCMAKE_TOOLCHAIN_FILE=${ANDROID_NDK}/build/cmake/android.toolchain.cmake -DCMAKE_ANDROID_NDK=${ANDROID_NDK} -DANDROID_ABI=armeabi-v7a -DANDROID_NATIVE_API_LEVEL=24 -DCMAKE_ANDROID_STL_TYPE=c++_static -DANDROID_32=ON -DREBUILD=ON -DDEBUG=ON -DRELEASE=ON ${PATHTOPLUGIN})
			if(DEBUG)
		...
		if(ANDROID_64)
			...
			file(MAKE_DIRECTORY ${CURRENT_DIR})
			ANDROID64_COMMAND(${CMAKE_COMMAND} -G ${GENERATOR} -A ARM64 -DCMAKE_TOOLCHAIN_FILE=${ANDROID_NDK}/build/cmake/android.toolchain.cmake -DCMAKE_ANDROID_NDK=${ANDROID_NDK} -DANDROID_ABI=arm64-v8a -DANDROID_NATIVE_API_LEVEL=24 -DCMAKE_ANDROID_STL_TYPE=c++_static -DANDROID_64=ON -DREBUILD=ON -DDEBUG=ON -DRELEASE=ON ${PATHTOPLUGIN})
			if(DEBUG)
				##DKSET(CURRENT_DIR ${PATHTOPLUGIN}/${OS}/Debug)
				##file(MAKE_DIRECTORY ${CURRENT_DIR})
