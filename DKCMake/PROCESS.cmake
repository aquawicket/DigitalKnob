...
foreach(plugin ${dkdepend_list})
	...
	if(QUEUE_BUILD AND CMAKE_FILE)
		...
		if(ANDROID_32)
			...
			file(MAKE_DIRECTORY ${CURRENT_DIR})
			ANDROID32_COMMAND(${DKCMAKE_ANDROID64} -DCMAKE_ANDROID_STL_TYPE=c++_static -DANDROID_32=ON -DREBUILD=ON -DDEBUG=ON -DRELEASE=ON ${PATHTOPLUGIN})
			if(DEBUG)
		...
		if(ANDROID_64)
			...
			file(MAKE_DIRECTORY ${CURRENT_DIR})
			ANDROID64_COMMAND(${DKCMAKE_ANDROID64} -DCMAKE_ANDROID_STL_TYPE=c++_static -DANDROID_64=ON -DREBUILD=ON -DDEBUG=ON -DRELEASE=ON ${PATHTOPLUGIN})
			if(DEBUG)
				##DKSET(CURRENT_DIR ${PATHTOPLUGIN}/${OS}/Debug)
				##file(MAKE_DIRECTORY ${CURRENT_DIR})
