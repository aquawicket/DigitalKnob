...
foreach(plugin ${dkdepend_list})
	...
	if(QUEUE_BUILD AND CMAKE_FILE)
		...
		if(LINUX_64)
			DKSET(CURRENT_DIR ${PATHTOPLUGIN}/linux64)
			file(MAKE_DIRECTORY ${CURRENT_DIR})
			LINUX64_COMMAND(${CMAKE_COMMAND} -G "Unix Makefiles" -DLINUX_64=ON -DDEBUG=ON -DRELEASE=ON -DREBUILD=ON ${PATHTOPLUGIN})
			if(DEBUG)
				LINUX64_COMMAND(make debug)
			endif()
			if(RELEASE)
