...
message("DIGITALKNOB:                   ${DIGITALKNOB}")
...
message("RELEASE_DIR:      ${RELEASE_DIR}")
	...
	if(QUEUE_BUILD AND CMAKE_FILE)
		...
		if(LINUX_64)
			...
			if(DEBUG)
				DKSET(CURRENT_DIR ${PATHTOPLUGIN}/${OS}/Debug)
				file(MAKE_DIRECTORY ${CURRENT_DIR})
				LINUX64_COMMAND(${CMAKE_COMMAND} -G "Unix Makefiles" -DCMAKE_BUILD_TYPE=Debug -DLINUX_64=ON -DREBUILD=ON -DDEBUG=ON ${PATHTOPLUGIN})
				LINUX64_COMMAND(make)
			endif()
			if(RELEASE)
				DKSET(CURRENT_DIR ${PATHTOPLUGIN}/${OS}/Release)
				file(MAKE_DIRECTORY ${CURRENT_DIR})
				LINUX64_COMMAND(${CMAKE_COMMAND} -G "Unix Makefiles" -DCMAKE_BUILD_TYPE=Release -DLINUX_64=ON -DREBUILD=ON -DRELEASE=ON ${PATHTOPLUGIN})
				LINUX64_COMMAND(make)
			endif()
		endif()
		...
		if(RASPBERRY_32)
			...
			if(DEBUG)
				DKSET(CURRENT_DIR ${PATHTOPLUGIN}/${OS}/Debug)
				file(MAKE_DIRECTORY ${CURRENT_DIR})
				RASPBERRY32_COMMAND(${CMAKE_COMMAND} -G "Unix Makefiles" -DCMAKE_BUILD_TYPE=Debug -DRASPBERRY_32=ON -DREBUILD=ON -DDEBUG=ON ${PATHTOPLUGIN})
				RASPBERRY32_COMMAND(make)
			endif()
			if(RELEASE)
				DKSET(CURRENT_DIR ${PATHTOPLUGIN}/${OS}/Release)
				file(MAKE_DIRECTORY ${CURRENT_DIR})
				RASPBERRY32_COMMAND(${CMAKE_COMMAND} -G "Unix Makefiles" -DCMAKE_BUILD_TYPE=Release -DRASPBERRY_32=ON -DREBUILD=ON -DRELEASE=ON ${PATHTOPLUGIN})
				RASPBERRY32_COMMAND(make)
			endif()
		endif()
		...
		if(RASPBERRY_64)
			...
			if(DEBUG)
				DKSET(CURRENT_DIR ${PATHTOPLUGIN}/${OS}/Debug)
				file(MAKE_DIRECTORY ${CURRENT_DIR})
				RASPBERRY64_COMMAND(${CMAKE_COMMAND} -G "Unix Makefiles" -DCMAKE_BUILD_TYPE=Debug -DRASPBERRY_64=ON -DREBUILD=ON -DDEBUG=ON ${PATHTOPLUGIN})
				RASPBERRY64_COMMAND(make)
			endif()
			if(RELEASE)
				DKSET(CURRENT_DIR ${PATHTOPLUGIN}/${OS}/Release)
				file(MAKE_DIRECTORY ${CURRENT_DIR})
				RASPBERRY64_COMMAND(${CMAKE_COMMAND} -G "Unix Makefiles" -DCMAKE_BUILD_TYPE=Release -DRASPBERRY_64=ON -DREBUILD=ON -DRELEASE=ON ${PATHTOPLUGIN})
				RASPBERRY64_COMMAND(make)
			endif()
		endif()
		...
		if(ANDROID_32)
			...
			file(MAKE_DIRECTORY ${CURRENT_DIR})
			ANDROID32_COMMAND(${DKCMAKE_ANDROID32} -DANDROID_32=ON -DREBUILD=ON -DDEBUG=ON -DRELEASE=ON ${PATHTOPLUGIN})
			if(DEBUG)
		...
		if(ANDROID_64)
			DKSET(CURRENT_DIR ${PATHTOPLUGIN}/android64)
			file(MAKE_DIRECTORY ${CURRENT_DIR})
			ANDROID64_COMMAND(${DKCMAKE_ANDROID64} -DANDROID_64=ON -DREBUILD=ON -DDEBUG=ON -DRELEASE=ON ${PATHTOPLUGIN})
			if(DEBUG)
				##DKSET(CURRENT_DIR ${PATHTOPLUGIN}/${OS}/Debug)
				##file(MAKE_DIRECTORY ${CURRENT_DIR})
