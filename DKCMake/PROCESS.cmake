	...
	if(QUEUE_BUILD AND CMAKE_FILE)
		...
		if(LINUX_64)
			...
			if(DEBUG)
				DKSET(CURRENT_DIR ${PATHTOPLUGIN}/${OS}/Debug)
				file(MAKE_DIRECTORY ${CURRENT_DIR})
				LINUX64_COMMAND(${DKCMAKE_LINUX_DEBUG} -DLINUX_64=ON -DREBUILD=ON -DDEBUG=ON ${PATHTOPLUGIN})
				LINUX64_COMMAND(make)
			endif()
			if(RELEASE)
				DKSET(CURRENT_DIR ${PATHTOPLUGIN}/${OS}/Release)
				file(MAKE_DIRECTORY ${CURRENT_DIR})
				LINUX64_COMMAND(${DKCMAKE_LINUX_RELEASE} -DLINUX_64=ON -DREBUILD=ON -DRELEASE=ON ${PATHTOPLUGIN})
				LINUX64_COMMAND(make)
			endif()
		endif()
