...
if(LINUX)
	...
	if(DEBUG)
		...
		target_link_libraries(${APP_NAME} ${DEBUG_LIBS} ${LIBS} ${LINUX_LIBS})
		#set_target_properties(${APP_NAME} PROPERTIES DEBUG_POSTFIX d)
	endif()
	if(RELEASE)
		add_executable(${APP_NAME} ${App_SRC})
		target_link_libraries(${APP_NAME} ${RELEASE_LIBS} ${LIBS} ${LINUX_LIBS})
	endif()
endif()
...
if(RASPBERRY)
	...
	if(DEBUG)
		add_definitions(-DDEBUG)
		add_executable(${APP_NAME} ${App_SRC})
		target_link_libraries(${APP_NAME} ${DEBUG_LIBS} ${LIBS} ${RASPBERRY_LIBS})
		#set_target_properties(${APP_NAME} PROPERTIES DEBUG_POSTFIX d)
	endif()
	if(RELEASE)
		add_executable(${APP_NAME} ${App_SRC})
		target_link_libraries(${APP_NAME} ${RELEASE_LIBS} ${LIBS} ${RASPBERRY_LIBS})
	endif()
endif()
...
if(ANDROID)
	...
	target_link_libraries(${APP_NAME} ${DEBUG_LIBS} ${RELEASE_LIBS} ${LIBS} ${ANDROID_LIBS})
	#set_target_properties(${APP_NAME} PROPERTIES DEBUG_POSTFIX d)
