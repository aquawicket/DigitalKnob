...
if(CMAKE_HOST_WIN32)
	...
	set(WIN_HOST_ARCH 			${CMAKE_HOST_SYSTEM_PROCESSOR}	CACHE INTERNAL "")
endif()
if(CMAKE_HOST_APPLE)
	set(UNIX_HOST 				TRUE 							CACHE INTERNAL "")
	set(UNIX_HOST_ARCH 			${CMAKE_HOST_SYSTEM_PROCESSOR}	CACHE INTERNAL "")
	set(MAC_HOST 				TRUE 							CACHE INTERNAL "")
	set(MAC_HOST_ARCH 			${CMAKE_HOST_SYSTEM_PROCESSOR}	CACHE INTERNAL "")
endif()
if(CMAKE_HOST_UNIX AND NOT CMAKE_HOST_APPLE)
	set(UNIX_HOST 				TRUE 							CACHE INTERNAL "")
	set(UNIX_HOST_ARCH 			${CMAKE_HOST_SYSTEM_PROCESSOR}	CACHE INTERNAL "")
	set(LINUX_HOST 				TRUE 							CACHE INTERNAL "")
	set(LINUX_HOST_ARCH 		${CMAKE_HOST_SYSTEM_PROCESSOR}	CACHE INTERNAL "")
	
	if("${CMAKE_HOST_SYSTEM_NAME}" STREQUAL "Android")
		set(ANDROID_HOST 		TRUE 							CACHE INTERNAL "")
		set(ANDROID_HOST_ARCH 	${CMAKE_HOST_SYSTEM_PROCESSOR}	CACHE INTERNAL "")
	endif()
endif()
...
if(NOT CMAKE_HOST_SYSTEM_PROCESSOR)
	if(WIN32)
		set(CMAKE_HOST_SYSTEM_PROCESSOR "$ENV{PROCESSOR_ARCHITECTURE}"	CACHE INTERNAL "")
	else()
...
elseif(${CMAKE_HOST_SYSTEM_PROCESSOR} MATCHES "ARM64")
	set(HOST_ARCH 	arm64	CACHE INTERNAL "")
elseif(${CMAKE_HOST_SYSTEM_PROCESSOR} MATCHES "EM64T")
	set(HOST_ARCH 	x86_64	CACHE INTERNAL "")
