...
if(EXISTS ${FREETYPE}/${triple}/Release/freetype.lib)
	...
	set(FREETYPE_LIBRARY ${FREETYPE}/${triple}/Release/freetype.lib CACHE FILEPATH "" FORCE)
	set(FREETYPE_LIBRARY_DEBUG ${FREETYPE}/${triple}/Debug/freetype.lib CACHE FILEPATH "" FORCE)
	set(FREETYPE_LIBRARY_RELEASE ${FREETYPE}/${triple}/Release/freetype.lib CACHE FILEPATH "" FORCE)
endif()

set(SDL2 ${DK3RDPARTY_DIR}/SDL2-2.0.14 CACHE PATH "" FORCE)
if(EXISTS ${SDL2}/${triple}/Release/SDL2.lib)
	set(SDL2_DIR ${SDL2} CACHE PATH "" FORCE)
	set(SDL2_INCLUDE_DIR ${SDL2}/include CACHE PATH "" FORCE)
	set(SDL2_LIBRARY_TEMP ${SDL2}/${triple}/Release/SDL2.lib CACHE FILEPATH "" FORCE)
	set(SDL2_LIBRARY ${SDL2}/${triple}/Release/SDL2.lib CACHE FILEPATH "" FORCE)
	set(SDL2_LIBRARY_DEBUG ${SDL2}/${triple}/Debug/SDL2d.lib CACHE FILEPATH "" FORCE)
	set(SDL2_LIBRARY_RELEASE ${SDL2}/${triple}/Release/SDL2.lib CACHE FILEPATH "" FORCE)
	set(SDL2MAIN_LIBRARY_TEMP ${SDL2}/${triple}/Release/SDL2main.lib CACHE FILEPATH "" FORCE)
	set(SDL2MAIN_LIBRARY ${SDL2}/${triple}/Release/SDL2main.lib CACHE FILEPATH "" FORCE)
	set(SDL2MAIN_LIBRARY_DEBUG ${SDL2}/${triple}/Debug/SDL2maind.lib CACHE FILEPATH "" FORCE)
	set(SDL2MAIN_LIBRARY_RELEASE ${SDL2}/${triple}/Release/SDL2main.lib CACHE FILEPATH "" FORCE)
endif()


set(SDL2_IMAGE ${DK3RDPARTY_DIR}/SDL2_image-2.0.1 CACHE PATH "" FORCE)
if(EXISTS ${SDL2_IMAGE}/${triple}/lib/Release/SDL_image.lib)
	set(SDL2_IMAGE_INCLUDE_DIR ${SDL2_IMAGE} CACHE PATH "" FORCE)
	set(SDL2_IMAGE_LIBRARY_TEMP ${SDL2_IMAGE}/${triple}/lib/Release/SDL_image.lib CACHE FILEPATH "" FORCE)
	set(SDL2_IMAGE_LIBRARY ${SDL2_IMAGE}/${triple}/lib/Release/SDL_image.lib CACHE FILEPATH "" FORCE)
	set(SDL2_IMAGE_LIBRARY_DEBUG ${SDL2_IMAGE}/${triple}/lib/Debug/SDL_image.lib CACHE FILEPATH "" FORCE)
	set(SDL2_IMAGE_LIBRARY_RELEASE ${SDL2_IMAGE}/${triple}/lib/Release/SDL_image.lib CACHE FILEPATH "" FORCE)
endif()


set(SFML ${DK3RDPARTY_DIR}/SFML-2.4.2 CACHE PATH "" FORCE)
if(EXISTS ${SFML}/${triple}/lib/Release/sfml-main.lib)
	set(SFML_INCLUDE_DIR ${SFML}/include CACHE FILEPATH "" FORCE)
	set(SFML_MAIN_LIBRARY_DEBUG ${SFML}/${triple}/lib/Debug/sfml-main-d.lib CACHE FILEPATH "" FORCE)
	set(SFML_MAIN_LIBRARY_RELEASE ${SFML}/${triple}/lib/Release/sfml-main.lib CACHE FILEPATH "" FORCE)
	set(SFML_SYSTEM_LIBRARY_DEBUG ${SFML}/${triple}/lib/Debug/sfml-system-s-d.lib CACHE FILEPATH "" FORCE)
	set(SFML_SYSTEM_LIBRARY_RELEASE ${SFML}/${triple}/lib/Debug/sfml-system-s.lib CACHE FILEPATH "" FORCE)
	set(SFML_WINDOW_LIBRARY_DEBUG ${SFML}/${triple}/lib/Debug/sfml-window-s-d.lib CACHE FILEPATH "" FORCE)
	set(SFML_WINDOW_LIBRARY_RELEASE ${SFML}/${triple}/lib/Release/sfml-window-s.lib CACHE FILEPATH "" FORCE)
	set(SFML_GRAPHICS_LIBRARY_DEBUG ${SFML}/${triple}/lib/Debug/sfml-graphics-s-d.lib CACHE FILEPATH "" FORCE)
	set(SFML_GRAPHICS_LIBRARY_RELEASE ${SFML}/${triple}/lib/Release/sfml-graphics-s.lib CACHE FILEPATH "" FORCE)
	set(SFML_AUDIO_LIBRARY_DEBUG ${SFML}/${triple}/lib/Debug/sfml-audio-s-d.lib CACHE FILEPATH "" FORCE)
	set(SFML_AUDIO_LIBRARY_RELEASE ${SFML}/${triple}/lib/Release/sfml-audio-s.lib CACHE FILEPATH "" FORCE)
endif()

# https://cmake.org/cmake/help/latest/module/FindGLEW.html
set(GLEW ${DK3RDPARTY_DIR}/glew-2.2.0 CACHE PATH "" FORCE)
if(EXISTS ${GLEW}/${triple}/lib/Release/libglew32.lib)
	##set(GLEW_DIR ${GLEW}/build/cmake CACHE PATH "" FORCE)
	set(GLEW_USE_STATIC_LIBS ON CACHE BOOL "" FORCE)
	set(GLEW_DIR ${GLEW}/${triple}/CMakeFiles/Export/lib/cmake/glew CACHE PATH "" FORCE)
	set(GLEW_LIBRARY ${GLEW}/${triple}/lib/Debug/libglew32.lib CACHE FILEPATH "" FORCE)
	set(GLEW_INCLUDE_DIR ${GLEW} CACHE PATH "" FORCE)
	set(GLEW_STATIC_LIBRARY_DEBUG ${GLEW}/${triple}/lib/Debug/libglew32d.lib CACHE FILEPATH "" FORCE)
	set(GLEW_STATIC_LIBRARY_RELEASE ${GLEW}/${triple}/lib/Release/libglew32.lib CACHE FILEPATH "" FORCE)
	set(GLEW_SHARED_LIBRARY_DEBUG ${GLEW}/${triple}/lib/Debug/glew32d.lib CACHE FILEPATH "" FORCE)
	set(GLEW_SHARED_LIBRARY_RELEASE ${GLEW}/${triple}/lib/Release/glew32.lib CACHE FILEPATH "" FORCE)
...
if(EXISTS ${OPENAL}/${triple}/Release/OpenAL32.lib)
# /I${OPENAL}/include/AL
	set(OPENAL_INCLUDE_DIR ${OPENAL}/include CACHE PATH "" FORCE)
	set(OPENAL_LIB_DIR ${OPENAL}/${triple}/Release CACHE PATH "" FORCE)
