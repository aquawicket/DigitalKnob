...
DKDISABLE(lua)
DKDISABLE(ncurses)
DKDISABLE(opencv)  #Takes too my CPU to constantly compile
...
if(NOT APPLE)
	...
	DKDISABLE(audio_toolbox)
	DKDISABLE(audio_unit)
	DKDISABLE(avf_audio)
	DKDISABLE(carbon)
	DKDISABLE(cocoa)
	DKDISABLE(core_audio)
	DKDISABLE(core_foundation)
	DKDISABLE(core_graphics)
	DKDISABLE(core_services)
	DKDISABLE(core_video)
	DKDISABLE(force_feedback)
	DKDISABLE(foundation)
	DKDISABLE(imageio)
	DKDISABLE(iokit)
