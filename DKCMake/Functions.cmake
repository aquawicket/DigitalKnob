...
function(DKSETPATH path)
	...
	# TODO https://stackoverflow.com/a/6595001/688352
		...
		endforeach()
		DKINFO("We are currently using \${CURRENT_DIR} to set build paths. We may be able to use a build in cmake variable")
		DKINFO("CURRENT_DIR = ${CURRENT_DIR}   <- this is the directory we need")
		DKINFO("CMAKE_CURRENT_LIST_DIR¶ = ${CMAKE_CURRENT_LIST_DIR¶}     match?")
		DKINFO("CMAKE_CURRENT_SOURCE_DIR = ${CMAKE_CURRENT_SOURCE_DIR}   match?") 
		DKINFO("It will beed to be used in the DKEXECUTE_COMMAND function instead or a specific created compiler command function.")
