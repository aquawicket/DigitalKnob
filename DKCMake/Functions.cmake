...
function(WIN_LINKDIR)
	if(WIN)
		DKLINKDIR(${ARGV})
	endif()
endfunction()

function(MAC_LINKDIR)
	if(MAC)
		DKLINKDIR(${ARGV})
	endif()
endfunction()

function(IOS_LINKDIR)
	if(IOS)
		DKLINKDIR(${ARGV})
	endif()
endfunction()

function(IOSSIM_LINKDIR)
	if(IOSSIM)
		DKLINKDIR(${ARGV})
	endif()
endfunction()

function(LINUX_LINKDIR)
	if(LINUX)
		DKLINKDIR(${ARGV})
	endif()
endfunction()

function(RASPBERRY_LINKDIR)
	if(RASPBERRY)
		DKLINKDIR(${ARGV})
	endif()
endfunction()
	
function(ANDROID_LINKDIR)
	if(ANDROID)
		DKLINKDIR(${ARGV})
	endif()
endfunction()	
...
function(RASPBERRY_RELEASE_SET)
	DKDEBUG(${ARGV})
