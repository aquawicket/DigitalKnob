...
function(CreateWrappers name)
	#message(STATUS "function(WIN_${name})\n if(WIN)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(WIN_${name})\n if(WIN)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(WIN32_${name})\n if(WIN_32)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(WIN64_${name})\n if(WIN_64)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(MAC_${name})\n if(MAC)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(MAC32_${name})\n if(MAC_32)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(MAC64_${name})\n if(MAC_64)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(IOS_${name})\n if(IOS)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(IOS32_${name})\n if(IOS_32)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(IOS64_${name})\n if(IOS_64)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(IOSSIM_${name})\n if(IOSSIM)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(IOSSIM32_${name})\n if(IOSSIM_32)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(IOSSIM64_${name})\n if(IOSSIM_64)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(LINUX_${name})\n if(LINUX)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(LINUX32_${name})\n if(LINUX_32)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(LINUX64_${name})\n if(LINUX_64)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(RASPBERRY_${name})\n if(RASPBERRY)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(RASPBERRY32_${name})\n if(RASPBERRY_32)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(RASPBERRY64_${name})\n if(RASPBERRY_64)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(ANDROID_${name})\n if(ANDROID)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(ANDROID32_${name})\n if(ANDROID_32)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(ANDROID64_${name})\n if(ANDROID_64)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	
	cmake_language(EVAL CODE "function(WIN_DEBUG_${name})\n if(WIN AND DEBUG)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(WIN32_DEBUG_${name})\n if(WIN_32 AND DEBUG)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(WIN64_DEBUG_${name})\n if(WIN_64 AND DEBUG)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(MAC_DEBUG_${name})\n if(MAC AND DEBUG)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(MAC32_DEBUG_${name})\n if(MAC_32 AND DEBUG)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(MAC64_DEBUG_${name})\n if(MAC_64 AND DEBUG)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(IOS_DEBUG_${name})\n if(IOS AND DEBUG)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(IOS32_DEBUG_${name})\n if(IOS_32 AND DEBUG)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(IOS64_DEBUG_${name})\n if(IOS_64 AND DEBUG)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(IOSSIM_DEBUG_${name})\n if(IOSSIM AND DEBUG)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(IOSSIM32_DEBUG_${name})\n if(IOSSIM_32 AND DEBUG)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(IOSSIM64_DEBUG_${name})\n if(IOSSIM_64 AND DEBUG)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(LINUX_DEBUG_${name})\n if(LINUX AND DEBUG)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(LINUX32_DEBUG_${name})\n if(LINUX_32 AND DEBUG)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(LINUX64_DEBUG_${name})\n if(LINUX_64 AND DEBUG)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(RASPBERRY_DEBUG_${name})\n if(RASPBERRY AND DEBUG)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(RASPBERRY32_DEBUG_${name})\n if(RASPBERRY_32 AND DEBUG)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(RASPBERRY64_DEBUG_${name})\n if(RASPBERRY_64 AND DEBUG)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(ANDROID_DEBUG_${name})\n if(ANDROID AND DEBUG)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(ANDROID32_DEBUG_${name})\n if(ANDROID_32 AND DEBUG)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(ANDROID64_DEBUG_${name})\n if(ANDROID_64 AND DEBUG)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	
	cmake_language(EVAL CODE "function(WIN_RELEASE_${name})\n if(WIN AND RELEASE)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(WIN32_RELEASE_${name})\n if(WIN_32 AND RELEASE)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(WIN64_RELEASE_${name})\n if(WIN_64 AND RELEASE)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(MAC_RELEASE_${name})\n if(MAC AND RELEASE)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(MAC32_RELEASE_${name})\n if(MAC_32 AND RELEASE)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(MAC64_RELEASE_${name})\n if(MAC_64 AND RELEASE)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(IOS_RELEASE_${name})\n if(IOS AND RELEASE)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(IOS32_RELEASE_${name})\n if(IOS_32 AND RELEASE)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(IOS64_RELEASE_${name})\n if(IOS_64 AND RELEASE)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(IOSSIM_RELEASE_${name})\n if(IOSSIM AND RELEASE)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(IOSSIM32_RELEASE_${name})\n if(IOSSIM_32 AND RELEASE)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(IOSSIM64_RELEASE_${name})\n if(IOSSIM_64 AND RELEASE)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(LINUX_RELEASE_${name})\n if(LINUX AND RELEASE)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(LINUX32_RELEASE_${name})\n if(LINUX_32 AND RELEASE)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(LINUX64_RELEASE_${name})\n if(LINUX_64 AND RELEASE)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(RASPBERRY_RELEASE_${name})\n if(RASPBERRY AND RELEASE)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(RASPBERRY32_RELEASE_${name})\n if(RASPBERRY_32 AND RELEASE)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(RASPBERRY64_RELEASE_${name})\n if(RASPBERRY_64 AND RELEASE)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(ANDROID_RELEASE_${name})\n if(ANDROID AND RELEASE)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(ANDROID32_RELEASE_${name})\n if(ANDROID_32 AND RELEASE)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(ANDROID64_RELEASE_${name})\n if(ANDROID_64 AND RELEASE)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	
	cmake_language(EVAL CODE "function(WIN_HOST_${name})\n if(WIN_HOST)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(WIN32_HOST_${name})\n if(WIN_HOST AND X86)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(WIN64_HOST_${name})\n if(WIN_HOST AND X64)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(MAC_HOST_${name})\n if(MAC_HOST)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(MAC32_HOST_${name})\n if(MAC_HOST AND X86)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
	cmake_language(EVAL CODE "function(MAC64_HOST_${name})\n if(MAC_HOST AND X64)\n ${name}(\${ARGV})\n endif()\n endfunction()\n")
...
function(WIN_VS_DEBUG folder sln_file) #target #arch
	...
	if(WIN AND DEBUG AND QUEUE_BUILD)
		...
		if(${ARGC} GREATER 3)
			DKINFO("GREATER THAN 3 ARGS  3=${ARGV3}")
...
function(IOSSIM_DEPEND)
	if(IOSSIM)
		DKDEPEND(${ARGV})
	endif()
endfunction()

function(LINUX_DEPEND)
	if(IOSSIM)
		DKDEPEND(${ARGV})
	endif()
endfunction()

function(RASPBERRY_DEPEND)
	if(RASPBERRY)
		DKDEPEND(${ARGV})
	endif()
endfunction()

function(ANDROID_DEPEND)
	if(ANDROID)
		DKDEPEND(${ARGV})
	endif()
endfunction()
