  	...
  	foreach(child ${children})
		if(EXISTS ${DIGITALKNOB}/${child}/DKApps)
			if(EXISTS ${DIGITALKNOB}/${child}/DKApps/${target}/DKMAKE.cmake)
				#set(target_path ${DIGITALKNOB}/${child}/DKApps/${target})
				#set(target_type DKApp)
  	...
  	foreach(child ${children})
		if(EXISTS ${DIGITALKNOB}/${child}/DKPlugins)
			if(EXISTS ${DIGITALKNOB}/${child}/DKPlugins/${target}/DKMAKE.cmake)
				#set(target_path ${DIGITALKNOB}/${child}/DKPlugins/${target})
				#set(target_type DKPlugin)
	...
	file(GLOB children RELATIVE ${DIGITALKNOB}/ ${DIGITALKNOB}/*)
  	foreach(child ${children})
		if(EXISTS ${DIGITALKNOB}/${child}/3rdParty/_DKIMPORTS)
			if(EXISTS ${DIGITALKNOB}/${child}/3rdParty/_DKIMPORTS/${target}/DKMAKE.cmake)
				#set(target_path ${DIGITALKNOB}/${child}/3rdParty/_DKIMPORTS/${target})
				#set(target_type 3rdParty)
