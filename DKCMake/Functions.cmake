...
function(DKSETPATH path)
	...
	#DKSET(OUTDIR ${OUTDIR} "-DCMAKE_ARCHIVE_OUTPUT_DIRECTORY=${CURRENT_DIR}")
	#DKSET(OUTDIR ${OUTDIR} "-DCMAKE_LIBRARY_OUTPUT_DIRECTORY=${CURRENT_DIR}")
	#DKSET(OUTDIR ${OUTDIR} "-DCMAKE_RUNTIME_OUTPUT_DIRECTORY=${CURRENT_DIR}")
#list(APPEND OUTDIR "-DCMAKE_ARCHIVE_OUTPUT_DIRECTORY=${CURRENT_DIR}" CACHE INTERNAL "")
#list(APPEND OUTDIR "-DCMAKE_LIBRARY_OUTPUT_DIRECTORY=${CURRENT_DIR}" CACHE INTERNAL "")
#list(APPEND OUTDIR "-DCMAKE_RUNTIME_OUTPUT_DIRECTORY=${CURRENT_DIR}" CACHE INTERNAL "")
	#DUMP(OUTDIR)
endfunction()
...
function(generateCmake plugin_name)
	...
	if(NOT EXISTS "${plugin_path}")
		message(FATAL_ERROR "generateCmake(${plugin_name}): plugin not found")
		return()
	endif()
...
function(dk_PathExists path result)
	...
	if(${path} STREQUAL ${abspath})
		message("${path} MATCHES ${abspath}")
		set(${result} TRUE PARENT_SCOPE)
		return()
	endif()
	message("${path} DOES NOT MATCH ${abspath}")
	set(${result} FALSE PARENT_SCOPE)
endfunction()
