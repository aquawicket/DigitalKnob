...
function(dk_importVariables PLUGIN_URL RESULT)
	...
	set(plugin ${PLUGIN_INSTALL_NAME_LOWER})
	...
	if(PLUGIN_INSTALL_URL)
		dk_set(${plugin}_URL ${PLUGIN_INSTALL_URL})
	endif()
	if(PLUGIN_INSTALL_VERSION)
		dk_set(${plugin}_VERSION ${PLUGIN_INSTALL_VERSION})
	endif()
	if(PLUGIN_INSTALL_FOLDER)
		dk_set(${plugin}_FOLDER ${PLUGIN_INSTALL_FOLDER})
	endif()
	#if(PLUGIN_INSTALL_PATH)
	#	dk_set(${plugin}_PATH ${PLUGIN_INSTALL_PATH})
	#endif()
	if(PLUGIN_INSTALL_BRANCH)
		dk_set(${plugin}_BRANCH ${PLUGIN_INSTALL_BRANCH})
	endif()
