...
function(dk_importVariables PLUGIN_URL)
	...
	# PLUGIN_URL_NAME_UPPER 	- from PLUGIN_URL_NAME
	...
	# PLUGIN_GITHUB_NAME_LOWER  - from PLUGIN_GITHUB_NAME
	# PLUGIN_GITHUB_NAME_UPPER  - from PLUGIN_GITHUB_NAME
	
	# PLUGIN_INSTALL_VERSION	- from PLUGIN_URL_NAME_LOWER and PLUGIN_IMPORT_NAME_LOWER
	# PLUGIN_INSTALL_NAME
	# PLUGIN_INSTALL_PATH		- from PLUGIN_URL_NAME and PLUGIN_INSTALL_VERSION
	
	
	#string(FIND ${CMAKE_CURRENT_LIST_DIR} ${DKIMPORTS} PLUGIN_IMPORT) 
	#if(${PLUGIN_IMPORT} GREATER -1)
	...
	if(PLUGIN_IMPORT)
		...
		#dk_getFilename(${PLUGIN_IMPORT_PATH} PLUGIN_IMPORT_NAME)		
	endif()
	...
	if(PLUGIN_URL_NAME_LOWER)
		...
		string(REPLACE ${PLUGIN_IMPORT_NAME_LOWER} "" PLUGIN_INSTALL_VERSION ${PLUGIN_URL_NAME_LOWER})	
		if(${PLUGIN_IMPORT_NAME_LOWER} STREQUAL ${PLUGIN_URL_NAME_LOWER})
	...
	if(PLUGIN_INSTALL_VERSION)
		set(PLUGIN_INSTALL_NAME ${PLUGIN_IMPORT_NAME}-${PLUGIN_INSTALL_VERSION})		# PLUGIN_INSTALL_NAME
	endif()
	if(3RDPARTY)
