...
function(dk_import2 PLUGIN_URL)
	...
	# PLUGIN_VERSION			- from PLUGIN_URL_NAME_LOWER and PLUGIN_IMPORT_NAME_LOWER
	...
	if(PLUGIN_URL_NAME_LOWER)
		...
		string(REPLACE ${PLUGIN_IMPORT_NAME_LOWER} "" PLUGIN_VERSION ${PLUGIN_URL_NAME_LOWER})	
	...
	if(PLUGIN_VERSION)
		set(PLUGIN_INSTALL_NAME ${PLUGIN_IMPORT_NAME}-${PLUGIN_VERSION})		# PLUGIN_INSTALL_NAME
	endif()
	if(3RDPARTY)
