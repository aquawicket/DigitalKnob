...
function(dk_importVariables PLUGIN_URL RESULT)
	...
	if(PLUGIN_INSTALL_FOLDER)
		dk_set(${PLUGIN_INSTALL_NAME_UPPER}_NAME 	${PLUGIN_INSTALL_FOLDER}) # FIXME: this is a unnecessary duplicate of PLUGIN_INSTALL_FOLDER
	endif()
	...
	#dk_debug("[${PLUGIN_INSTALL_NAME_UPPER}_NAME] 		= ${${PLUGIN_INSTALL_NAME_UPPER}_NAME}")  # FIXME: this is a unnecessary duplicate of PLUGIN_INSTALL_FOLDER
	dk_debug("[${PLUGIN_INSTALL_NAME_UPPER}_BRANCH] 	= ${${PLUGIN_INSTALL_NAME_UPPER}_BRANCH}")
	set(${RESULT} ${PLUGIN_INSTALL_NAME_UPPER} PARENT_SCOPE)
