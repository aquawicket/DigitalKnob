...
function(dk_importVariables PLUGIN_URL)
	...
	if(PLUGIN_GITHUB)
		...
		string(REPLACE ".git" "" PLUGIN_GITHUB_NAME ${PLUGIN_GITHUB_FILENAME})	# PLUGIN_GITHUB_NAME
		dk_getGitBranchName(${PLUGIN_URL} PLUGIN_GITHUB_BRANCH)					# PLUGIN_GITHUB_BRANCH
	endif()
	...
	elseif(PLUGIN_IMPORT_NAME)
		set(PLUGIN_INSTALL_NAME ${PLUGIN_INSTALL_NAME})
