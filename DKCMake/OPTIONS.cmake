...
if(CMAKE_GENERATOR STREQUAL "Visual Studio 16 2019")
	...
	if(ANDROID)
		...
		if(STATIC)
			DKSET(CMAKE_CXX_FLAGS_DEBUG "-DDEBUG -D_DEBUG -frtti -fexceptions -std=c++17") # -lstdc++fs")
			DKSET(CMAKE_CXX_FLAGS_RELEASE "-DNDEBUG -frtti -fexceptions -std=c++17") # -lstdc++fs")
		endif()
		if(SHARED)
