...
if(WIN_32)
	...
	#DKSET(BUILD_SHARED_LIBS OFF)
		...
		if(STATIC)
			...
			DKSET(CMAKE_CXX_FLAGS "/DWIN32 /D_WINDOWS /W3 /nologo /GR /EHsc /Zm500 /D_WIN32_WINNT=0x0600 /D_USING_V110_SDK71_ /std:c++17")
...
if(WIN_64)
	...
	#DKSET(BUILD_SHARED_LIBS OFF)
		...
		DKSET(CMAKE_C_FLAGS_RELEASE "/MT /O2 /Ob2 /DNDEBUG")
		#DKSET(CMAKE_CXX_FLAGS "/Yustdafx.h") #precompiled headers
		DKSET(CMAKE_CXX_FLAGS "/DWIN32 /DWIN64 /D_WINDOWS /W3 /nologo /GR /EHsc /Zm500 /D_WIN32_WINNT=0x0600 /MACHINE:X64 /std:c++17")
		DKSET(CMAKE_CXX_FLAGS_DEBUG "/MTd /Od /Ob0 /Zi /RTC1 /DDEBUG /D_DEBUG")
		DKSET(CMAKE_CXX_FLAGS_RELEASE "/MT /O2 /Ob2 /DNDEBUG")
