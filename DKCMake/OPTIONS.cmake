...
if(${index} GREATER -1)
	...
	DKSET(DEBUG_DIR Debug)
	DKSET(RELEASE_DIR Release)
	DKSET(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -m32")
	DKSET(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -m32")
	DKSET(CMAKE_SKIP_RPATH ON)
...
if(${index} GREATER -1)
	...
	DKSET(DEBUG_DIR Debug)
	DKSET(RELEASE_DIR Release)
	DKSET(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -m64")
	DKSET(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -m64")
	#DKSET(CMAKE_SKIP_RPATH ON)
	set(CMAKE_SKIP_BUILD_RPATH  FALSE)
	set(CMAKE_BUILD_WITH_INSTALL_RPATH FALSE) 
	set(CMAKE_INSTALL_RPATH "${CMAKE_INSTALL_PREFIX}/")
...
if(CMAKE_GENERATOR STREQUAL "Visual Studio 16 2019")
	...
	if(WIN)
		...
		DKSET(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} /W3 /nologo /GR /EHsc /Zm500 /D_WIN32_WINNT=0x0600 /D_USING_V110_SDK71_")
		if(STATIC)
			DKSET(CMAKE_CXX_FLAGS_DEBUG "${CMAKE_CXX_FLAGS_DEBUG} /MTd /Od /Ob0 /Zi /RTC1")
			DKSET(CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS_RELEASE} /MT /O2 /Ob2")
		endif()
		if(SHARED)
			DKSET(CMAKE_CXX_FLAGS_DEBUG "${CMAKE_CXX_FLAGS_DEBUG} /MDd /Od /Ob0 /Zi /RTC1")
			DKSET(CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS_RELEASE} /MD /O2 /Ob2")
		endif()
			DKSET(FLAGS "${FLAGS} /W3 /nologo /Zm500 /EHsc /GR /D_WIN32_WINNT=0x0600 /D_USING_V110_SDK71_ /Zc:__cplusplus $<$<CONFIG:Debug>:/MTd /Od /Ob0 /Zi /RTC1 /DDEBUG /D_DEBUG> $<$<CONFIG:Release>:/MT /O2 /Ob2 /DNDEBUG>")
	endif()
	if(ANDROID)
		## https://stackoverflow.com/a/38057807/688352
		if(STATIC)
			DKSET(CMAKE_CXX_FLAGS_DEBUG "${CMAKE_CXX_FLAGS_DEBUG} -frtti -fexceptions")
			DKSET(CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS_RELEASE} -frtti -fexceptions")
		endif()
		if(SHARED)
			#TODO
		endif()
...
if(CMAKE_GENERATOR STREQUAL "Visual Studio 16 2019 Win64")
	DKSET(CMAKE_COMMAND C:/Progra~2/CMake/bin/cmake.exe)
	##DKSET(CMAKE_CXX_FLAGS "/DWIN32 /D_WINDOWS /W3 /nologo /GR /EHsc /Yustdafx.h /Zm500 /D_WIN32_WINNT=0x0600") #precompiled headers
	DKSET(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} /DWIN32 /DWIN64 /D_WINDOWS /W3 /nologo /GR /EHsc /Zm500 /D_WIN32_WINNT=0x0600")
	DKSET(CMAKE_CXX_FLAGS_DEBUG "${CMAKE_CXX_FLAGS_DEBUG} /MTd /Od /Ob0 /Zi /RTC1")
	DKSET(CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS_RELEASE} /MT /O2 /Ob2")
	DKSET(FLAGS "${FLAGS} /DWIN64 /W3 /nologo /Zm500 /EHsc /GR /D_WIN32_WINNT=0x0600 /Zc:__cplusplus $<$<CONFIG:Debug>:/MTd /Od /Ob0 /Zi /RTC1 /DDEBUG /D_DEBUG> $<$<CONFIG:Release>:/MT /O2 /Ob2 /DNDEBUG>")
endif()

##### Apple Xcode #####
if(CMAKE_GENERATOR STREQUAL "Xcode")
	DKSET(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -x objective-c++")
endif()

##### Unix Makefiles #####
if(CMAKE_GENERATOR STREQUAL "Unix Makefiles")
	DKSET(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -fPIC")
	DKSET(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -fPIC")
endif()
