...
if(CMAKE_GENERATOR STREQUAL "Visual Studio 16 2019")
	...
	if(WIN)
		...
		DKSET(CMAKE_CXX_FLAGS "/DWIN32 /D_WINDOWS /W3 /std:c++17 /nologo /GR /EHsc /Zm500 /D_WIN32_WINNT=0x0600 /D_USING_V110_SDK71_")
		if(STATIC)
			#DKSET(CMAKE_CXX_FLAGS_DEBUG "/MTd /Od /Ob0 /Zi /RTC1 /D_ITERATOR_DEBUG_LEVEL=2")
			#DKSET(CMAKE_CXX_FLAGS_RELEASE "/MT /O2 /Ob2 /D_ITERATOR_DEBUG_LEVEL=0")
		...
		DKSET(FLAGS "${FLAGS} /DWIN32 /D_WINDOWS /W3 /std:c++17 /nologo /GR /EHsc /Zm500 /D_WIN32_WINNT=0x0600 /D_USING_V110_SDK71_ /Zc:__cplusplus
		...
		#DKSET(FLAGS "${FLAGS} /W3 /nologo /Zm500 /EHsc /GR /D_WIN32_WINNT=0x0600 /D_USING_V110_SDK71_ /Zc:__cplusplus 
