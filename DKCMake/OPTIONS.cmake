...
if(WIN_32)
	...
	#DKSET(BUILD_SHARED_LIBS OFF)
		...
		if(STATIC)
			DKSET(CMAKE_C_FLAGS "/DWIN32 /D_WINDOWS /W3 /nologo /std:c17")
			...
			DKSET(CMAKE_CXX_FLAGS "/DWIN32 /D_WINDOWS /W3 /nologo /GR /EHsc /Zm500 /D_WIN32_WINNT=0x0600 /D_USING_V110_SDK71_ /std:c17 /std:c++17")
		...
		DKSET(FLAGS "${EXTRA_C_FLAGS} /nologo /Zm500 /EHsc /GR /D_WIN32_WINNT=0x0600 /D_USING_V110_SDK71_ /std:c17 /std:c++17 /Zc:__cplusplus $<$<CONFIG:Debug>:/MTd /Od /Ob0 /Zi /RTC1 /DDEBUG /D_DEBUG> $<$<CONFIG:Release>:/MT /O2 /Ob2 /DNDEBUG>")
	#endif()
endif()
