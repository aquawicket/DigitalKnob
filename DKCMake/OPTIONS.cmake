...
if(WIN_32)
	...
	#DKSET(BUILD_SHARED_LIBS OFF)
	#if(CMAKE_GENERATOR STREQUAL "${VS_GENERATOR}")
		## add_definitions(-D__STDC_CONSTANT_MACROS)
		## add_definitions(-D_SCL_SECURE_NO_WARNINGS)
		## add_definitions(-D_CRT_SECURE_NO_DEPRECATE)
		
		#if(STATIC)
		#	DKSET(CMAKE_C_FLAGS "${DK_C_FLAGS}") #"/DWIN32 /D_WINDOWS /W3 /nologo /std:c17")
		#	DKSET(CMAKE_C_FLAGS_DEBUG "${DK_C_FLAGS_DEBUG}") #"/MTd /Od /Ob0 /Zi /RTC1 /DDEBUG /D_DEBUG")
		#	DKSET(CMAKE_C_FLAGS_RELEASE "${DK_C_FLAGS_RELEASE}")  #"/MT /O2 /Ob2 /DNDEBUG")
			#DKSET(CMAKE_CXX_FLAGS /Yustdafx.h) #precompiled headers")
		#	DKSET(CMAKE_CXX_FLAGS "${DK_CXX_FLAGS}") #"/DWIN32 /D_WINDOWS /W3 /nologo /GR /EHsc /Zm500 /D_WIN32_WINNT=0x0600 /D_USING_V110_SDK71_ /std:c17 /std:c++17")
		#	DKSET(CMAKE_CXX_FLAGS_DEBUG "${DK_CXX_FLAGS_DEBUG}")  #"/MTd /Od /Ob0 /Zi /RTC1 /DDEBUG /D_DEBUG")
		#	DKSET(CMAKE_CXX_FLAGS_RELEASE "${DK_CXX_FLAGS_RELEASE}")  #"/MT /O2 /Ob2 /DNDEBUG")
		#endif()
		...
		#DKSET(FLAGS "${DK_CXX_FLAGS} $<$<CONFIG:Debug>:${DK_CXX_FLAGS_DEBUG}> $<$<CONFIG:Release>:${DK_CXX_FLAGS_RELEASE}>") 
		
		#DKSET(FLAGS "/nologo /Zm500 /EHsc /GR /D_WIN32_WINNT=0x0600 /D_USING_V110_SDK71_ /std:c17 /std:c++17 /Zc:__cplusplus $<$<CONFIG:Debug>:/MTd /Od /Ob0 /Zi /RTC1 /DDEBUG /D_DEBUG> $<$<CONFIG:Release>:/MT /O2 /Ob2 /DNDEBUG>")
	#endif()
endif()
...
if(WIN_64)
	...
	#add_definitions(-D_WINDOWS)
	#DKSET(BUILD_SHARED_LIBS OFF)
	#if(CMAKE_GENERATOR STREQUAL "${VS_GENERATOR} Win64")
		#add_definitions(-D__STDC_CONSTANT_MACROS)
		#add_definitions(-D_SCL_SECURE_NO_WARNINGS)
		#add_definitions(-D_CRT_SECURE_NO_DEPRECATE)
		#DKSET(CMAKE_C_FLAGS "/DWIN64 /D_WINDOWS /W3 /nologo /std:c17")
		#DKSET(CMAKE_C_FLAGS_DEBUG "/MTd /Od /Ob0 /Zi /RTC1 /DDEBUG /D_DEBUG") 
		#DKSET(CMAKE_C_FLAGS_RELEASE "/MT /O2 /Ob2 /DNDEBUG")
		#DKSET(CMAKE_CXX_FLAGS "/Yustdafx.h") #precompiled headers
		#DKSET(CMAKE_CXX_FLAGS "/DWIN32 /DWIN64 /D_WINDOWS /W3 /nologo /GR /EHsc /Zm500 /D_WIN32_WINNT=0x0600 /MACHINE:X64 /std:c17 /std:c++17")
...
if(MAC_32)
	...
	#DKSET(CMAKE_CXX_FLAGS "-std=c++17 -x objective-c++")
	#DKSET(CMAKE_OSX_ARCHITECTURES x32) 
	#DKSET(BUILD_SHARED_LIBS OFF)
endif()
...
if(MAC_64)
	...
	#DKSET(CMAKE_C_FLAGS "-fPIC")
	#DKSET(CMAKE_CXX_FLAGS "-std=c++17 -x objective-c++")
	#DKSET(CMAKE_OSX_ARCHITECTURES x86_64) 
	#DKSET(BUILD_SHARED_LIBS OFF)
endif()
...
if(ANDROID_32) ## https://stackoverflow.com/a/38057807/688352
	...
	if(${ANDROIDNDK})
		DKSET(ANDROID_NDK ${ANDROIDNDK})
		DKSET(CMAKE_TOOLCHAIN_FILE ${ANDROIDNDK}/build/cmake/android.toolchain.cmake)
	endif()
	DKSET(ANDROID_TOOLCHAIN clang)
	DKSET(ANDROID_ABI armeabi-v7a)
	DKSET(ANDROID_STL c++_static)
	#DKSET(CMAKE_CXX_FLAGS ${CMAKE_CXX_FLAGS};-std=c++1z;-Wno-macro-redefined)
	#DKSET(ANDROID_CPP_FEATURES "rtti exceptions")
	#DKSET(ANDROID_STL_FORCE_FEATURES TRUE)
	#DKSET(ANDROID_NO_UNDEFINED TRUE)
	#DKSET(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -undef -std=c++1z")
endif()
...
if(ANDROID_64)
	...
	DKSET(ANDROID_TOOLCHAIN clang)
	DKSET(ANDROID_ABI arm64-v8a)
	DKSET(ANDROID_PLATFORM 26)
	DKSET(ANDROID_CPP_FEATURES "rtti exceptions")
	#DKSET(ANDROID_STL_FORCE_FEATURES TRUE)
	DKSET(ANDROID_NO_UNDEFINED TURE)
	DKSET(ANDROID_STL c++_static)
	DKSET(CMAKE_CXX_FLAGS -std=c++1z)
endif()
