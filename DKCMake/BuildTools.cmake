...
if(CMAKE_HOST_APPLE AND MAC OR IOS OR IOSSIM)
	...
	# Mac 32
	DKSET(DKCMAKE_MAC32 ${CMAKE_EXE} -G "Xcode" "CMAKE_CXX_FLAGS=-x objective-c++ -std=c++17" -DCMAKE_OSX_ARCHITECTURES=x32 -DBUILD_SHARED_LIBS=OFF build)

	# Mac 64
	DKSET(DKCMAKE_MAC64 ${CMAKE_EXE} -G "Xcode" "CMAKE_CXX_FLAGS=-x objective-c++ -std=c++17" -DCMAKE_OSX_ARCHITECTURES=x86_64 -DBUILD_SHARED_LIBS=OFF build)

	# iOS 32
	DKSET(DKCMAKE_IOS32 ${CMAKE_EXE} -G "Xcode" "CMAKE_CXX_FLAGS=-x objective-c++" -DCMAKE_TOOLCHAIN_FILE=${DKCMAKE}/ios.toolchain.cmake -DPLATFORM=OS -DBUILD_SHARED_LIBS=OFF build -arch i386)

	# iOS 64
	DKSET(DKCMAKE_IOS64 ${CMAKE_EXE} -G "Xcode" "CMAKE_CXX_FLAGS=-x objective-c++" -DCMAKE_TOOLCHAIN_FILE=${DKCMAKE}/ios.toolchain.cmake -DPLATFORM=OS64 -DBUILD_SHARED_LIBS=OFF)

	# iOS Simulator 32
	DKSET(DKCMAKE_IOSSIM32 ${CMAKE_EXE} -G "Xcode" "CMAKE_CXX_FLAGS=-x objective-c++" -DCMAKE_TOOLCHAIN_FILE=${DKCMAKE}/ios.toolchain.cmake -DPLATFORM=SIMULATOR -DBUILD_SHARED_LIBS=OFF build -arch i386)

	# iOS Simulator 64
	DKSET(DKCMAKE_IOSSIM64 ${CMAKE_EXE} -G "Xcode" "CMAKE_CXX_FLAGS=-x objective-c++" -DCMAKE_TOOLCHAIN_FILE=${DKCMAKE}/ios.toolchain.cmake -DPLATFORM=SIMULATOR64 -DBUILD_SHARED_LIBS=OFF)
endif()
...
if(CMAKE_HOST_LINUX AND LINUX)
	...
	# Linux
	DKSET(DKCMAKE_LINUX_DEBUG ${CMAKE_EXE} -G "Unix Makefiles" "CMAKE_CXX_FLAGS=-std=c++17 -lstdc++fs -g -no-pie -fPIC" -DCMAKE_BUILD_TYPE=Debug -DBUILD_SHARED_LIBS=OFF -DCMAKE_C_FLAGS=-fPIC)
	DKSET(DKCMAKE_LINUX_RELEASE ${CMAKE_EXE} -G "Unix Makefiles" "CMAKE_CXX_FLAGS=-std=c++17 -lstdc++fs -g -no-pie -fPIC" -DCMAKE_BUILD_TYPE=Release -DBUILD_SHARED_LIBS=OFF -DCMAKE_C_FLAGS=-fPIC)

	# Linux 32
	DKSET(DKCMAKE_LINUX32_DEBUG ${CMAKE_EXE} -G "Unix Makefiles" "CMAKE_CXX_FLAGS=-std=c++17 -lstdc++fs -g -no-pie -fPIC" -DCMAKE_BUILD_TYPE=Debug -DBUILD_SHARED_LIBS=OFF -DCMAKE_C_FLAGS=-fPIC)
	DKSET(DKCMAKE_LINUX32_RELEASE ${CMAKE_EXE} -G "Unix Makefiles" "CMAKE_CXX_FLAGS=-std=c++17 -lstdc++fs -g -no-pie -fPIC" -DCMAKE_BUILD_TYPE=Release -DBUILD_SHARED_LIBS=OFF -DCMAKE_C_FLAGS=-fPIC)

	# Linux 64
	DKSET(DKCMAKE_LINUX64_DEBUG ${CMAKE_EXE} -G "Unix Makefiles" "CMAKE_CXX_FLAGS=-std=c++17 -lstdc++fs -g -no-pie -fPIC" -DCMAKE_BUILD_TYPE=Debug -DBUILD_SHARED_LIBS=OFF -DCMAKE_C_FLAGS=-fPIC)
	DKSET(DKCMAKE_LINUX64_RELEASE ${CMAKE_EXE} -G "Unix Makefiles" "CMAKE_CXX_FLAGS=-std=c++17 -lstdc++fs -g -no-pie -fPIC" -DCMAKE_BUILD_TYPE=Release -DBUILD_SHARED_LIBS=OFF -DCMAKE_C_FLAGS=-fPIC)
endif()
...
if(CMAKE_HOST_WIN32 AND ANDROID)
	...
	#DKSET(DKCMAKE_ANDROID64 ${CMAKE_EXE} -G ${VISUALSTUDIO_NAME} -A ARM 
	#-DCMAKE_SYSTEM_NAME=Android 
	#-DCMAKE_SYSTEM_VERSION=26 
	#-DCMAKE_ANDROID_ARCH_ABI=armeabi-v7a 
	#-DCMAKE_ANDROID_NDK=${ANDROIDNDK} 
