...
### process extra flags
WIN32_DKSET(DK_C_FLAGS "${DK_C_FLAGS} /DWIN32 /D_WINDOWS /D_CRT_SECURE_NO_WARNINGS /nologo /std:c17")
...
WIN32_DKSET(DK_CXX_FLAGS "${DK_CXX_FLAGS} /DWIN32 /D_WINDOWS /D_CRT_SECURE_NO_WARNINGS /nologo /GR /EHsc /Zm500 /D_WIN32_WINNT=0x0600 /MACHINE:X32 /std:c++17 /D_USING_V110_SDK71_ /Zc:__cplusplus")
...
WIN32_DKSET(CMAKE_C_FLAGS "${DK_C_FLAGS}")
WIN32_DKSET(CMAKE_C_FLAGS_DEBUG "${DK_C_FLAGS_DEBUG}")
WIN32_DKSET(CMAKE_C_FLAGS_RELEASE "${DK_C_FLAGS_RELEASE}")
WIN32_DKSET(CMAKE_CXX_FLAGS "${DK_CXX_FLAGS}")
WIN32_DKSET(CMAKE_CXX_FLAGS_DEBUG "${DK_CXX_FLAGS_DEBUG}")
WIN32_DKSET(CMAKE_CXX_FLAGS_RELEASE "${DK_CXX_FLAGS_RELEASE}")
