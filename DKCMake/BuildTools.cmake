...
if(WARNINGS_AS_ERRORS)
	WIN_DKSET(EXTRA_C_FLAGS ${EXTRA_C_FLAGS} /WX)
endif()
if(WARNING_LEVEL)
	WIN_DKSET(EXTRA_C_FLAGS ${EXTRA_C_FLAGS} /W${WARNING_LEVEL})
endif()
if(WARNING_4244)
	WIN_DKSET(EXTRA_C_FLAGS ${EXTRA_C_FLAGS} /wd4244)
endif()
...
if(CMAKE_HOST_WIN32 AND WIN)
	...
	"-DCMAKE_C_FLAGS=/DWIN32 /D_WINDOWS /nologo ${EXTRA_C_FLAGS}"
	"-DCMAKE_C_FLAGS_DEBUG=/MTd /Od /Ob0 /Zi /RTC1 /DDEBUG /D_DEBUG" 
	"-DCMAKE_C_FLAGS_RELEASE=/MT /O2 /Ob2 /DNDEBUG" 
	"-DCMAKE_CXX_FLAGS=/DWIN32 /D_WINDOWS /nologo /EHsc" #/GR /Zm500 /D_WIN32_WINNT=0x0600 /D_USING_V110_SDK71_
	...
	-DBUILD_SHARED_LIBS=OFF 
	"-DCMAKE_C_FLAGS=/DWIN64 /D_WINDOWS /nologo ${EXTRA_C_FLAGS}"
	"-DCMAKE_C_FLAGS_DEBUG=/MTd /Od /Ob0 /Zi /RTC1 /DDEBUG /D_DEBUG" 
	"-DCMAKE_C_FLAGS_RELEASE=/MT /O2 /Ob2 /DNDEBUG" 
	"-DCMAKE_CXX_FLAGS=/DWIN64 /D_WINDOWS /nologo /EHsc" #/GR /Zm500 /D_WIN32_WINNT=0x0600 /MACHINE:X64
	"-DCMAKE_CXX_FLAGS_DEBUG=/MTd /Od /Ob0 /Zi /RTC1 /DDEBUG /D_DEBUG"
	"-DCMAKE_CXX_FLAGS_RELEASE=/MT /O2 /Ob2 /DNDEBUG")
