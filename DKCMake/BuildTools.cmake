...
WIN32_DKSET(DK_C_FLAGS_DEBUG ${DK_C_FLAGS_DEBUG} /MTd /Od /Ob0 /Zi /RTC1 /DDEBUG /D_DEBUG)
WIN32_DKSET(DK_C_FLAGS_RELEASE ${DK_C_FLAGS_RELEASE} /MT /O2 /Ob2 /DNDEBUG)
WIN32_DKSET(DK_CXX_FLAGS ${DK_CXX_FLAGS} /DWIN32 /D_WINDOWS /D_CRT_SECURE_NO_WARNINGS /nologo /GR /EHsc /Zm500 /D_WIN32_WINNT=0x0600 /std:c++17 /D_USING_V110_SDK71_ /Zc:__cplusplus)
WIN32_DKSET(DK_CXX_FLAGS_DEBUG ${DK_CXX_FLAGS_DEBUG} /MTd /Od /Ob0 /Zi /RTC1 /DDEBUG /D_DEBUG)
WIN32_DKSET(DK_CXX_FLAGS_RELEASE ${DK_CXX_FLAGS_RELEASE} /MT /O2 /Ob2 /DNDEBUG)
		
		
WIN64_DKSET(DK_C_FLAGS ${DK_C_FLAGS} /DWIN64 /D_WINDOWS /nologo /std:c17)
WIN64_DKSET(DK_C_FLAGS_DEBUG ${DK_C_FLAGS_DEBUG} /MTd /Od /Ob0 /Zi /RTC1 /DDEBUG /D_DEBUG)
WIN64_DKSET(DK_C_FLAGS_RELEASE ${DK_C_FLAGS_RELEASE} /MT /O2 /Ob2 /DNDEBUG)
WIN64_DKSET(DK_CXX_FLAGS ${DK_CXX_FLAGS} /DWIN64 /D_WINDOWS /nologo /GR /EHsc /Zm500 /D_WIN32_WINNT=0x0600 /MACHINE:X64 /std:c++17 /D_USING_V110_SDK71_ /Zc:__cplusplus)
WIN64_DKSET(DK_CXX_FLAGS_DEBUG ${DK_CXX_FLAGS_DEBUG} /MTd /Od /Ob0 /Zi /RTC1 /DDEBUG /D_DEBUG)
WIN64_DKSET(DK_CXX_FLAGS_RELEASE ${DK_CXX_FLAGS_RELEASE} /MT /O2 /Ob2 /DNDEBUG)
...
string(REPLACE ";" " " DK_C_FLAGS_STRING "${DK_C_FLAGS}")
string(REPLACE ";" " " DK_C_FLAGS_DEBUG_STRING "${DK_C_FLAGS_DEBUG}")
string(REPLACE ";" " " DK_C_FLAGS_RELEASE_STRING "${DK_C_FLAGS_RELEASE}")
string(REPLACE ";" " " DK_CXX_FLAGS_STRING "${DK_CXX_FLAGS}")
string(REPLACE ";" " " DK_CXX_FLAGS_DEBUG_STRING "${DK_CXX_FLAGS_DEBUG}")
string(REPLACE ";" " " DK_CXX_FLAGS_RELEASE_STRING "${DK_CXX_FLAGS_RELEASE}")

message(STATUS "CMAKE_C_FLAGS = ${DK_C_FLAGS_STRING}")
message(STATUS "CMAKE_C_FLAGS_DEBUG = ${DK_C_FLAGS_DEBUG_STRING}")
message(STATUS "CMAKE_C_FLAGS_RELEASE = ${DK_C_FLAGS_RELEASE_STRING}")
message(STATUS "CMAKE_CXX_FLAGS = ${DK_CXX_FLAGS_STRING}")
message(STATUS "CMAKE_CXX_FLAGS_DEBUG = ${DK_CXX_FLAGS_DEBUG_STRING}")
message(STATUS "CMAKE_CXX_FLAGS_RELEASE = ${DK_CXX_FLAGS_RELEASE_STRING}")
...
if(CMAKE_HOST_WIN32 AND WIN)
	...
	"-DCMAKE_C_FLAGS=${DK_C_FLAGS_STRING}"
	"-DCMAKE_C_FLAGS_DEBUG=${DK_C_FLAGS_DEBUG_STRING}"
	"-DCMAKE_C_FLAGS_RELEASE=${DK_C_FLAGS_RELEASE_STRING}"
	"-DCMAKE_CXX_FLAGS=${DK_CXX_FLAGS_STRING}"
	"-DCMAKE_CXX_FLAGS_DEBUG=${DK_CXX_FLAGS_DEBUG_STRING}"
	"-DCMAKE_CXX_FLAGS_RELEASE=${DK_CXX_FLAGS_RELEASE_STRING}")
