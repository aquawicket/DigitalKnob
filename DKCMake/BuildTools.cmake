...
if(CMAKE_HOST_WIN32 AND WIN)
	...
	# Windows 64
	DKSET(DKCMAKE_WIN64 ${CMAKE_EXE} -G ${VISUALSTUDIO_NAME} -A x64 -DBUILD_SHARED_LIBS=OFF "-DCMAKE_C_FLAGS=/DWIN64 /D_WINDOWS /W3 /nologo" "-DCMAKE_C_FLAGS_DEBUG=/MTd /Od /Ob0 /Zi /RTC1 /DDEBUG /D_DEBUG" "-DCMAKE_C_FLAGS_RELEASE=/MT /O2 /Ob2 /DNDEBUG" "-DCMAKE_CXX_FLAGS=/DWIN64 /D_WINDOWS /W3 /nologo /machine:x64" "-DCMAKE_CXX_FLAGS_DEBUG=/MTd /Od /Ob0 /Zi /RTC1 /DDEBUG /D_DEBUG" "-DCMAKE_CXX_FLAGS_RELEASE=/MT /O2 /Ob2 /DNDEBUG")
	...
	# LIST(APPEND WIN_LIBS kernel32.lib)  # https://www.geoffchappell.com/studies/windows/win32/kernel32/api/index.htm
...
if(CMAKE_HOST_APPLE AND MAC OR IOS OR IOSSIM)
	...
	# Mac 64
	DKSET(DKCMAKE_MAC64 ${CMAKE_EXE} -G "Xcode" -DCMAKE_OSX_ARCHITECTURES=x86_64 -DBUILD_SHARED_LIBS=OFF)
