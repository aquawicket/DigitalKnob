...
# Moc 32 DKCMake flags
MAC32_DKSET(DKCMAKE_FLAGS        "-DBUILD_SHARED_LIBS=OFF")

# Moc 64 DKCMake flags
MAC64_DKSET(DKCMAKE_FLAGS        "-DBUILD_SHARED_LIBS=OFF")

# iOS 32 DKCMake flags
IOS32_DKSET(DKCMAKE_FLAGS        "-DBUILD_SHARED_LIBS=OFF")

# iOS 64 DKCMake flags
IOS64_DKSET(DKCMAKE_FLAGS        "-DBUILD_SHARED_LIBS=OFF")

# iOS Simulator 32 DKCMake flags
IOSSIM32_DKSET(DKCMAKE_FLAGS     "-DBUILD_SHARED_LIBS=OFF")

# iOS Simulator 64 DKCMake flags
IOSSIM64_DKSET(DKCMAKE_FLAGS     "-DBUILD_SHARED_LIBS=OFF")
...
if(CMAKE_HOST_APPLE)
	...
	# Mac 32
	DKSET(DKCMAKE_MAC32 ${CMAKE_EXE} -G "Xcode" -DCMAKE_OSX_ARCHITECTURES=x86
	"${DKCMAKE_FLAGS}")

	# Mac 64
	DKSET(DKCMAKE_MAC64 ${CMAKE_EXE} -G "Xcode"	-DCMAKE_OSX_ARCHITECTURES=x86_64
	"${DKCMAKE_FLAGS}") 


	# iOS 32
	DKSET(DKCMAKE_IOS32 ${CMAKE_EXE} -G "Xcode" -DCMAKE_TOOLCHAIN_FILE=${DKCMAKE}/ios.toolchain.cmake
	"${DKCMAKE_FLAGS}"
	-DPLATFORM=OS
	-DSDK_VERSION=15.0 
	...
	# iOS 64
	DKSET(DKCMAKE_IOS64 ${CMAKE_EXE} -G "Xcode" -DCMAKE_TOOLCHAIN_FILE=${DKCMAKE}/ios.toolchain.cmake 
	"${DKCMAKE_FLAGS}"
	-DPLATFORM=OS64
	-DSDK_VERSION=15.0 
	-DDEPLOYMENT_TARGET=13.0)
	...
	# iOS Simulator 32
	DKSET(DKCMAKE_IOSSIM32 ${CMAKE_EXE} -G "Xcode" -DCMAKE_TOOLCHAIN_FILE=${DKCMAKE}/ios.toolchain.cmake 
	"${DKCMAKE_FLAGS}"
	-DPLATFORM=SIMULATOR
	-DSDK_VERSION=15.0 
	-DDEPLOYMENT_TARGET=13.0)
	...
	${CMAKE_EXE} -G "Xcode" -DCMAKE_TOOLCHAIN_FILE=${DKCMAKE}/ios.toolchain.cmake 
	"${DKCMAKE_FLAGS}"
