...
if(CMAKE_HOST_WIN32 AND WIN)
	...
	DKSET(DKCMAKE_WIN32_GENERATE ${CMAKE_EXE} -G ${VS_GENERATOR} -A Win32) 
	DKSET(DKCMAKE_WIN32_FLAGS -DBUILD_SHARED_LIBS=OFF
	"-DCMAKE_C_FLAGS=/DWIN32 /D_WINDOWS /W3 /nologo" 
	"-DCMAKE_C_FLAGS_DEBUG=/MTd /Od /Ob0 /Zi /RTC1 /DDEBUG /D_DEBUG" 
	"-DCMAKE_C_FLAGS_RELEASE=/MT /O2 /Ob2 /DNDEBUG" 
	"-DCMAKE_CXX_FLAGS=/DWIN32 /D_WINDOWS /W3 /nologo /EHsc" #/GR /EHsc /Zm500 /D_WIN32_WINNT=0x0600 /D_USING_V110_SDK71_
	"-DCMAKE_CXX_FLAGS_DEBUG=/MTd /Od /Ob0 /Zi /RTC1 /DDEBUG /D_DEBUG"
	"-DCMAKE_CXX_FLAGS_RELEASE=/MT /O2 /Ob2 /DNDEBUG")
	DKSET(DKCMAKE_WIN32 ${DKCMAKE_WIN32_GENERATE} ${DKCMAKE_WIN32_FLAGS})
	...
	"-DCMAKE_C_FLAGS_DEBUG=/MTd /Od /Ob0 /Zi /RTC1 /DDEBUG /D_DEBUG" 
	"-DCMAKE_C_FLAGS_RELEASE=/MT /O2 /Ob2 /DNDEBUG" 
	"-DCMAKE_CXX_FLAGS=/DWIN64 /D_WINDOWS /W3 /nologo /EHsc" #/GR /Zm500 /D_WIN32_WINNT=0x0600 /MACHINE:X64
	"-DCMAKE_CXX_FLAGS_DEBUG=/MTd /Od /Ob0 /Zi /RTC1 /DDEBUG /D_DEBUG"
	"-DCMAKE_CXX_FLAGS_RELEASE=/MT /O2 /Ob2 /DNDEBUG")
...
if(CMAKE_HOST_APPLE)
	...
	${CMAKE_EXE} -G "Xcode"
	"-DCMAKE_CXX_FLAGS=-std=c++17 -x objective-c++"
	-DCMAKE_TOOLCHAIN_FILE=${DKCMAKE}/ios.toolchain.cmake 
	-DPLATFORM=SIMULATOR64
	-DSDK_VERSION=15.0 
	-DDEPLOYMENT_TARGET=13.0
	-DBUILD_SHARED_LIBS=OFF)
	#-DCMAKE_CXX_FLAGS=-c++_static
