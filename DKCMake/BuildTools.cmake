...
MAC32_DKSET(DKCMAKE_C_FLAGS    "-DMAC32 -std=c17 -x objective-c")
MAC32_DKSET(DKCMAKE_CXX_FLAGS  "-DMAC32 -std=c++17 -x objective-c++")
...
MAC64_DKSET(DKCMAKE_C_FLAGS "-DMAC64 -std=c17 -x objective-c")
MAC64_DKSET(DKCMAKE_CXX_FLAGS "-DMAC64 -std=c++17 -x objective-c++")
...
LINUX_DKSET(DKCMAKE_C_FLAGS    "-DLINUX -std=gnu11 -no-pie -fPIC")
...
LINUX32_DKSET(DKCMAKE_C_FLAGS    "-m32 -DLINUX -DLINUX32 -std=gnu11 -no-pie -fPIC")
...
LINUX64_DKSET(DKCMAKE_C_FLAGS    "-DLINUX -DLINUX32 -std=gnu11 -no-pie -fPIC")
...
RASPBERRY_DKSET(DKCMAKE_C_FLAGS    "-DLINUX -DRASPBERRY -std=gnu11 -no-pie -fPIC")
...
RASPBERRY32_DKSET(DKCMAKE_C_FLAGS    "-m32 -DLINUX -DLINUX32 -DRASPBERRY -DRASPBERRY32 -std=gnu11 -no-pie -fPIC")
...
RASPBERRY64_DKSET(DKCMAKE_C_FLAGS    "-m64 -DLINUX -DLINUX64 -DRASPBERRY -DRASPBERRY32 -std=gnu11 -no-pie -fPIC")
