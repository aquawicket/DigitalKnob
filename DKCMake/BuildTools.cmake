...
if(CMAKE_HOST_APPLE AND MAC OR IOS OR IOSSIM)
	...
	DKSET(DKCMAKE_MAC64 ${CMAKE_EXE} -G "Unix Makefiles" -DCMAKE_BUILD_TYPE=Debug -DBUILD_SHARED_LIBS=OFF -DCMAKE_C_FLAGS=-fPIC)
	DKSET(DKCMAKE_MAC64_DEBUG ${CMAKE_EXE} -G "Unix Makefiles" -DCMAKE_BUILD_TYPE=Debug -DBUILD_SHARED_LIBS=OFF -DCMAKE_C_FLAGS=-fPIC)
	DKSET(DKCMAKE_MAC64_RELEASE ${CMAKE_EXE} -G "Unix Makefiles" -DCMAKE_BUILD_TYPE=Release -DBUILD_SHARED_LIBS=OFF -DCMAKE_C_FLAGS=-fPIC)
