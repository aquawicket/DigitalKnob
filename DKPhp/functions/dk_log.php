...
if(!isset($dk_log_VERBOSE_COLOR))		{ $dk_log_VERBOSE_COLOR="${magenta}"; }
...
if(!isset($dk_log_DEBUG_COLOR))			{ $dk_log_DEBUG_COLOR="${lblue}"; }
...
if(!isset($dk_log_DEFAULT_COLOR))		{ $dk_log_DEFAULT_COLOR="${white}";}
...
if(!isset($dk_log_INFO_COLOR))			{ $dk_log_INFO_COLOR="${white}"; }
...
if(!isset($dk_log_SUCCESS_COLOR))		{ $dk_log_SUCCESS_COLOR="${green}"; }
...
if(!isset($dk_log_TODO_COLOR))			{ $dk_log_TODO_COLOR="${blue}"; }
...
if(!isset($dk_log_NOTICE_COLOR))		{ $dk_log_NOTICE_COLOR="${lyellow}"; }
...
if(!isset($dk_log_FIXME_COLOR))			{ $dk_log_FIXME_COLOR="${lyellow}"; }
...
if(!isset($dk_log_FIXME_PAUSE))			{ $dk_log_FIXME_PAUSE=1; }
//if(!isset($dk_log_FIXME_TIMEOUT))		{ $dk_log_FIXME_TIMEOUT=0; }
//if(!isset($dk_log_FIXME_HALT))		{ $dk_log_FIXME_HALT=0; }

//### WARNING ###
if(!isset($dk_log_WARNING_ENABLE))		{ $dk_log_WARNING_ENABLE=1; }
if(!isset($dk_log_WARNING_COLOR))		{ $dk_log_WARNING_COLOR="${yellow}"; }
...
if(!isset($dk_log_DEPRECATED_COLOR))	{ $dk_log_DEPRECATED_COLOR="${dim}${yellow}"; }
...
if(!isset($dk_log_DEPRECATED_PAUSE))	{ $dk_log_DEPRECATED_PAUSE=1; }
//if(!isset($dk_log_DEPRECATED_TIMEOUT)){ $dk_log_DEPRECATED_TIMEOUT=0; }
//if(!isset($dk_log_DEPRECATED_HALT))	{ $dk_log_DEPRECATED_HALT=0; }

//### ERROR ###
if(!isset($dk_log_ERROR_ENABLE))		{ $dk_log_ERROR_ENABLE=1; }
if(!isset($dk_log_ERROR_COLOR))			{ $dk_log_ERROR_COLOR="${lred}"; }
...
if(!isset($dk_log_FATAL_COLOR))			{ $dk_log_FATAL_COLOR="${red}"; }
