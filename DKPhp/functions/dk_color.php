...
*/
	...
	//############ C0 control codes #############
	global $NUL; $NUL="\000";						// Null - Does nothing. The code of blank paper tape, and also used for padding to slow transmission
	global $SOH; $SOH="\001";						// Start of Heading - First character of the heading of a message
	global $STX; $STX="\002";						// Start of Text - Terminates the header and starts the message text
	global $ETX; $ETX="\003";						// End of Text - Ends the message text, starts a footer (up to the next TC character)
	global $EOT; $EOT="\004";						// End of Transmission - Ends the transmission of one or more messages. May place terminals on standby.
	...
	global $DC3; $DC3="\023";						// Device Control Three
	global $DC4; $DC4="\024";						// Device Control Four
	global $NAK; $NAK="\025";						// Negative Acknowledge - Negative response to a sender, such as a detected error.
