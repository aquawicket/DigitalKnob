...
if %FLAG_F1_LINE_NUMBER_FILTER% neq 0 (
  if "!FINDSTR_FIRST_FILTER_CMD_LINE:/N =!" neq "!FINDSTR_FIRST_FILTER_CMD_LINE!" (
...
if "!FINDSTR_LINES_FILTER_CMD_LINE!" neq "" set CMD_LINE=!CMD_LINE! ^| findstr !FINDSTR_LINES_FILTER_CMD_LINE!
