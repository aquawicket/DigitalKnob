...
set out=!out:^%NL%%NL%=^^^%NL%%NL%^%NL%%NL%!  &rem Replace every new-line by an escaped new-line
echo.
echo.
...
echo.
echo.
echo ###### Actual variable content ###### &rem Do NOT use `echo` to show true content of variable:
set data
::###########################################
