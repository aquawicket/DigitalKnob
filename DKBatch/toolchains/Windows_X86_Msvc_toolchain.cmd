...
rem %dk_call% dk_set 			CMAKE_GENERATOR_PLATFORM	"%VS_X86_GENERATOR_PLATFORM%"
rem %dk_call% dk_set	 		CMAKE_CXX_COMPILER			"%VS_X86_COMPILER%"
rem %dk_call% dk_set 			CMAKE_C_COMPILER			"%VS_X86_COMPILER%"
rem %dk_call% dk_set 			CMAKE_DUMPBIN				"%VS_X86_DUMPBIN%"
rem %dk_call% dk_set 			CMAKE_LINKER				"%VS_X86_LINKER%"
