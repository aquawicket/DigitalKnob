...
%dk_call% dk_echo "############################################################################"
%dk_call% dk_echo "################### Windows_X86_64_Ucrt_toolchain.cmd ######################"
%dk_call% dk_echo "############################################################################"

rem %dk_call% dk_prependArgs CMAKE_ARGS -DMSYSTEM=UCRT64
set "MSYSTEM=UCRT64"
...
rem %dk_call% dk_set 				MSYSTEM 				UCRT64
rem %dk_call% dk_set 				SINGLE_CONFIG			1
rem %dk_call% dk_prependArgs 		CMAKE_ARGS 				-DMSYSTEM=UCRT64
...
rem %dk_call% dk_set 				CMAKE_C_COMPILER		"!%MSYSTEM%_BIN!/gcc.exe"
rem %dk_call% dk_set 				CMAKE_CXX_COMPILER 		"!%MSYSTEM%_BIN!/g++.exe"
