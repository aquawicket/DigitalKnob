...
::%dk_call% dk_validate 		MSYS2_MAKE_PROGRAM				"%dk_call% dk_depend msys2"
...
::%dk_call% dk_set 				CMAKE_LINKER					
::%dk_call% dk_set 				CMAKE_MAKE_PROGRAM				
...
::%dk_call% dk_set 				DKCONFIGURE_CC					"%CMAKE_C_COMPILER%"
::%dk_call% dk_set 				DKCONFIGURE_CXX					"%CMAKE_CXX_COMPILER%"
::%dk_call% dk_append 			DKCONFIGURE_FLAGS				"--build=x86_64-w64"
::%dk_call% dk_append 			DKCONFIGURE_CFLAGS				"%CMAKE_C_FLAGS%"
::%dk_call% dk_append 			DKCONFIGURE_CXXFLAGS			"%CMAKE_CXX_FLAGS%"
