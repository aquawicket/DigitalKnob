...
rem %dk_call% dk_validate Cosmopolitan				%dk_call% dk_depend Cosmopolitan
rem %dk_call% dk_validate make 						%dk_call% dk_depend make
...
rem %dk_call% dk_set CMAKE_MAKE_PROGRAM				"%M	SYS2_MAKE_PROGRAM%"
rem %dk_call% dk_append CMAKE_C_FLAGS				-DCOSMOPOLITAN)# -std=gnu17   &rem -D_CRT_SECURE_NO_WARNINGS
rem %dk_call% dk_append CMAKE_CXX_FLAGS				-DCOSMOPOLITAN)# -std=gnu++17 &rem -D_CRT_SECURE_NO_WARNINGS
