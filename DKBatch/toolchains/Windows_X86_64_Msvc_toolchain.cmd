...
rem %dk_call% dk_depend 		visualstudio
rem %dk_call% dk_set 			CMAKE_GENERATOR				%VS_GENERATOR%
rem %dk_call% dk_set 			CMAKE_MAKE_PROGRAM 			%VS_MAKE_PROGRAM%
rem %dk_call% dk_set 			CMAKE_GENERATOR_PLATFORM	%VS_X86_64_GENERATOR_PLATFORM%
rem %dk_call% dk_set 			CMAKE_CXX_COMPILER			%VS_X86_64_COMPILER%
rem %dk_call% dk_set 			CMAKE_C_COMPILER			%VS_X86_64_COMPILER%
rem %dk_call% dk_set 			CMAKE_DUMPBIN				%VS_X86_64_DUMPBIN%
rem %dk_call% dk_set 			CMAKE_LINKER				%VS_X86_64_LINKER%
