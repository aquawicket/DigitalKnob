...
rem %dk_call% dk_prependArgs CMAKE_ARGS -DMSYSTEM=MINGW64
set "MSYSTEM=MINGW64"
...
rem %dk_call% dk_prependEnvPath 							"%msys2%/mingw64/lib"
rem %dk_call% dk_set 				%ACLOCAL_PATH% 			"%msys2%/usr/share/aclocal"
