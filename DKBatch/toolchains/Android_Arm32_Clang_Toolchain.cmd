...
%dk_call% dk_echo "#####################################################################"
%dk_call% dk_echo "################ Android_Arm32_Clang_Toolchain.cmake ################"
%dk_call% dk_echo "#####################################################################"
::# https://android.googlesource.com/platform/ndk/+/master/docs/BuildSystemMaintainers.md


::%dk_call% dk_validate 	ANDROID_NDK					"%dk_call% dk_depend android-ndk"
%dk_call% dk_set 			ANDROID_ABI					"armeabi-v7a"
...
if defined Windows_Host (
	...
	::%dk_call% dk_set 		CMAKE_MAKE_PROGRAM			"%MSYS2_BIN%/make.exe")
...
::%dk_call% dk_append 		CMAKE_C_FLAGS				-DANDROID -DANDROID_ARM64 -std=c17
::%dk_call% dk_append 		CMAKE_CXX_FLAGS				-DANDROID -DANDROID_ARM64 -std=c++1z
