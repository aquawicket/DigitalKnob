...
::if not defined DKINIT (if not defined DKINIT call "%DKBATCH_FUNCTIONS_DIR_%DK.cmd" & call :TEST_dk_includeGuard)
::if not defined DKINIT (if not defined DKINIT call "%DKBATCH_FUNCTIONS_DIR_%DK.cmd")
