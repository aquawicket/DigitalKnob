...
:: setlocal
	...
	rem    )
		...
		rem %dk_call% dk_printVar DKBRANCH_DIR
		
		rem		set "DK3RDPARTY_DIR=%DKBRANCH_DIR%\3rdParty"
		rem		rem%dk_call% dk_printVar DK3RDPARTY_DIR
		rem			set "DKIMPORTS_DIR=%DK3RDPARTY_DIR%\_DKIMPORTS"
		rem			rem%dk_call% dk_printVar DKIMPORTS_DIR
			
		rem		set "DKAPPS_DIR=%DKBRANCH_DIR%\DKApps"
		rem		rem%dk_call% dk_printVar DKAPPS_DIR
