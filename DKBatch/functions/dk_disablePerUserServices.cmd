...
%setlocal%
	...
	%dk_call% dk_registrySetKey "HKLM\SYSTEM\ControlSet001\Services\BluetoothUserService"					"UserServiceFlags" "REG_DWORD" "0"
	...
	%dk_call% dk_registrySetKey "HKLM\SYSTEM\ControlSet001\Services\CloudBackupRestoreSvc"					"UserServiceFlags" "REG_DWORD" "0"
	%dk_call% dk_registrySetKey "HKLM\SYSTEM\ControlSet001\Services\ConsentUxUserSvc" 						"UserServiceFlags" "REG_DWORD" "0"
	%dk_call% dk_registrySetKey "HKLM\SYSTEM\ControlSet001\Services\CredentialEnrollmentManagerUserSvc"		"UserServiceFlags" "REG_DWORD" "0"
	...
	%dk_call% dk_registrySetKey "HKLM\SYSTEM\ControlSet001\Services\NPSMSvc"								"UserServiceFlags" "REG_DWORD" "0"
	...
	%dk_call% dk_registrySetKey "HKLM\SYSTEM\ControlSet001\Services\PrintWorkflowUserSvc"					"UserServiceFlags" "REG_DWORD" "0"
	...
	%dk_call% dk_registrySetKey "HKLM\SYSTEM\ControlSet001\Services\webthreatdefusersvc"					"UserServiceFlags" "REG_DWORD" "0"
	
	%dk_call% dk_registrySetKey "HKLM\SYSTEM\CurrentControlSet\Services\AarSvc" 							"UserServiceFlags" "REG_DWORD" "0"
	%dk_call% dk_registrySetKey "HKLM\SYSTEM\CurrentControlSet\Services\BluetoothUserService"				"UserServiceFlags" "REG_DWORD" "0"
	...
	%dk_call% dk_registrySetKey "HKLM\SYSTEM\CurrentControlSet\Services\CloudBackupRestoreSvc"				"UserServiceFlags" "REG_DWORD" "0"
	%dk_call% dk_registrySetKey "HKLM\SYSTEM\CurrentControlSet\Services\ConsentUxUserSvc" 					"UserServiceFlags" "REG_DWORD" "0"
	%dk_call% dk_registrySetKey "HKLM\SYSTEM\CurrentControlSet\Services\CredentialEnrollmentManagerUserSvc"	"UserServiceFlags" "REG_DWORD" "0"
	...
	%dk_call% dk_registrySetKey "HKLM\SYSTEM\CurrentControlSet\Services\NPSMSvc"							"UserServiceFlags" "REG_DWORD" "0"
	...
	%dk_call% dk_registrySetKey "HKLM\SYSTEM\CurrentControlSet\Services\PrintWorkflowUserSvc"				"UserServiceFlags" "REG_DWORD" "0"
	...
	%dk_call% dk_registrySetKey "HKLM\SYSTEM\CurrentControlSet\Services\webthreatdefusersvc"				"UserServiceFlags" "REG_DWORD" "0"
