...
:dk_setTargetTriple
	...
	if CMAKE_SCRIPT_MODE_FILE (
		%dk_call% validate host_triple "%dk_call% host_triple"
		...
		) else if "!input!" STREQUAL "2" (
			%dk_call% dk_set os "cosmo"
			%dk_call% dk_set arch "cosmo"
			%dk_call% dk_set env "cosmo"
		) else if "!input!" STREQUAL "3" (
			%dk_call% dk_set os "android"
			%dk_call% dk_set arch "arm32"
		) else if "!input!" STREQUAL "4" (
			%dk_call% dk_set os "android"
			%dk_call% dk_set arch "arm64"
		) else if "!input!" STREQUAL "5" (
			%dk_call% dk_set os "android"
			%dk_call% dk_set arch "x86"
		) else if "!input!" STREQUAL "6" (
			%dk_call% dk_set os "android"
			%dk_call% dk_set arch "x86_64"
		) else if "!input!" STREQUAL "7" (
			%dk_call% dk_set os "emscripten"
			%dk_call% dk_set arch "x86"
		) else if "!input!" STREQUAL "8" (
			%dk_call% dk_set os "ios"
			%dk_call% dk_set arch "arm32"
		) else if "!input!" STREQUAL "9" (
			%dk_call% dk_set os "ios"
			%dk_call% dk_set arch "arm64"
		) else if "!input!" STREQUAL "10" (
			%dk_call% dk_set os "ios"
			%dk_call% dk_set arch "x86"
		) else if "!input!" STREQUAL "11" (
			%dk_call% dk_set os "ios"
			%dk_call% dk_set arch "x86_64"
		) else if "!input!" STREQUAL "12" (
			%dk_call% dk_set os "iossim"
			%dk_call% dk_set arch "arm32"
		) else if "!input!" STREQUAL "13" (
			%dk_call% dk_set os "iossim"
			%dk_call% dk_set arch "arm64"
		) else if "!input!" STREQUAL "14" (
			%dk_call% dk_set os "iossim"
			%dk_call% dk_set arch "x86"
		) else if "!input!" STREQUAL "15" (
			%dk_call% dk_set os "iossim"
			%dk_call% dk_set arch "x86_64"
		) else if "!input!" STREQUAL "16" (
			%dk_call% dk_set os "linux"
			%dk_call% dk_set arch "arm32"
		) else if "!input!" STREQUAL "17" (
			%dk_call% dk_set os "linux"
			%dk_call% dk_set arch "arm64"
		) else if "!input!" STREQUAL "18" (
			%dk_call% dk_set os "linux"
			%dk_call% dk_set arch "x86"
		) else if "!input!" STREQUAL "19" (
			%dk_call% dk_set os "linux"
			%dk_call% dk_set arch "x86_64"
		) else if "!input!" STREQUAL "20" (
			%dk_call% dk_set os "mac"
			%dk_call% dk_set arch "arm32"
		) else if "!input!" STREQUAL "21" (
			%dk_call% dk_set os "mac"
			%dk_call% dk_set arch "arm64"
		) else if "!input!" STREQUAL "22" (
			%dk_call% dk_set os "mac"
			%dk_call% dk_set arch "x86"
		) else if "!input!" STREQUAL "23" (
			%dk_call% dk_set os "mac"
			%dk_call% dk_set arch "x86_64"
		) else if "!input!" STREQUAL "24" (
			%dk_call% dk_set os "raspberry"
			%dk_call% dk_set arch "arm32"
		) else if "!input!" STREQUAL "25" (
			%dk_call% dk_set os "raspberry"
			%dk_call% dk_set arch "arm64"
		) else if "!input!" STREQUAL "26" (
			%dk_call% dk_set os "raspberry"
			%dk_call% dk_set arch "x86"
		) else if "!input!" STREQUAL "27" (
			%dk_call% dk_set os "raspberry"
			%dk_call% dk_set arch "x86_64"
		) else if "!input!" STREQUAL "28" (
			%dk_call% dk_set os "win"
			%dk_call% dk_set arch "arm32"
		) else if "!input!" STREQUAL "29" (
			%dk_call% dk_set os "win"
			%dk_call% dk_set arch "arm64"
			%dk_call% dk_set env "clang"
		) else if "!input!" STREQUAL "30" (
			%dk_call% dk_set os "win"
			%dk_call% dk_set arch "x86"
			%dk_call% dk_set env "mingw"
		) else if "!input!" STREQUAL "31" (
			%dk_call% dk_set os "win"
			%dk_call% dk_set arch "x86"
			%dk_call% dk_set env "clang"
		) else if "!input!" STREQUAL "32" (
			%dk_call% dk_set os "win"
			%dk_call% dk_set arch "x86"
			%dk_call% dk_set env "msvc"
		) else if "!input!" STREQUAL "33" (
			%dk_call% dk_set os "win"
			%dk_call% dk_set arch "x86_64"
			%dk_call% dk_set env "mingw"
		) else if "!input!" STREQUAL "34" (
			%dk_call% dk_set os "win"
			%dk_call% dk_set arch "x86_64"
			%dk_call% dk_set env "clang"
		) else if "!input!" STREQUAL "35" (
			%dk_call% dk_set os "win"
			%dk_call% dk_set arch "x86_64"
			%dk_call% dk_set env "ucrt"
		) else if "!input!" STREQUAL "36" (
			%dk_call% dk_set os "win"
			%dk_call% dk_set arch "x86_64"
			%dk_call% dk_set env "msvc"
		) else if "!input!" STREQUAL "37" (
			%dk_call% dk_exit 0
		else
