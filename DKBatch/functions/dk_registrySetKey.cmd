...
setlocal
    ...
    %dk_call% dk_registrySetKey "HKCR\*\shell\Edit with Notepad++" "Icon" "REG_SZ" "\"%NOTEPADPP_EXE%\""
    %dk_call% dk_registrySetKey "HKCR\*\shell\Edit with Notepad++\command" " " " " "\"%NOTEPADPP_EXE%\" \"%%%%^1\""
%endfunction%
