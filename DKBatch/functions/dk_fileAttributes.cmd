...
rem ################################################################################
rem # dk_fileAttributes(<pathname>, <rtn_var>:optional)
rem #
...
%setlocal%
	...
	for %%Z in ("%pathname%") do set "dk_fileAttributes=%%~aZ"

	endlocal & (
		set "dk_fileAttributes=%dk_fileAttributes%"
		if "%~2" neq "" (set "%~2=%dk_fileAttributes%")
	)	
%endfunction%
...
%setlocal%
	...
	%dk_call% dk_fileAttributes "%myPath%" attributes
	%dk_call% dk_echo "dk_fileAttributes = %dk_fileAttributes%"
