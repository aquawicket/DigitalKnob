...
:dk_color
	...
	:USE_COLOR_else
		...
		call dk_unset bold
		call dk_unset dim
		call dk_unset italic
		call dk_unset underline
		call dk_unset blink
		call dk_unset fblink
		call dk_unset negative
		call dk_unset invisible
		call dk_unset strike
		
		::# Attributes off
		call dk_unset nobold
		call dk_unset noitalic
		call dk_unset nounderline
		call dk_unset noblink
		call dk_unset nonegative
		call dk_unset visible
		call dk_unset nostrike
...
:DKTEST
	...
	call dk_echo "dim        %dim% dim %clr%"
	call dk_echo "italic     %italic% italic %clr%"
	call dk_echo "underline  %underline% underline %clr%"
	call dk_echo "blink      %blink% blink %clr%"
	call dk_echo "fblink     %fblink% fblink %clr%"
	...
	call dk_echo "%bg_RGB%0;0;255m    bg_RGB test 0;0;255     %clr%"
	call dk_echo "%bg_RGB%0;0;250m    bg_RGB test 0;0;250     %clr%"
	call dk_echo "%bg_RGB%0;0;245m    bg_RGB test 0;0;245     %clr%"
	call dk_echo "%bg_RGB%0;0;240m    bg_RGB test 0;0;240     %clr%"
	call dk_echo "%bg_RGB%0;0;235m    bg_RGB test 0;0;235     %clr%"
	call dk_echo "%bg_RGB%0;0;230m    bg_RGB test 0;0;230     %clr%"
	call dk_echo "%bg_RGB%0;0;225m    bg_RGB test 0;0;225     %clr%"
	call dk_echo "%bg_RGB%0;0;220m    bg_RGB test 0;0;220     %clr%"
	call dk_echo "%bg_RGB%0;0;215m    bg_RGB test 0;0;215     %clr%"
	call dk_echo "%bg_RGB%0;0;210m    bg_RGB test 0;0;210     %clr%"
	call dk_echo "%bg_RGB%0;0;205m    bg_RGB test 0;0;205     %clr%"
	call dk_echo "%bg_RGB%0;0;200m    bg_RGB test 0;0;200     %clr%"
	call dk_echo "%bg_RGB%0;0;195m    bg_RGB test 0;0;195     %clr%"
	call dk_echo "%bg_RGB%0;0;190m    bg_RGB test 0;0;190     %clr%"
	call dk_echo "%bg_RGB%0;0;185m    bg_RGB test 0;0;185     %clr%"
	call dk_echo "%bg_RGB%0;0;180m    bg_RGB test 0;0;180     %clr%"
	call dk_echo "%bg_RGB%0;0;175m    bg_RGB test 0;0;175     %clr%"
	call dk_echo "%bg_RGB%0;0;170m    bg_RGB test 0;0;170     %clr%"
	call dk_echo "%bg_RGB%0;0;165m    bg_RGB test 0;0;165     %clr%"
	call dk_echo "%bg_RGB%0;0;160m    bg_RGB test 0;0;160     %clr%"
	call dk_echo "%bg_RGB%0;0;155m    bg_RGB test 0;0;155     %clr%"
	call dk_echo "%bg_RGB%0;0;150m    bg_RGB test 0;0;150     %clr%"
	call dk_echo "%bg_RGB%0;0;145m    bg_RGB test 0;0;145     %clr%"
	call dk_echo "%bg_RGB%0;0;140m    bg_RGB test 0;0;140     %clr%"
	call dk_echo "%bg_RGB%0;0;135m    bg_RGB test 0;0;135     %clr%"
	call dk_echo "%bg_RGB%0;0;130m    bg_RGB test 0;0;130     %clr%"
	call dk_echo "%bg_RGB%0;0;125m    bg_RGB test 0;0;125     %clr%"
	call dk_echo "%bg_RGB%0;0;120m    bg_RGB test 0;0;120     %clr%"
	call dk_echo "%bg_RGB%0;0;115m    bg_RGB test 0;0;115     %clr%"
	call dk_echo "%bg_RGB%0;0;110m    bg_RGB test 0;0;110     %clr%"
	call dk_echo "%bg_RGB%0;0;105m    bg_RGB test 0;0;105     %clr%"
	call dk_echo "%bg_RGB%0;0;100m    bg_RGB test 0;0;100     %clr%"
	call dk_echo "%bg_RGB%0;0;95m    bg_RGB test 0;0;95      %clr%"
	call dk_echo "%bg_RGB%0;0;90m    bg_RGB test 0;0;90      %clr%"
	call dk_echo "%bg_RGB%0;0;85m    bg_RGB test 0;0;85      %clr%"
	call dk_echo "%bg_RGB%0;0;80m    bg_RGB test 0;0;80      %clr%"
	call dk_echo "%bg_RGB%0;0;75m    bg_RGB test 0;0;75      %clr%"
	call dk_echo "%bg_RGB%0;0;70m    bg_RGB test 0;0;70      %clr%"
	call dk_echo "%bg_RGB%0;0;65m    bg_RGB test 0;0;65      %clr%"
	call dk_echo "%bg_RGB%0;0;60m    bg_RGB test 0;0;60      %clr%"
	call dk_echo "%bg_RGB%0;0;55m    bg_RGB test 0;0;55      %clr%"
	call dk_echo "%bg_RGB%0;0;50m    bg_RGB test 0;0;50      %clr%"
	call dk_echo "%bg_RGB%0;0;45m    bg_RGB test 0;0;45      %clr%"
	call dk_echo "%bg_RGB%0;0;40m    bg_RGB test 0;0;40      %clr%"
	call dk_echo "%bg_RGB%0;0;35m    bg_RGB test 0;0;35      %clr%"
	call dk_echo "%bg_RGB%0;0;30m    bg_RGB test 0;0;30      %clr%"
	call dk_echo "%bg_RGB%0;0;25m    bg_RGB test 0;0;25      %clr%"
	call dk_echo "%bg_RGB%0;0;20m    bg_RGB test 0;0;20      %clr%"
	call dk_echo "%bg_RGB%0;0;15m    bg_RGB test 0;0;15      %clr%"
