...
# Test/dk_test()
#
def Test_dk_test(*args):
#   dk_debugFunc 0 99

    print(f" ################# Test/dk_test.cmd ################")
...
#    dk_test("from Test/DKTEST()", "to dk_test()")
#    print("")
#	print("GLOBAL_VAR = "+GLOBAL_VAR)
#	print("RETURN_VAR = "+RETURN_VAR)
	
    Test_dk_test("from Test/DKTEST()", "to Test/dk_test()")
    print("")
#	print("GLOBAL_VAR = "+GLOBAL_VAR)
#	print("RETURN_VAR = "+RETURN_VAR)
	
#   Test_Test_dk_test("from Test/DKTEST()", "to Test/Test/dk_test()")
#   print("")
#	print("GLOBAL_VAR = "+GLOBAL_VAR)
#	print("RETURN_VAR = "+RETURN_VAR)
#endfunction
